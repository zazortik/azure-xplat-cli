...
_.extend(ServiceBusManagementService.prototype, {
  ...
  */
  ...
  createNamespace: function (namespaceName, region, callback) {
    ...
    this._getResult(path, 'put', { outputdata: body}, 'NamespaceDescription', callback);
  },
  ...
  */
  ...
  _getResult: function (path, verb, requestBody, responseContentElementName, callback) {
    ...
    this.performRequest(webResource, null, null, function (responseObject, next) {
      console.log("Response for path " + path + " is " + util.inspect(responseObject, false, 100, false)); 
