...
exports.init = function(cli) {
  ...
  dnsserver.command('register <dnsip>')
    ...
    .option('-i, --dns-id <name>', 'Name identifier for the DNS entry')
    .option('-s, --subscription <id>', 'use the subscription id')
  ...
  dnsserver.command('unregister')
    ...
    .option('-i, --dns-id <name>', 'Name identifier of the DNS entry')
    .option('-p, --dns-ip <name>', 'IP address of the DNS entry')
