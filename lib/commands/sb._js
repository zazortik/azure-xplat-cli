...
exports.init = function (cli) {
  ...
  sbnamespace.command('list')
    ...
    .execute(function (options, _) {
      ...
      var namespaces = service.namespaces.list(_).namespaces;
  ...
  sbnamespace.command('show [name]')
    ...
    .execute(function (name, options, _) {
      ...
      var namespace = service.namespaces.get(name, _).namespace;
      progress.end();
  ...
  sbnamespace.command('check <name>')
    ...
    .execute(function (name, options, _) {
      ...
      var result = service.namespaces.checkAvailability(name, _).isAvailable;
      progress.end();
  ...
  function createService(subscription) {
    return utils._createServiceBusManagementService(cli.category('account').getCurrentSubscription(subscription), log);
  }
};