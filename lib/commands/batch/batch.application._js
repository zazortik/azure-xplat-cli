...
exports.init = function(cli) {
  ...
  */
  ...
  function addApplication(resourcegroup, accountName, applicationId, options, _) {
    ...
    var batchAccount = service.account.get(options.resourceGroup, options.accountName, _);
    ...
    try {
      startProgress(tips);
      service.applicationOperations.addApplication(options.resourceGroup, options.accountName, options.applicationId, { parameters : param }, _);
    } finally {
      endProgress();
    }
  ...
  */
  function showApplication(resourcegroup, accountName, applicationId, options, _) {
    ...
    try {
      startProgress(tips);
      application = service.applicationOperations.getApplication(options.resourceGroup, options.accountName, options.applicationId, _);
    } finally {
      endProgress();
    }
  ...
  */
  ...
  function addApplicationPkg(resourcegroup, accountName, applicationId, version, packageFile, options, _) {
    ...
    try {
      startProgress(tips);
      var response = service.applicationOperations.addApplicationPackage(options.resourceGroup, options.accountName, options.applicationId, options.version, _);
  ...
  function showApplicationPkg(resourcegroup, accountName, applicationId, version, options, _) {
    ...
    try {
      startProgress(tips);
      application = service.applicationOperations.getApplicationPackage(options.resourceGroup, options.accountName, options.applicationId, options.version, _);
    } finally {
      endProgress();
    }
