...
exports.init = function(cli) {
  ...
  */
  ...
  certificate.command('create [thumbprint] [cert-file]')
    ...
    .option('--cert-file <cert-file>', $('the certificate file: cer file or pfx file'))
    .option('--thumbprint-algorithm <thumbprint-algorithm>', $('the certificate thumbprint algorithm'))
    .option('--password <password>', $('password for PFX file'))
  ...
  */
  ...
  function deleteCertificate(thumbprint, options, _) {
    ...
    if (options.abort) {
      tips = util.format($('Cacnelling certificate %s deletion'), thumbprint);
