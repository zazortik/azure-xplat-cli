...
exports.init = function(cli) {
  ...
  */
  ...
  jobSchedule.command('create [json-file]')
    ...
    .option('-p, --pool-id <poolId>', $('the id of an existing pool; all the tasks of jobs created under this schedule will run on the speicfied pool'))
    ...
    .option('--do-not-run-until <do-not-run-until>', $('the earliest time at which any ob may be created under this job schedule; if you do not specify a time, the scheudle becomes ready to create jobs immediately.'))
