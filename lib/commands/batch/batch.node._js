...
exports.init = function(cli) {
  ...
  */
  ...
  node.command('addUser [pool-id] [node-id] [user-name] [user-password]')
  ...
  node.command('deleteUser [pool-id] [node-id] [user-name]')
  ...
  node.command('updateUser [pool-id] [node-id] [user-name]')
  ...
  node.command('disableScheduling [pool-id] [node-id]')
  ...
  node.command('enableScheduling [pool-id] [node-id]')
  ...
  node.command('getRemoteDesktop [pool-id] [node-id] [rdp-file]')
