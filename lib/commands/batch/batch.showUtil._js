...
batchShowUtil.showJobManagerTask = function(jobManagerTask, output, indent) {
  ...
  batchShowUtil.showArray(jobManagerTask.environmentSettings, batchShowUtil.showEnviromentSetting, $('Environment Settings'), $('Environment Setting'), output, indent);
...
batchShowUtil.showJobPreparationTask = function(jobPrepTask, output, indent) {
  ...
  batchShowUtil.showArray(jobPrepTask.environmentSettings, batchShowUtil.showEnviromentSetting, $('Environment Settings'), $('Environment Setting'), output, indent);
...
batchShowUtil.showJobReleaseTask = function(jobReleaseTask, output, indent) {
  ...
  batchShowUtil.showArray(jobReleaseTask.environmentSettings, batchShowUtil.showEnviromentSetting, $('Environment Settings'), $('Environment Setting'), output, indent);
...
batchShowUtil.showEnviromentSetting = function(setting, output, indent) {
  var showNameValue = batchShowUtil.showNameValue;
...
batchShowUtil.showStartTask = function(startTask, output, indent) {
  ...
  batchShowUtil.showArray(startTask.environmentSettings, batchShowUtil.showEnviromentSetting, $('Environment Settings'), $('Environment Setting'), output, indent);
}
...
batchShowUtil.showSchedulingError = function(error, output, indent) {
  ...
  batchShowUtil.showKvPairs($('Details'), error.details, output, indent);
}
...
batchShowUtil.showNodeError = function(error, output, indent) {
  ...
  showNameValue($('Code'), error.code, true, output, indent);
  showNameValue($('Message'), error.message, true, output, indent);
  batchShowUtil.showKvPairs($('Details'), error.errorDetails, output, indent);
}

batchShowUtil.showComputeNode = function(node, output, indent) {
  if (!node) {
    return;
  }
  ...
  batchShowUtil.showArray(node.recentTasks, batchShowUtil.showNodeError, $('Compute Node Erros'), $('Error'), output, indent);
}
