...
exports.init = function(cli) {
  ...
  */
  ...
  job.command('set [jobId] [json-file]')
    ...
    .option('-f, --json-file <json-file>', $('the file containing the job properties to patch/update in JSON format'))
  ...
  job.command('stop <jobId>')
    ...
    .option('--reason [reason]', $('the text you want to appear as the job\'s terminate reason'))
    .appendCommonHeaderFilterOption(true, true)
    .appendBatchAccountOption()
