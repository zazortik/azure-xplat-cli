...
function generateNodeDeploymentScript(repositoryRoot, scriptType, _) {
    ...
    generateBasicDeploymentScript("node.template", scriptType, repositoryRoot, _);
}
...
function generateWapDeploymentScript(repositoryRoot, projectPath, solutionPath, scriptType, _) {
    ...
    generateDotNetDeploymentScript("deploy.batch.aspnet.wap.template", msbuildArguments, repositoryRoot, _);
}
...
function generateWebSiteDeploymentScript(repositoryRoot, solutionPath, scriptType, _) {
    if (solutionPath) {
        ...
        generateDotNetDeploymentScript("deploy.batch.aspnet.website.template", msbuildArguments, repositoryRoot, _);
    }
    else {
        // Basic website
        generateBasicDeploymentScript("basic.template", scriptType, repositoryRoot, _);
    }
}

function generateBasicDeploymentScript(templateFileName, scriptType, repositoryRoot, _) {
...
function generateDotNetDeploymentScript(templateFileName, msbuildArguments, repositoryRoot, _) {
    argNotNull(templateFileName, "templateFileName");
    ...
    templateContent =
        templateContent.replace(/{MSBuildArguments}/g, msbuildArguments);
