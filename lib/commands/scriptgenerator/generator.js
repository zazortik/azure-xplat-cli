...
ScriptGenerator.prototype.generateDeploymentScript = function ScriptGenerator_prototype_generateDeploymentScript__1(_) { var __this = this; var __frame = { name: "ScriptGenerator_prototype_generateDeploymentScript__1", line: 81 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateDeploymentScript__1, 0, __frame, function __$ScriptGenerator_prototype_generateDeploymentScript__1() { return (function __$ScriptGenerator_prototype_generateDeploymentScript__1(__then) {
      if ((__this.projectType === ProjectType.wap)) {
        return __this.generateWapDeploymentScript(__cb(_, __frame, 2, 8, __then, true)); } else { return (function __$ScriptGenerator_prototype_generateDeploymentScript__1(__then) {

          if ((__this.projectType === ProjectType.website)) {
            return __this.generateWebSiteDeploymentScript(__cb(_, __frame, 5, 8, __then, true)); } else { return (function __$ScriptGenerator_prototype_generateDeploymentScript__1(__then) {

              if ((__this.projectType === ProjectType.node)) {
                return __this.generateNodeDeploymentScript(__cb(_, __frame, 8, 8, __then, true)); } else { return (function __$ScriptGenerator_prototype_generateDeploymentScript__1(__then) {

                  if ((__this.projectType === ProjectType.basic)) {
                    if (__this.solutionPath) {
                      return _(new Error("Solution path is not supported with this website type")); } ;

                    return __this.generateWebSiteDeploymentScript(__cb(_, __frame, 14, 8, __then, true)); } else {


                    return _(new Error(("Invalid project type received: " + __this.projectType))); } ; })(__then); } ; })(__then); } ; })(__then); } ; })(_); });};
...
ScriptGenerator.prototype.generateNodeDeploymentScript = function ScriptGenerator_prototype_generateNodeDeploymentScript__2(_) { var __this = this; var __frame = { name: "ScriptGenerator_prototype_generateNodeDeploymentScript__2", line: 112 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateNodeDeploymentScript__2, 0, __frame, function __$ScriptGenerator_prototype_generateNodeDeploymentScript__2() {
...
ScriptGenerator.prototype.generateWapDeploymentScript = function ScriptGenerator_prototype_generateWapDeploymentScript__3(_) { var msbuildArguments, solutionDir, __this = this; var __frame = { name: "ScriptGenerator_prototype_generateWapDeploymentScript__3", line: 153 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateWapDeploymentScript__3, 0, __frame, function __$ScriptGenerator_prototype_generateWapDeploymentScript__3() {
...
ScriptGenerator.prototype.generateWebSiteDeploymentScript = function ScriptGenerator_prototype_generateWebSiteDeploymentScript__4(_) { var msbuildArguments, __this = this; var __frame = { name: "ScriptGenerator_prototype_generateWebSiteDeploymentScript__4", line: 172 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateWebSiteDeploymentScript__4, 0, __frame, function __$ScriptGenerator_prototype_generateWebSiteDeploymentScript__4() { return (function __$ScriptGenerator_prototype_generateWebSiteDeploymentScript__4(__then) {
      if (__this.solutionPath) {
...
ScriptGenerator.prototype.generateDotNetDeploymentScript = function ScriptGenerator_prototype_generateDotNetDeploymentScript__6(templateFileName, msbuildArguments, _) { var templateContent, __this = this; var __frame = { name: "ScriptGenerator_prototype_generateDotNetDeploymentScript__6", line: 206 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateDotNetDeploymentScript__6, 2, __frame, function __$ScriptGenerator_prototype_generateDotNetDeploymentScript__6() {
    argNotNull(templateFileName, "templateFileName");
...
function writeContentToFile(path, content, _) { var __frame = { name: "writeContentToFile", line: 267 }; return __func(_, this, arguments, writeContentToFile, 2, __frame, function __$writeContentToFile() { return (function __$writeContentToFile(__then) {
