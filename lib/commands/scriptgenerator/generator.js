...
function generateNodeDeploymentScript(repositoryRoot, scriptType, _) { var __frame = { name: "generateNodeDeploymentScript", line: 71 }; return __func(_, this, arguments, generateNodeDeploymentScript, 2, __frame, function __$generateNodeDeploymentScript() {
    ...
    return generateBasicDeploymentScript("node.template", scriptType, __cb(_, __frame, 5, 4, _, true)); });};
...
function generateWapDeploymentScript(repositoryRoot, projectPath, solutionPath, scriptType, _) { var relativeProjectPath, relativeSolutionPath, msbuildArguments; var __frame = { name: "generateWapDeploymentScript", line: 113 }; return __func(_, this, arguments, generateWapDeploymentScript, 4, __frame, function __$generateWapDeploymentScript() {
    ...
    return generateDotNetDeploymentScript("deploy.batch.aspnet.wap.template", msbuildArguments, __cb(_, __frame, 18, 4, _, true)); });};
...
function generateWebSiteDeploymentScript(repositoryRoot, solutionPath, scriptType, _) { var relativeSolutionPath, msbuildArguments; var __frame = { name: "generateWebSiteDeploymentScript", line: 134 }; return __func(_, this, arguments, generateWebSiteDeploymentScript, 3, __frame, function __$generateWebSiteDeploymentScript() { return (function __$generateWebSiteDeploymentScript(__then) {
      if (solutionPath) {
        ...
        return generateDotNetDeploymentScript("deploy.batch.aspnet.website.template", msbuildArguments, __cb(_, __frame, 12, 8, __then, true)); } else {



        return generateBasicDeploymentScript("basic.template", scriptType, __cb(_, __frame, 16, 8, __then, true)); } ; })(_); });};



function generateBasicDeploymentScript(templateFileName, scriptType, _) { var lowerCaseScriptType, templateContent; var __frame = { name: "generateBasicDeploymentScript", line: 154 }; return __func(_, this, arguments, generateBasicDeploymentScript, 2, __frame, function __$generateBasicDeploymentScript() {
    ...
    return writeDeploymentFiles(templateContent, scriptType, __cb(_, __frame, 12, 4, _, true)); });};


function generateDotNetDeploymentScript(templateFileName, msbuildArguments, _) { var templateContent; var __frame = { name: "generateDotNetDeploymentScript", line: 169 }; return __func(_, this, arguments, generateDotNetDeploymentScript, 2, __frame, function __$generateDotNetDeploymentScript() {
    argNotNull(templateFileName, "templateFileName");
    ...
    return writeDeploymentFiles(templateContent, "BATCH", __cb(_, __frame, 7, 4, _, true)); });};
...
function writeDeploymentFiles(templateContent, scriptType, _) { var deployScriptFileName, deploymentCommand; var __frame = { name: "writeDeploymentFiles", line: 189 }; return __func(_, this, arguments, writeDeploymentFiles, 2, __frame, function __$writeDeploymentFiles() {
    ...
    return writeContentToFile(deployScriptFileName, templateContent, __cb(_, __frame, 15, 4, function __$writeDeploymentFiles() {


      return writeContentToFile(".deployment", ("[config]\ncommand = " + deploymentCommand), __cb(_, __frame, 18, 4, function __$writeDeploymentFiles() {
...
function writeContentToFile(path, content, _) { var __frame = { name: "writeContentToFile", line: 220 }; return __func(_, this, arguments, writeContentToFile, 2, __frame, function __$writeContentToFile() { return (function __$writeContentToFile(__then) {

      if (fs.existsSync(path)) {
        return confirm((("The file: \"" + path) + "\" already exists\nAre you sure you want to overwrite it: "), __cb(_, __frame, 3, 12, function ___(__0, __1) { return (function __$writeContentToFile(__then) { if (__1) { __then(); } else {


              return _(new Error("File already exist")); } ; })(__then); }, true)); } else { __then(); } ; })(function __$writeContentToFile() {



      return fs.writeFile(path, content, __cb(_, __frame, 10, 4, _, true)); }); });};
