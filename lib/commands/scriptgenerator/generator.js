...
exports.generateDeploymentScript = function exports_generateDeploymentScript__1(repositoryRoot, projectType, projectPath, solutionPath, sitePath, scriptType, logger, confirmFunc, _) { var relativeProjectPath, relativeSolutionPath, relativeSitePath; var __frame = { name: "exports_generateDeploymentScript__1", line: 13 }; return __func(_, this, arguments, exports_generateDeploymentScript__1, 8, __frame, function __$exports_generateDeploymentScript__1() {
    ...
    projectType = projectType.toUpperCase(); return (function __$exports_generateDeploymentScript__1(__then) {
      if ((projectType === "WAP")) {
        return generateWapDeploymentScript(repositoryRoot, relativeProjectPath, relativeSolutionPath, scriptType, relativeSitePath, __cb(_, __frame, 44, 8, __then, true)); } else { return (function __$exports_generateDeploymentScript__1(__then) {

          if ((projectType === "WEBSITE")) {
            return generateWebSiteDeploymentScript(repositoryRoot, relativeSolutionPath, scriptType, relativeSitePath, __cb(_, __frame, 47, 8, __then, true)); } else { return (function __$exports_generateDeploymentScript__1(__then) {

              if ((projectType === "NODE")) {
                return generateNodeDeploymentScript(repositoryRoot, scriptType, relativeSitePath, __cb(_, __frame, 50, 8, __then, true)); } else { return (function __$exports_generateDeploymentScript__1(__then) {

                  if ((projectType === "BASIC")) {
                    if (solutionPath) {
                      return _(new Error("Solution path is not supported with this website type")); } ;

                    return generateWebSiteDeploymentScript(repositoryRoot, relativeSolutionPath, scriptType, relativeSitePath, __cb(_, __frame, 56, 8, __then, true)); } else {
...
function generateNodeDeploymentScript(repositoryRoot, scriptType, sitePath, _) { var __frame = { name: "generateNodeDeploymentScript", line: 86 }; return __func(_, this, arguments, generateNodeDeploymentScript, 3, __frame, function __$generateNodeDeploymentScript() {
    argNotNull(repositoryRoot, "repositoryRoot");
    ...
    return utils.copyIisNodeWhenServerJsPresent(log, repositoryRoot, __cb(_, __frame, 4, 4, function __$generateNodeDeploymentScript() {
      ...
      return generateBasicDeploymentScript("node.template", scriptType, repositoryRoot, sitePath, __cb(_, __frame, 6, 4, _, true)); }, true)); });};
...
function generateWapDeploymentScript(repositoryRoot, projectPath, solutionPath, scriptType, sitePath, _) { var msbuildArguments; var __frame = { name: "generateWapDeploymentScript", line: 129 }; return __func(_, this, arguments, generateWapDeploymentScript, 5, __frame, function __$generateWapDeploymentScript() {
    argNotNull(repositoryRoot, "repositoryRoot");
    ...
    return generateDotNetDeploymentScript("deploy.batch.aspnet.wap.template", msbuildArguments, repositoryRoot, sitePath, __cb(_, __frame, 15, 4, _, true)); });};


function generateWebSiteDeploymentScript(repositoryRoot, solutionPath, scriptType, sitePath, _) { var msbuildArguments; var __frame = { name: "generateWebSiteDeploymentScript", line: 147 }; return __func(_, this, arguments, generateWebSiteDeploymentScript, 4, __frame, function __$generateWebSiteDeploymentScript() { return (function __$generateWebSiteDeploymentScript(__then) {
      if (solutionPath) {
        ...
        return generateDotNetDeploymentScript("deploy.batch.aspnet.website.template", msbuildArguments, repositoryRoot, sitePath, __cb(_, __frame, 10, 8, __then, true)); } else {



        return generateBasicDeploymentScript("basic.template", scriptType, repositoryRoot, sitePath, __cb(_, __frame, 14, 8, __then, true)); } ; })(_); });};



function generateBasicDeploymentScript(templateFileName, scriptType, repositoryRoot, sitePath, _) { var lowerCaseScriptType, templateContent; var __frame = { name: "generateBasicDeploymentScript", line: 165 }; return __func(_, this, arguments, generateBasicDeploymentScript, 4, __frame, function __$generateBasicDeploymentScript() {
    ...
    return writeDeploymentFiles(templateContent, scriptType, repositoryRoot, __cb(_, __frame, 13, 4, _, true)); });};


function generateDotNetDeploymentScript(templateFileName, msbuildArguments, repositoryRoot, sitePath, _) { var templateContent; var __frame = { name: "generateDotNetDeploymentScript", line: 181 }; return __func(_, this, arguments, generateDotNetDeploymentScript, 4, __frame, function __$generateDotNetDeploymentScript() {
    argNotNull(templateFileName, "templateFileName");
    ...
    return writeDeploymentFiles(templateContent, "BATCH", repositoryRoot, __cb(_, __frame, 12, 4, _, true)); });};
...
function writeDeploymentFiles(templateContent, scriptType, repositoryRoot, _) { var deployScriptFileName, deploymentCommand, deployScriptPath, deploymentFilePath; var __frame = { name: "writeDeploymentFiles", line: 206 }; return __func(_, this, arguments, writeDeploymentFiles, 3, __frame, function __$writeDeploymentFiles() {
...
function writeContentToFile(path, content, _) { var __frame = { name: "writeContentToFile", line: 240 }; return __func(_, this, arguments, writeContentToFile, 2, __frame, function __$writeContentToFile() { return (function __$writeContentToFile(__then) {
