...
exports.generateDeploymentScript = function exports_generateDeploymentScript__1(repositoryRoot, projectType, projectPath, solutionPath, scriptType, logger, confirmFunc, _) { var __frame = { name: "exports_generateDeploymentScript__1", line: 13 }; return __func(_, this, arguments, exports_generateDeploymentScript__1, 7, __frame, function __$exports_generateDeploymentScript__1() {
...
function generateNodeDeploymentScript(repositoryRoot, scriptType, _) { var __frame = { name: "generateNodeDeploymentScript", line: 72 }; return __func(_, this, arguments, generateNodeDeploymentScript, 2, __frame, function __$generateNodeDeploymentScript() {
    argNotNull(repositoryRoot, "repositoryRoot");
    ...
    return utils.copyIisNodeWhenServerJsPresent(log, repositoryRoot, __cb(_, __frame, 4, 4, function __$generateNodeDeploymentScript() {
      ...
      return generateBasicDeploymentScript("node.template", scriptType, repositoryRoot, __cb(_, __frame, 6, 4, _, true)); }, true)); });};
...
function generateBasicDeploymentScript(templateFileName, scriptType, repositoryRoot, _) { var lowerCaseScriptType, templateContent; var __frame = { name: "generateBasicDeploymentScript", line: 156 }; return __func(_, this, arguments, generateBasicDeploymentScript, 3, __frame, function __$generateBasicDeploymentScript() {
...
function generateDotNetDeploymentScript(templateFileName, msbuildArguments, repositoryRoot, _) { var templateContent; var __frame = { name: "generateDotNetDeploymentScript", line: 171 }; return __func(_, this, arguments, generateDotNetDeploymentScript, 3, __frame, function __$generateDotNetDeploymentScript() {
    argNotNull(templateFileName, "templateFileName");
    ...
    templateContent = templateContent.replace(/{MSBuildArguments}/g, msbuildArguments);
...
function writeDeploymentFiles(templateContent, scriptType, repositoryRoot, _) { var deployScriptFileName, deploymentCommand, deployScriptPath, deploymentFilePath; var __frame = { name: "writeDeploymentFiles", line: 191 }; return __func(_, this, arguments, writeDeploymentFiles, 3, __frame, function __$writeDeploymentFiles() {
...
function writeContentToFile(path, content, _) { var __frame = { name: "writeContentToFile", line: 225 }; return __func(_, this, arguments, writeContentToFile, 2, __frame, function __$writeContentToFile() { return (function __$writeContentToFile(__then) {
