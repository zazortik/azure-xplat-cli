...
ScriptGenerator.prototype.generateWebSiteDeploymentScript = function ScriptGenerator_prototype_generateWebSiteDeploymentScript__4(_) { var msbuildArguments, packageJsonFilePath, __this = this; var __frame = { name: "ScriptGenerator_prototype_generateWebSiteDeploymentScript__4", line: 186 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateWebSiteDeploymentScript__4, 0, __frame, function __$ScriptGenerator_prototype_generateWebSiteDeploymentScript__4() { return (function __$ScriptGenerator_prototype_generateWebSiteDeploymentScript__4(__then) {
      if (__this.solutionPath) {
        ...
        packageJsonFilePath = path.join(__this.absoluteSitePath, "package.json");
        console.log(packageJsonFilePath); return (function __$ScriptGenerator_prototype_generateWebSiteDeploymentScript__4(__then) {
          if (fs.existsSync(packageJsonFilePath)) {

            return __this.generateBasicDeploymentScript("node.template", __cb(_, __frame, 18, 12, __then, true)); } else {



            return __this.generateBasicDeploymentScript("basic.template", __cb(_, __frame, 22, 12, __then, true)); } ; })(__then); } ; })(_); });};




ScriptGenerator.prototype.generateBasicDeploymentScript = function ScriptGenerator_prototype_generateBasicDeploymentScript__5(templateFileName, _) { var lowerCaseScriptType, templateContent, __this = this; var __frame = { name: "ScriptGenerator_prototype_generateBasicDeploymentScript__5", line: 213 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateBasicDeploymentScript__5, 1, __frame, function __$ScriptGenerator_prototype_generateBasicDeploymentScript__5() {
...
ScriptGenerator.prototype.generateDotNetDeploymentScript = function ScriptGenerator_prototype_generateDotNetDeploymentScript__6(templateFileName, msbuildArguments, _) { var templateContent, __this = this; var __frame = { name: "ScriptGenerator_prototype_generateDotNetDeploymentScript__6", line: 229 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateDotNetDeploymentScript__6, 2, __frame, function __$ScriptGenerator_prototype_generateDotNetDeploymentScript__6() {
    argNotNull(templateFileName, "templateFileName");
