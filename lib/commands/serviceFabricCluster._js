...
exports.init = function (cli) {
  ...
  cluster.command('connect [connectionEndpoint] [clientConnectionEndpoint] [clientKeyPath] [clientCertPath] [caCertPath]')
    ...
    .execute(function (connectionEndpoint, clientConnectionEndpoint, clientKeyPath, clientCertPath, caCertPath, options, _) {
