...
exports.init = function (cli) {
  ...
  storageAccount.showCommand = function (name, options, _) {
      ...
      if (storageAccount) {
        cli.interaction.formatOutput(storageAccount, function(outputData) {
          ...
          logEachData($('Account Properties'), outputData.properties);
          logEachData($('Extended Properties'), outputData.extendedProperties);
          logEachData($('Capabilities'), outputData.capabilities);
        });
      } else {
  ...
  storageAccount.createCommand = function (name, options, _) {
      ...
      var location = cli.interaction.chooseIfNotGiven($('Location: '), $('Getting locations'), params.values.location,
          function (cb) {
      ...
      var storageOptions = {
        ...
        geoReplicationEnabled: options.geoReplication !== undefined ? options.geoReplication : false
      };
  ...
  storageAccount.updateCommand = function (name, options, _) {
      ...
      if (options.geoReplication !== undefined || options.disableGeoReplication !== undefined) {
        storageOptions.geoReplicationEnabled = options.geoReplication;
      }
