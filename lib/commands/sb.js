...
exports.init = function(cli) {
  ...
  function promptIfNotGiven(promptString, currentValue, _) { var value; var __frame = { name: "promptIfNotGiven", line: 206 }; return __func(_, this, arguments, promptIfNotGiven, 2, __frame, function __$promptIfNotGiven() { return (function __$promptIfNotGiven(__then) {
        if (__.isUndefined(currentValue)) {
          return prompt(promptString, __cb(_, __frame, 2, 18, function ___(__0, __1) { value = __1;
  ...
  function chooseIfNotGiven(promptString, progressString, currentValue, valueProvider, _) { var progress, values, i; var __frame = { name: "chooseIfNotGiven", line: 216 }; return __func(_, this, arguments, chooseIfNotGiven, 4, __frame, function __$chooseIfNotGiven() { return (function __$chooseIfNotGiven(__then) {
        if (__.isUndefined(currentValue)) {
          progress = cli.progress(progressString);
          return valueProvider(__cb(_, __frame, 3, 19, function ___(__0, __1) { values = __1;
            progress.end();

            log.help(promptString);
            return choose(values, __cb(_, __frame, 7, 14, function ___(__0, __2) { i = __2;
