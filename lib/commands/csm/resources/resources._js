...
exports.init = function (cli) {
  ...
  resource.command('create [resource-group] [name] [resourceType] [location]')
    .usage('[options] <resource-group> <name> <resourceType> <location>')
  ...
  resource.command('delete [resource-group] [name] [resourceType]')
    ...
    .execute(function (resourceGroup, name, resourceType, options, _) {
      ...
      try {
        ...
        client.resources.delete(resourceGroup, name, _);
      } finally {
        progress.end();
      }
    });
