...
exports.init = function (cli) {
  ...
  resource.command('create [resource-group] [name] [resource-type] [location] [api-version]')
    ...
    .execute(function (resourceGroup, name, resourceType, location, options, _) {
      resource.createResource(resourceGroup, name, resourceType, location, options, _);
    });
  ...
  resource.createResource = function (resourceGroup, name, resourceType, location, apiVersion, options, _) {
    ...
    var group = group.createResourceGroup(resourceGroup, location, options, _);
    ...
    if (location) {
      ...
      resource.location = newGroup.location;
    }
  ...
  resource.command('list [resource-group] [api-version]')
    .description($('Lists the resources'))
    .option('-g --resource-group <resource-group>', $('The resource group name'))
    .option('-r --resource-type <resource-type>', $('The resource type'))
    .option('-o --api-version <api-version>', $('The API version of the resource provider'))
    .option('--subscription <subscription>', $('the subscription identifier'))
    .execute(function (resourceGroup, apiVersion, options, _) {
      if (!apiVersion) {
        return cli.missingArgument('apiVersion');
      }
  ...
  resource.command('set [resource-group] [name] [resource-type] [properties]')
    ...
    .execute(function (resourceGroup, name, resourceType, properties, options, _) {
      if (!resourceGroup) {
        return cli.missingArgument('resourceGroup');
      } else if (!name) {
        return cli.missingArgument('name');
