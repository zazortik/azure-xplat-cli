...
exports.createDeployment = function (cli, resourceGroup, name, options, _) {
  ...
  cli.interaction.withProgress($('Creatinga a deployment'),
  function (log, _) {
...
exports.validateTemplate = function (cli, resourceGroup, options, _) {
  ...
  var result;
  cli.interaction.withProgress($('Validating the template'),
    function (log, _) {
      result = client.deployments.validate(resourceGroup, 'fakedDeploymentName', templateParameters, _);
    }, _);
  return result;
};
