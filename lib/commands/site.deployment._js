...
exports.init = function (cli) {
  ...
  scm.doDeploymentsGet = function (context, _) {
    ...
    var progress = cli.progress($('Getting deployments'));
    try {
  ...
  scm.doDeploymentGet = function (context, _) {
    ...
    var progress = cli.progress($('Getting deployment info'));
    try {
  ...
  scm.doLogGet = function (context, _) {
    ...
    var progress = cli.progress($('Getting deployment log info'));
    try {
  ...
  function getLogDetails(context, _) {
    ...
    if (logs && logs.length) {
      var progress = cli.progress($('Getting log details'));
      try {
