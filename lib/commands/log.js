...
exports.init = function(cli) {
  ...
  diagnostic.command("download [name]").description("Download diagnostic log").option("-s, --subscription <id>", "use the subscription id").option("-o, --output <path>", "output path, default is local folder").execute(function __1(name, options, _) { var context, repositoryUri, buf; var __frame = { name: "__1", line: 41 }; return __func(_, this, arguments, __1, 2, __frame, function __$__1() {
  ...
  diagnostic.command("tail [name]").description("Live diagnostic log").option("-s, --subscription <id>", "use the subscription id").option("-p, --path <path>", "the log path under LogFiles folder").option("-f, --filter <filter>", "filter matching line").execute(function __2(name, options, _) { var context, repositoryUri, buf; var __frame = { name: "__2", line: 75 }; return __func(_, this, arguments, __2, 2, __frame, function __$__2() {
  ...
  function doDownloadDiagnostic(context, _) { var channel, progress; var __frame = { name: "doDownloadDiagnostic", line: 97 }; return __func(_, this, arguments, doDownloadDiagnostic, 1, __frame, function __$doDownloadDiagnostic() {
  ...
  function doLogStream(context, _, chunkcb) { var channel; var __frame = { name: "doLogStream", line: 108 }; return __func(_, this, arguments, doLogStream, 1, __frame, function __$doLogStream() {
