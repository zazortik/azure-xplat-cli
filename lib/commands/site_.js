...
var ScriptGenerator = require('./scriptgenerator/generator').ScriptGenerator;
...
exports.init = function (cli) {
  ...
  site.command('deploymentscript')
        ...
        .execute(function (name, options, _) {
            ...
            var scriptGenerator = new ScriptGenerator(repositoryRoot, projectType, projectFile, solutionFile, sitePath, scriptType, noDotDeployment, log, confirmFunc);
