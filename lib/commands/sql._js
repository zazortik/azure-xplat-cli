...
exports.init = function (cli) {
  ...
  server.command('create [administratorLogin] [administratorPassword] [location]')
    ...
    .execute(function (administratorLogin, administratorPassword, location, options, _) {
      ...
      administratorPassword = interaction.promptPasswordIfNotGiven(cli, "New administrator login password: ", params.values.administratorPassword, _);
  ...
  db.command('create [serverName] [databaseName] [administratorPassword]')
