...
exports.init = function (cli) {
  ...
  applicationPackage.command('copy [applicationPackagePath] [imageStoreConnectionString] [applicationPackagePathInImageStore]')
    ...
    .execute(function (applicationPackagePath, imageStoreConnectionString, applicationPackagePathInImageStore, options, _) {
      ...
      try {
        ...
        var clientOptions = serviceFabricUtils.getClientOptions(config, _);
  ...
  //       var command = util.format('copyapplicationpackage "%s" "%s" "%s" "%s" "%s"', config.tcpConnectionEndpoint, applicationPackagePath, imageStoreConnectionString, applicationPackagePathInImageStore ? applicationPackagePathInImageStore : '', fingerprint ? fingerprint : '');
