...
exports.init = function (cli) {
  ...
  function validateRequiredOptions(fields, options) {
    Object.keys(fields).forEach(function (fieldName) {
      if (!options[fieldName]) {
        throw new Error($(fields[fileName]));
      }
    });
  }
  ...
  var envFieldsToOptionsFields = [
    ...
    ['resourceManagementEndpointUrl', 'resourceManagementEndpoint'],
    ['activeDirectoryEndpointUrl', 'activeDirectoryEndpoint'],
    ['publicGalleryEndpointUrl', 'publicGalleryEndpoint']
  ];
  ...
  environment.command('add [environment]')
    ...
    .option('--resource-management-endpoint <resourceManagementEndpoint>', $('Endpoint for resource management'))
    .option('--public-gallery-endpoint <publicGalleryEndpoint>',$('Endpoint for public gallery'))
    .execute(function (environment, options, _) {
