...
exports.init = function(cli) {
  ...
  function exportNetworkConfig(filePath, options, cmdCallback) {
    var progress = cli.progress($('Enumerating network configuration'));
  ...
  function listVNet(options, _) {
    ...
    var progress = cli.progress($('Enumerating virtual networks'));
    try {
  ...
  function createVNet(vnet, options, _) {
    ...
    var affinityGroup;
    progress = cli.progress($('Enumerating or creating affinity group'));
    try {
  ...
  function getOrCreateAffinityGroup(options, callback) {
    ...
    var _getLocations = function(locationsCallBack) {
      progress = cli.progress($('Enumerating locations'));
    ...
    var _getAffinityGroups = function(locationsCallBack) {
      progress = cli.progress($('Enumerating affinity groups'));
