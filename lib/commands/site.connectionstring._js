...
exports.init = function (cli) {
  ...
  siteConnectionStrings.command('list [name]')
    ...
    .execute(function (name, options, _) {
      ...
      if (siteConfigurations.AppSettings.NameValuePair) {
        siteConfigurations = {
          '$': siteConfigurations['$'],
          AppSettings: getSettings(siteConfigurations.AppSettings)
        };
  ...
  siteConnectionStrings.command('add <keyvaluepair> [name]')
    .usage('[options] <keyvaluepair> [name]')
    .description('Adds a connection string for your site')
    .option('-s, --subscription <id>', 'use the subscription id')
  ...
  siteConnectionStrings.command('delete <key> [name]')
  ...
  siteConnectionStrings.command('show <key> [name]')
    .usage('[options] <key> [name]')
    ...
    if (!found) {
      throw new Error('Connection string with key "' + key + '" does not exist.');
    }
  });
};