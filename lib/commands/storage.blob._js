...
exports.init = function(cli) {
  ...
  */
  ...
  blob.command('upload [file] [container] [blob]')
    ...
    .option('-p, --properties <properties>', 'Storage blob properties for uploaded file. Properties are key=value pairs and separated with semicolon(;). Available properties are contentType, contentEncoding, contentLanguage, contentMD5, cacheControl.')
