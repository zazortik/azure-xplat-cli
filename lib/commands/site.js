      ...
      if (options.aspWAP) {
        ...
        if (options.aspWebSite) {
          ...
          if (options.node) {
            ...
            return scriptGenerator.generateDeploymentScript(repositoryRoot, projectType, projectFile, solutionFile, scriptType, log, confirm, __cb(_, __frame, 36, 16, __then, true)); }); })(function ___(e, __result) { __tryCatch(_, function __$__2() { if (e) {
