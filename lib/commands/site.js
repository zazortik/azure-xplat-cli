...
exports.init = function(cli) {
  ...
  site.command("list").description("List your web sites").option("-s, --subscription <id>", "use the subscription id").execute(function __1(options, _) { var parameters, sites, s; var __frame = { name: "__1", line: 78 }; return __func(_, this, arguments, __1, 1, __frame, function __$__1() {
  ...
  site.command("create [name]").description("Create a new web site").option("-s, --subscription <id>", "use the subscription id").option("--location <location>", "the geographic region to create the website").option("--hostname <hostname>", "custom host name to use").option("--git", "configure git on web site and local folder").option("-pu, --publishingUsername <publishingUsername>", "The publishing username for git").option("--github", "configure github on web site and local folder").option("--githubusername <username>", "The github username").option("--githubpassword <password>", "The github password").option("--githubrepository <repository>", "The github repository full name (i.e. user/repository)").execute(function __3(nameArg, options, _) { var context;
    ...
    function updateLocalConfigWithSiteName(_) { var cfg; var __frame = { name: "updateLocalConfigWithSiteName", line: 308 }; return __func(_, this, arguments, updateLocalConfigWithSiteName, 0, __frame, function __$updateLocalConfigWithSiteName() {
    ...
    function createSite(_) { var __frame = { name: "createSite", line: 318 }; return __func(_, this, arguments, createSite, 0, __frame, function __$createSite() {
    ...
    function initializeRemoteRepo(_) { var __frame = { name: "initializeRemoteRepo", line: 325 }; return __func(_, this, arguments, initializeRemoteRepo, 0, __frame, function __$initializeRemoteRepo() {
    ...
    function addRemoteToLocalGitRepo(_) { var remotes, azureExists, gitUri; var __frame = { name: "addRemoteToLocalGitRepo", line: 341 }; return __func(_, this, arguments, addRemoteToLocalGitRepo, 0, __frame, function __$addRemoteToLocalGitRepo() {
        ...
        if (!context.flags.isGitWorkingTree) {
          ...
          return exec("git remote", __cb(_, __frame, 13, 26, function ___(__0, __3) { remotes = __3;
            azureExists = ((remotes.stdout + remotes.stderr)).split("\n").some(function(item) {
              ...
              return exec(("git remote add azure " + gitUri), __cb(_, __frame, 25, 12, function __$addRemoteToLocalGitRepo() {
                log.info("A new remote, 'azure', has been added to your local git repository.");
                log.info("Use git locally to make changes to your site, commit, and then use 'git push azure master' to deploy to Azure."); _(); }, true)); }); }, true)); }); }); };
  ...
  location.command("list").description("List locations available for your account").execute(function __4(options, _) { var context, spaces, s; var __frame = { name: "__4", line: 440 }; return __func(_, this, arguments, __4, 1, __frame, function __$__4() {
  ...
  site.command("browse [name]").description("Open your web site in a browser.").option("-s, --subscription <id>", "use the subscription id").execute(function __5(name, options, _) { var context, cache, siteData, href; var __frame = { name: "__5", line: 462 }; return __func(_, this, arguments, __5, 2, __frame, function __$__5() {
      ...
      return lookupSiteNameAndWebSpace(context, __cb(_, __frame, 9, 22, function ___(__0, __2) { cache = __2; return (function __$__5(_) {
          var __1 = cache; if (__1) { return _(null, __1); } ; return site.doSiteGet(context, __cb(_, __frame, 10, 40, _, true)); })(__cb(_, __frame, -461, 17, function ___(__0, __3) { siteData = clean(__3);
  ...
  site.command("show [name]").description("Show details for a web site").option("-s, --subscription <id>", "use the subscription id").execute(function __6(name, options, _) { var context, result, repositoryUri, gitUri, settings, data, index; var __frame = { name: "__6", line: 482 }; return __func(_, this, arguments, __6, 2, __frame, function __$__6() {
      ...
      return lookupSiteNameAndWebSpace(context, __cb(_, __frame, 8, 10, function __$__6() {
        ...
        return async.parallel([function __1(_) { var __frame = { name: "__1", line: 496 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() {
            return site.doSiteGet(context, __cb(_, __frame, 0, 34, _, true)); });
        },function __2(_) { var __frame = { name: "__2", line: 497 }; return __func(_, this, arguments, __2, 0, __frame, function __$__2() { return site.doSiteConfigGet(context, __cb(_, __frame, 0, 34, _, true)); }); },], __cb(_, __frame, 13, 23, function ___(__0, __3) { result = __3;
  ...
  function lookupSiteName(context, _) { var cfg; var __frame = { name: "lookupSiteName", line: 529 }; return __func(_, this, arguments, lookupSiteName, 1, __frame, function __$lookupSiteName() {
  ...
  function lookupSiteWebSpace(context, _) { var sites, index; var __frame = { name: "lookupSiteWebSpace", line: 550 }; return __func(_, this, arguments, lookupSiteWebSpace, 1, __frame, function __$lookupSiteWebSpace() {
  ...
  function lookupSiteNameAndWebSpace(context, _) { var cache; var __frame = { name: "lookupSiteNameAndWebSpace", line: 564 }; return __func(_, this, arguments, lookupSiteNameAndWebSpace, 1, __frame, function __$lookupSiteNameAndWebSpace() {
  ...
  function ensureRepositoryUri(context, _) { var siteData, repositoryUri; var __frame = { name: "ensureRepositoryUri", line: 638 }; return __func(_, this, arguments, ensureRepositoryUri, 1, __frame, function __$ensureRepositoryUri() {
  ...
  site.command("delete [name]").description("Delete a web site").option("-s, --subscription <id>", "use the subscription id").option("-q, --quiet", "quiet mode, do not ask for delete confirmation").execute(function __7(name, options, _) { var context, progress, result; var __frame = { name: "__7", line: 656 }; return __func(_, this, arguments, __7, 2, __frame, function __$__7() {
      ...
      return lookupSiteNameAndWebSpace(context, __cb(_, __frame, 8, 10, function __$__7() {
        ...
        log.info("Deleting site", context.site.name); return (function __$__7(_) {
          var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return confirm((("Delete " + context.site.name) + " site?  (y/n) "), __cb(_, __frame, 11, 33, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -655, 17, function ___(__0, __2) { return (function __$__7(__then) { if (__2) { return _(null); } else { __then(); } ; })(function __$__7() {
  ...
  site.command("start [name]").description("Start a web site").option("-s, --subscription <id>", "use the subscription id").execute(function __8(name, options, _) { var context; var __frame = { name: "__8", line: 693 }; return __func(_, this, arguments, __8, 2, __frame, function __$__8() {
  ...
  site.command("stop [name]").description("Stop a web site").option("-s, --subscription <id>", "use the subscription id").execute(function __9(name, options, _) { var context; var __frame = { name: "__9", line: 713 }; return __func(_, this, arguments, __9, 2, __frame, function __$__9() {
  ...
  site.command("restart [name]").description("Stop and then start a web site").option("-s, --subscription <id>", "use the subscription id").execute(function __10(name, options, _) { var context; var __frame = { name: "__10", line: 733 }; return __func(_, this, arguments, __10, 2, __frame, function __$__10() {
  ...
  function updateSiteState(channel, context, newState, _) { var progress, result; var __frame = { name: "updateSiteState", line: 751 }; return __func(_, this, arguments, updateSiteState, 3, __frame, function __$updateSiteState() {
  ...
  site.readConfig = function site_readConfig__11(_) { var __frame = { name: "site_readConfig__11", line: 790 }; return __func(_, this, arguments, site_readConfig__11, 0, __frame, function __$site_readConfig__11() {
  ...
  site.writeConfig = function site_writeConfig__12(cfg, _) { var __frame = { name: "site_writeConfig__12", line: 797 }; return __func(_, this, arguments, site_writeConfig__12, 1, __frame, function __$site_writeConfig__12() {
  ...
  site.readConfigValue = function site_readConfigValue__13(name, _) { var result; var __frame = { name: "site_readConfigValue__13", line: 802 }; return __func(_, this, arguments, site_readConfigValue__13, 1, __frame, function __$site_readConfigValue__13() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$site_readConfigValue__13() {
  ...
  site.writeConfigValue = function site_writeConfigValue__14(name, value, _) { var __frame = { name: "site_writeConfigValue__14", line: 813 }; return __func(_, this, arguments, site_writeConfigValue__14, 2, __frame, function __$site_writeConfigValue__14() {
  ...
  site.doSpacesGet = function site_doSpacesGet__15(options, _) { var progress, result, spaces; var __frame = { name: "site_doSpacesGet__15", line: 911 }; return __func(_, this, arguments, site_doSpacesGet__15, 1, __frame, function __$site_doSpacesGet__15() {
      log.verbose("Subscription", options.subscription);
  ...
  site.doSitesGet = function site_doSitesGet__16(options, _) { var spaces, channel, progress, result, sites; var __frame = { name: "site_doSitesGet__16", line: 933 }; return __func(_, this, arguments, site_doSitesGet__16, 1, __frame, function __$site_doSitesGet__16() {
      log.verbose("Subscription", options.subscription);
      ...
      return site.doSpacesGet(options, __cb(_, __frame, 3, 17, function ___(__0, __2) { spaces = __2;
        ...
        progress = cli.progress("Enumerating sites"); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$site_doSitesGet__16() {
              ...
              return async.map(spaces, function __1(webspace, _) { var __frame = { name: "__1", line: 947 }; return __func(_, this, arguments, __1, 1, __frame, function __$__1() {
  ...
  site.doSiteConfigPUT = function site_doSiteConfigPUT__17(config, options, _) { var progress, xmlConfig; var __frame = { name: "site_doSiteConfigPUT__17", line: 1024 }; return __func(_, this, arguments, site_doSiteConfigPUT__17, 2, __frame, function __$site_doSiteConfigPUT__17() {
  ...
  site.doRepositoryGet = function site_doRepositoryGet__18(options, _) { var siteData; var __frame = { name: "site_doRepositoryGet__18", line: 1046 }; return __func(_, this, arguments, site_doRepositoryGet__18, 1, __frame, function __$site_doRepositoryGet__18() {
  ...
  site.doPublishingUsersGet = function site_doPublishingUsersGet__19(options, _) { var progress, publishingUsers; var __frame = { name: "site_doPublishingUsersGet__19", line: 1051 }; return __func(_, this, arguments, site_doPublishingUsersGet__19, 1, __frame, function __$site_doPublishingUsersGet__19() {
