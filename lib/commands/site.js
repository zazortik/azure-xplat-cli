...
exports.init = function(cli) {
  ...
  site.command("deploymentscript").whiteListPowershell().usage("[options]").description("Generate custom deployment script").option("-r, --repositoryRoot [dir path]", "The root path for the repository (default: .)").option("--aspWAP <projectFilePath>", "Create a deployment script for .NET web application, specify the project file path").option("--aspWebSite", "Create a deployment script for basic website").option("--node", "Create a deployment script for node.js website").option("--php", "Create a deployment script for php website").option("--python", "Create a deployment script for python website").option("--basic", "Create a deployment script for any other website").option("-s, --solutionFile [file path]", "The solution file path (sln)").option("-p, --sitePath [directory path]", "The path to the site being deployed (default: same as repositoryRoot)").option("-t, --scriptType [batch|bash]", "The script output type (default: batch)").option("-y, --suppressPrompt", "Suppresses prompting to confirm you want to overwrite an existing destination file.").option("--no-dot-deployment", "Do not generate the .deployment file.").execute(function __2(name, options, _) { var repositoryRoot, scriptType, projectFile, solutionFile, sitePath, noDotDeployment, exclusionFlags, flagCount, i, projectType, confirmFunc; var __frame = { name: "__2", line: 117 }; return __func(_, this, arguments, __2, 2, __frame, function __$__2() {
      ...
      return scriptGenerator.generateDeploymentScript(repositoryRoot, projectType, projectFile, solutionFile, sitePath, scriptType, noDotDeployment, log, confirmFunc, __cb(_, __frame, 41, 12, _, true)); }); });
