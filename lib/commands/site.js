...
exports.init = function(cli) {
  ...
  site.command("browse [name]").whiteListPowershell().description("Open your web site in a browser.").option("-s, --subscription <id>", "use the subscription id").execute(function __4(name, options, _) { var context, cache, siteData, href; var __frame = { name: "__4", line: 412 }; return __func(_, this, arguments, __4, 2, __frame, function __$__4() {
      ...
      return lookupSiteNameAndWebSpace(context, __cb(_, __frame, 9, 22, function ___(__0, __2) { cache = __2; return (function __$__4(_) {
          var __1 = cache; if (__1) { return _(null, __1); } ; return site.doSiteGet(context, __cb(_, __frame, 10, 40, _, true)); })(__cb(_, __frame, -411, 17, function ___(__0, __3) { siteData = clean(__3);
  ...
  site.command("show [name]").whiteListPowershell().description("Show details for a web site").option("-s, --subscription <id>", "use the subscription id").execute(function __5(name, options, _) { var context, result, repositoryUri, gitUri, settings, data, index; var __frame = { name: "__5", line: 433 }; return __func(_, this, arguments, __5, 2, __frame, function __$__5() {
      ...
      return lookupSiteNameAndWebSpace(context, __cb(_, __frame, 8, 10, function __$__5() {

        log.info("Showing details for site");
        log.verbose("Parameters", context);

        return async.parallel([function __1(_) { var __frame = { name: "__1", line: 447 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() {
            return site.doSiteGet(context, __cb(_, __frame, 0, 34, _, true)); });
        },function __2(_) { var __frame = { name: "__2", line: 448 }; return __func(_, this, arguments, __2, 0, __frame, function __$__2() { return site.doSiteConfigGet(context, __cb(_, __frame, 0, 34, _, true)); }); },], __cb(_, __frame, 13, 23, function ___(__0, __3) { result = __3;



          repositoryUri = getRepositoryUri(result[0]);
          gitUri = (repositoryUri ? getGitUri(repositoryUri, context.site.name) : "none");
          settings = []; return (function __$__5(__then) {
            if (repositoryUri) {
              return site.ensureRepositoryUri(context, __cb(_, __frame, 23, 12, function __$__5() {
                return site.category("repository").doSettingsGet(context, __cb(_, __frame, 24, 23, function ___(__0, __4) { settings = __4; __then(); }, true)); }, true)); } else { __then(); } ; })(function __$__5() {
  ...
  function lookupSiteName(context, _) { var cfg; var __frame = { name: "lookupSiteName", line: 480 }; return __func(_, this, arguments, lookupSiteName, 1, __frame, function __$lookupSiteName() {
  ...
  function lookupSiteWebSpace(context, _) { var sites, index; var __frame = { name: "lookupSiteWebSpace", line: 501 }; return __func(_, this, arguments, lookupSiteWebSpace, 1, __frame, function __$lookupSiteWebSpace() {
  ...
  function lookupSiteNameAndWebSpace(context, _) { var cache; var __frame = { name: "lookupSiteNameAndWebSpace", line: 515 }; return __func(_, this, arguments, lookupSiteNameAndWebSpace, 1, __frame, function __$lookupSiteNameAndWebSpace() {
  ...
  function ensureRepositoryUri(context, _) { var siteData, repositoryUri; var __frame = { name: "ensureRepositoryUri", line: 589 }; return __func(_, this, arguments, ensureRepositoryUri, 1, __frame, function __$ensureRepositoryUri() {
  ...
  site.command("delete [name]").whiteListPowershell().description("Delete a web site").option("-s, --subscription <id>", "use the subscription id").option("-q, --quiet", "quiet mode, do not ask for delete confirmation").execute(function __6(name, options, _) { var context, progress, result; var __frame = { name: "__6", line: 608 }; return __func(_, this, arguments, __6, 2, __frame, function __$__6() {
      ...
      return lookupSiteNameAndWebSpace(context, __cb(_, __frame, 8, 10, function __$__6() {
        ...
        log.info("Deleting site", context.site.name); return (function __$__6(_) {
          var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return confirm((("Delete " + context.site.name) + " site?  (y/n) "), __cb(_, __frame, 11, 33, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -607, 17, function ___(__0, __2) { return (function __$__6(__then) { if (__2) { return _(null); } else { __then(); } ; })(function __$__6() {



            progress = cli.progress("Deleting site"); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__6() {
                  ...
                  return getChannel().path(context.subscription).path("services").path("webspaces").path(context.site.webspace).path("sites").path(context.site.name).DELETE(__cb(_, __frame, 24, 25, function ___(__0, __3) { result = __3;
                    return cacheUtils.deleteSite(context, __cb(_, __frame, 25, 12, function __$__6() { _(null, null, true); }, true)); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__6() {
  ...
  site.command("start [name]").whiteListPowershell().description("Start a web site").option("-s, --subscription <id>", "use the subscription id").execute(function __7(name, options, _) { var context; var __frame = { name: "__7", line: 646 }; return __func(_, this, arguments, __7, 2, __frame, function __$__7() {
      ...
      return lookupSiteNameAndWebSpace(context, __cb(_, __frame, 8, 10, function __$__7() {
        ...
        return updateSiteState(getChannel(), context, "Running", __cb(_, __frame, 12, 10, function __$__7() {

          log.info((("Site " + context.site.name) + " has been started")); _(); }, true)); }, true)); }); });


  site.command("stop [name]").whiteListPowershell().description("Stop a web site").option("-s, --subscription <id>", "use the subscription id").execute(function __8(name, options, _) { var context; var __frame = { name: "__8", line: 667 }; return __func(_, this, arguments, __8, 2, __frame, function __$__8() {
      ...
      return lookupSiteNameAndWebSpace(context, __cb(_, __frame, 8, 10, function __$__8() {
        ...
        return updateSiteState(getChannel(), context, "Stopped", __cb(_, __frame, 12, 10, function __$__8() {

          log.info((("Site " + context.site.name) + " has been stopped")); _(); }, true)); }, true)); }); });


  site.command("restart [name]").whiteListPowershell().description("Stop and then start a web site").option("-s, --subscription <id>", "use the subscription id").execute(function __9(name, options, _) { var context; var __frame = { name: "__9", line: 688 }; return __func(_, this, arguments, __9, 2, __frame, function __$__9() {
      ...
      return lookupSiteNameAndWebSpace(context, __cb(_, __frame, 8, 10, function __$__9() {
        ...
        log.info("Stopping site", context.site.name);
        return updateSiteState(getChannel(), context, "Stopped", __cb(_, __frame, 11, 10, function __$__9() {

          log.info((("Site " + context.site.name) + " has been stopped, restarting"));
          return updateSiteState(getChannel(), context, "Running", __cb(_, __frame, 14, 10, function __$__9() {
            log.info((("Site " + context.site.name) + " has been restarted")); _(); }, true)); }, true)); }, true)); }); });


  function updateSiteState(channel, context, newState, _) { var progress, result; var __frame = { name: "updateSiteState", line: 706 }; return __func(_, this, arguments, updateSiteState, 3, __frame, function __$updateSiteState() {
  ...
  site.readConfig = function site_readConfig__10(_) { var __frame = { name: "site_readConfig__10", line: 745 }; return __func(_, this, arguments, site_readConfig__10, 0, __frame, function __$site_readConfig__10() {
  ...
  site.writeConfig = function site_writeConfig__11(cfg, _) { var __frame = { name: "site_writeConfig__11", line: 752 }; return __func(_, this, arguments, site_writeConfig__11, 1, __frame, function __$site_writeConfig__11() {
  ...
  site.readConfigValue = function site_readConfigValue__12(name, _) { var result; var __frame = { name: "site_readConfigValue__12", line: 757 }; return __func(_, this, arguments, site_readConfigValue__12, 1, __frame, function __$site_readConfigValue__12() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$site_readConfigValue__12() {
  ...
  site.writeConfigValue = function site_writeConfigValue__13(name, value, _) { var __frame = { name: "site_writeConfigValue__13", line: 768 }; return __func(_, this, arguments, site_writeConfigValue__13, 2, __frame, function __$site_writeConfigValue__13() {
  ...
  site.doSpacesGet = function site_doSpacesGet__14(options, _) { var progress, result, spaces; var __frame = { name: "site_doSpacesGet__14", line: 866 }; return __func(_, this, arguments, site_doSpacesGet__14, 1, __frame, function __$site_doSpacesGet__14() {
      log.verbose("Subscription", options.subscription);
  ...
  site.doSitesGet = function site_doSitesGet__15(options, _) { var spaces, channel, progress, result, sites; var __frame = { name: "site_doSitesGet__15", line: 888 }; return __func(_, this, arguments, site_doSitesGet__15, 1, __frame, function __$site_doSitesGet__15() {
      log.verbose("Subscription", options.subscription);
      ...
      return site.doSpacesGet(options, __cb(_, __frame, 3, 17, function ___(__0, __2) { spaces = __2;
        ...
        progress = cli.progress("Enumerating sites"); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$site_doSitesGet__15() {
              ...
              return async.map(spaces, function __1(webspace, _) { var __frame = { name: "__1", line: 902 }; return __func(_, this, arguments, __1, 1, __frame, function __$__1() {
  ...
  site.doSiteConfigPUT = function site_doSiteConfigPUT__16(config, options, _) { var progress, xmlConfig; var __frame = { name: "site_doSiteConfigPUT__16", line: 979 }; return __func(_, this, arguments, site_doSiteConfigPUT__16, 2, __frame, function __$site_doSiteConfigPUT__16() {
  ...
  site.doRepositoryGet = function site_doRepositoryGet__17(options, _) { var siteData; var __frame = { name: "site_doRepositoryGet__17", line: 1001 }; return __func(_, this, arguments, site_doRepositoryGet__17, 1, __frame, function __$site_doRepositoryGet__17() {
  ...
  site.doPublishingUsersGet = function site_doPublishingUsersGet__18(options, _) { var progress, publishingUsers; var __frame = { name: "site_doPublishingUsersGet__18", line: 1006 }; return __func(_, this, arguments, site_doPublishingUsersGet__18, 1, __frame, function __$site_doPublishingUsersGet__18() {
