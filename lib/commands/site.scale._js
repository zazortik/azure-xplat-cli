...
exports.init = function (cli) {
  ...
  siteScale.command('mode [name] <mode>')
    .description('Sets the web site mode')
    .usage('[name] <mode>')
    .option('--mode <mode>', 'The mode of the site (available are: free, shared and reserved)')
    .option('-s, --subscription <id>', 'use the subscription id')
    .execute(function (name, mode, options, _) {
      ...
      mode = interaction.promptPasswordIfNotGiven(cli, 'mode', params.values.mode, _);
