...
__.extend(WebsitesClient.prototype, {
  ...
  getDiagnosticsSettings: function (context, _) {
    ...
    var service = utils._createWebSiteExtensionsClient(context.site.name,
      context.repositoryAuth[0],
      context.repositoryAuth[1],
  ...
  updateDiagnosticsSettings: function (context, settings, _) {
    ...
    try {
      return service.diagnostics.update(settings, _);
    } finally {
      progress.end();
    }
  },
  ...
  getHostNameSuffix: function (subscription, _) {
    ...
    if (subscriptionId) {
      ...
      return hostNameSuffix.dnsSuffix || subscription.hostNameSuffix;
    } else {
      return subscription.hostNameSuffix;
    }
  },
