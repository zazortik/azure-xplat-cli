...
exports.init = function (cli) {
  ...
  siteCertificates.command('add [certificate-path] [name]')
    ...
    .execute(function (certificatePath, name, options, _) {
      ...
      certificatePath = interaction.promptIfNotGiven(cli, 'Certificate path: ', params.values.certificatePath, _);
  ...
  siteCertificates.command('delete [thumbprint] [name]')
    ...
    .execute(function (thumbprint, name, options, _) {
      ...
      thumbprint = interaction.promptIfNotGiven(cli, 'Certificate thumbprint: ', params.values.thumbprint, _);
