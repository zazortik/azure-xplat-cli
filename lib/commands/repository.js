...
exports.init = function(cli) {
  ...
  repository.command("branch <branch> [name]>").usage("<branch> [name] [options]").description("set your repository branch").option("-s, --subscription <id>", "use the subscription id").execute(function __1(branch, name, options, _) { var context, repositoryUri; var __frame = { name: "__1", line: 41 }; return __func(_, this, arguments, __1, 3, __frame, function __$__1() {
  ...
  repository.command("delete [name]").usage("[name] [options]").description("Delete your repository").option("-s, --subscription <id>", "use the subscription id").option("-q, --quiet", "quiet mode, do not ask for delete confirmation").execute(function __2(name, options, _) { var context, repositoryUri; var __frame = { name: "__2", line: 62 }; return __func(_, this, arguments, __2, 2, __frame, function __$__2() {
      ...
      return site.ensureRepositoryUri(context, __cb(_, __frame, 6, 26, function ___(__0, __2) { repositoryUri = __2; return (function __$__2(__then) {
          if (repositoryUri) { return (function __$__2(_) {
              var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return site.confirm("Delete repository?  (y/n) ", __cb(_, __frame, 8, 31, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -61, 17, function ___(__0, __3) { return (function __$__2(__then) { if (__3) { return _(null); } else { __then(); } ; })(function __$__2() {
  ...
  function doSettingsGet(context, _) { var channel, progress; var __frame = { name: "doSettingsGet", line: 81 }; return __func(_, this, arguments, doSettingsGet, 1, __frame, function __$doSettingsGet() {
  ...
  function doSettingsSet(context, _) { var channel, data, progress; var __frame = { name: "doSettingsSet", line: 97 }; return __func(_, this, arguments, doSettingsSet, 1, __frame, function __$doSettingsSet() {
  ...
  function doDeleteRepository(context, _) { var channel, progress; var __frame = { name: "doDeleteRepository", line: 113 }; return __func(_, this, arguments, doDeleteRepository, 1, __frame, function __$doDeleteRepository() {
