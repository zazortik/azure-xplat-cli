...
exports.init = function(cli) {
  ...
  vm.command('create [options] <dns-name> <image> <user-name> [password]')
  ...
  vm.command('create-from <dns-name> <role-file> [options]')
  ...
  vm.command('delete <name> [options]')
  ...
  vm.command('restart <name> [options]')
  ...
  vm.command('shutdown <name> [options]')
  ...
  vm.command('capture <vm-name> <target-image-name> [options]')
  ...
  vm.command('export <vm-name> <file-path> [options]')
  ...
  endpoint.command('create <vm-name> <lb-port> [vm-port] [options]')
  ...
  endpoint.command('create-multiple <vm-name> <endpoints> [options]')
  ...
  endpoint.command('delete <vm-name> <vm-port> [options]')
  ...
  endpoint.command('list <vm-name> [options]')
    .usage('<vm-name>')
  ...
  endpoint.command('show <vm-name> [options]')
    .usage('<vm-name>')
  ...
  osImage.command('create <name> [source-path] [options]')
  ...
  disk.command('upload <source-path> <blob-url> <storage-account-key> [options]')
  ...
  disk.command('attach <vm-name> <disk-image-name> [options]')
  ...
  disk.command('attach-new <vm-name> <size-in-gb> [blob-url] [options]')
  ...
  disk.command('detach <vm-name> <lun> [options]')
    .usage('<vm-name> <lun>')
