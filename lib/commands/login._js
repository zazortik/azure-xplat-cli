...
exports.init = function (cli) {
  ...
  cli.command('login')
    ...
    .option('--servicePrincipal', $('If given, log in as a service principal rather than a user'))
    ...
    .execute(function(options, _) {
      ...
      var supportedLoginTypeText = $('Please note that currently you can login only via Microsoft organizational account or service pincipal. ' +
