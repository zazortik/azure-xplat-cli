...
exports.init = function (cli) {
  ...
  cli.command('login')
    ...
    .option('-d --disable-validate-authority', $('Disable authority validation. This should only be used for AzureStack.'))
    ...
    .execute(function(options, _) {
      ...
      if (options.disableValidateAuthority) {
        process.env['DISABLE_VALIDATE_AUTHORITY'] = true;
      }
