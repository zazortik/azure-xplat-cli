...
/*
  ...
  --name
*/
  var networkAbortMigration = cli.category('network').description('Commands to migrate resources to ARM.').category('vnet')
...
/*
  ...
  --name
*/
  var networkCommitMigration = cli.category('network').description('Commands to migrate resources to ARM.').category('vnet')
  .description($('Commands to manage your network.  '));
...
/*
  ...
  --name
*/
  var networkPrepareMigration = cli.category('network').description('Commands to migrate resources to ARM.').category('vnet')
  .description($('Commands to manage your network.  '));
