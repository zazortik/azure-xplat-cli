...
exports.init = function (cli) {
  ...
  reservedIPAbortMigration.command('abort-migration [name]')
    ...
    .execute(function(name, options, _) {
      ...
      var subscription = profile.current.getSubscription(options.subscription);
      var networkManagementClient = utils.createNetworkClient(subscription);
      var result = networkManagementClient.reservedIPs.abortMigration(name, _);
      if (result) {
        cli.output.json(result);
      }
    });
  ...
  reservedIPCommitMigration.command('commit-migration [name]')
    ...
    .execute(function(name, options, _) {
      ...
      var subscription = profile.current.getSubscription(options.subscription);
      var networkManagementClient = utils.createNetworkClient(subscription);
      var result = networkManagementClient.reservedIPs.commitMigration(name, _);
      if (result) {
        cli.output.json(result);
      }
    });
  ...
  reservedIPPrepareMigration.command('prepare-migration [name]')
    ...
    .execute(function(name, options, _) {
      ...
      var subscription = profile.current.getSubscription(options.subscription);
      var networkManagementClient = utils.createNetworkClient(subscription);
      var result = networkManagementClient.reservedIPs.prepareMigration(name, _);
      if (result) {
        cli.output.json(result);
      }
    });
