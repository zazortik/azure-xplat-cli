...
var $ = utils.getLocaleString;exports.init = function (cli) {
  ...
  reservedIPAbortMigration.command('abort-migration [ip-name]')
    .description($(''))
    .usage('[options] <ip-name>')
    .option('--ip-name <ip-name>', $('ip-name'))
    .option('-s, --subscription <subscription>', $('The subscription identifier'))
    .execute(function(ipName, options, _) {
      if (!ipName) {
        ipName = cli.interaction.promptIfNotGiven($('ip-name : '), ipName, _);
      }

      cli.output.verbose('ipName = ' + ipName);
      var subscription = profile.current.getSubscription(options.subscription);
      var networkManagementClient = utils.createNetworkClient(subscription);
      var result = networkManagementClient.reservedIPs.abortMigration(ipName, _);
      if (result) {
        cli.output.json(result);
      }
    });
  ...
  var reservedIPCommitMigration = cli.category('network').description('Commands to invoke service management operations.')
    .category('reserved-ip').description($('Commands to manage your reserved ip.  '));
  reservedIPCommitMigration.command('commit-migration [ip-name]')
    .description($(''))
    .usage('[options] <ip-name>')
    .option('--ip-name <ip-name>', $('ip-name'))
    .option('-s, --subscription <subscription>', $('The subscription identifier'))
    .execute(function(ipName, options, _) {
      ...
      var subscription = profile.current.getSubscription(options.subscription);
      var networkManagementClient = utils.createNetworkClient(subscription);
      var result = networkManagementClient.reservedIPs.commitMigration(ipName, _);
      if (result) {
        cli.output.json(result);
      }
    });
  ...
  var reservedIPPrepareMigration = cli.category('network').description('Commands to invoke service management operations.')
    .category('reserved-ip').description($('Commands to manage your reserved ip.  '));
  reservedIPPrepareMigration.command('prepare-migration [ip-name]')
    .description($(''))
    .usage('[options] <ip-name>')
    .option('--ip-name <ip-name>', $('ip-name'))
    .option('-s, --subscription <subscription>', $('The subscription identifier'))
    .execute(function(ipName, options, _) {
      ...
      var subscription = profile.current.getSubscription(options.subscription);
      var networkManagementClient = utils.createNetworkClient(subscription);
      var result = networkManagementClient.reservedIPs.prepareMigration(ipName, _);
      if (result) {
        cli.output.json(result);
      }
    });
  ...
  var reservedIPValidateMigration = cli.category('network').description('Commands to invoke service management operations.')
    .category('reserved-ip').description($('Commands to manage your reserved ip.  '));
  reservedIPValidateMigration.command('validate-migration [ip-name]')
    .description($(''))
    .usage('[options] <ip-name>')
    .option('--ip-name <ip-name>', $('ip-name'))
    .option('-s, --subscription <subscription>', $('The subscription identifier'))
    .execute(function(ipName, options, _) {
      ...
      var subscription = profile.current.getSubscription(options.subscription);
      var networkManagementClient = utils.createNetworkClient(subscription);
      var result = networkManagementClient.reservedIPs.validateMigration(ipName, _);
      if (result) {
        cli.output.json(result);
      }
    });
