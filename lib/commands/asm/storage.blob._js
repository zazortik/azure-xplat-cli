  ...
  function applyBlobServicePatch(blobService) {
    ...
    */
    blobService.listAllContainers = function (options, callback) {
      listWithContinuation(blobService.listContainersSegmentedWithPrefix, options.prefix, null, options, callback);
    };
    ...
    */
    blobService.listAllBlobs = function (container, options, callback) {
      listWithContinuation(blobService.listBlobsSegmentedWithPrefix, container, options.prefix, null, options, callback);
    };
