...
exports.init = function (cli) {
  ...
  */
  function showAzureContainer(container, options, _) {
    var blobService = getBlobServiceClient(options);
    container = cli.interaction.promptIfNotGiven($('Container name: '), container, _);
  ...
  */
  function listAzureBlob(container, blobName, options, _) {
    var blobService = getBlobServiceClient(options);
    var specifiedContainerName = cli.interaction.promptIfNotGiven($('Container name: '), container, _);
  ...
  */
  function getAzureBlobProperties(container, blobName, options, _) {
    var blobService = getBlobServiceClient(options);
    var specifiedContainerName = cli.interaction.promptIfNotGiven($('Container name: '), container, _);
    var specifiedBlobName = cli.interaction.promptIfNotGiven($('Blob name: '), blobName, _);
    var storageOptions = getStorageBlobOperationDefaultOption();
    var blob = {};
  ...
  */
  function uploadAzureBlob(file, container, blobName, options, _) {
    ...
    var specifiedContainerName = cli.interaction.promptIfNotGiven($('Container name: '), container, _);
    var specifiedFileName = cli.interaction.promptIfNotGiven($('File name: '), file, _);
  ...
  */
  function startBlobCopy(sourceUri, destContainer, options, _) {
    ...
    var destContainerName = cli.interaction.promptIfNotGiven($('Destination container name: '), destContainer, _);
  ...
  */
  function showBlobCopy(container, blob, options, _) {
    container = cli.interaction.promptIfNotGiven($('Destination container: '), container, _);
    blob = cli.interaction.promptIfNotGiven($('Destination blob: '), blob, _);
