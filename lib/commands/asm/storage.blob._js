  ...
  function applyBlobServicePatch(blobService) {
    ...
    */
    blobService.listAllContainers = function(options, callback) {
      StorageUtil.listWithContinuation(blobService.listContainersSegmentedWithPrefix, blobService, 1, options.prefix, null, options, callback);
    };
    ...
    */
    blobService.listAllBlobs = function(container, options, callback) {
      StorageUtil.listWithContinuation(blobService.listBlobsSegmentedWithPrefix, blobService, 2, container, options.prefix, null, options, callback);
    };
  }
