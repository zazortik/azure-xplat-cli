...
exports.init = function (cli) {
  ...
  httpListener.command('add [gateway-name] [name] [frontend-port-name]')
    ...
    .execute(function (gatewayName, name, frontendPortName, options, _) {
      ...
      var networkClient = new NetworkClient(cli, options.subscription);
      networkClient.addApplicationGatewayHttpListener(gatewayName, name, frontendPortName, options, _);
    });
