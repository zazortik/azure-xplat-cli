...
exports.init = function (cli) {
  ...
  tmProfile.command('create [name]')
    ...
    .option('-m, --load-balancing-method <load-balancing-method>', $('the load balancing method to use to distribute connection.' +
    '   Valid values are [Performance, Failover, RoundRobin]'))
    .option('-o, --monitor-port <monitor-port>', $('the port used to monitor endpoint health.' +
    '   Valid range is [1 .. 65,535] inclusive'))
    .option('-p, --monitor-protocol <monitor-protocol>', $('the protocol to use to monitor endpoint health.' +
