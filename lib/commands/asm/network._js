...
exports.init = function (cli) {
  ...
  var applicationGateway = network.category('application-gateway')
    .description('Commands to manage application gateway');

  applicationGateway.command('create [name] [vnet-name]')
  ...
  applicationGateway.command('set [name] [vnet-name]')
  ...
  applicationGateway.command('list')
  ...
  applicationGateway.command('show [name]')
  ...
  applicationGateway.command('delete [name]')
  ...
  applicationGateway.command('start [name]')
  ...
  applicationGateway.command('stop [name]')
  ...
  var gatewaySsl = applicationGateway.category('ssl-cert')
    .description($('Commands to manage application gateway SSL certificates'));

  gatewaySsl.command('add [name] [cert-name]')
  ...
  gatewaySsl.command('remove [name] [cert-name]')
