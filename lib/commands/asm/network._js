...
exports.init = function (cli) {
  ...
  appGatewayFrontendIp.command('remove [gateway-name] [name]')
    ...
    .execute(function (gatewayName, name, options, _) {
      ...
      var networkClient = new NetworkClient(cli, options.subscription);
      networkClient.removeApplicationGatewayFrontendIp(gatewayName, name, options, _);
    });
  ...
  appGatewayFrontendPort.command('remove [gateway-name] [name]')
    ...
    .execute(function (gatewayName, name, options, _) {
      ...
      var networkClient = new NetworkClient(cli, options.subscription);
      networkClient.removeApplicationGatewayFrontendPort(gatewayName, name, options, _);
    });
  ...
  appGatewayHttpListener.command('remove [gateway-name] [name]')
    ...
    .execute(function (gatewayName, name, options, _) {
      ...
      var networkClient = new NetworkClient(cli, options.subscription);
      networkClient.removeApplicationGatewayHttpListener(gatewayName, name, options, _);
    });
  ...
  appGatewayBalancingRule.command('remove [gateway-name] [name]')
    ...
    .execute(function (gatewayName, name, options, _) {
      ...
      var networkClient = new NetworkClient(cli, options.subscription);
      networkClient.removeApplicationGatewayBalancingRule(gatewayName, name, options, _);
    });
  ...
  profileEndpoint.command('create [profile-name] [name] [type]')
    ...
    .option('-y, --type <type>', util.format($('the endpoint type, valid values are: %s'), constants.trafficManager.endpoints.types))
    ...
    .option('-u, --endpoint-status <endpoint-status>', util.format($('the endpoint status, valid values are: %s Default is Enabled'), constants.trafficManager.endpoints.statuses))
    ...
    .execute(function (profileName, name, type, options, _) {
      ...
      var networkClient = new NetworkClient(cli, options.subscription);
      networkClient.createProfileEndpoint(profileName, name, type, options, _);
    });

  profileEndpoint.command('update [profile-name] [name]')
    .description($('Update an endpoint in a traffic manager profile'))
    ...
    .execute(function (profileName, name, options, _) {
      ...
      var networkClient = new NetworkClient(cli, options.subscription);
      networkClient.updateProfileEndpoint(profileName, name, options, _);
    });
  ...
  profileEndpoint.command('delete [profile-name] [name]')
    ...
    .execute(function (profileName, name, options, _) {
      ...
      var networkClient = new NetworkClient(cli, options.subscription);
      networkClient.deleteProfileEndpoint(profileName, name, options, _);
    });
