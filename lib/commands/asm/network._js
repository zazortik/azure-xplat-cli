...
exports.init = function (cli) {
  ...
  localNetwork.command('create [name] [address-prefixes]')
    ...
    .execute(function (name, addressPrefixes, options, _) {
      ...
      var networkClient = new NetworkClient(cli, options.subscription);
      networkClient.createLocalNetwork(name, addressPrefixes, options, _);
    });
  ...
  appGateway.command('create [name] [vnet-name] [subnet-names]')
    ...
    .execute(function (name, vnetName, subnetNames, options, _) {
      ...
      var networkClient = new NetworkClient(cli, options.subscription);
      networkClient.createApplicationGateway(name, vnetName, subnetNames, options, _);
    });
  ...
  appGatewayConfig.command('show [name]')
    ...
    .execute(function (name, options, _) {
      ...
      var networkClient = new NetworkClient(cli, options.subscription);
      networkClient.showApplicationGatewayConfig(name, options, _);
    });
  ...
  appGatewayConfig.command('export [name] [export-to-file]')
    ...
    .execute(function (name, exportToFile, options, _) {
      ...
      var networkClient = new NetworkClient(cli, options.subscription);
      networkClient.exportApplicationGatewayConfig(name, exportToFile, options, _);
    });
  ...
  tmProfile.command('create [name]')
    ...
    .option('-d, --domain-name <domain-name>', $('the endpoint domain name'))
    ...
    .execute(function (name, options, _) {
      ...
      var networkClient = new NetworkClient(cli, options.subscription);
      networkClient.createTrafficManager(name, options, _);
    });
  ...
  tmProfile.command('set [name]')
    ...
    .execute(function (name, options, _) {
      ...
      var networkClient = new NetworkClient(cli, options.subscription);
      networkClient.updateTrafficManager(name, options, _);
    });
  ...
  tmProfile.command('show [name]')
    ...
    .execute(function (name, options, _) {
      ...
      var networkClient = new NetworkClient(cli, options.subscription);
      networkClient.showTrafficManager(name, options, _);
    });
  ...
  var frontendIp = appGateway.category('frontend-ip')
    .description('Commands to manage application gateway frontend ip config');

  frontendIp.command('remove [gateway-name] [name]')
    ...
    .execute(function (gatewayName, name, options, _) {
      ...
      var networkClient = new NetworkClient(cli, options.subscription);
      networkClient.deleteApplicationGatewayFrontendIp(gatewayName, name, options, _);
    });

  var frontendPort = appGateway.category('frontend-port')
    .description('Commands to manage application gateway frontend port');

  frontendPort.command('add [gateway-name] [name] [port]')
    ...
    .execute(function (gatewayName, name, port, options, _) {
      ...
      var networkClient = new NetworkClient(cli, options.subscription);
      networkClient.addApplicationGatewayFrontendPort(gatewayName, name, port, options, _);
    });

  frontendPort.command('remove [gateway-name] [name]')
    ...
    .execute(function (gatewayName, name, options, _) {
      ...
      var networkClient = new NetworkClient(cli, options.subscription);
      networkClient.deleteApplicationGatewayFrontendPort(gatewayName, name, options, _);
    });

  var httpListener = appGateway.category('http-listener')
    .description('Commands to manage application gateway http listener');

  httpListener.command('add [gateway-name] [name] [frontend-port]')
    .description($('Add an http listener to an application gateway'))
    .usage('[options] <gateway-name> <name> <frontend-port>')
    .option('-w, --gateway-name <gateway-name>', $('the name of the application gateway'))
    .option('-n, --name <name>', $('the name of the HTTP listener'))
    .option('-i, --frontend-ip <frontend-ip>', $('the name of an existing frontend ip configuration'))
    .option('-p, --frontend-port <frontend-port>', $('the name of an existing frontend port'))
    ...
    .option('-s, --subscription <subscription>', $('the subscription identifier'))
    .execute(function (gatewayName, name, frontendPort, options, _) {
      gatewayName = cli.interaction.promptIfNotGiven($('Application gateway name: '), gatewayName, _);
      name = cli.interaction.promptIfNotGiven($('The HTTP listener name: '), name, _);
      frontendPort = cli.interaction.promptIfNotGiven($('Frontend port name: '), frontendPort, _);

      var networkClient = new NetworkClient(cli, options.subscription);
      networkClient.addApplicationGatewayHttpListener(gatewayName, name, frontendPort, options, _);
    });

  httpListener.command('remove [gateway-name] [name]')
    .description($('Remove an http listener drom an application gateway'))
    .usage('[options] <gateway-name> <name>')
    .option('-w, --gateway-name <gateway-name>', $('the name of the application gateway'))
    .option('-n, --name <name>', $('the name of the HTTP listener'))
    .option('-q, --quiet', $('quiet mode, do not ask for delete confirmation'))
    ...
    .execute(function (gatewayName, name, options, _) {
      ...
      var networkClient = new NetworkClient(cli, options.subscription);
      networkClient.deleteApplicationGatewayHttpListener(gatewayName, name, options, _);
    });

  var lbRule = appGateway.category('lb-rule')
    .description('Commands to manage application gateway load balancing rule');

  lbRule.command('add [gateway-name] [name] [http-settings] [http-listener] [address-pool]')
    .description($('Add load balancing rule to an application gateway'))
    ...
    .execute(function (gatewayName, name, httpSettings, httpListener, addressPool, options, _) {
      ...
      var networkClient = new NetworkClient(cli, options.subscription);
      networkClient.addApplicationGatewayBalancingRule(gatewayName, name, httpSettings, httpListener, addressPool, options, _);
    });

  lbRule.command('remove [gateway-name] [name]')
    .description($('Remove an http listener drom an application gateway'))
    .usage('[options] <gateway-name> <name>')
    .option('-w, --gateway-name <gateway-name>', $('the name of the application gateway'))
    .option('-n, --name <name>', $('the name of the load balancing rule'))
    ...
    .execute(function (gatewayName, name, options, _) {
      ...
      var networkClient = new NetworkClient(cli, options.subscription);
      networkClient.deleteApplicationGatewayBalancingRule(gatewayName, name, options, _);
    });
