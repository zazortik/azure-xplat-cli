  ...
  createSite: function (subscription, webspace, site, _) {
    ...
    try {
      ...
      if (err.statusCode === 500) {
        err.message = 'The server encountered an internal error. There is a bright chance ' + 
          'that the site may be actually created.\nPlease execute: \'azure site list\' to verify ' + 
          'that the created site: \'' + siteName + '\' appears in the list.\n If it does not appear ' + 
          'in the list then, retry the request.\n';
      }
