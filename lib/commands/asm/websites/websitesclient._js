...
__.extend(WebsitesClient.prototype, {
  ...
  createStorageClient: function() {
    return utils._createStorageClient(profile.current.getSubscription(this.subscription));
  },

  createWebsiteManagementService: function (subscription, callback) {
    return utils._createWebsiteClient(profile.current.getSubscription(this.subscription), callback);
  },
