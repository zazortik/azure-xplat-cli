...
function createComputeManagementClient(cli, options) {
  return utils._createComputeClient(profile.current.getSubscription(options.subscription));
}

function createManagementClient(cli, options) {
  return utils._createManagementClient(profile.current.getSubscription(options.subscription));
}

function createStorageClient(cli, options) {
  return utils._createStorageClient(profile.current.getSubscription(options.subscription));
}