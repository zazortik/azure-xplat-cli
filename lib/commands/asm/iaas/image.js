...
exports.delete = function(what, cli) {
  return function(diskName, deleteOptions, callback) {
    ...
    var logger = cli.output;
    deleteImage.deleteImage(whatAPI[what], ['Disk', 'OS Image'][what], logger, computeManagementClient, storageClient, diskName, deleteOptions, cli.interaction.progress, callback);
  };
};
