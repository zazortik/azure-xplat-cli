...
exports.init = function (cli) {
  ...
  trafficManagerProfile.command('create [name]')
    ...
    .execute(function (name, options, _) {
      ...
      options.domainName = cli.interaction.promptIfNotGiven($('Profile domain name: '), options.domainName, _);
      ...
      trafficManager.createProfile(name, options, _);
    });

  trafficManagerProfile.command('set [name]')
    ...
    .execute(function (name, options, _) {
      ...
      var trafficManagerManagementClient = createTrafficManagerManagementClient(options);
      var trafficManager = new TrafficManager(cli, trafficManagerManagementClient);
      trafficManager.setProfile(name, options, _);
    });

  trafficManagerProfile.command('show [name]')
    ...
    .execute(function (name, options, _) {
      ...
      var trafficManagerManagementClient = createTrafficManagerManagementClient(options);
      var trafficManager = new TrafficManager(cli, trafficManagerManagementClient);
      trafficManager.showProfile(name, options, _);
    });
  ...
  trafficManagerProfile.command('delete [name]')
    .usage('[options] <name>')
    ...
    .execute(function (name, options, _) {
      ...
      var trafficManagerManagementClient = createTrafficManagerManagementClient(options);
      var trafficManager = new TrafficManager(cli, trafficManagerManagementClient);
      trafficManager.deleteProfile(name, options, _);
    });

  trafficManagerProfile.command('enable [name]')
    ...
    .execute(function (name, options, _) {
      ...
      var trafficManagerManagementClient = createTrafficManagerManagementClient(options);
      var trafficManager = new TrafficManager(cli, trafficManagerManagementClient);
      trafficManager.enableProfile(name, options, _);
    });

  trafficManagerProfile.command('disable [name]')
    ...
    .execute(function (name, options, _) {
      ...
      var trafficManagerManagementClient = createTrafficManagerManagementClient(options);
      var trafficManager = new TrafficManager(cli, trafficManagerManagementClient);
      trafficManager.disableProfile(name, options, _);
    });
  ...
  trafficManagerEndpoint.command('create [profile-name] [name] [type]')
  ...
  trafficManagerEndpoint.command('set [profile-name] [name]')
  ...
  trafficManagerEndpoint.command('delete [profile-name] [name]')
