...
__.extend(NetworkClient.prototype, {
  ...
  removeApplicationGatewayFrontendIp: function (appGatewayName, frontendIpName, options, _) {
    var networkManagementClient = this._createNetworkManagementClient(this.subscription);
    var appGateway = new AppGateway(this.cli, networkManagementClient);
    appGateway.removeFrontendIp(appGatewayName, frontendIpName, options, _);
  },
  ...
  removeApplicationGatewayFrontendPort: function (appGatewayName, name, options, _) {
    var networkManagementClient = this._createNetworkManagementClient(this.subscription);
    var appGateway = new AppGateway(this.cli, networkManagementClient);
    appGateway.removeFrontendPort(appGatewayName, name, options, _);
  },

  addApplicationGatewayHttpListener: function (appGatewayName, httpListenerName, frontendPortName, options, _) {
    var networkManagementClient = this._createNetworkManagementClient(this.subscription);
    var appGateway = new AppGateway(this.cli, networkManagementClient);
    appGateway.addHttpListener(appGatewayName, httpListenerName, frontendPortName, options, _);
  },

  removeApplicationGatewayHttpListener: function (appGatewayName, httpListenerName, options, _) {
    var networkManagementClient = this._createNetworkManagementClient(this.subscription);
    var appGateway = new AppGateway(this.cli, networkManagementClient);
    appGateway.removeHttpListener(appGatewayName, httpListenerName, options, _);
  },
  ...
  removeApplicationGatewayBalancingRule: function (appGatewayName, ruleName, options, _) {
    var networkManagementClient = this._createNetworkManagementClient(this.subscription);
    var appGateway = new AppGateway(this.cli, networkManagementClient);
    appGateway.removeLoadBalancingRule(appGatewayName, ruleName, options, _);
  },
  ...
  createProfileEndpoint: function (profileName, domainName, type, options, _) {
    var trafficManagerManagementClient = this._createTrafficManagerManagementClient(this.subscription);
    var trafficManager = new TrafficManager(this.cli, trafficManagerManagementClient);
    trafficManager.createEndpoint(profileName, domainName, type, options, _);
  },

  updateProfileEndpoint: function (profileName, domainName, options, _) {
    var trafficManagerManagementClient = this._createTrafficManagerManagementClient(this.subscription);
    var trafficManager = new TrafficManager(this.cli, trafficManagerManagementClient);
    trafficManager.updateEndpoint(profileName, domainName, options, _);
  },

  deleteProfileEndpoint: function (profileName, domainName, options, _) {
    var trafficManagerManagementClient = this._createTrafficManagerManagementClient(this.subscription);
    var trafficManager = new TrafficManager(this.cli, trafficManagerManagementClient);
    trafficManager.deleteEndpoint(profileName, domainName, options, _);
  },
