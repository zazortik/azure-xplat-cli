...
exports.init = function (cli) {
  ...
  function getCertificate(serviceName, thumbprint, thumbprintAlgorithm, options, _) {
    ...
    try {
      var params = { 'serviceName' : serviceName, 'thumbprint' : thumbprint, 'thumbprintAlgorithm' : thumbprintAlgorithm };
      certificate = service.serviceCertificates.get(params, _);
    } finally {
      progress.end();
    }
  ...
  certificates.command('get')
    .description($('Get Azure certificate'))
    .option('--service-name <serviceName>', $('the cloud service name'))
    .option('--thumbprint <thumbprint>', $('the thumbprint'))
    .option('--thumbprint-algorithm <thumbprint-algorithm>', $('the thumbprint algorithm'))
    .option('-s, --subscription <id>', $('the subscription id'))
    .execute(function (options, _) {
      var certificate = getCertificate(options.serviceName, options.thumbprint, options.thumbprintAlgorithm, options, _);
