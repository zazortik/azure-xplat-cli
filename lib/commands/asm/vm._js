...
exports.init = function (cli) {
  ...
  extension.command('set <vm-name> <extension-name> <publisher-name> <version>')
    ...
    .option('-c, --public-config <public-config>', $('public configuration text'))
    .option('-C, --public-config-path <public-config-path>', $('public configuration file path'))
    .option('-i, --private-config <private-config>', $('private configuration text'))
    .option('-I, --private-config-path <private-config-path>', $('private configuration file path'))
