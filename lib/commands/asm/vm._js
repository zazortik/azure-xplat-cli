...
exports.init = function (cli) {
  ...
  publicIP.command('list <vm-name>')
      .description($('List a VM public IP addresses'))
      .option('-d, --dns-name <name>', $('consider VM hosted in this DNS name'))
      .option('-s, --subscription <id>', $('the subscription id'))
      .execute(function (vmName, options, callback) {
        var vmClient = new VMClient(cli, options.subscription);
  ...
  publicIP.command('set <vm-name> <publicip-name>')
      .description($('Set a VM public IP address'))
  ...
  publicIP.command('remove <vm-name> <publicip-name>')
      .description($('Remove a VM public IP address'))
  ...
  aclRule.command('create <vm-name> <endpoint-name> <order> <action> <remote-subnet>')
      ...
      .option('-d, --dns-name <name>', $('only consider VMs for this DNS name'))
      .option('-r, --description', $('description for the ACL rule'))
      .option('-s, --subscription <id>', $('the subscription id'))
  ...
  aclRule.command('delete <vm-name> <endpoint-name> <order>')
      .description($('Remove an ACL rule for a VM endpoint'))
      .option('-d, --dns-name <name>', $('only consider VMs for this DNS name'))
      .option('-s, --subscription <id>', $('the subscription id'))
  ...
  aclRule.command('update <vm-name> <endpoint-name> <order>')
      .description($('Update an ACL rule defined for a VM endpoint'))
      .option('-d, --dns-name <name>', $('only consider VMs for this DNS name'))
      .option('-o, --new-order <id>', $('the new order for the ACL'))
