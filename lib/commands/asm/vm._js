...
exports.init = function(cli) {
  ...
  endpoint.command('create <vm-name> <public-port> [local-port]')
    ...
    .option('-k, --probe-interval <probe-interval>', $('the availability status check interval specified in seconds'))
    .option('-c, --probe-timeout <probe-timeout>', $('the availability status check timeout specified in seconds'))
