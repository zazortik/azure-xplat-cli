...
_.extend(VMClient.prototype, {
  ...
  createComputeManagementClient: function() {
    var self = this;
    return utils._createComputeClient(profile.current.getSubscription(self.subscription));
  },

  createManagementClient: function() {
    var self = this;
    return utils._createManagementClient(profile.current.getSubscription(self.subscription));
  },

  createStorageClient: function() {
    var self = this;
    return utils._createStorageClient(profile.current.getSubscription(self.subscription));
  },

  createNetworkClient: function() {
    var self = this;
    return utils._createNetworkClient(profile.current.getSubscription(self.subscription));
  },
