...
function parseNICParams(nicParams) {
  ...
  var nicConfigFmtMsg = '--nic-config must be comma seperated NIC definitions, format of each NIC definition must be <nicName>:<subnetName>:[vnetStaticIP]:[nsgName]:[ipForwarding]';
