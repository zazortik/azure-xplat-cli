...
exports.init = function (cli) {
  ...
  function regenerateAccountKeys(serviceClient, accountName, options, _) {
    ...
    if (isResourceMode) {
      ...
      return serviceClient.storageAccounts.regenerateKey(options.resourceGroup, accountName, keyType, _);
    } else {
  ...
  Object.getPrototypeOf(storage).appendSubscriptionAndResourceGroupOption = function () {
    if (isResourceMode) {
      this.option('--resource-group <resourceGroup>', $('the resource group name'));
    }
