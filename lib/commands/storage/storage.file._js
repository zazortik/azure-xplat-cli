...
exports.init = function(cli) {
  ...
  */
  function uploadFile(source, share, path, options, _) {
    ...
    var uploadFile;
    try {
      uploadFile = performStorageOperation(
    ...
    if (succeeded === true) {
      uploadFile = StorageUtil.embedTransferSummary(uploadFile, summary);
      cli.interaction.formatOutput(uploadFile, function(data) {
  ...
  function downloadFile(share, path, destination, options, _) {
    ...
    cli.interaction.formatOutput(downloadedFile, function(data) {
