...
exports.init = function(cli) {
  ...
  */
  function createShareSas(share, permissions, expiry, options, _) {
    createSas(share, null, permissions, options.protocol, options.ipRange, expiry, options, true, _);
  }
  ...
  */
  function createFileSas(share, path, permissions, expiry, options, _) {
    createSas(share, path, permissions, options.protocol, options.ipRange, expiry, options, false, _);
  }

  /**
  * Create shared access signature
  */
  function createSas(share, path, permissions, protocol, ipRange, expiry, options, isShare, _) {
    var fileService = getFileServiceClient(options);
    share = interaction.promptIfNotGiven($('Share name: '), share, _);
    ...
    if (!isShare) {
      ...
      accessType = StorageUtil.AccessType.File;
    } else {
      accessType = StorageUtil.AccessType.Share;
    }
  ...
  */
  ...
  function doesStorageFileExist(share, path, options, _) {
    ...
    return performStorageOperation(propertiesOperation, _, share, result.dirname, result.basename, storageOptions).exists;
  }
  ...
  */
  function startFileCopy(sourceUri, destShare, options, _) {
    ...
    StorageUtil.startAsyncCopy(startCopyParams, destShare, options, _);
  }
