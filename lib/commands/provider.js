...
exports.init = function (cli) {
  ...
  provider.command('register')
    ...
    .execute(function (resourceName, options, cb) {
      ...
      var progress = cli.progress(util.format($('Registering resource %s'), resourceName));
  ...
  provider.command('unregister')
    ...
    .execute(function (resourceName, options, cb) {
      ...
      var progress = cli.progress(util.format($('Unregistering resource %s'), resourceName));
  ...
  provider.command('list')
    ...
    .execute(function (options, cb) {
      ...
      var progress = cli.progress($('Getting registered resource types'));
