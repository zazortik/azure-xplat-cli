...
exports.init = function (cli) {
  ...
  function getBaseChannel(options) {
    console.log('getBaseChannel, options.subscription', options.subscription);
    var currentSubscription = cli.category('account').getCurrentSubscription(options.subscription);
    console.log('getBaseChannel, currentSubscription', currentSubscription);
    ...
    console.log('getBaseChannel, managementEndpoint', managementEndpoint);
