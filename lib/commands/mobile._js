...
exports.init = function (cli) {
  ...
  function getBaseChannel(options) {
    ...
    var account = cli.category('account');
    var managementEndpoint = url.parse(cli.globalSettingsManager.getManagementEndpointUrl(account.managementEndpointUrl()));
  ...
  mobile.createService = function (options, callback) {
    ...
    if (options.sqlServer) {
      ...
      serverSpec = {
        ...
        URI:  cli.globalSettingsManager.getSqlManagementEndpointUrl() +
          ...
          ProvisioningConfigParameters: {
            Server: {
              StringConcat: [
                ...
                cli.globalSettingsManager.getSqlServerHostnameSuffix()
              ]
            },
            Database: {
