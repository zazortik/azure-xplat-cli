...
exports.init = function(cli) {
  ...
  scm.command("list [name]").usage("[options] [name]").description("List your git deployments").option("-s, --subscription <id>", "use the subscription id").option("-m, --max <count>", "limit the maximum number of results").execute(function __1(name, options, _) { var context, repositoryUri; var __frame = { name: "__1", line: 71 }; return __func(_, this, arguments, __1, 2, __frame, function __$__1() {
  ...
  scm.command("show <commitId> [name]").usage("[options] <commitId> [name]").description("Show your git deployment").option("-s, --subscription <id>", "use the subscription id").option("-d, --details", "display log details").execute(function __2(commitId, name, options, _) { var context, repositoryUri, deployment, data, logs, i, details, j; var __frame = { name: "__2", line: 93 }; return __func(_, this, arguments, __2, 3, __frame, function __$__2() {
  ...
  scm.command("redeploy <commitId> [name]").usage("[options] <commitId> [name]").description("Redeploy your git deployment").option("-s, --subscription <id>", "use the subscription id").option("-q, --quiet", "quiet mode, do not ask for redeploy confirmation").execute(function __3(commitId, name, options, _) { var context, repositoryUri; var __frame = { name: "__3", line: 144 }; return __func(_, this, arguments, __3, 3, __frame, function __$__3() {
  ...
  scm.command("github [name]").usage("[options] [name]").description("Links a website to a github account for deployment").option("-s, --subscription <id>", "use the subscription id").option("--githubusername <username>", "The github username").option("--githubpassword <password>", "The github password").option("--githubrepository <repository>", "The github repository full name (i.e. user/repository)").execute(function __4(name, options, _) { var context;
    ...
    function initializeRemoteRepo(_) { var __frame = { name: "initializeRemoteRepo", line: 207 }; return __func(_, this, arguments, initializeRemoteRepo, 0, __frame, function __$initializeRemoteRepo() {
        log.silly("InitializeRemoteRepo");
        return site.doRepositoryPost(context, __cb(_, __frame, 2, 8, function __$initializeRemoteRepo() {
          return site.ensureRepositoryUri(context, __cb(_, __frame, 3, 8, _, true)); }, true)); }); }; var __frame = { name: "__4", line: 176 }; return __func(_, this, arguments, __4, 2, __frame, function __$__4() { context = { subscription: cli.category("account").lookupSubscriptionId(options.subscription), site: { name: name }, github: { username: options.githubusername, password: options.githubpassword, repositoryFullName: options.githubrepository }, flags: { } }; if (!context.github.repositoryFullName) { context.flags = { forceRepositorySelection: true }; } ; return site.ensureRepositoryUri(context, __cb(_, __frame, 21, 6, function __$__4() { return (function __$__4(__then) { if (!context.repositoryUri) { return initializeRemoteRepo(__cb(_, __frame, 24, 8, __then, true)); } else { __then(); } ; })(function __$__4() { context.lvcClient = linkedRevisionControl.createClient(cli, "github"); return context.lvcClient.init(context, __cb(_, __frame, 28, 6, function __$__4() { return context.lvcClient.deploy(context, __cb(_, __frame, 29, 6, _, true)); }, true)); }); }, true)); }); });



  scm.doDeploymentsGet = function scm_doDeploymentsGet__5(context, _) { var maxItems, channel, progress, deployments; var __frame = { name: "scm_doDeploymentsGet__5", line: 214 }; return __func(_, this, arguments, scm_doDeploymentsGet__5, 1, __frame, function __$scm_doDeploymentsGet__5() {
  ...
  scm.doDeploymentGet = function scm_doDeploymentGet__6(context, _) { var channel, progress; var __frame = { name: "scm_doDeploymentGet__6", line: 235 }; return __func(_, this, arguments, scm_doDeploymentGet__6, 1, __frame, function __$scm_doDeploymentGet__6() {
  ...
  scm.doDeploymentPut = function scm_doDeploymentPut__7(context, _) { var channel, progress; var __frame = { name: "scm_doDeploymentPut__7", line: 247 }; return __func(_, this, arguments, scm_doDeploymentPut__7, 1, __frame, function __$scm_doDeploymentPut__7() {
  ...
  scm.doLogGet = function scm_doLogGet__8(context, _) { var channel, progress, logs; var __frame = { name: "scm_doLogGet__8", line: 259 }; return __func(_, this, arguments, scm_doLogGet__8, 1, __frame, function __$scm_doLogGet__8() {
  ...
  function listDeployments(context, _) { var deployments, authorLength, messageLength; var __frame = { name: "listDeployments", line: 273 }; return __func(_, this, arguments, listDeployments, 1, __frame, function __$listDeployments() {
  ...
  function getLogDetails(context, _) { var results, logs, progress, i; var __frame = { name: "getLogDetails", line: 291 }; return __func(_, this, arguments, getLogDetails, 1, __frame, function __$getLogDetails() {
      ...
      return scm.doLogGet(context, __cb(_, __frame, 2, 15, function ___(__0, __2) { logs = __2; return (function __$getLogDetails(__then) {
          if ((logs && logs.length)) {
            progress = cli.progress("Retrieving log details"); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$getLogDetails() {
                  ...
                  return async.map(logs, function __1(log, _) { var details; var __frame = { name: "__1", line: 297 }; return __func(_, this, arguments, __1, 1, __frame, function __$__1() { return (function __$__1(__then) {
                        if (log.hasDetails) {
