...
exports.init = function (cli) {
  ...
  var siteConfig = site.category('config')
    .description('Commands to manage your Web Site configurations');
  ...
  siteConfig.command('list [name]')
    ...
    .execute(function (name, options, _) {
      ...
      if (siteConfigurations.AppSettings.NameValuePair) {
        ...
        log.info('No app settings defined yet. You can define app settings using "azure site config add <name>=<value>.');
      }
    });
