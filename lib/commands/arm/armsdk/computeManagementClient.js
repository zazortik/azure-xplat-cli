...
var AvailabilitySetOperations = ( /** @lends AvailabilitySetOperations */ function() {
   ...
   * 
   * @param {Plan} [parameters.availabilitySet.plan] Gets or sets the plan of
   * the resource.
   * 
   * @param {string} [parameters.availabilitySet.plan.name] Gets or sets the
   * plan ID.
   * 
   * @param {string} [parameters.availabilitySet.plan.publisher] Gets or sets
   * the publisher ID.
   * 
   * @param {string} [parameters.availabilitySet.plan.product] Gets or sets the
   * offer ID.
   * 
   * @param {string} [parameters.availabilitySet.plan.promotionCode] Gets or
  ...
  AvailabilitySetOperations.prototype.createOrUpdate = function(resourceGroupName, parameters, callback) {
    ...
    if (parameters.availabilitySet.plan !== null && parameters.availabilitySet.plan !== undefined) {
      var planValue = {};
      availabilitySetCreateOrUpdateParametersValue['plan'] = planValue;
      
      if (parameters.availabilitySet.plan.name !== null && parameters.availabilitySet.plan.name !== undefined) {
        planValue['name'] = parameters.availabilitySet.plan.name;
      }
      
      if (parameters.availabilitySet.plan.publisher !== null && parameters.availabilitySet.plan.publisher !== undefined) {
        planValue['publisher'] = parameters.availabilitySet.plan.publisher;
      }
      
      if (parameters.availabilitySet.plan.product !== null && parameters.availabilitySet.plan.product !== undefined) {
        planValue['product'] = parameters.availabilitySet.plan.product;
      }
      
      if (parameters.availabilitySet.plan.promotionCode !== null && parameters.availabilitySet.plan.promotionCode !== undefined) {
        planValue['promotionCode'] = parameters.availabilitySet.plan.promotionCode;
      }
    }
      ...
      if (statusCode === 200) {
        ...
        if (responseDoc !== null && responseDoc !== undefined) {
          ...
          if (planValue2 !== null && planValue2 !== undefined) {
            var planInstance = {};
            availabilitySetInstance.plan = planInstance;
...
var VirtualMachineExtensionOperations = ( /** @lends VirtualMachineExtensionOperations */ function() {
   ...
   * 
   * @param {Plan} [parameters.virtualMachineExtension.plan] Gets or sets the
   * plan of the resource.
   * 
   * @param {string} [parameters.virtualMachineExtension.plan.name] Gets or
   * sets the plan ID.
   * 
   * @param {string} [parameters.virtualMachineExtension.plan.publisher] Gets
   * or sets the publisher ID.
   * 
   * @param {string} [parameters.virtualMachineExtension.plan.product] Gets or
   * sets the offer ID.
   * 
   * @param {string} [parameters.virtualMachineExtension.plan.promotionCode]
  ...
  VirtualMachineExtensionOperations.prototype.beginCreateOrUpdating = function(resourceGroupName, vmName, parameters, callback) {
    ...
    if (parameters.virtualMachineExtension.plan !== null && parameters.virtualMachineExtension.plan !== undefined) {
      var planValue = {};
      virtualMachineExtensionCreateOrUpdateParametersValue['plan'] = planValue;
      
      if (parameters.virtualMachineExtension.plan.name !== null && parameters.virtualMachineExtension.plan.name !== undefined) {
        planValue['name'] = parameters.virtualMachineExtension.plan.name;
      }
      
      if (parameters.virtualMachineExtension.plan.publisher !== null && parameters.virtualMachineExtension.plan.publisher !== undefined) {
        planValue['publisher'] = parameters.virtualMachineExtension.plan.publisher;
      }
      
      if (parameters.virtualMachineExtension.plan.product !== null && parameters.virtualMachineExtension.plan.product !== undefined) {
        planValue['product'] = parameters.virtualMachineExtension.plan.product;
      }
      
      if (parameters.virtualMachineExtension.plan.promotionCode !== null && parameters.virtualMachineExtension.plan.promotionCode !== undefined) {
        planValue['promotionCode'] = parameters.virtualMachineExtension.plan.promotionCode;
      }
    }
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      if (statusCode === 200 || statusCode === 201) {
        ...
        if (responseDoc !== null && responseDoc !== undefined) {
          ...
          if (planValue2 !== null && planValue2 !== undefined) {
            var planInstance = {};
            virtualMachineExtensionInstance.plan = planInstance;
            
            var nameValue3 = planValue2['name'];
            if (nameValue3 !== null && nameValue3 !== undefined) {
              var nameInstance3 = nameValue3;
              planInstance.name = nameInstance3;
            }
            
            var publisherValue2 = planValue2['publisher'];
      ...
      if (statusCode === 200) {
        ...
        if (responseDoc !== null && responseDoc !== undefined) {
          ...
          if (planValue !== null && planValue !== undefined) {
            ...
            var nameValue3 = planValue['name'];
            if (nameValue3 !== null && nameValue3 !== undefined) {
              var nameInstance3 = nameValue3;
              planInstance.name = nameInstance3;
            }
            
            var publisherValue2 = planValue['publisher'];
            if (publisherValue2 !== null && publisherValue2 !== undefined) {
              var publisherInstance2 = publisherValue2;
              planInstance.publisher = publisherInstance2;
            }
...
var VirtualMachineOperations = ( /** @lends VirtualMachineOperations */ function() {
  ...
  VirtualMachineOperations.prototype.beginCapturing = function(resourceGroupName, vmName, parameters, callback) {
    ...
    requestDoc = parameters.virtualHardDiskNamePrefix;
    
    requestDoc = parameters.destinationContainerName;
    
    requestDoc = parameters.overwrite;
   ...
   * attached to the resource.
   * 
   * @param {Plan} [parameters.virtualMachine.plan] Gets or sets the plan of
   * the resource.
   * 
   * @param {string} [parameters.virtualMachine.plan.name] Gets or sets the
   * plan ID.
   * 
   * @param {string} [parameters.virtualMachine.plan.publisher] Gets or sets
   * the publisher ID.
   * 
   * @param {string} [parameters.virtualMachine.plan.product] Gets or sets the
   * offer ID.
   * 
   * @param {string} [parameters.virtualMachine.plan.promotionCode] Gets or
   * sets the promotion code.
   * 
   * @param {function} callback
   * 
  ...
  VirtualMachineOperations.prototype.beginCreateOrUpdating = function(resourceGroupName, parameters, callback) {
    ...
    if (parameters.virtualMachine.virtualMachineSubResources !== null && parameters.virtualMachine.virtualMachineSubResources !== undefined) {
      ...
      if (parameters.virtualMachine.virtualMachineSubResources.extensions !== null && parameters.virtualMachine.virtualMachineSubResources.extensions !== undefined) {
        ...
        for (var loweredIndex5 = 0; loweredIndex5 < parameters.virtualMachine.virtualMachineSubResources.extensions.length; loweredIndex5 = loweredIndex5 + 1) {
          ...
          if (extensionsItem.plan !== null && extensionsItem.plan !== undefined) {
            var planValue = {};
            requestDoc = planValue;
            
            if (extensionsItem.plan.name !== null && extensionsItem.plan.name !== undefined) {
              planValue['name'] = extensionsItem.plan.name;
            }
            
            if (extensionsItem.plan.publisher !== null && extensionsItem.plan.publisher !== undefined) {
              planValue['publisher'] = extensionsItem.plan.publisher;
            }
            
            if (extensionsItem.plan.product !== null && extensionsItem.plan.product !== undefined) {
              planValue['product'] = extensionsItem.plan.product;
            }
            
            if (extensionsItem.plan.promotionCode !== null && extensionsItem.plan.promotionCode !== undefined) {
              planValue['promotionCode'] = extensionsItem.plan.promotionCode;
            }
          }
        }
    ...
    if (parameters.virtualMachine.plan !== null && parameters.virtualMachine.plan !== undefined) {
      var planValue2 = {};
      virtualMachineCreateOrUpdateParametersValue['plan'] = planValue2;
      
      if (parameters.virtualMachine.plan.name !== null && parameters.virtualMachine.plan.name !== undefined) {
        planValue2['name'] = parameters.virtualMachine.plan.name;
      }
      
      if (parameters.virtualMachine.plan.publisher !== null && parameters.virtualMachine.plan.publisher !== undefined) {
        planValue2['publisher'] = parameters.virtualMachine.plan.publisher;
      }
      
      if (parameters.virtualMachine.plan.product !== null && parameters.virtualMachine.plan.product !== undefined) {
        planValue2['product'] = parameters.virtualMachine.plan.product;
      }
      
      if (parameters.virtualMachine.plan.promotionCode !== null && parameters.virtualMachine.plan.promotionCode !== undefined) {
        planValue2['promotionCode'] = parameters.virtualMachine.plan.promotionCode;
      }
    }
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      if (statusCode === 200 || statusCode === 201) {
        ...
        if (responseDoc !== null && responseDoc !== undefined) {
          ...
          if (resourcesValue2 !== null && resourcesValue2 !== undefined) {
            ...
            if (extensionsArray2 !== null && extensionsArray2 !== undefined) {
              for (var loweredIndex10 = 0; loweredIndex10 < extensionsArray2.length; loweredIndex10 = loweredIndex10 + 1) {
                ...
                var planValue3 = extensionsValue['plan'];
                if (planValue3 !== null && planValue3 !== undefined) {
                  var planInstance = {};
                  virtualMachineExtensionInstance.plan = planInstance;
                  
                  var nameValue5 = planValue3['name'];
                  if (nameValue5 !== null && nameValue5 !== undefined) {
                    var nameInstance5 = nameValue5;
                    planInstance.name = nameInstance5;
                  }
                  
                  var publisherValue2 = planValue3['publisher'];
                  if (publisherValue2 !== null && publisherValue2 !== undefined) {
                    var publisherInstance2 = publisherValue2;
                    planInstance.publisher = publisherInstance2;
                  }
                  
                  var productValue = planValue3['product'];
                  if (productValue !== null && productValue !== undefined) {
                    var productInstance = productValue;
                    planInstance.product = productInstance;
                  }
                  
                  var promotionCodeValue = planValue3['promotionCode'];
                  if (promotionCodeValue !== null && promotionCodeValue !== undefined) {
                    var promotionCodeInstance = promotionCodeValue;
                    planInstance.promotionCode = promotionCodeInstance;
                  }
          ...
          var planValue4 = responseDoc['plan'];
          if (planValue4 !== null && planValue4 !== undefined) {
            var planInstance2 = {};
            virtualMachineInstance.plan = planInstance2;
            
            var nameValue7 = planValue4['name'];
            if (nameValue7 !== null && nameValue7 !== undefined) {
              var nameInstance7 = nameValue7;
              planInstance2.name = nameInstance7;
            }
            
            var publisherValue3 = planValue4['publisher'];
            if (publisherValue3 !== null && publisherValue3 !== undefined) {
              var publisherInstance3 = publisherValue3;
              planInstance2.publisher = publisherInstance3;
            }
            
            var productValue2 = planValue4['product'];
            if (productValue2 !== null && productValue2 !== undefined) {
              var productInstance2 = productValue2;
              planInstance2.product = productInstance2;
            }
            
            var promotionCodeValue2 = planValue4['promotionCode'];
            if (promotionCodeValue2 !== null && promotionCodeValue2 !== undefined) {
              var promotionCodeInstance2 = promotionCodeValue2;
              planInstance2.promotionCode = promotionCodeInstance2;
            }
          }
      ...
      if (statusCode === 200) {
        ...
        if (responseDoc !== null && responseDoc !== undefined) {
          ...
          if (resourcesValue !== null && resourcesValue !== undefined) {
            ...
            if (extensionsArray !== null && extensionsArray !== undefined) {
              for (var loweredIndex3 = 0; loweredIndex3 < extensionsArray.length; loweredIndex3 = loweredIndex3 + 1) {
                ...
                var planValue = extensionsValue['plan'];
                if (planValue !== null && planValue !== undefined) {
                  var planInstance = {};
                  virtualMachineExtensionInstance.plan = planInstance;
                  
                  var nameValue5 = planValue['name'];
                  if (nameValue5 !== null && nameValue5 !== undefined) {
                    var nameInstance5 = nameValue5;
                    planInstance.name = nameInstance5;
                  }
          ...
          if (planValue2 !== null && planValue2 !== undefined) {
            ...
            var nameValue7 = planValue2['name'];
            if (nameValue7 !== null && nameValue7 !== undefined) {
              var nameInstance7 = nameValue7;
              planInstance2.name = nameInstance7;
            }
            
            var publisherValue3 = planValue2['publisher'];
            if (publisherValue3 !== null && publisherValue3 !== undefined) {
              var publisherInstance3 = publisherValue3;
              planInstance2.publisher = publisherInstance3;
            }
            
            var productValue2 = planValue2['product'];
            if (productValue2 !== null && productValue2 !== undefined) {
              var productInstance2 = productValue2;
              planInstance2.product = productInstance2;
            }
            
            var promotionCodeValue2 = planValue2['promotionCode'];
            if (promotionCodeValue2 !== null && promotionCodeValue2 !== undefined) {
              var promotionCodeInstance2 = promotionCodeValue2;
              planInstance2.promotionCode = promotionCodeInstance2;
            }
        ...
        if (responseDoc !== null && responseDoc !== undefined) {
          ...
          if (valueArray !== null && valueArray !== undefined) {
            for (var loweredIndex1 = 0; loweredIndex1 < valueArray.length; loweredIndex1 = loweredIndex1 + 1) {
              ...
              var planValue2 = valueValue['plan'];
              if (planValue2 !== null && planValue2 !== undefined) {
                var planInstance2 = {};
                virtualMachineInstance.plan = planInstance2;
