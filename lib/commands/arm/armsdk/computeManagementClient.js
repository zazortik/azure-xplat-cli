...
var AvailabilitySetOperations = ( /** @lends AvailabilitySetOperations */ function() {
   ...
   * 
   * @param {string} [parameters.availabilitySet.id] Gets or sets the ID of the
   * resource.
   * 
   * @param {string} [parameters.availabilitySet.name] Gets or sets the name of
   * the resource.
   * 
  ...
  AvailabilitySetOperations.prototype.createOrUpdate = function(resourceGroupName, parameters, callback) {
    ...
    if (parameters.availabilitySet.location === null || parameters.availabilitySet.location === undefined) {
      return callback(new Error('parameters.availabilitySet.location cannot be null.'));
    }
...
var VirtualMachineExtensionOperations = ( /** @lends VirtualMachineExtensionOperations */ function() {
   ...
   * The resource status information.
   * 
   * @param {string} [parameters.virtualMachineExtension.id] Gets or sets the
   * ID of the resource.
   * 
   * @param {string} [parameters.virtualMachineExtension.name] Gets or sets the
  ...
  VirtualMachineExtensionOperations.prototype.beginCreateOrUpdating = function(resourceGroupName, vmName, parameters, callback) {
    ...
    if (parameters.virtualMachineExtension.location === null || parameters.virtualMachineExtension.location === undefined) {
      return callback(new Error('parameters.virtualMachineExtension.location cannot be null.'));
    }
...
var VirtualMachineOperations = ( /** @lends VirtualMachineOperations */ function() {
   ...
   * 
   * @param {string} parameters.virtualHardDiskNamePrefix The captured
   * VirtualHardDisk's name prefix.
   * 
   * @param {string} parameters.destinationContainerName The destination
   * container name.
   * 
   * @param {boolean} parameters.overwrite Overwrite destination
   ...
   * 
   * @param {VirtualHardDisk}
   * [parameters.virtualMachine.virtualMachineProperties.storageProfile.oSDisk.sourceImage]
   ...
   * 
   * @param {string}
   * [parameters.virtualMachine.virtualMachineProperties.storageProfile.oSDisk.sourceImage.uri]
   * The virtual hard disk's uri. It should be a valid Uri to a virtual hard
   * disk.
   * 
   * @param {string}
   ...
   * 
   * @param {string}
   * [parameters.virtualMachine.virtualMachineProperties.oSProfile.customData]
   ...
   * 
   * @param {boolean}
   * [parameters.virtualMachine.virtualMachineProperties.oSProfile.windowsConfiguration.enableAutomaticUpdates]
   * Determines if Windows updates are automatically installed on the VM
   * 
   * @param {string}
   * [parameters.virtualMachine.virtualMachineProperties.oSProfile.windowsConfiguration.timeZone]
   * Time Zone of the VM
   * 
   * @param {array}
   * [parameters.virtualMachine.virtualMachineProperties.oSProfile.windowsConfiguration.additionalUnattendContent]
   ...
   * [parameters.virtualMachine.virtualMachineProperties.oSProfile.windowsConfiguration.windowsRemoteManagementConfiguration]
   * Windows Remote Management configuration of the VM
   * 
   * @param {array}
   * [parameters.virtualMachine.virtualMachineProperties.oSProfile.windowsConfiguration.windowsRemoteManagementConfiguration.listeners]
   * List of Windows Remote Management listeners
   * 
   * @param {LinuxConfiguration}
   * [parameters.virtualMachine.virtualMachineProperties.oSProfile.linuxConfiguration]
   * Linux Configuration of the OS profile.
   * 
   * @param {boolean}
   * [parameters.virtualMachine.virtualMachineProperties.oSProfile.linuxConfiguration.disablePasswordAuthentication]
   * Indicates whether Authentication using user name and password is allowed
   * or not
   * 
   * @param {SSHConfiguration}
   * [parameters.virtualMachine.virtualMachineProperties.oSProfile.linuxConfiguration.ssh]
   * SSH configuration for linux VMs
   * 
   * @param {array}
   * [parameters.virtualMachine.virtualMachineProperties.oSProfile.linuxConfiguration.ssh.publicKeys]
   ...
   * 
   * @param {string} [parameters.virtualMachine.id] Gets or sets the ID of the
   * resource.
   * 
   * @param {string} [parameters.virtualMachine.name] Gets or sets the name of
   * the resource.
   * 
  ...
  VirtualMachineOperations.prototype.beginCreateOrUpdating = function(resourceGroupName, parameters, callback) {
    ...
    if (parameters.virtualMachine.location === null || parameters.virtualMachine.location === undefined) {
      return callback(new Error('parameters.virtualMachine.location cannot be null.'));
    }
      ...
      if (parameters.virtualMachine.virtualMachineSubResources.extensions !== null && parameters.virtualMachine.virtualMachineSubResources.extensions !== undefined) {
        for (var loweredIndex2 = 0; loweredIndex2 < parameters.virtualMachine.virtualMachineSubResources.extensions.length; loweredIndex2 = loweredIndex2 + 1) {
          ...
          if (extensionsParameterItem.location === null || extensionsParameterItem.location === undefined) {
            return callback(new Error('parameters.virtualMachine.virtualMachineSubResources.extensions.location cannot be null.'));
          }
    ...
    if (parameters.virtualMachine.virtualMachineProperties !== null && parameters.virtualMachine.virtualMachineProperties !== undefined) {
      ...
      if (parameters.virtualMachine.virtualMachineProperties.storageProfile !== null && parameters.virtualMachine.virtualMachineProperties.storageProfile !== undefined) {
        ...
        if (parameters.virtualMachine.virtualMachineProperties.storageProfile.oSDisk !== null && parameters.virtualMachine.virtualMachineProperties.storageProfile.oSDisk !== undefined) {
          ...
          if (parameters.virtualMachine.virtualMachineProperties.storageProfile.oSDisk.sourceImage !== null && parameters.virtualMachine.virtualMachineProperties.storageProfile.oSDisk.sourceImage !== undefined) {
            var imageValue = {};
            osDiskValue['image'] = imageValue;
            
            if (parameters.virtualMachine.virtualMachineProperties.storageProfile.oSDisk.sourceImage.uri !== null && parameters.virtualMachine.virtualMachineProperties.storageProfile.oSDisk.sourceImage.uri !== undefined) {
              imageValue['uri'] = parameters.virtualMachine.virtualMachineProperties.storageProfile.oSDisk.sourceImage.uri;
            }
          }
      ...
      if (parameters.virtualMachine.virtualMachineProperties.oSProfile !== null && parameters.virtualMachine.virtualMachineProperties.oSProfile !== undefined) {
        ...
        if (parameters.virtualMachine.virtualMachineProperties.oSProfile.customData !== null && parameters.virtualMachine.virtualMachineProperties.oSProfile.customData !== undefined) {
          osProfileValue['customData'] = new Buffer(parameters.virtualMachine.virtualMachineProperties.oSProfile.customData).toString('base64');
        }
        ...
        if (parameters.virtualMachine.virtualMachineProperties.oSProfile.windowsConfiguration !== null && parameters.virtualMachine.virtualMachineProperties.oSProfile.windowsConfiguration !== undefined) {
          ...
          if (parameters.virtualMachine.virtualMachineProperties.oSProfile.windowsConfiguration.enableAutomaticUpdates !== null && parameters.virtualMachine.virtualMachineProperties.oSProfile.windowsConfiguration.enableAutomaticUpdates !== undefined) {
            windowsConfigurationValue['enableAutomaticUpdates'] = parameters.virtualMachine.virtualMachineProperties.oSProfile.windowsConfiguration.enableAutomaticUpdates;
          }
          
          if (parameters.virtualMachine.virtualMachineProperties.oSProfile.windowsConfiguration.timeZone !== null && parameters.virtualMachine.virtualMachineProperties.oSProfile.windowsConfiguration.timeZone !== undefined) {
            windowsConfigurationValue['timeZone'] = parameters.virtualMachine.virtualMachineProperties.oSProfile.windowsConfiguration.timeZone;
          }
          
          if (parameters.virtualMachine.virtualMachineProperties.oSProfile.windowsConfiguration.additionalUnattendContent !== null && parameters.virtualMachine.virtualMachineProperties.oSProfile.windowsConfiguration.additionalUnattendContent !== undefined) {
            var additionalUnattendContentArray = [];
            for (var loweredIndex4 = 0; loweredIndex4 < parameters.virtualMachine.virtualMachineProperties.oSProfile.windowsConfiguration.additionalUnattendContent.length; loweredIndex4 = loweredIndex4 + 1) {
              var additionalUnattendContentItem = parameters.virtualMachine.virtualMachineProperties.oSProfile.windowsConfiguration.additionalUnattendContent[loweredIndex4];
          ...
          if (parameters.virtualMachine.virtualMachineProperties.oSProfile.windowsConfiguration.windowsRemoteManagementConfiguration !== null && parameters.virtualMachine.virtualMachineProperties.oSProfile.windowsConfiguration.windowsRemoteManagementConfiguration !== undefined) {
            var winRMValue = {};
            windowsConfigurationValue['winRM'] = winRMValue;
            
            if (parameters.virtualMachine.virtualMachineProperties.oSProfile.windowsConfiguration.windowsRemoteManagementConfiguration.listeners !== null && parameters.virtualMachine.virtualMachineProperties.oSProfile.windowsConfiguration.windowsRemoteManagementConfiguration.listeners !== undefined) {
              var listenersArray = [];
              for (var loweredIndex5 = 0; loweredIndex5 < parameters.virtualMachine.virtualMachineProperties.oSProfile.windowsConfiguration.windowsRemoteManagementConfiguration.listeners.length; loweredIndex5 = loweredIndex5 + 1) {
                var listenersItem = parameters.virtualMachine.virtualMachineProperties.oSProfile.windowsConfiguration.windowsRemoteManagementConfiguration.listeners[loweredIndex5];
        ...
        if (parameters.virtualMachine.virtualMachineProperties.oSProfile.linuxConfiguration !== null && parameters.virtualMachine.virtualMachineProperties.oSProfile.linuxConfiguration !== undefined) {
          var linuxConfigurationValue = {};
          osProfileValue['linuxConfiguration'] = linuxConfigurationValue;
          
          if (parameters.virtualMachine.virtualMachineProperties.oSProfile.linuxConfiguration.disablePasswordAuthentication !== null && parameters.virtualMachine.virtualMachineProperties.oSProfile.linuxConfiguration.disablePasswordAuthentication !== undefined) {
            linuxConfigurationValue['disablePasswordAuthentication'] = parameters.virtualMachine.virtualMachineProperties.oSProfile.linuxConfiguration.disablePasswordAuthentication;
          }
          
          if (parameters.virtualMachine.virtualMachineProperties.oSProfile.linuxConfiguration.ssh !== null && parameters.virtualMachine.virtualMachineProperties.oSProfile.linuxConfiguration.ssh !== undefined) {
            var sshValue = {};
            linuxConfigurationValue['ssh'] = sshValue;
            
            if (parameters.virtualMachine.virtualMachineProperties.oSProfile.linuxConfiguration.ssh.publicKeys !== null && parameters.virtualMachine.virtualMachineProperties.oSProfile.linuxConfiguration.ssh.publicKeys !== undefined) {
              var publicKeysArray = [];
              for (var loweredIndex6 = 0; loweredIndex6 < parameters.virtualMachine.virtualMachineProperties.oSProfile.linuxConfiguration.ssh.publicKeys.length; loweredIndex6 = loweredIndex6 + 1) {
                var publicKeysItem = parameters.virtualMachine.virtualMachineProperties.oSProfile.linuxConfiguration.ssh.publicKeys[loweredIndex6];
      ...
      if (parameters.virtualMachine.virtualMachineProperties.networkProfile !== null && parameters.virtualMachine.virtualMachineProperties.networkProfile !== undefined) {
        ...
        if (parameters.virtualMachine.virtualMachineProperties.networkProfile.networkInterfaces !== null && parameters.virtualMachine.virtualMachineProperties.networkProfile.networkInterfaces !== undefined) {
          ...
          for (var loweredIndex7 = 0; loweredIndex7 < parameters.virtualMachine.virtualMachineProperties.networkProfile.networkInterfaces.length; loweredIndex7 = loweredIndex7 + 1) {
            var networkInterfacesItem = parameters.virtualMachine.virtualMachineProperties.networkProfile.networkInterfaces[loweredIndex7];
    ...
    if (parameters.virtualMachine.virtualMachineSubResources !== null && parameters.virtualMachine.virtualMachineSubResources !== undefined) {
      ...
      if (parameters.virtualMachine.virtualMachineSubResources.extensions !== null && parameters.virtualMachine.virtualMachineSubResources.extensions !== undefined) {
        var extensionsArray = [];
        for (var loweredIndex8 = 0; loweredIndex8 < parameters.virtualMachine.virtualMachineSubResources.extensions.length; loweredIndex8 = loweredIndex8 + 1) {
          var extensionsItem = parameters.virtualMachine.virtualMachineSubResources.extensions[loweredIndex8];
          ...
          if (extensionsItem.virtualMachineExtensionProperties !== null && extensionsItem.virtualMachineExtensionProperties !== undefined) {
            ...
            if (extensionsItem.virtualMachineExtensionProperties.instanceView !== null && extensionsItem.virtualMachineExtensionProperties.instanceView !== undefined) {
              ...
              if (extensionsItem.virtualMachineExtensionProperties.instanceView.subStatuses !== null && extensionsItem.virtualMachineExtensionProperties.instanceView.subStatuses !== undefined) {
                var substatusesArray = [];
                for (var loweredIndex9 = 0; loweredIndex9 < extensionsItem.virtualMachineExtensionProperties.instanceView.subStatuses.length; loweredIndex9 = loweredIndex9 + 1) {
                  var substatusesItem = extensionsItem.virtualMachineExtensionProperties.instanceView.subStatuses[loweredIndex9];
              ...
              if (extensionsItem.virtualMachineExtensionProperties.instanceView.statuses !== null && extensionsItem.virtualMachineExtensionProperties.instanceView.statuses !== undefined) {
                var statusesArray = [];
                for (var loweredIndex10 = 0; loweredIndex10 < extensionsItem.virtualMachineExtensionProperties.instanceView.statuses.length; loweredIndex10 = loweredIndex10 + 1) {
                  var statusesItem = extensionsItem.virtualMachineExtensionProperties.instanceView.statuses[loweredIndex10];
          ...
          if (extensionsItem.id !== null && extensionsItem.id !== undefined) {
            requestDoc = extensionsItem.id;
          }
          
          if (extensionsItem.name !== null && extensionsItem.name !== undefined) {
            requestDoc = extensionsItem.name;
          }
          
          if (extensionsItem.type !== null && extensionsItem.type !== undefined) {
            requestDoc = extensionsItem.type;
          }
          
          requestDoc = extensionsItem.location;
        ...
        if (responseDoc !== null && responseDoc !== undefined) {
          ...
          if (propertiesValue3 !== null && propertiesValue3 !== undefined) {
            ...
            if (storageProfileValue2 !== null && storageProfileValue2 !== undefined) {
              ...
              if (dataDisksArray2 !== null && dataDisksArray2 !== undefined) {
                for (var loweredIndex11 = 0; loweredIndex11 < dataDisksArray2.length; loweredIndex11 = loweredIndex11 + 1) {
                  var dataDisksValue = dataDisksArray2[loweredIndex11];
            ...
            if (osProfileValue2 !== null && osProfileValue2 !== undefined) {
              ...
              if (windowsConfigurationValue2 !== null && windowsConfigurationValue2 !== undefined) {
                var windowsConfigurationInstance = { additionalUnattendContent: [] };
                ...
                if (additionalUnattendContentArray2 !== null && additionalUnattendContentArray2 !== undefined) {
                  for (var loweredIndex12 = 0; loweredIndex12 < additionalUnattendContentArray2.length; loweredIndex12 = loweredIndex12 + 1) {
                    var additionalUnattendContentValue2 = additionalUnattendContentArray2[loweredIndex12];
                    var additionalUnattendContentInstance = {};
                    windowsConfigurationInstance.additionalUnattendContent.push(additionalUnattendContentInstance);
                ...
                if (winRMValue2 !== null && winRMValue2 !== undefined) {
                  ...
                  windowsConfigurationInstance.windowsRemoteManagementConfiguration = winRMInstance;
                  
                  var listenersArray2 = winRMValue2['listeners'];
                  if (listenersArray2 !== null && listenersArray2 !== undefined) {
                    for (var loweredIndex13 = 0; loweredIndex13 < listenersArray2.length; loweredIndex13 = loweredIndex13 + 1) {
                      var listenersValue = listenersArray2[loweredIndex13];
              ...
              if (linuxConfigurationValue2 !== null && linuxConfigurationValue2 !== undefined) {
                ...
                if (sshValue2 !== null && sshValue2 !== undefined) {
                  ...
                  linuxConfigurationInstance.ssh = sshInstance;
                  
                  var publicKeysArray2 = sshValue2['publicKeys'];
                  if (publicKeysArray2 !== null && publicKeysArray2 !== undefined) {
                    for (var loweredIndex14 = 0; loweredIndex14 < publicKeysArray2.length; loweredIndex14 = loweredIndex14 + 1) {
                      var publicKeysValue = publicKeysArray2[loweredIndex14];
            ...
            if (networkProfileValue2 !== null && networkProfileValue2 !== undefined) {
              ...
              if (networkInterfacesArray2 !== null && networkInterfacesArray2 !== undefined) {
                for (var loweredIndex15 = 0; loweredIndex15 < networkInterfacesArray2.length; loweredIndex15 = loweredIndex15 + 1) {
                  var networkInterfacesValue = networkInterfacesArray2[loweredIndex15];
          ...
          if (resourcesValue2 !== null && resourcesValue2 !== undefined) {
            ...
            if (extensionsArray2 !== null && extensionsArray2 !== undefined) {
              for (var loweredIndex16 = 0; loweredIndex16 < extensionsArray2.length; loweredIndex16 = loweredIndex16 + 1) {
                var extensionsValue = extensionsArray2[loweredIndex16];
                var virtualMachineExtensionInstance = { tags: {} };
                  ...
                  if (instanceViewValue2 !== null && instanceViewValue2 !== undefined) {
                    ...
                    if (substatusesArray2 !== null && substatusesArray2 !== undefined) {
                      for (var loweredIndex17 = 0; loweredIndex17 < substatusesArray2.length; loweredIndex17 = loweredIndex17 + 1) {
                        var substatusesValue = substatusesArray2[loweredIndex17];
                        var instanceViewStatusInstance = {};
                        instanceViewInstance.subStatuses.push(instanceViewStatusInstance);
                    ...
                    var statusesArray2 = instanceViewValue2['statuses'];
                    if (statusesArray2 !== null && statusesArray2 !== undefined) {
                      for (var loweredIndex18 = 0; loweredIndex18 < statusesArray2.length; loweredIndex18 = loweredIndex18 + 1) {
                        var statusesValue = statusesArray2[loweredIndex18];
                        var instanceViewStatusInstance2 = {};
                        instanceViewInstance.statuses.push(instanceViewStatusInstance2);
        ...
        if (responseDoc !== null && responseDoc !== undefined) {
          ...
          if (propertiesValue !== null && propertiesValue !== undefined) {
            ...
            if (networkProfileValue !== null && networkProfileValue !== undefined) {
              ...
              if (networkInterfacesArray !== null && networkInterfacesArray !== undefined) {
                for (var loweredIndex5 = 0; loweredIndex5 < networkInterfacesArray.length; loweredIndex5 = loweredIndex5 + 1) {
                  var networkInterfacesValue = networkInterfacesArray[loweredIndex5];
                  var networkInterfaceReferenceInstance = {};
                  networkProfileInstance.networkInterfaces.push(networkInterfaceReferenceInstance);
          ...
          if (resourcesValue !== null && resourcesValue !== undefined) {
            ...
            if (extensionsArray !== null && extensionsArray !== undefined) {
              for (var loweredIndex6 = 0; loweredIndex6 < extensionsArray.length; loweredIndex6 = loweredIndex6 + 1) {
                var extensionsValue = extensionsArray[loweredIndex6];
                var virtualMachineExtensionInstance = { tags: {} };
                resourcesInstance.extensions.push(virtualMachineExtensionInstance);
                ...
                if (propertiesValue2 !== null && propertiesValue2 !== undefined) {
                  ...
                  if (instanceViewValue !== null && instanceViewValue !== undefined) {
                    ...
                    var substatusesArray = instanceViewValue['substatuses'];
                    if (substatusesArray !== null && substatusesArray !== undefined) {
                      for (var loweredIndex7 = 0; loweredIndex7 < substatusesArray.length; loweredIndex7 = loweredIndex7 + 1) {
                        var substatusesValue = substatusesArray[loweredIndex7];
                        var instanceViewStatusInstance = {};
                        instanceViewInstance.subStatuses.push(instanceViewStatusInstance);
                    ...
                    var statusesArray = instanceViewValue['statuses'];
                    if (statusesArray !== null && statusesArray !== undefined) {
                      for (var loweredIndex8 = 0; loweredIndex8 < statusesArray.length; loweredIndex8 = loweredIndex8 + 1) {
                        var statusesValue = statusesArray[loweredIndex8];
                        var instanceViewStatusInstance2 = {};
                        instanceViewInstance.statuses.push(instanceViewStatusInstance2);
            ...
            for (var loweredIndex1 = 0; loweredIndex1 < valueArray.length; loweredIndex1 = loweredIndex1 + 1) {
              ...
              if (propertiesValue !== null && propertiesValue !== undefined) {
                ...
                if (networkProfileValue !== null && networkProfileValue !== undefined) {
                  ...
                  var networkInterfacesArray = networkProfileValue['networkInterfaces'];
                  if (networkInterfacesArray !== null && networkInterfacesArray !== undefined) {
                    for (var loweredIndex6 = 0; loweredIndex6 < networkInterfacesArray.length; loweredIndex6 = loweredIndex6 + 1) {
                      var networkInterfacesValue = networkInterfacesArray[loweredIndex6];
                      var networkInterfaceReferenceInstance = {};
                      networkProfileInstance.networkInterfaces.push(networkInterfaceReferenceInstance);
              ...
              if (resourcesValue !== null && resourcesValue !== undefined) {
                ...
                var extensionsArray = resourcesValue['extensions'];
                if (extensionsArray !== null && extensionsArray !== undefined) {
                  for (var loweredIndex7 = 0; loweredIndex7 < extensionsArray.length; loweredIndex7 = loweredIndex7 + 1) {
                    var extensionsValue = extensionsArray[loweredIndex7];
                    var virtualMachineExtensionInstance = { tags: {} };
                    resourcesInstance.extensions.push(virtualMachineExtensionInstance);
                    ...
                    if (propertiesValue2 !== null && propertiesValue2 !== undefined) {
                      ...
                      if (instanceViewValue !== null && instanceViewValue !== undefined) {
                        ...
                        var substatusesArray = instanceViewValue['substatuses'];
                        if (substatusesArray !== null && substatusesArray !== undefined) {
                          for (var loweredIndex8 = 0; loweredIndex8 < substatusesArray.length; loweredIndex8 = loweredIndex8 + 1) {
                            var substatusesValue = substatusesArray[loweredIndex8];
                            var instanceViewStatusInstance = {};
                            instanceViewInstance.subStatuses.push(instanceViewStatusInstance);
