 ...
 */
exports.createTrafficManagerManagementClient = function (credentials, baseUri, filters) {
  return new exports.TrafficManagerManagementClient.TrafficManagerManagementClient(credentials, baseUri, filters);
};