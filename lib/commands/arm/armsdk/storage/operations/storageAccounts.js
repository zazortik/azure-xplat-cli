...
/**
 * Creates a custom account key or updates an existing key with the specified
 * parameters. Subsequent create operations after creating a custom key do
 * not regenerate the key value, only permissions can be updated. For
 * regenerating the key value use regenerateKey. Up to two custom keys can be
 ...
 * characters in length and use numbers and lower-case letters only.
 * 
 * @param {string} keyName The key name. Valid key names are 5 to 20
 * characters long with lower case alphanumeric characters only. Key names
 * â€œkey1â€ and â€œkey2â€ are reserved for the default keys.
 * 
 * @param {string} permissions Permissions for the key. Possible values
 * include: 'READ', 'FULL'
 * 
 * @param {object} [options] Optional Parameters.
 * 
 ...
 *
 *                      {object} [result]   - The deserialized result object.
 *                      See {@link StorageAccountKey} for more information.
 *
 *                      {object} [request]  - The HTTP Request object if an error did not occur.
 *
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
StorageAccounts.prototype.createCustomKey = function (resourceGroupName, accountName, keyName, permissions, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  try {
    ...
    if (permissions) {
      var allowedValues = [ 'READ', 'FULL' ];
      if (!allowedValues.some( function(item) { return item === permissions; })) {
        throw new Error(permissions + ' is not a valid value. The valid values are: ' + allowedValues);
      }
    } else {
      throw new Error('permissions cannot be null or undefined.');
    }
    if (this.client.acceptLanguage !== null && this.client.acceptLanguage !== undefined && typeof this.client.acceptLanguage.valueOf() !== 'string') {
      throw new Error('this.client.acceptLanguage must be of type string.');
    }
  ...
  {
      permissions1 = new client.models['StorageAccountCreateCustomKeyParameters']();
      permissions1.permissions = permissions;
  }

  // Construct URL
  var requestUrl = this.client.baseUri +
                   '//subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/customKeys/{keyName}';
  requestUrl = requestUrl.replace('{resourceGroupName}', encodeURIComponent(resourceGroupName));
  requestUrl = requestUrl.replace('{accountName}', encodeURIComponent(accountName));
  ...
  var requestModel = null;
  try {
    if (permissions1 !== null && permissions1 !== undefined) {
      var requestModelMapper = new client.models['StorageAccountCreateCustomKeyParameters']().mapper();
      requestModel = client.serialize(requestModelMapper, permissions1, 'permissions1');
    }
    requestContent = JSON.stringify(requestModel);
  } catch (error) {
    var serializationError = new Error(util.format('Error "%s" occurred in serializing the ' + 
        'payload - "%s"', error.message, util.inspect(permissions1, {depth: null})));
    return callback(serializationError);
  }
  httpRequest.body = requestContent;
  // Send Request
  return client.pipeline(httpRequest, function (err, response, responseBody) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        result = JSON.parse(responseBody);
        if (parsedResponse !== null && parsedResponse !== undefined) {
          var resultMapper = new client.models['StorageAccountKey']().mapper();
          result = client.deserialize(resultMapper, parsedResponse, 'result');
        }
      } catch (error) {
        var deserializationError = new Error(util.format('Error "%s" occurred in deserializing the responseBody - "%s"', error, responseBody));
...
/**
 * Deletes the specified custom account key.
 *
 * @param {string} resourceGroupName The name of the resource group within the
 * user's subscription.
 * 
 ...
 * 
 * @param {string} keyName The name of the custom key to be deleted.
 * 
 * @param {object} [options] Optional Parameters.
 * 
 * @param {object} [options.customHeaders] Headers that will be added to the
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
StorageAccounts.prototype.deleteCustomKey = function (resourceGroupName, accountName, keyName, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
...
/**
 * Gets the specified custom account key.
 *
 * @param {string} resourceGroupName The name of the resource group within the
 * user's subscription.
 * 
 ...
 * specified resource group.
 * 
 * @param {string} keyName The name of the custom key.
 * 
 * @param {object} [options] Optional Parameters.
 * 
 * @param {object} [options.customHeaders] Headers that will be added to the
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
StorageAccounts.prototype.getCustomKey = function (resourceGroupName, accountName, keyName, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
...
/**
 * Lists the access keys for the specified storage account including the
 * default and the custom keys.
 *
...
/**
 * Lists the read-only custom keys for the specified storage account.
 *
 * @param {string} resourceGroupName The name of the resource group.
 * 
 * @param {string} accountName The name of the storage account.
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
StorageAccounts.prototype.listReadOnlyKeys = function (resourceGroupName, accountName, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  // Construct URL
  var requestUrl = this.client.baseUri +
                   '//subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/listReadOnlyKeys';
  requestUrl = requestUrl.replace('{resourceGroupName}', encodeURIComponent(resourceGroupName));
  requestUrl = requestUrl.replace('{accountName}', encodeURIComponent(accountName));
  requestUrl = requestUrl.replace('{subscriptionId}', encodeURIComponent(this.client.subscriptionId));
  var queryParameters = [];
