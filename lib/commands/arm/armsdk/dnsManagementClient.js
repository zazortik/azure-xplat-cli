...
var DnsManagementClient = ( /** @lends DnsManagementClient */ function() {
  ...
  function DnsManagementClient(credentials, baseUri, filters) {
    ...
    if (this.apiVersion === null || this.apiVersion === undefined) {
      this.apiVersion = '2014-09-16-alpha';
    }
...
var RecordSetOperations = ( /** @lends RecordSetOperations */ function() {
   ...
   * 
   * @param {string} [parameters.recordSet.properties.eTag] Gets or sets the
   * ETag of the RecordSet.
   * 
  ...
  RecordSetOperations.prototype.createOrUpdate = function(resourceGroupName, zoneName, relativeRecordSetName, recordType, parameters, callback) {
    ...
    var queryParameters = [];
    queryParameters.push('api-version=2014-09-16-alpha');
    ...
    httpRequest.headers['If-Match'] = parameters.recordSet.properties.eTag;
    ...
    if (parameters.recordSet.properties !== null && parameters.recordSet.properties !== undefined) {
      ...
      if (parameters.recordSet.properties.eTag !== null && parameters.recordSet.properties.eTag !== undefined) {
        propertiesValue['etag'] = parameters.recordSet.properties.eTag;
      }
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      if (responseDoc !== null && responseDoc !== undefined) {
        ...
        if (propertiesValue2 !== null && propertiesValue2 !== undefined) {
          ...
          var etagValue = propertiesValue2['etag'];
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      if (responseDoc !== null && responseDoc !== undefined) {
        ...
        if (propertiesValue !== null && propertiesValue !== undefined) {
          ...
          var etagValue = propertiesValue['etag'];
          if (etagValue !== null && etagValue !== undefined) {
            var etagInstance = etagValue;
            propertiesInstance.eTag = etagInstance;
          }
   ...
   * elements to retrieve (first N elements). Optional.
   * 
   * @param {string} [parametersOrCallback.skipToken] Gets or sets the
   * continuation token from a previous list operation to retrieve the next
   * page. Optional.
   * 
   * @param {string} [parametersOrCallback.filter] Gets or sets the filter for
   * the records enumeration. Optional.
   * 
   * @param {function} callback
   * 
   * @returns {Stream} The response stream.
  ...
  RecordSetOperations.prototype.list = function(resourceGroupName, zoneName, recordType, parametersOrCallback, callback) {
    ...
    if (parameters !== null && parameters !== undefined && parameters.skipToken !== null && parameters.skipToken !== undefined) {
      queryParameters.push('$skipToken=' + encodeURIComponent(parameters.skipToken));
    }
    var odataFilter = [];
...
var ZoneOperations = ( /** @lends ZoneOperations */ function() {
   ...
   * 
   * @param {string} [parameters.zone.properties.eTag] Gets or sets the ETag of
   * the zone that is being updated, as received from a Get operation.
   * 
  ...
  ZoneOperations.prototype.createOrUpdate = function(resourceGroupName, zoneName, parameters, callback) {
    ...
    // Set Headers
    httpRequest.headers['Content-Type'] = 'application/json; charset=utf-8';
    // TODO this is a temporary workaround and will be removed soon
    if (parameters.zone.properties.eTag !== null && parameters.zone.properties.eTag !== undefined) {
      httpRequest.headers['If-Match'] = parameters.zone.properties.eTag;
    } else {
    ...
    if (parameters.zone.properties !== null && parameters.zone.properties !== undefined) {
      ...
      if (parameters.zone.properties.eTag !== null && parameters.zone.properties.eTag !== undefined) {
        propertiesValue['etag'] = parameters.zone.properties.eTag;
      }
    }
