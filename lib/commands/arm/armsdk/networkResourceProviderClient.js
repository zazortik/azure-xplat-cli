...
var NetworkResourceProviderClient = ( /** @lends NetworkResourceProviderClient */ function() {
  ...
  function NetworkResourceProviderClient(credentials, baseUri, filters) {
    ...
    /**
     * Provides an instance of the
     * [NetworkSecurityRuleOperations](-NetworkSecurityRuleOperations.html)
     * object.
     * @type {object}
     */
    this.networkSecurityRules = new NetworkSecurityRuleOperations(this);
    /**
     * Provides an instance of the
...
var NetworkInterfaceOperations = ( /** @lends NetworkInterfaceOperations */ function() {
   ...
   * 
   * @param {ResourceId} [parameters.properties.networkSecurityGroup] The id of
   * the NetworkSecurityGroup resource
   * 
   * @param {string} [parameters.properties.networkSecurityGroup.id] Id of the
   * resource
   * 
  ...
  NetworkInterfaceOperations.prototype.beginCreateOrUpdating = function(resourceGroupName, networkInterfaceName, parameters, callback) {
    ...
    if (parameters.properties !== null && parameters.properties !== undefined) {
      ...
      if (parameters.properties.networkSecurityGroup !== null && parameters.properties.networkSecurityGroup !== undefined) {
        var networkSecurityGroupValue = {};
        propertiesValue['networkSecurityGroup'] = networkSecurityGroupValue;
        
        if (parameters.properties.networkSecurityGroup.id !== null && parameters.properties.networkSecurityGroup.id !== undefined) {
          networkSecurityGroupValue['id'] = parameters.properties.networkSecurityGroup.id;
        }
      }
        ...
        if (responseDoc !== null && responseDoc !== undefined) {
          ...
          if (propertiesValue3 !== null && propertiesValue3 !== undefined) {
            ...
            if (networkSecurityGroupValue2 !== null && networkSecurityGroupValue2 !== undefined) {
              ...
              propertiesInstance.networkSecurityGroup = networkSecurityGroupInstance;
              ...
              for (var loweredIndex4 = 0; loweredIndex4 < ipConfigurationsArray2.length; loweredIndex4 = loweredIndex4 + 1) {
                ...
                if (propertiesValue4 !== null && propertiesValue4 !== undefined) {
                  ...
                  if (accessControlListValue2 !== null && accessControlListValue2 !== undefined) {
                    ...
                    var idValue5 = accessControlListValue2['id'];
                    if (idValue5 !== null && idValue5 !== undefined) {
                      var idInstance5 = idValue5;
                      accessControlListInstance.id = idInstance5;
                    }
                  }
                  ...
                  if (loadBalancerBackendAddressPoolValue2 !== null && loadBalancerBackendAddressPoolValue2 !== undefined) {
                    ...
                    var idValue6 = loadBalancerBackendAddressPoolValue2['id'];
                    if (idValue6 !== null && idValue6 !== undefined) {
                      var idInstance6 = idValue6;
                      loadBalancerBackendAddressPoolInstance.id = idInstance6;
                    }
                  }
                  ...
                  if (loadBalancerInboundNatRulesArray2 !== null && loadBalancerInboundNatRulesArray2 !== undefined) {
                    for (var loweredIndex5 = 0; loweredIndex5 < loadBalancerInboundNatRulesArray2.length; loweredIndex5 = loweredIndex5 + 1) {
                      ...
                      var idValue7 = loadBalancerInboundNatRulesValue['id'];
                      if (idValue7 !== null && idValue7 !== undefined) {
                        var idInstance7 = idValue7;
                        resourceIdInstance.id = idInstance7;
                      }
                    }
                  }
                ...
                var idValue8 = ipConfigurationsValue['id'];
                if (idValue8 !== null && idValue8 !== undefined) {
                  var idInstance8 = idValue8;
                  networkInterfaceIpConfigurationInstance.id = idInstance8;
                }
              }
            }
          ...
          var idValue9 = responseDoc['id'];
          if (idValue9 !== null && idValue9 !== undefined) {
            var idInstance9 = idValue9;
            networkInterfaceInstance.id = idInstance9;
          }
              ...
              for (var loweredIndex1 = 0; loweredIndex1 < ipConfigurationsArray.length; loweredIndex1 = loweredIndex1 + 1) {
                ...
                if (propertiesValue2 !== null && propertiesValue2 !== undefined) {
                  ...
                  if (accessControlListValue !== null && accessControlListValue !== undefined) {
                    ...
                    var idValue5 = accessControlListValue['id'];
                    if (idValue5 !== null && idValue5 !== undefined) {
                      var idInstance5 = idValue5;
                      accessControlListInstance.id = idInstance5;
                    }
                  ...
                  if (loadBalancerBackendAddressPoolValue !== null && loadBalancerBackendAddressPoolValue !== undefined) {
                    ...
                    var idValue6 = loadBalancerBackendAddressPoolValue['id'];
                    if (idValue6 !== null && idValue6 !== undefined) {
                      var idInstance6 = idValue6;
                      loadBalancerBackendAddressPoolInstance.id = idInstance6;
                    }
...
var NetworkSecurityGroupOperations = ( /** @lends NetworkSecurityGroupOperations */ function() {
   ...
   * group.
   * 
   * @param {NetworkSecurityGroupCreateOrUpdateParameters} parameters
   * Parameters supplied to the create/update Network Security Group operation
   * 
   * @param {NetworkSecurityGroupProperties} [parameters.properties]
   * 
   * @param {IEnumerable} [parameters.properties.rules] Security rules of
   * network security group
   * 
   * @param {IEnumerable} [parameters.properties.defaultRules] Default security
   * rules of network security group
   * 
   * @param {IEnumerable} [parameters.properties.networkInterfaces] Read only.A
   * collection of references to NICs
   * 
   * @param {IEnumerable} [parameters.properties.subnets] Read only.A
  ...
  NetworkSecurityGroupOperations.prototype.beginCreateOrUpdating = function(resourceGroupName, networkSecurityGroupName, parameters, callback) {
    ...
    if (parameters.properties !== null && parameters.properties !== undefined) {
      if (parameters.properties.defaultRules !== null && parameters.properties.defaultRules !== undefined) {
        for (var loweredIndex1 = 0; loweredIndex1 < parameters.properties.defaultRules.length; loweredIndex1 = loweredIndex1 + 1) {
          var defaultRulesParameterItem = parameters.properties.defaultRules[loweredIndex1];
          if (defaultRulesParameterItem.properties !== null && defaultRulesParameterItem.properties !== undefined) {
            if (defaultRulesParameterItem.properties.access === null || defaultRulesParameterItem.properties.access === undefined) {
              return callback(new Error('parameters.properties.defaultRules.properties.access cannot be null.'));
            }
            if (defaultRulesParameterItem.properties.destinationAddressPrefix === null || defaultRulesParameterItem.properties.destinationAddressPrefix === undefined) {
              return callback(new Error('parameters.properties.defaultRules.properties.destinationAddressPrefix cannot be null.'));
            }
            if (defaultRulesParameterItem.properties.direction === null || defaultRulesParameterItem.properties.direction === undefined) {
              return callback(new Error('parameters.properties.defaultRules.properties.direction cannot be null.'));
            }
            if (defaultRulesParameterItem.properties.protocol === null || defaultRulesParameterItem.properties.protocol === undefined) {
              return callback(new Error('parameters.properties.defaultRules.properties.protocol cannot be null.'));
            }
            if (defaultRulesParameterItem.properties.sourceAddressPrefix === null || defaultRulesParameterItem.properties.sourceAddressPrefix === undefined) {
              return callback(new Error('parameters.properties.defaultRules.properties.sourceAddressPrefix cannot be null.'));
            }
          }
        }
      }
      if (parameters.properties.rules !== null && parameters.properties.rules !== undefined) {
        for (var loweredIndex2 = 0; loweredIndex2 < parameters.properties.rules.length; loweredIndex2 = loweredIndex2 + 1) {
          var rulesParameterItem = parameters.properties.rules[loweredIndex2];
          if (rulesParameterItem.properties !== null && rulesParameterItem.properties !== undefined) {
            if (rulesParameterItem.properties.access === null || rulesParameterItem.properties.access === undefined) {
              return callback(new Error('parameters.properties.rules.properties.access cannot be null.'));
            }
            if (rulesParameterItem.properties.destinationAddressPrefix === null || rulesParameterItem.properties.destinationAddressPrefix === undefined) {
              return callback(new Error('parameters.properties.rules.properties.destinationAddressPrefix cannot be null.'));
            }
            if (rulesParameterItem.properties.direction === null || rulesParameterItem.properties.direction === undefined) {
              return callback(new Error('parameters.properties.rules.properties.direction cannot be null.'));
            }
            if (rulesParameterItem.properties.protocol === null || rulesParameterItem.properties.protocol === undefined) {
              return callback(new Error('parameters.properties.rules.properties.protocol cannot be null.'));
            }
            if (rulesParameterItem.properties.sourceAddressPrefix === null || rulesParameterItem.properties.sourceAddressPrefix === undefined) {
              return callback(new Error('parameters.properties.rules.properties.sourceAddressPrefix cannot be null.'));
            }
          }
        }
      }
    ...
    var networkSecurityGroupCreateOrUpdateParametersValue = {};
    requestDoc = networkSecurityGroupCreateOrUpdateParametersValue;
    
    if (parameters.properties !== null && parameters.properties !== undefined) {
      var propertiesValue = {};
      networkSecurityGroupCreateOrUpdateParametersValue['properties'] = propertiesValue;
      
      if (parameters.properties.rules !== null && parameters.properties.rules !== undefined) {
        var rulesArray = [];
        for (var loweredIndex3 = 0; loweredIndex3 < parameters.properties.rules.length; loweredIndex3 = loweredIndex3 + 1) {
          var rulesItem = parameters.properties.rules[loweredIndex3];
          var networkSecurityRuleValue = {};
          rulesArray.push(networkSecurityRuleValue);
          
          if (rulesItem.properties !== null && rulesItem.properties !== undefined) {
            var propertiesValue2 = {};
            networkSecurityRuleValue['properties'] = propertiesValue2;
            
            if (rulesItem.properties.description !== null && rulesItem.properties.description !== undefined) {
              propertiesValue2['description'] = rulesItem.properties.description;
            }
            
            propertiesValue2['protocol'] = rulesItem.properties.protocol;
            
            if (rulesItem.properties.sourcePortRange !== null && rulesItem.properties.sourcePortRange !== undefined) {
              propertiesValue2['sourcePortRange'] = rulesItem.properties.sourcePortRange;
            }
            
            if (rulesItem.properties.destinationPortRange !== null && rulesItem.properties.destinationPortRange !== undefined) {
              propertiesValue2['destinationPortRange'] = rulesItem.properties.destinationPortRange;
            }
            
            propertiesValue2['sourceAddressPrefix'] = rulesItem.properties.sourceAddressPrefix;
            
            propertiesValue2['destinationAddressPrefix'] = rulesItem.properties.destinationAddressPrefix;
            
            propertiesValue2['access'] = rulesItem.properties.access;
            
            if (rulesItem.properties.priority !== null && rulesItem.properties.priority !== undefined) {
              propertiesValue2['priority'] = rulesItem.properties.priority;
            }
            
            propertiesValue2['direction'] = rulesItem.properties.direction;
            
            if (rulesItem.properties.provisioningState !== null && rulesItem.properties.provisioningState !== undefined) {
              propertiesValue2['provisioningState'] = rulesItem.properties.provisioningState;
            }
          }
          
          if (rulesItem.name !== null && rulesItem.name !== undefined) {
            networkSecurityRuleValue['name'] = rulesItem.name;
          }
          
          if (rulesItem.etag !== null && rulesItem.etag !== undefined) {
            networkSecurityRuleValue['etag'] = rulesItem.etag;
          }
          
          if (rulesItem.id !== null && rulesItem.id !== undefined) {
            networkSecurityRuleValue['id'] = rulesItem.id;
          }
        }
        propertiesValue['rules'] = rulesArray;
      }
      
      if (parameters.properties.defaultRules !== null && parameters.properties.defaultRules !== undefined) {
        var defaultRulesArray = [];
        for (var loweredIndex4 = 0; loweredIndex4 < parameters.properties.defaultRules.length; loweredIndex4 = loweredIndex4 + 1) {
          var defaultRulesItem = parameters.properties.defaultRules[loweredIndex4];
          var networkSecurityRuleValue2 = {};
          defaultRulesArray.push(networkSecurityRuleValue2);
          
          if (defaultRulesItem.properties !== null && defaultRulesItem.properties !== undefined) {
            var propertiesValue3 = {};
            networkSecurityRuleValue2['properties'] = propertiesValue3;
            
            if (defaultRulesItem.properties.description !== null && defaultRulesItem.properties.description !== undefined) {
              propertiesValue3['description'] = defaultRulesItem.properties.description;
            }
            
            propertiesValue3['protocol'] = defaultRulesItem.properties.protocol;
            
            if (defaultRulesItem.properties.sourcePortRange !== null && defaultRulesItem.properties.sourcePortRange !== undefined) {
              propertiesValue3['sourcePortRange'] = defaultRulesItem.properties.sourcePortRange;
            }
            
            if (defaultRulesItem.properties.destinationPortRange !== null && defaultRulesItem.properties.destinationPortRange !== undefined) {
              propertiesValue3['destinationPortRange'] = defaultRulesItem.properties.destinationPortRange;
            }
            
            propertiesValue3['sourceAddressPrefix'] = defaultRulesItem.properties.sourceAddressPrefix;
            
            propertiesValue3['destinationAddressPrefix'] = defaultRulesItem.properties.destinationAddressPrefix;
            
            propertiesValue3['access'] = defaultRulesItem.properties.access;
            
            if (defaultRulesItem.properties.priority !== null && defaultRulesItem.properties.priority !== undefined) {
              propertiesValue3['priority'] = defaultRulesItem.properties.priority;
            }
            
            propertiesValue3['direction'] = defaultRulesItem.properties.direction;
            
            if (defaultRulesItem.properties.provisioningState !== null && defaultRulesItem.properties.provisioningState !== undefined) {
              propertiesValue3['provisioningState'] = defaultRulesItem.properties.provisioningState;
            }
          }
          
          if (defaultRulesItem.name !== null && defaultRulesItem.name !== undefined) {
            networkSecurityRuleValue2['name'] = defaultRulesItem.name;
          }
          
          if (defaultRulesItem.etag !== null && defaultRulesItem.etag !== undefined) {
            networkSecurityRuleValue2['etag'] = defaultRulesItem.etag;
          }
          
          if (defaultRulesItem.id !== null && defaultRulesItem.id !== undefined) {
            networkSecurityRuleValue2['id'] = defaultRulesItem.id;
          }
        }
        propertiesValue['defaultRules'] = defaultRulesArray;
      }
      
      if (parameters.properties.networkInterfaces !== null && parameters.properties.networkInterfaces !== undefined) {
        var networkInterfacesArray = [];
        for (var loweredIndex5 = 0; loweredIndex5 < parameters.properties.networkInterfaces.length; loweredIndex5 = loweredIndex5 + 1) {
          var networkInterfacesItem = parameters.properties.networkInterfaces[loweredIndex5];
          var resourceIdValue = {};
      ...
      if (parameters.properties.subnets !== null && parameters.properties.subnets !== undefined) {
        var subnetsArray = [];
        for (var loweredIndex6 = 0; loweredIndex6 < parameters.properties.subnets.length; loweredIndex6 = loweredIndex6 + 1) {
          var subnetsItem = parameters.properties.subnets[loweredIndex6];
          var resourceIdValue2 = {};
    ...
    if (parameters.location !== null && parameters.location !== undefined) {
      networkSecurityGroupCreateOrUpdateParametersValue['location'] = parameters.location;
    }
    ...
    if (parameters.tags !== null && parameters.tags !== undefined) {
      ...
      networkSecurityGroupCreateOrUpdateParametersValue['tags'] = tagsDictionary;
    }
    
    if (parameters.name !== null && parameters.name !== undefined) {
      networkSecurityGroupCreateOrUpdateParametersValue['name'] = parameters.name;
    }
    
    if (parameters.etag !== null && parameters.etag !== undefined) {
      networkSecurityGroupCreateOrUpdateParametersValue['etag'] = parameters.etag;
    }
    
    if (parameters.id !== null && parameters.id !== undefined) {
      networkSecurityGroupCreateOrUpdateParametersValue['id'] = parameters.id;
    }
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      if (statusCode === 200 || statusCode === 201) {
        ...
        if (responseDoc !== null && responseDoc !== undefined) {
          var networkSecurityGroupInstance = { tags: {} };
          result.networkSecurityGroup = networkSecurityGroupInstance;
          
          var propertiesValue4 = responseDoc['properties'];
          if (propertiesValue4 !== null && propertiesValue4 !== undefined) {
            var propertiesInstance = { defaultRules: [], networkInterfaces: [], rules: [], subnets: [] };
            networkSecurityGroupInstance.properties = propertiesInstance;
            
            var rulesArray2 = propertiesValue4['rules'];
            if (rulesArray2 !== null && rulesArray2 !== undefined) {
              for (var loweredIndex7 = 0; loweredIndex7 < rulesArray2.length; loweredIndex7 = loweredIndex7 + 1) {
                var rulesValue = rulesArray2[loweredIndex7];
                var networkSecurityRuleInstance = {};
                propertiesInstance.rules.push(networkSecurityRuleInstance);
                
                var propertiesValue5 = rulesValue['properties'];
                if (propertiesValue5 !== null && propertiesValue5 !== undefined) {
                  var propertiesInstance2 = {};
                  networkSecurityRuleInstance.properties = propertiesInstance2;
                  ...
                  if (descriptionValue !== null && descriptionValue !== undefined) {
                    ...
                    propertiesInstance2.description = descriptionInstance;
                  }
                  
                  var protocolValue = propertiesValue5['protocol'];
                  if (protocolValue !== null && protocolValue !== undefined) {
                    var protocolInstance = protocolValue;
                    propertiesInstance2.protocol = protocolInstance;
                  }
                  ...
                  if (sourcePortRangeValue !== null && sourcePortRangeValue !== undefined) {
                    ...
                    propertiesInstance2.sourcePortRange = sourcePortRangeInstance;
                  }
                  ...
                  if (destinationPortRangeValue !== null && destinationPortRangeValue !== undefined) {
                    ...
                    propertiesInstance2.destinationPortRange = destinationPortRangeInstance;
                  }
                  ...
                  if (sourceAddressPrefixValue !== null && sourceAddressPrefixValue !== undefined) {
                    ...
                    propertiesInstance2.sourceAddressPrefix = sourceAddressPrefixInstance;
                  }
                  ...
                  if (destinationAddressPrefixValue !== null && destinationAddressPrefixValue !== undefined) {
                    ...
                    propertiesInstance2.destinationAddressPrefix = destinationAddressPrefixInstance;
                  }
                  
                  var accessValue = propertiesValue5['access'];
                  if (accessValue !== null && accessValue !== undefined) {
                    var accessInstance = accessValue;
                    propertiesInstance2.access = accessInstance;
                  }
                  ...
                  if (directionValue !== null && directionValue !== undefined) {
                    ...
                    propertiesInstance2.direction = directionInstance;
                  }
                ...
                var nameValue = rulesValue['name'];
                if (nameValue !== null && nameValue !== undefined) {
                  var nameInstance = nameValue;
                  networkSecurityRuleInstance.name = nameInstance;
                }
                
                var etagValue = rulesValue['etag'];
                if (etagValue !== null && etagValue !== undefined) {
                  var etagInstance = etagValue;
                  networkSecurityRuleInstance.etag = etagInstance;
                }
                
                var idValue = rulesValue['id'];
                if (idValue !== null && idValue !== undefined) {
                  var idInstance = idValue;
                  networkSecurityRuleInstance.id = idInstance;
                }
              }
            }
            
            var defaultRulesArray2 = propertiesValue4['defaultRules'];
            if (defaultRulesArray2 !== null && defaultRulesArray2 !== undefined) {
              for (var loweredIndex8 = 0; loweredIndex8 < defaultRulesArray2.length; loweredIndex8 = loweredIndex8 + 1) {
                var defaultRulesValue = defaultRulesArray2[loweredIndex8];
                var networkSecurityRuleInstance2 = {};
                propertiesInstance.defaultRules.push(networkSecurityRuleInstance2);
                
                var propertiesValue6 = defaultRulesValue['properties'];
                if (propertiesValue6 !== null && propertiesValue6 !== undefined) {
                  var propertiesInstance3 = {};
                  networkSecurityRuleInstance2.properties = propertiesInstance3;
                  ...
                  if (descriptionValue2 !== null && descriptionValue2 !== undefined) {
                    ...
                    propertiesInstance3.description = descriptionInstance2;
                  }
                  
                  var protocolValue2 = propertiesValue6['protocol'];
                  if (protocolValue2 !== null && protocolValue2 !== undefined) {
                    var protocolInstance2 = protocolValue2;
                    propertiesInstance3.protocol = protocolInstance2;
                  }
                  ...
                  if (sourcePortRangeValue2 !== null && sourcePortRangeValue2 !== undefined) {
                    ...
                    propertiesInstance3.sourcePortRange = sourcePortRangeInstance2;
                  }
                  ...
                  if (destinationPortRangeValue2 !== null && destinationPortRangeValue2 !== undefined) {
                    ...
                    propertiesInstance3.destinationPortRange = destinationPortRangeInstance2;
                  }
                  ...
                  if (sourceAddressPrefixValue2 !== null && sourceAddressPrefixValue2 !== undefined) {
                    ...
                    propertiesInstance3.sourceAddressPrefix = sourceAddressPrefixInstance2;
                  }
                  ...
                  if (destinationAddressPrefixValue2 !== null && destinationAddressPrefixValue2 !== undefined) {
                    ...
                    propertiesInstance3.destinationAddressPrefix = destinationAddressPrefixInstance2;
                  }
                  
                  var accessValue2 = propertiesValue6['access'];
                  if (accessValue2 !== null && accessValue2 !== undefined) {
                    var accessInstance2 = accessValue2;
                    propertiesInstance3.access = accessInstance2;
                  }
                  ...
                  if (priorityValue2 !== null && priorityValue2 !== undefined) {
                    ...
                    propertiesInstance3.priority = priorityInstance2;
                  }
                  ...
                  if (directionValue2 !== null && directionValue2 !== undefined) {
                    ...
                    propertiesInstance3.direction = directionInstance2;
                  }
                ...
                var nameValue2 = defaultRulesValue['name'];
                if (nameValue2 !== null && nameValue2 !== undefined) {
                  var nameInstance2 = nameValue2;
                  networkSecurityRuleInstance2.name = nameInstance2;
                }
                
                var etagValue2 = defaultRulesValue['etag'];
                if (etagValue2 !== null && etagValue2 !== undefined) {
                  var etagInstance2 = etagValue2;
                  networkSecurityRuleInstance2.etag = etagInstance2;
                }
                
                var idValue2 = defaultRulesValue['id'];
                if (idValue2 !== null && idValue2 !== undefined) {
                  var idInstance2 = idValue2;
                  networkSecurityRuleInstance2.id = idInstance2;
                }
              }
            }
            ...
            if (networkInterfacesArray2 !== null && networkInterfacesArray2 !== undefined) {
              for (var loweredIndex9 = 0; loweredIndex9 < networkInterfacesArray2.length; loweredIndex9 = loweredIndex9 + 1) {
                ...
                var resourceIdInstance = {};
                propertiesInstance.networkInterfaces.push(resourceIdInstance);
            ...
            if (subnetsArray2 !== null && subnetsArray2 !== undefined) {
              for (var loweredIndex10 = 0; loweredIndex10 < subnetsArray2.length; loweredIndex10 = loweredIndex10 + 1) {
                ...
                var resourceIdInstance2 = {};
                propertiesInstance.subnets.push(resourceIdInstance2);
            ...
            if (provisioningStateValue3 !== null && provisioningStateValue3 !== undefined) {
              var provisioningStateInstance3 = provisioningStateValue3;
              propertiesInstance.provisioningState = provisioningStateInstance3;
            }
          }
      ...
      if (statusCode === 200) {
        ...
        if (responseDoc !== null && responseDoc !== undefined) {
          ...
          if (propertiesValue !== null && propertiesValue !== undefined) {
            ...
            var rulesArray = propertiesValue['rules'];
            if (rulesArray !== null && rulesArray !== undefined) {
              for (var loweredIndex1 = 0; loweredIndex1 < rulesArray.length; loweredIndex1 = loweredIndex1 + 1) {
                var rulesValue = rulesArray[loweredIndex1];
                var networkSecurityRuleInstance = {};
                propertiesInstance.rules.push(networkSecurityRuleInstance);
                
                var propertiesValue2 = rulesValue['properties'];
                if (propertiesValue2 !== null && propertiesValue2 !== undefined) {
                  var propertiesInstance2 = {};
                  networkSecurityRuleInstance.properties = propertiesInstance2;
            ...
            var defaultRulesArray = propertiesValue['defaultRules'];
            if (defaultRulesArray !== null && defaultRulesArray !== undefined) {
              for (var loweredIndex2 = 0; loweredIndex2 < defaultRulesArray.length; loweredIndex2 = loweredIndex2 + 1) {
                var defaultRulesValue = defaultRulesArray[loweredIndex2];
                var networkSecurityRuleInstance2 = {};
                propertiesInstance.defaultRules.push(networkSecurityRuleInstance2);
                
                var propertiesValue3 = defaultRulesValue['properties'];
                if (propertiesValue3 !== null && propertiesValue3 !== undefined) {
                  var propertiesInstance3 = {};
                  networkSecurityRuleInstance2.properties = propertiesInstance3;
          ...
          if (valueArray !== null && valueArray !== undefined) {
            for (var loweredIndex1 = 0; loweredIndex1 < valueArray.length; loweredIndex1 = loweredIndex1 + 1) {
              ...
              if (propertiesValue !== null && propertiesValue !== undefined) {
                ...
                var defaultRulesArray = propertiesValue['defaultRules'];
                if (defaultRulesArray !== null && defaultRulesArray !== undefined) {
                  for (var loweredIndex3 = 0; loweredIndex3 < defaultRulesArray.length; loweredIndex3 = loweredIndex3 + 1) {
                    var defaultRulesValue = defaultRulesArray[loweredIndex3];
                    var networkSecurityRuleInstance2 = {};
                    propertiesInstance.defaultRules.push(networkSecurityRuleInstance2);
...
var NetworkSecurityRuleOperations = ( /** @lends NetworkSecurityRuleOperations */ function() {
  /**
   * @class
   * The Network Resource Provider API includes operations for managing the
   ...
   * instance of the [NetworkResourceProviderClient] {@link
   * NetworkResourceProviderClient~NetworkResourceProviderClient}.
   * See [networkSecurityRules] {@link
   * NetworkResourceProviderClient~NetworkResourceProviderClient#networkSecurityRules}.
   * Initializes a new instance of the NetworkSecurityRuleOperations class.
   * @constructor
   * 
   * @param {NetworkResourceProviderClient} client Reference to the service
   * client.
   */
  function NetworkSecurityRuleOperations(client) {
    this.client = client;
  }
   ...
   * group.
   * 
   * @param {string} networkSecurityRuleName The name of the network security
   * rule.
   * 
   * @param {NetworkSecurityRuleCreateOrUpdateParameters} parameters Parameters
   * supplied to the create/update network security rule operation
   * 
   * @param {NetworkSecurityRuleProperties} [parameters.properties]
   * 
   * @param {string} [parameters.properties.description] A description for this
   * rule. Restricted to 140 chars.
   * 
   * @param {string} [parameters.properties.protocol] Network protocol this
   * rule applies to. Can be Tcp, Udp or All(*).
   * 
   * @param {string} [parameters.properties.sourcePortRange] Source Port or
   * Range. Integer or range between 0 and 65535. Asterix “*” can also be used
   * to match all ports.
   * 
   * @param {string} [parameters.properties.destinationPortRange] Destination
   * Port or Range. Integer or range between 0 and 65535. Asterix “*” can also
   * be used to match all ports.
   * 
   * @param {string} [parameters.properties.sourceAddressPrefix] CIDR or source
   * IP range. Asterix “*” can also be used to match all source IPs. Default
   * tags such as ‘VirtualNetwork’, ‘AzureLoadBalancer’ and ‘Internet’ can
   * also be used. If this is an ingress rule, specifies where network traffic
   * originates from.
   * 
   * @param {string} [parameters.properties.destinationAddressPrefix] CIDR or
   ...
   * can also be used.
   * 
   * @param {string} [parameters.properties.access] Specifies whether network
   * traffic is allowed or denied. Possible values are “Allow” and “Deny”
   * 
   * @param {number} [parameters.properties.priority] Specifies the priority of
   * the rule. The value can be between 100 and 4096. The priority number must
   * be unique for each rule in the collection. The lower the priority number,
   * the higher the priority of the rule.
   * 
   * @param {string} [parameters.properties.direction] InBound or Outbound. The
   ...
   * @returns {Stream} The response stream.
   */
  NetworkSecurityRuleOperations.prototype.beginCreateOrUpdating = function(resourceGroupName, networkSecurityGroupName, networkSecurityRuleName, parameters, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
    ...
    if (networkSecurityRuleName === null || networkSecurityRuleName === undefined) {
      return callback(new Error('networkSecurityRuleName cannot be null.'));
    }
    if (parameters === null || parameters === undefined) {
      return callback(new Error('parameters cannot be null.'));
    }
    if (parameters.properties !== null && parameters.properties !== undefined) {
      if (parameters.properties.access === null || parameters.properties.access === undefined) {
        return callback(new Error('parameters.properties.access cannot be null.'));
      }
      if (parameters.properties.destinationAddressPrefix === null || parameters.properties.destinationAddressPrefix === undefined) {
        return callback(new Error('parameters.properties.destinationAddressPrefix cannot be null.'));
      }
      if (parameters.properties.direction === null || parameters.properties.direction === undefined) {
        return callback(new Error('parameters.properties.direction cannot be null.'));
      }
      if (parameters.properties.protocol === null || parameters.properties.protocol === undefined) {
        return callback(new Error('parameters.properties.protocol cannot be null.'));
      }
      if (parameters.properties.sourceAddressPrefix === null || parameters.properties.sourceAddressPrefix === undefined) {
        return callback(new Error('parameters.properties.sourceAddressPrefix cannot be null.'));
      }
    }
    ...
    url2 = url2 + encodeURIComponent(networkSecurityRuleName);
    var queryParameters = [];
    queryParameters.push('api-version=2014-12-01-preview');
    if (queryParameters.length > 0) {
      url2 = url2 + '?' + queryParameters.join('&');
    ...
    var networkSecurityRuleCreateOrUpdateParametersValue = {};
    requestDoc = networkSecurityRuleCreateOrUpdateParametersValue;
    
    if (parameters.properties !== null && parameters.properties !== undefined) {
      var propertiesValue = {};
      networkSecurityRuleCreateOrUpdateParametersValue['properties'] = propertiesValue;
      ...
      propertiesValue['protocol'] = parameters.properties.protocol;
      
      if (parameters.properties.sourcePortRange !== null && parameters.properties.sourcePortRange !== undefined) {
        propertiesValue['sourcePortRange'] = parameters.properties.sourcePortRange;
      }
      
      if (parameters.properties.destinationPortRange !== null && parameters.properties.destinationPortRange !== undefined) {
        propertiesValue['destinationPortRange'] = parameters.properties.destinationPortRange;
      }
      
      propertiesValue['sourceAddressPrefix'] = parameters.properties.sourceAddressPrefix;
      
      propertiesValue['destinationAddressPrefix'] = parameters.properties.destinationAddressPrefix;
      
      propertiesValue['access'] = parameters.properties.access;
      
      if (parameters.properties.priority !== null && parameters.properties.priority !== undefined) {
        propertiesValue['priority'] = parameters.properties.priority;
      }
      
      propertiesValue['direction'] = parameters.properties.direction;
    ...
    if (parameters.name !== null && parameters.name !== undefined) {
      networkSecurityRuleCreateOrUpdateParametersValue['name'] = parameters.name;
    }
    
    if (parameters.etag !== null && parameters.etag !== undefined) {
      networkSecurityRuleCreateOrUpdateParametersValue['etag'] = parameters.etag;
    }
    
    if (parameters.id !== null && parameters.id !== undefined) {
      networkSecurityRuleCreateOrUpdateParametersValue['id'] = parameters.id;
    }
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      if (statusCode === 200 || statusCode === 201) {
        ...
        if (responseDoc !== null && responseDoc !== undefined) {
          var networkSecurityRuleInstance = {};
          result.networkSecurityRule = networkSecurityRuleInstance;
          
          var propertiesValue2 = responseDoc['properties'];
          if (propertiesValue2 !== null && propertiesValue2 !== undefined) {
            var propertiesInstance = {};
            networkSecurityRuleInstance.properties = propertiesInstance;
            ...
            if (protocolValue !== null && protocolValue !== undefined) {
              var protocolInstance = protocolValue;
              propertiesInstance.protocol = protocolInstance;
            }
            
            var sourcePortRangeValue = propertiesValue2['sourcePortRange'];
            if (sourcePortRangeValue !== null && sourcePortRangeValue !== undefined) {
              var sourcePortRangeInstance = sourcePortRangeValue;
              propertiesInstance.sourcePortRange = sourcePortRangeInstance;
            }
            
            var destinationPortRangeValue = propertiesValue2['destinationPortRange'];
            if (destinationPortRangeValue !== null && destinationPortRangeValue !== undefined) {
              var destinationPortRangeInstance = destinationPortRangeValue;
              propertiesInstance.destinationPortRange = destinationPortRangeInstance;
            }
            
            var sourceAddressPrefixValue = propertiesValue2['sourceAddressPrefix'];
            if (sourceAddressPrefixValue !== null && sourceAddressPrefixValue !== undefined) {
              var sourceAddressPrefixInstance = sourceAddressPrefixValue;
              propertiesInstance.sourceAddressPrefix = sourceAddressPrefixInstance;
            }
            
            var destinationAddressPrefixValue = propertiesValue2['destinationAddressPrefix'];
            if (destinationAddressPrefixValue !== null && destinationAddressPrefixValue !== undefined) {
              var destinationAddressPrefixInstance = destinationAddressPrefixValue;
              propertiesInstance.destinationAddressPrefix = destinationAddressPrefixInstance;
            }
            
            var accessValue = propertiesValue2['access'];
            if (accessValue !== null && accessValue !== undefined) {
              var accessInstance = accessValue;
              propertiesInstance.access = accessInstance;
            }
            ...
            if (directionValue !== null && directionValue !== undefined) {
              var directionInstance = directionValue;
              propertiesInstance.direction = directionInstance;
            }
   ...
   * @returns {Stream} The response stream.
   */
  NetworkSecurityRuleOperations.prototype.beginDeleting = function(resourceGroupName, networkSecurityGroupName, networkSecurityRuleName, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
   ...
   * @returns {Stream} The response stream.
   */
  NetworkSecurityRuleOperations.prototype.createOrUpdate = function(resourceGroupName, networkSecurityGroupName, networkSecurityRuleName, parameters, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    var client2 = this.client;
    
    return client2.networkSecurityRules.beginCreateOrUpdating(resourceGroupName, networkSecurityGroupName, networkSecurityRuleName, parameters, function (err, result) {
      if (err !== null && err !== undefined) {
        return callback(err);
      }
      var delayInSeconds = result.retryAfter;
   ...
   * @returns {Stream} The response stream.
   */
  NetworkSecurityRuleOperations.prototype.deleteMethod = function(resourceGroupName, networkSecurityGroupName, networkSecurityRuleName, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    var client2 = this.client;
    
    return client2.networkSecurityRules.beginDeleting(resourceGroupName, networkSecurityGroupName, networkSecurityRuleName, function (err, result) {
      if (err !== null && err !== undefined) {
        return callback(err);
      }
      var delayInSeconds = result.retryAfter;
   ...
   * @returns {Stream} The response stream.
   */
  NetworkSecurityRuleOperations.prototype.get = function(resourceGroupName, networkSecurityGroupName, networkSecurityRuleName, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
   ...
   * @returns {Stream} The response stream.
   */
  NetworkSecurityRuleOperations.prototype.list = function(resourceGroupName, networkSecurityGroupName, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
        ...
        if (responseDoc !== null && responseDoc !== undefined) {
          ...
          if (valueArray !== null && valueArray !== undefined) {
            for (var loweredIndex1 = 0; loweredIndex1 < valueArray.length; loweredIndex1 = loweredIndex1 + 1) {
              var valueValue = valueArray[loweredIndex1];
              var networkSecurityRuleInstance = {};
              result.networkSecurityRules.push(networkSecurityRuleInstance);
  ...
  return NetworkSecurityRuleOperations;
})();
    ...
    if (parameters.properties !== null && parameters.properties !== undefined) {
      ...
      if (parameters.properties.subnets !== null && parameters.properties.subnets !== undefined) {
        ...
        for (var loweredIndex4 = 0; loweredIndex4 < parameters.properties.subnets.length; loweredIndex4 = loweredIndex4 + 1) {
          ...
          if (subnetsItem.properties.networkSecurityGroup !== null && subnetsItem.properties.networkSecurityGroup !== undefined) {
            var networkSecurityGroupValue = {};
            propertiesValue2['networkSecurityGroup'] = networkSecurityGroupValue;
            
            if (subnetsItem.properties.networkSecurityGroup.id !== null && subnetsItem.properties.networkSecurityGroup.id !== undefined) {
              networkSecurityGroupValue['id'] = subnetsItem.properties.networkSecurityGroup.id;
            }
          }
            ...
            if (subnetsArray2 !== null && subnetsArray2 !== undefined) {
              for (var loweredIndex9 = 0; loweredIndex9 < subnetsArray2.length; loweredIndex9 = loweredIndex9 + 1) {
                ...
                if (propertiesValue4 !== null && propertiesValue4 !== undefined) {
                  ...
                  if (networkSecurityGroupValue2 !== null && networkSecurityGroupValue2 !== undefined) {
                    var networkSecurityGroupInstance = {};
                    propertiesInstance2.networkSecurityGroup = networkSecurityGroupInstance;
