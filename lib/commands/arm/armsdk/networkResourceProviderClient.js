...
var GatewayOperations = ( /** @lends GatewayOperations */ function() {
   ...
   * gateway.
   *
   * @param {AddressSpace} [parameters.vpnClientAddressSpace] Vpn client
   * address space.
   *
   * @param {IEnumerable} [parameters.vpnClientAddressSpace.addressPrefixes]
   * Gets or sets List of address blocks reserved for this virtual network in
   * CIDR notation
   *
   * @param {IEnumerable} [parameters.defaultSite] The default site on the
   * gateway.
   *
  ...
  GatewayOperations.prototype.beginCreateOrUpdatingVirtualNetworkGateway = function(resourceGroupName, virtualNetworkGatewayName, parameters, callback) {
    ...
    if (parameters.vpnClientAddressSpace !== null && parameters.vpnClientAddressSpace !== undefined) {
      var vpnClientAddressSpaceValue = {};
      propertiesValue['vpnClientAddressSpace'] = vpnClientAddressSpaceValue;

      if (parameters.vpnClientAddressSpace.addressPrefixes !== null && parameters.vpnClientAddressSpace.addressPrefixes !== undefined) {
        var addressPrefixesArray = [];
        for (var loweredIndex2 = 0; loweredIndex2 < parameters.vpnClientAddressSpace.addressPrefixes.length; loweredIndex2 = loweredIndex2 + 1) {
          var addressPrefixesItem = parameters.vpnClientAddressSpace.addressPrefixes[loweredIndex2];
          addressPrefixesArray.push(addressPrefixesItem);
        }
        vpnClientAddressSpaceValue['addressPrefixes'] = addressPrefixesArray;
      }
    }

    if (parameters.defaultSite !== null && parameters.defaultSite !== undefined) {
      var defaultSiteArray = [];
      for (var loweredIndex3 = 0; loweredIndex3 < parameters.defaultSite.length; loweredIndex3 = loweredIndex3 + 1) {
        var defaultSiteItem = parameters.defaultSite[loweredIndex3];
        defaultSiteArray.push(defaultSiteItem);
      }
      propertiesValue['defaultSite'] = defaultSiteArray;
    }
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      if (statusCode === 200 || statusCode === 201) {
        ...
        if (responseDoc !== null && responseDoc !== undefined) {
          var virtualNetworkGatewayInstance = { defaultSite: [], ipConfigurations: [], tags: {} };
          ...
          if (propertiesValue3 !== null && propertiesValue3 !== undefined) {
            ...
            var vpnClientAddressSpaceValue2 = propertiesValue3['vpnClientAddressSpace'];
            if (vpnClientAddressSpaceValue2 !== null && vpnClientAddressSpaceValue2 !== undefined) {
              var vpnClientAddressSpaceInstance = { addressPrefixes: [] };
              virtualNetworkGatewayInstance.vpnClientAddressSpace = vpnClientAddressSpaceInstance;

              var addressPrefixesArray2 = vpnClientAddressSpaceValue2['addressPrefixes'];
              if (addressPrefixesArray2 !== null && addressPrefixesArray2 !== undefined) {
                for (var loweredIndex5 = 0; loweredIndex5 < addressPrefixesArray2.length; loweredIndex5 = loweredIndex5 + 1) {
                  var addressPrefixesValue = addressPrefixesArray2[loweredIndex5];
                  vpnClientAddressSpaceInstance.addressPrefixes.push(addressPrefixesValue);
                }
              }
            }

            var defaultSiteArray2 = propertiesValue3['defaultSite'];
            if (defaultSiteArray2 !== null && defaultSiteArray2 !== undefined) {
              for (var loweredIndex6 = 0; loweredIndex6 < defaultSiteArray2.length; loweredIndex6 = loweredIndex6 + 1) {
                var defaultSiteValue = defaultSiteArray2[loweredIndex6];
                virtualNetworkGatewayInstance.defaultSite.push(defaultSiteValue);
              }
            }
   ...
   *
   * @param {AddressSpace}
   * [parameters.virtualNetworkGateway1.vpnClientAddressSpace] Vpn client
   * address space.
   *
   * @param {IEnumerable}
   * [parameters.virtualNetworkGateway1.vpnClientAddressSpace.addressPrefixes]
   * Gets or sets List of address blocks reserved for this virtual network in
   * CIDR notation
   *
   * @param {IEnumerable} [parameters.virtualNetworkGateway1.defaultSite] The
   * default site on the gateway.
   *
   ...
   * of this virtual network gateway.
   *
   * @param {string} [parameters.virtualNetworkGateway2.gatewayType] The size
   * of this virtual network gateway.
   *
   * @param {AddressSpace}
   * [parameters.virtualNetworkGateway2.vpnClientAddressSpace] Vpn client
   * address space.
   *
   * @param {IEnumerable}
   * [parameters.virtualNetworkGateway2.vpnClientAddressSpace.addressPrefixes]
   * Gets or sets List of address blocks reserved for this virtual network in
   * CIDR notation
   *
   * @param {IEnumerable} [parameters.virtualNetworkGateway2.defaultSite] The
   * default site on the gateway.
   *
   ...
   * @returns {Stream} The response stream.
   */
  GatewayOperations.prototype.beginCreateOrUpdatingVirtualNetworkGatewayConnection = function(resourceGroupName, virtualNetworkGatewayConnectionName, parameters, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
    ...
    url2 = url2 + '/resourceGroups/';
    url2 = url2 + encodeURIComponent(resourceGroupName);
    url2 = url2 + '/providers/microsoft.network/connections/';
    ...
    if (parameters.virtualNetworkGateway1 !== null && parameters.virtualNetworkGateway1 !== undefined) {
      ...
      if (parameters.virtualNetworkGateway1.vpnClientAddressSpace !== null && parameters.virtualNetworkGateway1.vpnClientAddressSpace !== undefined) {
        var vpnClientAddressSpaceValue = {};
        virtualNetworkGateway1Value['vpnClientAddressSpace'] = vpnClientAddressSpaceValue;

        if (parameters.virtualNetworkGateway1.vpnClientAddressSpace.addressPrefixes !== null && parameters.virtualNetworkGateway1.vpnClientAddressSpace.addressPrefixes !== undefined) {
          var addressPrefixesArray = [];
          for (var loweredIndex2 = 0; loweredIndex2 < parameters.virtualNetworkGateway1.vpnClientAddressSpace.addressPrefixes.length; loweredIndex2 = loweredIndex2 + 1) {
            var addressPrefixesItem = parameters.virtualNetworkGateway1.vpnClientAddressSpace.addressPrefixes[loweredIndex2];
            addressPrefixesArray.push(addressPrefixesItem);
          }
          vpnClientAddressSpaceValue['addressPrefixes'] = addressPrefixesArray;
        }
      ...
      if (parameters.virtualNetworkGateway1.defaultSite !== null && parameters.virtualNetworkGateway1.defaultSite !== undefined) {
        var defaultSiteArray = [];
        for (var loweredIndex3 = 0; loweredIndex3 < parameters.virtualNetworkGateway1.defaultSite.length; loweredIndex3 = loweredIndex3 + 1) {
          var defaultSiteItem = parameters.virtualNetworkGateway1.defaultSite[loweredIndex3];
          defaultSiteArray.push(defaultSiteItem);
        }
        virtualNetworkGateway1Value['defaultSite'] = defaultSiteArray;
      }
    ...
    if (parameters.virtualNetworkGateway2 !== null && parameters.virtualNetworkGateway2 !== undefined) {
      ...
      if (parameters.virtualNetworkGateway2.ipConfigurations !== null && parameters.virtualNetworkGateway2.ipConfigurations !== undefined) {
        ...
        for (var loweredIndex4 = 0; loweredIndex4 < parameters.virtualNetworkGateway2.ipConfigurations.length; loweredIndex4 = loweredIndex4 + 1) {
          var ipConfigurationsItem2 = parameters.virtualNetworkGateway2.ipConfigurations[loweredIndex4];
      ...
      if (parameters.virtualNetworkGateway2.vpnClientAddressSpace !== null && parameters.virtualNetworkGateway2.vpnClientAddressSpace !== undefined) {
        var vpnClientAddressSpaceValue2 = {};
        virtualNetworkGateway2Value['vpnClientAddressSpace'] = vpnClientAddressSpaceValue2;

        if (parameters.virtualNetworkGateway2.vpnClientAddressSpace.addressPrefixes !== null && parameters.virtualNetworkGateway2.vpnClientAddressSpace.addressPrefixes !== undefined) {
          var addressPrefixesArray2 = [];
          for (var loweredIndex5 = 0; loweredIndex5 < parameters.virtualNetworkGateway2.vpnClientAddressSpace.addressPrefixes.length; loweredIndex5 = loweredIndex5 + 1) {
            var addressPrefixesItem2 = parameters.virtualNetworkGateway2.vpnClientAddressSpace.addressPrefixes[loweredIndex5];
            addressPrefixesArray2.push(addressPrefixesItem2);
          }
          vpnClientAddressSpaceValue2['addressPrefixes'] = addressPrefixesArray2;
        }
      }

      if (parameters.virtualNetworkGateway2.defaultSite !== null && parameters.virtualNetworkGateway2.defaultSite !== undefined) {
        var defaultSiteArray2 = [];
        for (var loweredIndex6 = 0; loweredIndex6 < parameters.virtualNetworkGateway2.defaultSite.length; loweredIndex6 = loweredIndex6 + 1) {
          var defaultSiteItem2 = parameters.virtualNetworkGateway2.defaultSite[loweredIndex6];
          defaultSiteArray2.push(defaultSiteItem2);
        }
        virtualNetworkGateway2Value['defaultSite'] = defaultSiteArray2;
      }
    ...
    if (parameters.localNetworkGateway2 !== null && parameters.localNetworkGateway2 !== undefined) {
      ...
      if (parameters.localNetworkGateway2.localNetworkSiteAddressSpace !== null && parameters.localNetworkGateway2.localNetworkSiteAddressSpace !== undefined) {
        ...
        if (parameters.localNetworkGateway2.localNetworkSiteAddressSpace.addressPrefixes !== null && parameters.localNetworkGateway2.localNetworkSiteAddressSpace.addressPrefixes !== undefined) {
          var addressPrefixesArray3 = [];
          for (var loweredIndex7 = 0; loweredIndex7 < parameters.localNetworkGateway2.localNetworkSiteAddressSpace.addressPrefixes.length; loweredIndex7 = loweredIndex7 + 1) {
            var addressPrefixesItem3 = parameters.localNetworkGateway2.localNetworkSiteAddressSpace.addressPrefixes[loweredIndex7];
            addressPrefixesArray3.push(addressPrefixesItem3);
          }
          localNetworkSiteAddressSpaceValue['addressPrefixes'] = addressPrefixesArray3;
        }
      }
        ...
        if (responseDoc !== null && responseDoc !== undefined) {
          ...
          if (propertiesValue2 !== null && propertiesValue2 !== undefined) {
            ...
            if (virtualNetworkGateway1Value2 !== null && virtualNetworkGateway1Value2 !== undefined) {
              var virtualNetworkGateway1Instance = { defaultSite: [], ipConfigurations: [], tags: {} };
              ...
              if (ipConfigurationsArray3 !== null && ipConfigurationsArray3 !== undefined) {
                for (var loweredIndex8 = 0; loweredIndex8 < ipConfigurationsArray3.length; loweredIndex8 = loweredIndex8 + 1) {
                  var ipConfigurationsValue = ipConfigurationsArray3[loweredIndex8];
              ...
              var vpnClientAddressSpaceValue3 = virtualNetworkGateway1Value2['vpnClientAddressSpace'];
              if (vpnClientAddressSpaceValue3 !== null && vpnClientAddressSpaceValue3 !== undefined) {
                var vpnClientAddressSpaceInstance = { addressPrefixes: [] };
                virtualNetworkGateway1Instance.vpnClientAddressSpace = vpnClientAddressSpaceInstance;

                var addressPrefixesArray4 = vpnClientAddressSpaceValue3['addressPrefixes'];
                if (addressPrefixesArray4 !== null && addressPrefixesArray4 !== undefined) {
                  for (var loweredIndex9 = 0; loweredIndex9 < addressPrefixesArray4.length; loweredIndex9 = loweredIndex9 + 1) {
                    var addressPrefixesValue = addressPrefixesArray4[loweredIndex9];
                    vpnClientAddressSpaceInstance.addressPrefixes.push(addressPrefixesValue);
                  }
                }
              }

              var defaultSiteArray3 = virtualNetworkGateway1Value2['defaultSite'];
              if (defaultSiteArray3 !== null && defaultSiteArray3 !== undefined) {
                for (var loweredIndex10 = 0; loweredIndex10 < defaultSiteArray3.length; loweredIndex10 = loweredIndex10 + 1) {
                  var defaultSiteValue = defaultSiteArray3[loweredIndex10];
                  virtualNetworkGateway1Instance.defaultSite.push(defaultSiteValue);
                }
              }
            ...
            if (virtualNetworkGateway2Value2 !== null && virtualNetworkGateway2Value2 !== undefined) {
              var virtualNetworkGateway2Instance = { defaultSite: [], ipConfigurations: [], tags: {} };
              ...
              if (ipConfigurationsArray4 !== null && ipConfigurationsArray4 !== undefined) {
                for (var loweredIndex11 = 0; loweredIndex11 < ipConfigurationsArray4.length; loweredIndex11 = loweredIndex11 + 1) {
                  var ipConfigurationsValue2 = ipConfigurationsArray4[loweredIndex11];
              ...
              var vpnClientAddressSpaceValue4 = virtualNetworkGateway2Value2['vpnClientAddressSpace'];
              if (vpnClientAddressSpaceValue4 !== null && vpnClientAddressSpaceValue4 !== undefined) {
                var vpnClientAddressSpaceInstance2 = { addressPrefixes: [] };
                virtualNetworkGateway2Instance.vpnClientAddressSpace = vpnClientAddressSpaceInstance2;

                var addressPrefixesArray5 = vpnClientAddressSpaceValue4['addressPrefixes'];
                if (addressPrefixesArray5 !== null && addressPrefixesArray5 !== undefined) {
                  for (var loweredIndex12 = 0; loweredIndex12 < addressPrefixesArray5.length; loweredIndex12 = loweredIndex12 + 1) {
                    var addressPrefixesValue2 = addressPrefixesArray5[loweredIndex12];
                    vpnClientAddressSpaceInstance2.addressPrefixes.push(addressPrefixesValue2);
                  }
                }
              }

              var defaultSiteArray4 = virtualNetworkGateway2Value2['defaultSite'];
              if (defaultSiteArray4 !== null && defaultSiteArray4 !== undefined) {
                for (var loweredIndex13 = 0; loweredIndex13 < defaultSiteArray4.length; loweredIndex13 = loweredIndex13 + 1) {
                  var defaultSiteValue2 = defaultSiteArray4[loweredIndex13];
                  virtualNetworkGateway2Instance.defaultSite.push(defaultSiteValue2);
                }
              }
            ...
            if (localNetworkGateway2Value2 !== null && localNetworkGateway2Value2 !== undefined) {
              ...
              if (localNetworkSiteAddressSpaceValue2 !== null && localNetworkSiteAddressSpaceValue2 !== undefined) {
                ...
                var addressPrefixesArray6 = localNetworkSiteAddressSpaceValue2['addressPrefixes'];
                if (addressPrefixesArray6 !== null && addressPrefixesArray6 !== undefined) {
                  for (var loweredIndex14 = 0; loweredIndex14 < addressPrefixesArray6.length; loweredIndex14 = loweredIndex14 + 1) {
                    var addressPrefixesValue3 = addressPrefixesArray6[loweredIndex14];
                    localNetworkSiteAddressSpaceInstance.addressPrefixes.push(addressPrefixesValue3);
                  }
                }
              }
          ...
          if (errorValue !== null && errorValue !== undefined) {
            ...
            var detailsArray = errorValue['details'];
            if (detailsArray !== null && detailsArray !== undefined) {
              for (var loweredIndex15 = 0; loweredIndex15 < detailsArray.length; loweredIndex15 = loweredIndex15 + 1) {
                var detailsValue = detailsArray[loweredIndex15];
                var errorDetailsInstance = {};
                errorInstance.details.push(errorDetailsInstance);
   ...
   * @returns {Stream} The response stream.
   */
  GatewayOperations.prototype.beginDeletingLocalNetworkGateway = function(resourceGroupName, localNetworkGatewayName, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
   ...
   * @returns {Stream} The response stream.
   */
  GatewayOperations.prototype.beginDeletingVirtualNetworkGateway = function(resourceGroupName, virtualNetworkGatewayName, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
   ...
   * virtual network Gateway connection through NRP.
   *
   * @param {string} resourceGroupName The name of the resource group.
   *
   * @param {string} virtualNetworkGatewayConnectionName The name of the
   ...
   * @returns {Stream} The response stream.
   */
  GatewayOperations.prototype.beginDeletingVirtualNetworkGatewayConnection = function(resourceGroupName, virtualNetworkGatewayConnectionName, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
   ...
   * virtual network gatewayin the specified resource group through NRP.
   *
   * @param {string} resourceGroupName The name of the resource group.
   *
   * @param {string} virtualNetworkGatewayName The name of the virtual network
   ...
   *
   * @param {VirtualNetworkGateway} parameters Parameters supplied to the Begin
   * Reset Virtual Network Gateway operation through NRP.
   *
   * @param {IEnumerable} [parameters.ipConfigurations] IpConfigurations for
   * Virtual network gateway.
   *
   ...
   * @returns {Stream} The response stream.
   */
  GatewayOperations.prototype.beginResetVirtualNetworkGateway = function(resourceGroupName, virtualNetworkGatewayName, parameters, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
   ...
   * gateway connection in the specified resource group through NRP.
   *
   * @param {string} resourceGroupName The name of the resource group.
   *
   ...
   * @returns {Stream} The response stream.
   */
  GatewayOperations.prototype.beginResetVirtualNetworkGatewayConnectionSharedKey = function(resourceGroupName, virtualNetworkGatewayConnectionName, parameters, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
   ...
   * Set Virtual Network Gateway conection Shared key operation through NRP.
   *
   ...
   * @returns {Stream} The response stream.
   */
  GatewayOperations.prototype.beginSetVirtualNetworkGatewayConnectionSharedKey = function(resourceGroupName, virtualNetworkGatewayConnectionName, parameters, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
   ...
   * @returns {Stream} The response stream.
   */
  GatewayOperations.prototype.createOrUpdateLocalNetworkGateway = function(resourceGroupName, localNetworkGatewayName, parameters, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    var client2 = this.client;

    return client2.gateways.beginCreateOrUpdatingLocalNetworkGateway(resourceGroupName, localNetworkGatewayName, parameters, function (err, result) {
      if (err !== null && err !== undefined) {
        return callback(err);
      }
   ...
   * @returns {Stream} The response stream.
   */
  GatewayOperations.prototype.createOrUpdateVirtualNetworkGateway = function(resourceGroupName, virtualNetworkGatewayName, parameters, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    var client2 = this.client;

    return client2.gateways.beginCreateOrUpdatingVirtualNetworkGateway(resourceGroupName, virtualNetworkGatewayName, parameters, function (err, result) {
      if (err !== null && err !== undefined) {
        return callback(err);
      }
      var delayInSeconds = result.retryAfter;
   ...
   * updates an existing virtualnetwork gateway connection through NRP.
   *
   * @param {string} resourceGroupName The name of the resource group.
   *
   * @param {string} virtualNetworkGatewayConnectionName The name of the
   ...
   * @returns {Stream} The response stream.
   */
  GatewayOperations.prototype.createOrUpdateVirtualNetworkGatewayConnection = function(resourceGroupName, virtualNetworkGatewayConnectionName, parameters, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    var client2 = this.client;

    return client2.gateways.beginCreateOrUpdatingVirtualNetworkGatewayConnection(resourceGroupName, virtualNetworkGatewayConnectionName, parameters, function (err, result) {
      if (err !== null && err !== undefined) {
        return callback(err);
      }
      var delayInSeconds = result.retryAfter;
   ...
   * @returns {Stream} The response stream.
   */
  GatewayOperations.prototype.deleteLocalNetworkGateway = function(resourceGroupName, localNetworkGatewayName, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    var client2 = this.client;

    return client2.gateways.beginDeletingLocalNetworkGateway(resourceGroupName, localNetworkGatewayName, function (err, result) {
      if (err !== null && err !== undefined) {
        return callback(err);
      }
      var delayInSeconds = result.retryAfter;
   ...
   * @returns {Stream} The response stream.
   */
  GatewayOperations.prototype.deleteVirtualNetworkGateway = function(resourceGroupName, virtualNetworkGatewayName, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    var client2 = this.client;

    return client2.gateways.beginDeletingVirtualNetworkGateway(resourceGroupName, virtualNetworkGatewayName, function (err, result) {
      if (err !== null && err !== undefined) {
        return callback(err);
      }
      var delayInSeconds = result.retryAfter;
   ...
   * @returns {Stream} The response stream.
   */
  GatewayOperations.prototype.deleteVirtualNetworkGatewayConnection = function(resourceGroupName, virtualNetworkGatewayConnectionName, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    var client2 = this.client;

    return client2.gateways.beginDeletingVirtualNetworkGatewayConnection(resourceGroupName, virtualNetworkGatewayConnectionName, function (err, result) {
      if (err !== null && err !== undefined) {
        return callback(err);
      }
      var delayInSeconds = result.retryAfter;
   ...
   * specified local network gateway through NRP..
   *
   * @param {string} resourceGroupName The name of the resource group.
   *
   * @param {string} localNetworkGatewayName The name of the local network
   ...
   * @returns {Stream} The response stream.
   */
  GatewayOperations.prototype.getLocalNetworkGateway = function(resourceGroupName, localNetworkGatewayName, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
   ...
   * specified virtual network gateway through NRP..
   *
   * @param {string} resourceGroupName The name of the resource group.
   *
   * @param {string} virtualNetworkGatewayName The name of the virtual network
   ...
   * @returns {Stream} The response stream.
   */
  GatewayOperations.prototype.getVirtualNetworkGateway = function(resourceGroupName, virtualNetworkGatewayName, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
      ...
      if (statusCode === 200) {
        ...
        if (responseDoc !== null && responseDoc !== undefined) {
          ...
          if (propertiesValue !== null && propertiesValue !== undefined) {
            ...
            var vpnClientAddressSpaceValue = propertiesValue['vpnClientAddressSpace'];
            if (vpnClientAddressSpaceValue !== null && vpnClientAddressSpaceValue !== undefined) {
              var vpnClientAddressSpaceInstance = { addressPrefixes: [] };
              virtualNetworkGatewayInstance.vpnClientAddressSpace = vpnClientAddressSpaceInstance;

              var addressPrefixesArray = vpnClientAddressSpaceValue['addressPrefixes'];
              if (addressPrefixesArray !== null && addressPrefixesArray !== undefined) {
            ...
            var defaultSiteArray = propertiesValue['defaultSite'];
            if (defaultSiteArray !== null && defaultSiteArray !== undefined) {
              for (var loweredIndex3 = 0; loweredIndex3 < defaultSiteArray.length; loweredIndex3 = loweredIndex3 + 1) {
                var defaultSiteValue = defaultSiteArray[loweredIndex3];
                virtualNetworkGatewayInstance.defaultSite.push(defaultSiteValue);
              }
            }
   ...
   * about the specified virtual network gateway connection through NRP..
   *
   * @param {string} resourceGroupName The name of the resource group.
   *
   * @param {string} virtualNetworkGatewayConnectionName The name of the
   ...
   * @returns {Stream} The response stream.
   */
  GatewayOperations.prototype.getVirtualNetworkGatewayConnection = function(resourceGroupName, virtualNetworkGatewayConnectionName, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
        ...
        if (responseDoc !== null && responseDoc !== undefined) {
          ...
          if (propertiesValue !== null && propertiesValue !== undefined) {
            ...
            if (virtualNetworkGateway1Value !== null && virtualNetworkGateway1Value !== undefined) {
              ...
              var vpnClientAddressSpaceValue = virtualNetworkGateway1Value['vpnClientAddressSpace'];
              if (vpnClientAddressSpaceValue !== null && vpnClientAddressSpaceValue !== undefined) {
                var vpnClientAddressSpaceInstance = { addressPrefixes: [] };
                virtualNetworkGateway1Instance.vpnClientAddressSpace = vpnClientAddressSpaceInstance;
              ...
              var defaultSiteArray = virtualNetworkGateway1Value['defaultSite'];
              if (defaultSiteArray !== null && defaultSiteArray !== undefined) {
                for (var loweredIndex3 = 0; loweredIndex3 < defaultSiteArray.length; loweredIndex3 = loweredIndex3 + 1) {
                  var defaultSiteValue = defaultSiteArray[loweredIndex3];
                  virtualNetworkGateway1Instance.defaultSite.push(defaultSiteValue);
            ...
            if (virtualNetworkGateway2Value !== null && virtualNetworkGateway2Value !== undefined) {
              ...
              if (ipConfigurationsArray2 !== null && ipConfigurationsArray2 !== undefined) {
                for (var loweredIndex4 = 0; loweredIndex4 < ipConfigurationsArray2.length; loweredIndex4 = loweredIndex4 + 1) {
                  var ipConfigurationsValue2 = ipConfigurationsArray2[loweredIndex4];
                  var virtualNetworkGatewayIpConfigurationInstance2 = {};
                  virtualNetworkGateway2Instance.ipConfigurations.push(virtualNetworkGatewayIpConfigurationInstance2);
              ...
              var vpnClientAddressSpaceValue2 = virtualNetworkGateway2Value['vpnClientAddressSpace'];
              if (vpnClientAddressSpaceValue2 !== null && vpnClientAddressSpaceValue2 !== undefined) {
                var vpnClientAddressSpaceInstance2 = { addressPrefixes: [] };
                virtualNetworkGateway2Instance.vpnClientAddressSpace = vpnClientAddressSpaceInstance2;
                ...
                if (addressPrefixesArray2 !== null && addressPrefixesArray2 !== undefined) {
                  for (var loweredIndex5 = 0; loweredIndex5 < addressPrefixesArray2.length; loweredIndex5 = loweredIndex5 + 1) {
                    var addressPrefixesValue2 = addressPrefixesArray2[loweredIndex5];
                    vpnClientAddressSpaceInstance2.addressPrefixes.push(addressPrefixesValue2);
                  }
                }
              }

              var defaultSiteArray2 = virtualNetworkGateway2Value['defaultSite'];
              if (defaultSiteArray2 !== null && defaultSiteArray2 !== undefined) {
                for (var loweredIndex6 = 0; loweredIndex6 < defaultSiteArray2.length; loweredIndex6 = loweredIndex6 + 1) {
                  var defaultSiteValue2 = defaultSiteArray2[loweredIndex6];
                  virtualNetworkGateway2Instance.defaultSite.push(defaultSiteValue2);
                }
              }
            ...
            if (localNetworkGateway2Value !== null && localNetworkGateway2Value !== undefined) {
              ...
              if (localNetworkSiteAddressSpaceValue !== null && localNetworkSiteAddressSpaceValue !== undefined) {
                ...
                var addressPrefixesArray3 = localNetworkSiteAddressSpaceValue['addressPrefixes'];
                if (addressPrefixesArray3 !== null && addressPrefixesArray3 !== undefined) {
                  for (var loweredIndex7 = 0; loweredIndex7 < addressPrefixesArray3.length; loweredIndex7 = loweredIndex7 + 1) {
                    var addressPrefixesValue3 = addressPrefixesArray3[loweredIndex7];
                    localNetworkSiteAddressSpaceInstance.addressPrefixes.push(addressPrefixesValue3);
                  }
                }
              }
   ...
   * @returns {Stream} The response stream.
   */
  GatewayOperations.prototype.getVirtualNetworkGatewayConnectionSharedKey = function(resourceGroupName, connectionSharedKeyName, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
   ...
   * @returns {Stream} The response stream.
   */
  GatewayOperations.prototype.listLocalNetworkGateways = function(resourceGroupName, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
   ...
   * @returns {Stream} The response stream.
   */
  GatewayOperations.prototype.listVirtualNetworkGatewayConnections = function(resourceGroupName, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
            ...
            for (var loweredIndex1 = 0; loweredIndex1 < valueArray.length; loweredIndex1 = loweredIndex1 + 1) {
              ...
              if (propertiesValue !== null && propertiesValue !== undefined) {
                ...
                if (virtualNetworkGateway1Value !== null && virtualNetworkGateway1Value !== undefined) {
                  ...
                  var defaultSiteArray = virtualNetworkGateway1Value['defaultSite'];
                  if (defaultSiteArray !== null && defaultSiteArray !== undefined) {
                    for (var loweredIndex4 = 0; loweredIndex4 < defaultSiteArray.length; loweredIndex4 = loweredIndex4 + 1) {
                      var defaultSiteValue = defaultSiteArray[loweredIndex4];
                      virtualNetworkGateway1Instance.defaultSite.push(defaultSiteValue);
                    }
                  }
                ...
                if (virtualNetworkGateway2Value !== null && virtualNetworkGateway2Value !== undefined) {
                  ...
                  var ipConfigurationsArray2 = virtualNetworkGateway2Value['ipConfigurations'];
                  if (ipConfigurationsArray2 !== null && ipConfigurationsArray2 !== undefined) {
                    for (var loweredIndex5 = 0; loweredIndex5 < ipConfigurationsArray2.length; loweredIndex5 = loweredIndex5 + 1) {
                      var ipConfigurationsValue2 = ipConfigurationsArray2[loweredIndex5];
                      var virtualNetworkGatewayIpConfigurationInstance2 = {};
                      virtualNetworkGateway2Instance.ipConfigurations.push(virtualNetworkGatewayIpConfigurationInstance2);
                  ...
                  if (vpnClientAddressSpaceValue2 !== null && vpnClientAddressSpaceValue2 !== undefined) {
                    ...
                    if (addressPrefixesArray2 !== null && addressPrefixesArray2 !== undefined) {
                      for (var loweredIndex6 = 0; loweredIndex6 < addressPrefixesArray2.length; loweredIndex6 = loweredIndex6 + 1) {
                        var addressPrefixesValue2 = addressPrefixesArray2[loweredIndex6];
                        vpnClientAddressSpaceInstance2.addressPrefixes.push(addressPrefixesValue2);
                      }
                    }
                  }
                  ...
                  var defaultSiteArray2 = virtualNetworkGateway2Value['defaultSite'];
                  if (defaultSiteArray2 !== null && defaultSiteArray2 !== undefined) {
                    for (var loweredIndex7 = 0; loweredIndex7 < defaultSiteArray2.length; loweredIndex7 = loweredIndex7 + 1) {
                      var defaultSiteValue2 = defaultSiteArray2[loweredIndex7];
                      virtualNetworkGateway2Instance.defaultSite.push(defaultSiteValue2);
                    }
                  }
                ...
                if (localNetworkGateway2Value !== null && localNetworkGateway2Value !== undefined) {
                  ...
                  if (localNetworkSiteAddressSpaceValue !== null && localNetworkSiteAddressSpaceValue !== undefined) {
                    ...
                    var addressPrefixesArray3 = localNetworkSiteAddressSpaceValue['addressPrefixes'];
                    if (addressPrefixesArray3 !== null && addressPrefixesArray3 !== undefined) {
                      for (var loweredIndex8 = 0; loweredIndex8 < addressPrefixesArray3.length; loweredIndex8 = loweredIndex8 + 1) {
                        var addressPrefixesValue3 = addressPrefixesArray3[loweredIndex8];
                        localNetworkSiteAddressSpaceInstance.addressPrefixes.push(addressPrefixesValue3);
                      }
                    }
                  }
   ...
   * @returns {Stream} The response stream.
   */
  GatewayOperations.prototype.listVirtualNetworkGateways = function(resourceGroupName, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
      ...
      if (statusCode === 200) {
        ...
        if (responseDoc !== null && responseDoc !== undefined) {
          ...
          if (valueArray !== null && valueArray !== undefined) {
            for (var loweredIndex1 = 0; loweredIndex1 < valueArray.length; loweredIndex1 = loweredIndex1 + 1) {
              var valueValue = valueArray[loweredIndex1];
              var virtualNetworkGatewayJsonFormatInstance = { defaultSite: [], ipConfigurations: [], tags: {} };
              ...
              if (propertiesValue !== null && propertiesValue !== undefined) {
                ...
                if (vpnClientAddressSpaceValue !== null && vpnClientAddressSpaceValue !== undefined) {
                  var vpnClientAddressSpaceInstance = { addressPrefixes: [] };
                  virtualNetworkGatewayJsonFormatInstance.vpnClientAddressSpace = vpnClientAddressSpaceInstance;
                ...
                if (defaultSiteArray !== null && defaultSiteArray !== undefined) {
                  for (var loweredIndex4 = 0; loweredIndex4 < defaultSiteArray.length; loweredIndex4 = loweredIndex4 + 1) {
                    var defaultSiteValue = defaultSiteArray[loweredIndex4];
                    virtualNetworkGatewayJsonFormatInstance.defaultSite.push(defaultSiteValue);
                  }
                }
  ...
  /**
   * The Reset VirtualNetworkGateway operation resets the primary of the
   * virtual network gateway in the specified resource group through NRP.
   *
   * @param {string} resourceGroupName The name of the resource group.
   *
   * @param {string} virtualNetworkGatewayName The name of the virtual network
   ...
   * @returns {Stream} The response stream.
   */
  GatewayOperations.prototype.resetVirtualNetworkGateway = function(resourceGroupName, virtualNetworkGatewayName, parameters, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    var client2 = this.client;

    return client2.gateways.beginResetVirtualNetworkGateway(resourceGroupName, virtualNetworkGatewayName, parameters, function (err, result) {
      if (err !== null && err !== undefined) {
        return callback(err);
      }
      var delayInSeconds = result.retryAfter;
   ...
   * @returns {Stream} The response stream.
   */
  GatewayOperations.prototype.resetVirtualNetworkGatewayConnectionSharedKey = function(resourceGroupName, virtualNetworkGatewayConnectionName, parameters, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    var client2 = this.client;

    return client2.gateways.beginResetVirtualNetworkGatewayConnectionSharedKey(resourceGroupName, virtualNetworkGatewayConnectionName, parameters, function (err, result) {
      if (err !== null && err !== undefined) {
        return callback(err);
      }
      var delayInSeconds = result.retryAfter;
   ...
   * @returns {Stream} The response stream.
   */
  GatewayOperations.prototype.setVirtualNetworkGatewayConnectionSharedKey = function(resourceGroupName, virtualNetworkGatewayConnectionName, parameters, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    var client2 = this.client;

    return client2.gateways.beginSetVirtualNetworkGatewayConnectionSharedKey(resourceGroupName, virtualNetworkGatewayConnectionName, parameters, function (err, result) {
      if (err !== null && err !== undefined) {
        return callback(err);
      }
      var delayInSeconds = result.retryAfter;
