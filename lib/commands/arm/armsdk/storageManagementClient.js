...
var StorageAccountService = ( /** @lends StorageAccountService */ function() {
   ...
   * @returns {Stream} The response stream.
   */
  StorageAccountService.prototype.beginPuttingStorageAccount = function(resourceGroupName, accountName, storageAccount, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
  ...
  StorageAccountService.prototype.putStorageAccount = function(resourceGroupName, accountName, storageAccount, callback) {
    ...
    return client2.storageAccountService.beginPuttingStorageAccount(resourceGroupName, accountName, storageAccount, function (err, result) {
      if (err !== null && err !== undefined) {
        return callback(err);
      }
      ...
      var pollOperation = function () {
        setTimeout(function () {
          return client2.storageAccountService.getOperationResult(result.locationUrl, function (err2, result2) {
            if (err2 !== null && err2 !== undefined) {
              return callback(err2);
            } else {
              if (result2.statusCode !== '202') {
