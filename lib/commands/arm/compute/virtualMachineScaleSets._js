...
*/
 var virtualMachineScaleSetsScale = cli.category('vmss')
  ...
  .description($('The operation to Scale Up Virtual machine scale set'))
  .usage('[options] <resource-group> <name> <new capacity value>')
  .option('-g, --resource-group <resource-group>', $('resource-group'))
  .option('-n, --name <name>', $('name'))
  .option('-i, --out <New capacity value>',$('New capacity value that is higher than the current value.'))
  .option('-s, --subscription <subscription>', $('The subscription identifier'))
