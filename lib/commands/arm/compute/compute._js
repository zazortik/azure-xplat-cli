...
azure containerservice config container-service set
--parameter-file $f
--parse
...
azure containerservice config container-service delete
--parameter-file $f
--provisioning-state
...
azure containerservice config orchestrator-profile set
--parameter-file $f
--parse
--orchestrator-type $orchestratorType

azure containerservice config orchestrator-profile delete
--parameter-file $f
--orchestrator-type

azure containerservice config master-profile set
--parameter-file $f
--parse
--count $count
...
azure containerservice config master-profile delete
--parameter-file $f
--count
--dns-prefix
--fqdn

azure containerservice config agent-pool-profiles set
--parameter-file $f
--index $i
--value $v
--parse
...
azure containerservice config agent-pool-profiles delete
--parameter-file $f
--index $pindex
--name
--count
...
azure containerservice config windows-profile set
--parameter-file $f
--parse
--admin-username $adminUsername
--admin-password $adminPassword

azure containerservice config windows-profile delete
--parameter-file $f
--admin-username
--admin-password

azure containerservice config linux-profile set
--parameter-file $f
--parse
--admin-username $adminUsername
--ssh $ssh

azure containerservice config linux-profile delete
--parameter-file $f
--admin-username
--ssh

azure containerservice config ssh set
--parameter-file $f
--parse
--public-keys $publicKeys

azure containerservice config ssh delete
--parameter-file $f
--public-keys

azure containerservice config public-keys set
--parameter-file $f
--index $i
--value $v
--parse
...
azure containerservice config public-keys delete
--parameter-file $f
--index $pindex
--key-data

azure containerservice config diagnostics-profile set
--parameter-file $f
--parse
--vm-diagnostics $vmDiagnostics

azure containerservice config diagnostics-profile delete
--parameter-file $f
--vm-diagnostics

azure containerservice config vm-diagnostics set
--parameter-file $f
--parse
--enabled $enabled
--storage-uri $storageUri

azure containerservice config vm-diagnostics delete
--parameter-file $f
--enabled
--storage-uri

azure containerservice create 
--resource-group $p0
--name $p1
--parameters $p2
--parameter-file $f

azure containerservice config generate 
--parameter-file $f

azure containerservice config patch 
--parameter-file $f

azure containerservice delete 
--resource-group $p0
--name $p1

azure containerservice show 
--resource-group $p0
--name $p1

azure containerservice list 
--resource-group $p0
...
*/
  var containerServiceCreateOrUpdate = cli.category('containerservice')
  ...
  var catparametersCreateOrUpdateContainerServiceContainerService0 = cli.category('containerservice');
  ...
  .description($('Commands to configure container-service of containerservice in config file.'));
  ...
  var catparametersCreateOrUpdateContainerServiceContainerService1 = cli.category('containerservice');
  ...
  var catparametersCreateOrUpdateContainerServiceOrchestratorProfile0 = cli.category('containerservice');
  ...
  .description($('Commands to configure orchestrator-profile of containerservice in config file.'));
  ...
  var catparametersCreateOrUpdateContainerServiceOrchestratorProfile1 = cli.category('containerservice');
  ...
  var catparametersCreateOrUpdateContainerServiceMasterProfile0 = cli.category('containerservice');
  ...
  .description($('Commands to configure master-profile of containerservice in config file.'));
  ...
  var catparametersCreateOrUpdateContainerServiceMasterProfile1 = cli.category('containerservice');
  ...
  var catparametersCreateOrUpdateContainerServiceAgentPoolProfiles0 = cli.category('containerservice');
  ...
  .description($('Commands to configure agent-pool-profiles of containerservice in config file.'));
  ...
  var catparametersCreateOrUpdateContainerServiceAgentPoolProfiles1 = cli.category('containerservice');
  ...
  var catparametersCreateOrUpdateContainerServiceWindowsProfile0 = cli.category('containerservice');
  ...
  .description($('Commands to configure windows-profile of containerservice in config file.'));
  ...
  var catparametersCreateOrUpdateContainerServiceWindowsProfile1 = cli.category('containerservice');
  ...
  var catparametersCreateOrUpdateContainerServiceLinuxProfile0 = cli.category('containerservice');
  ...
  .description($('Commands to configure linux-profile of containerservice in config file.'));
  ...
  var catparametersCreateOrUpdateContainerServiceLinuxProfile1 = cli.category('containerservice');
  ...
  //config set ssh
  var catparametersCreateOrUpdateContainerServiceSsh0 = cli.category('containerservice');
  ...
  .description($('Commands to configure ssh of containerservice in config file.'));
  ...
  //config delete ssh
  var catparametersCreateOrUpdateContainerServiceSsh1 = cli.category('containerservice');
  ...
  var catparametersCreateOrUpdateContainerServicePublicKeys0 = cli.category('containerservice');
  ...
  .description($('Commands to configure public-keys of containerservice in config file.'));
  ...
  var catparametersCreateOrUpdateContainerServicePublicKeys1 = cli.category('containerservice');
  ...
  var catparametersCreateOrUpdateContainerServiceDiagnosticsProfile0 = cli.category('containerservice');
  ...
  .description($('Commands to configure diagnostics-profile of containerservice in config file.'));
  ...
  var catparametersCreateOrUpdateContainerServiceDiagnosticsProfile1 = cli.category('containerservice');
  ...
  var catparametersCreateOrUpdateContainerServiceVmDiagnostics0 = cli.category('containerservice');
  ...
  .description($('Commands to configure vm-diagnostics of containerservice in config file.'));
  ...
  var catparametersCreateOrUpdateContainerServiceVmDiagnostics1 = cli.category('containerservice');
...
/*
  ...
  --name
*/
  var containerServiceDelete = cli.category('containerservice')
  .description($('Commands to manage your container service.  '));
...
/*
  ...
  --name
*/
  var containerServiceGet = cli.category('containerservice')
  .description($('Commands to manage your container service.  '));
...
/*
  ...
  --resource-group
*/
  var containerServiceList = cli.category('containerservice')
  .description($('Commands to manage your container service.  '));
...
*/
  ...
  .execute(function(resourceGroup, options, _) {
    ...
    var subscription = profile.current.getSubscription(options.subscription);
    var computeManagementClient = utils.createComputeManagementClient(subscription);
    var result = computeManagementClient.virtualMachineScaleSets.list(resourceGroup, _);
