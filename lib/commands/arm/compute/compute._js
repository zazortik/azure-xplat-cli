...
azure container-service config containerservice set
--parameter-file $f
--parse
...
azure container-service config containerservice delete
--parameter-file $f
--provisioning-state
...
*/
  ...
  //config delete containerservice
  ...
  .description($('Commands to manage configuration of container-service in the parameter file.'));
  var deleteparametersCreateOrUpdateContainerServiceContainerService1 = parametersCreateOrUpdateContainerServiceContainerService1.category('containerservice')
  .description($('Commands to configure containerservice of container-service in config file.'));
  deleteparametersCreateOrUpdateContainerServiceContainerService1.command('delete')
  .description($('Remove containerservice in config string or files, e.g. \r\n{\r\n  "provisioningState":"",\r\n  "orchestratorProfile":{\r\n    "orchestratorType":null\r\n  },\r\n  "masterProfile":{\r\n    "count":null,\r\n    "dnsPrefix":"",\r\n    "fqdn":""\r\n  },\r\n  "agentPoolProfiles":[\r\n    {\r\n      "name":"",\r\n      "count":null,\r\n      "vmSize":"",\r\n      "dnsPrefix":"",\r\n      "fqdn":""\r\n    }\r\n  ],\r\n  "windowsProfile":{\r\n    "adminUsername":"",\r\n    "adminPassword":""\r\n  },\r\n  "linuxProfile":{\r\n    "adminUsername":"",\r\n    "ssh":{\r\n      "publicKeys":[\r\n        {\r\n          "keyData":""\r\n        }\r\n      ]\r\n    }\r\n  },\r\n  "diagnosticsProfile":{\r\n    "vmDiagnostics":{\r\n      "enabled":null,\r\n      "storageUri":""\r\n    }\r\n  },\r\n  "id":null,\r\n  "name":null,\r\n  "type":null,\r\n  "location":"",\r\n  "tags":{\r\n  }\r\n}\r\n         There are two sets of commands:\r\n           1) function commands that are used to manage Azure resources in the cloud, and \r\n           2) parameter commands that generate & edit input files for the other set of commands.\r\n         For example, \'vmss show/list/stop\' are the function commands that call get, list and stop operations of \r\n         virtual machine scale set, whereas \'vmss config * generate/create/set/delete/add\' commands \r\n         are used to configure the input parameter file. The \'vmss config\' command takes a parameter \r\n         file as for the VM scale set configuration, and creates it online.'))
  .usage('[options]')
  .option('--parameter-file <parameter-file>', $('The parameter file path.'))
