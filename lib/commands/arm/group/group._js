...
exports.init = function (cli) {
      ...
      if (options.details) {
        ...
        try {
          for (var i in resourceGroups) {
            ...
            resourceGroup.permissions = client.resourceGroups.getPermissions(resourceGroup.name, _);
          }
        } finally {
          progress.end();
        }
  ...
  group.command('show [name]')
    ...
    .execute(function (name, options, _) {
      ...
      try {
        ...
        resourceGroup.permissions = client.resourceGroups.getPermissions(name, _);
      } finally {
        progress.end();
      }
  ...
  function showDetailedResourceGroup (resourceGroup) {
    ...
    if (resourceGroup.permissions) {
      ...
      var permittedActions = resourceGroup.permissions.permittedActions;
