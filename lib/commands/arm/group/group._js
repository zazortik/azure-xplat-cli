...
exports.init = function (cli) {
  ...
  group.command('set [name] [tags]')
    ...
    .option('-t --tags <tags>', $('Tags to set to the resource group. Can be mutliple. ' +
          'In the format of \'name=value\'. Name is required and value is optional. For example, -t tag1=value1;tag2'))
    .option('--subscription <subscription>', $('the subscription identifier'))
    .execute(function (name, tags, options, _) {
      options.tags = tags;
  ...
  group.createResourceGroup = function (name, location, options, _) {
    ...
    var tags = {};
    if (options.tags) {
      tags = tagUtils.buildTagsObject(options.tags);
    }
  ...
  group.command('list')
    ...
    .execute(function (options, _) {
      ...
      try {
        result = client.resourceGroups.list(parameters, _);
      } finally {
        progress.end();
      }
