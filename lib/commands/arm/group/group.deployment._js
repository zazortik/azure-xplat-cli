...
exports.init = function (cli) {
  ...
  deployment.command('create [resource-group] [name]')
    ...
    .option('-m --mode <mode>', $('the deployment mode: specify one of Incremental or Complete. If no mode is specified, Incremental is used as default'))
    ...
    .execute(function (resourceGroup, name, options, _) {
      ...
      if (!utils.ignoreCaseEquals(options.mode, 'complete') && !utils.ignoreCaseEquals(options.mode, 'incremental')) {
