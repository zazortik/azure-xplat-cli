      ...
      if (!options.nowait) {
        ...
        function (log, _) {
          do {
            ...
            console.log('>>>>>>>>>operations is ' + util.inspect(operations, { depth: null }));

            var nestedOperations = getNestedOperations(client, resourceGroup, operations, _);
            console.log('>>>>>>>>>>nested operations is ' + util.inspect(nestedOperations, { depth: null }));
            
            displayDeploymentStatusMessage(nestedOperations, log, _);
...
function getDeploymentOperations(client, resourceGroup, deploymentName, _) {
  ...
  //console.log('returning from getDeploymentOperations with ' + util.inspect(allOperations, { depth: null }));
...
function displayDeploymentStatusMessage(operations, log, _) {
  if (operations) {
