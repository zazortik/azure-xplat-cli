...
exports.listGraphObjects = function (client, objectType, interaction, log, _) {
  ...
  var response = client[objectType + 'Operations'].list(null, _);
  var nextLink = response.odatanextLink;

  while (nextLink) {
    var response2 = client[objectType + 'Operations'].listNext(nextLink, _);
    // push to the existing array efficiently
