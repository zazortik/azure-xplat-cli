...
var ADGraphClient = require('azure-graph');
var log = require('../../../../lib/util/logging');
var utils = require('../../../util/utils');
var $ = utils.getLocaleString;

exports.getADGraphClient = function getADGraphClient(subscription) {
  console.log('before creating graph client');
  var client = new ADGraphClient(subscription._createCredentials(), subscription.tenantId, subscription.activeDirectoryGraphResourceId);
