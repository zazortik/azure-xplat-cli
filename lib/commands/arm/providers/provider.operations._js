...
exports.init = function (cli) {
  ...
  providerOperations.command('show [operationSearchString]')
    ...
    .option('-o --operationSearchString <operationSearchString>', $('The provider action string (with possible wildcard (*) characters). Example: "*" to get all actions for all providers, "Microsoft.Insights/*" to get actions for a particular provider, "*/virtualMachines/*" to get all actions that can be performed on virtual machines.'))
  ...
  function getProviderOperationsWithWildCard(client, actionString, _) {
    ...
    console.log("In get wildcard ", actionString);
