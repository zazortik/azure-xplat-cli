...
exports.init = function (cli) {
  ...
  providerOperations.command('show [operationSearchString]')
    .description($('Show operations for the requested provider operation search string. The command takes as input a operation search string (with wildcard (*) character) which determines the action details to display.'))
