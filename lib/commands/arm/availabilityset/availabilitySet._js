...
__.extend(AvailabilitySet.prototype, {
    ...
    getAllAvailSets: function (resourceGroupName, _) {
      var availSets;
    ...
    _expandAvailSet: function (availSet, depth, memoize, dependencies, _) {
      ...
      if (availabilitySet.properties.virtualMachinesReferences instanceof Array) {
        for (var i = 0; i < availabilitySet.properties.virtualMachinesReferences.length; i++) {
          var vmReference =  availabilitySet.properties.virtualMachinesReferences[i];
