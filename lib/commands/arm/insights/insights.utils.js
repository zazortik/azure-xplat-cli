...
exports.formatOutputListNonJSON = function (cli, log, options, values) {
...
exports.formatOutputJSON = function (cli, log, options, value) {
...
exports.formatOutputList = function(cli, log, options, values) {
  ...
  if (options.json) {
    ...
    log.data(JSON.stringify(values));
  }
};
