...
__.extend(VpnGateway.prototype, {
  create: function (resourceGroupName, gatewayName, location, options, _) {
  ...
  set: function (resourceGroupName, gatewayName, location, options, _) {
  ...
  update: function (resourceGroupName, gatewayName, gatewayParameters, _) {
  ...
  addIpConfig: function (resourceGroupName, gatewayName, options, _) {
  ...
  removeIp: function (resourceGroupName, gatewayName, options, _) {
    var gateway = this.getVirtualNetworkGateway(resourceGroupName, gatewayName, _);
    if (gateway) {
      gateway = gateway.virtualNetworkGateway;
  ...
  createConnection: function (resourceGroupName, gatewayName, options, _) {
  ...
  setConnection: function (resourceGroupName, gatewayName, options, _) {
    var connectionProfile = this._parseVirtualNetworkGatewayConnection(gatewayName, options, _);
    var connection = this.getVirtualNetworkGatewayConnection(resourceGroupName, gatewayName, _);
    if (!connection) {
  ...
  showConnection: function (resourceGroupName, gatewayName, options, _) {
    var connection = this.getVirtualNetworkGatewayConnection(resourceGroupName, gatewayName, _);
    var output = this.cli.output;
    if (!connection) {
      if (output.format().json) {
  ...
  getConnection: function (resourceGroupName, gatewayName, _) {
  ...
  getAllConnections: function (resourceGroupName, options, _) {
  ...
  deleteConnection: function (resourceGroupName, gatewayName, options, _) {
    var connection = this.getVirtualNetworkGatewayConnection(resourceGroupName, gatewayName, _);
    if (!connection) {
      throw new Error(util.format($('A virtual network gateway connection with name "%s" not found in the resource group "%s"'), gatewayName, resourceGroupName));
    }
  ...
  _getConnectionByIds: function (resourceGroupName, gatewayId, connectedEntityId, _) {
  ...
  _parseConnection: function (name, options, _) {
    var parameters = {};
  ...
  _parseLocalNetworkGateway: function (localGateway, options) {
  ...
  _parseGateway: function (name, options, useDefaults) {
    var parameters = {};
  ...
  _removeIpConfig: function (ipConfigurations, options) {
