...
__.extend(VpnGateway.prototype, {
  ...
  createVirtualNetworkGatewayConnection: function (resourceGroup, name, options, _) {
    var connectionProfile = this._parseAndValidateVPNGatewayConnection(name, options, _);
  ...
  showVirtualNetworkGatewayConnection: function (resourceGroup, name, options, _) {
    ...
    this._showVPNGatewayConnection(connection.virtualNetworkGatewayConnection);
  },
  ...
  _showVPNGatewayConnection: function (connection) {
    var log = this.log;
  ...
  _parseAndValidateVPNGatewayConnection: function (name, options, _) {
    var parameters = {};
