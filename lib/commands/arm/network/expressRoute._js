...
__.extend(ExpressRoute.prototype, {
  ...
  createAuthorization: function (resourceGroupName, circuitName, name, options, _) {
    ...
    try {
      circuitAuthorization = self.networkManagementClient.expressRouteCircuitAuthorizations.createOrUpdate(resourceGroupName, circuitName, name, circuitAuth, _);
    } finally {
      progress.end();
    }
    self._showCircuitAuthorization(circuitAuthorization);
  },
  ...
  showAuthorization: function (resourceGroupName, circuitName, name, options, _) {
    ...
    self._showCircuitAuthorization(circuitAuth);
  },
