...
__.extend(NetworkClient.prototype, {
  ...
  showPublicIP: function(resourceGroupName, publicIpName, options, _) {
    var networkResourceProviderClient = this._getNetworkProviderClient(this.subscription);

    var publicipCRUD = new PublicipCRUD(this.cli, networkResourceProviderClient);
    publicipCRUD.show(resourceGroupName, publicIpName, options, _);
  },

  deletePublicIP: function(resourceGroupName, publicIpName, options, _) {
    var networkResourceProviderClient = this._getNetworkProviderClient(this.subscription);

    var publicipCRUD = new PublicipCRUD(this.cli, networkResourceProviderClient);
    publicipCRUD.delete(resourceGroupName, publicIpName, options, _);
  },
