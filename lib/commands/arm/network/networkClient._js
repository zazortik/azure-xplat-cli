...
__.extend(NetworkClient.prototype, {
  ...
  listAddressPrefix: function (resourceGroupName, vNetName, options, _) {
    var networkResourceProviderClient = this._getNetworkProviderClient(this.subscription);
  ...
  addLoadBalancerRule: function(resourceGroupName, lbName, ruleName, options, _) {
    ...
    var loadbalancerCRUD = new LoadBalancerCRUD(this.cli, networkResourceProviderClient);
    loadbalancerCRUD.addLBRule(resourceGroupName, lbName, ruleName, options, _);
  },
  ...
  updateLoadBalancerRule: function(resourceGroupName, lbName, ruleName, options, _) {
    ...
    var loadbalancerCRUD = new LoadBalancerCRUD(this.cli, networkResourceProviderClient);
    loadbalancerCRUD.updateLBRule(resourceGroupName, lbName, ruleName, options, _);
  },
  ...
  deleteLoadBalancerRule: function (resourceGroupName, lbName, ruleName, options, _) {
    ...
    var loadbalancerCRUD = new LoadBalancerCRUD(this.cli, networkResourceProviderClient);
    loadbalancerCRUD.deleteLBRule(resourceGroupName, lbName, ruleName, options, _);
  },
  ...
  addFrontEndIPConfig: function(resourceGroupName, lbName, ipConfigName, options, _) {
    ...
    var loadbalancerCRUD = new LoadBalancerCRUD(this.cli, networkResourceProviderClient);
    loadbalancerCRUD.addFrontEndIPConfig(resourceGroupName, lbName, ipConfigName, options, _);
  },
  ...
  updateFrontEndIPConfig: function(resourceGroupName, lbName, ipConfigName, options, _) {
    ...
    var loadbalancerCRUD = new LoadBalancerCRUD(this.cli, networkResourceProviderClient);
    loadbalancerCRUD.updateFrontEndIPConfig(resourceGroupName, lbName, ipConfigName, options, _);
  },
  ...
  deleteFrontEndIPConfig: function(resourceGroupName, lbName, ipConfigName, options, _) {
    ...
    var loadbalancerCRUD = new LoadBalancerCRUD(this.cli, networkResourceProviderClient);
    loadbalancerCRUD.deleteFrontEndIPConfig(resourceGroupName, lbName, ipConfigName, options, _);
  },
  ...
  addBackendAddressPool: function(resourceGroupName, lbName, poolName, options, _) {
    ...
    var loadbalancerCRUD = new LoadBalancerCRUD(this.cli, networkResourceProviderClient);
    loadbalancerCRUD.addBackendAddressPool(resourceGroupName, lbName, poolName, options, _);
  },
  ...
  updateBackendAddressPool: function(resourceGroupName, lbName, poolName, options, _) {
    ...
    var loadbalancerCRUD = new LoadBalancerCRUD(this.cli, networkResourceProviderClient);
    loadbalancerCRUD.updateBackendAddressPool(resourceGroupName, lbName, poolName, options, _);
  },
  ...
  deleteBackendAddressPool: function (resourceGroupName, lbName, poolName, options, _) {
    ...
    var loadbalancerCRUD = new LoadBalancerCRUD(this.cli, networkResourceProviderClient);
    loadbalancerCRUD.deleteBackendAddressPool(resourceGroupName, lbName, poolName, options, _);
  },
  ...
  createOutboundRule: function (resourceGroupName, lbName, outboundRuleName, options, _) {
    ...
    var loadbalancerCRUD = new LoadBalancerCRUD(this.cli, networkResourceProviderClient);
    loadbalancerCRUD.createOutboundRule(resourceGroupName, params, _);
  },
  ...
  updateOutboundRule: function (resourceGroupName, lbName, outboundRuleName, options, _) {
    ...
    var loadbalancerCRUD = new LoadBalancerCRUD(this.cli, networkResourceProviderClient);
    loadbalancerCRUD.updateOutboundRule(resourceGroupName, params, _);
  },
  ...
  deleteOutboundRule: function (resourceGroupName, lbName, outboundRuleName, options, _) {
    ...
    var loadbalancerCRUD = new LoadBalancerCRUD(this.cli, networkResourceProviderClient);
    loadbalancerCRUD.deleteOutboundRule(resourceGroupName, params, _);
  },
  ...
  listPublicIPs: function (resourceGroupName, options, _) {
    ...
    var publicipCRUD = new PublicipCRUD(this.cli, networkResourceProviderClient);
    publicipCRUD.list(resourceGroupName, options, _);
  },
  ...
  showPublicIP: function (resourceGroupName, name, options, _) {
    ...
    var publicipCRUD = new PublicipCRUD(this.cli, networkResourceProviderClient);
    publicipCRUD.show(resourceGroupName, name, options, _);
  },
  ...
  deletePublicIP: function (resourceGroupName, name, options, _) {
    ...
    var publicipCRUD = new PublicipCRUD(this.cli, networkResourceProviderClient);
    publicipCRUD.delete(resourceGroupName, name, options, _);
  },
