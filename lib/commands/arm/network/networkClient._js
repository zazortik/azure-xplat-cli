...
__.extend(NetworkClient.prototype, {
  ...
  exportVNet: function (resourceGroupName, vNetName, filePath, _) {
    ...
    var vnet = new Vnet(this.cli, networkResourceProviderClient);
    vnet.export(resourceGroupName, vNetName, filePath, _);
  },
  ...
  importVNet: function (resourceGroupName, vNetName, filePath, _) {
    ...
    var vnet = new Vnet(this.cli, networkResourceProviderClient);
    vnet.import(resourceGroupName, vNetName, filePath, _);
  },
  ...
  exportLoadBalancer: function (resourceGroupName, name, options, _) {
    ...
    var loadBalancer = new LoadBalancer(this.cli, networkResourceProviderClient);
    loadBalancer.export(resourceGroupName, params, _);
  },
  ...
  importLoadBalancer: function (resourceGroupName, name, options, _) {
    ...
    var loadBalancer = new LoadBalancer(this.cli, networkResourceProviderClient);
    loadBalancer.import(resourceGroupName, params, _);
  },
