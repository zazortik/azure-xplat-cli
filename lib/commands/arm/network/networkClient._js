...
var DnsRecords = require('./dnsRecords');
...
__.extend(NetworkClient.prototype, {
  ...
  createDnsRecord: function (resourceGroup, zoneName, name, options, _) {
    var dnsManagementClient = this._getDnsManagementClient(this.subscription);

    var dnsRecords = new DnsRecords(this.cli, dnsManagementClient);
    dnsRecords.create(resourceGroup, zoneName, name, options, _);
  },

  setDnsRecord: function (resourceGroup, zoneName, name, options, _) {
    var dnsManagementClient = this._getDnsManagementClient(this.subscription);

    var dnsRecords = new DnsRecords(this.cli, dnsManagementClient);
    dnsRecords.set(resourceGroup, zoneName, name, options, _);
  },

  listDnsRecords: function (resourceGroup, zoneName, options, _) {
    var dnsManagementClient = this._getDnsManagementClient(this.subscription);

    var dnsRecords = new DnsRecords(this.cli, dnsManagementClient);
    dnsRecords.list(resourceGroup, zoneName, options, _);
  },

  showDnsRecord: function (resourceGroup, zoneName, name, options, _) {
    var dnsManagementClient = this._getDnsManagementClient(this.subscription);

    var dnsRecords = new DnsRecords(this.cli, dnsManagementClient);
    dnsRecords.show(resourceGroup, zoneName, name, options, _);
  },
  ...
  deleteDnsRecord: function (resourceGroup, zoneName, name, options, _) {
    ...
    var dnsRecords = new DnsRecords(this.cli, dnsManagementClient);
    dnsRecords.delete(resourceGroup, zoneName, name, options, _);
  },

  addRecord: function (resourceGroup, zoneName, name, options, _) {
    var dnsManagementClient = this._getDnsManagementClient(this.subscription);

    var dnsRecords = new DnsRecords(this.cli, dnsManagementClient);
    dnsRecords.addRecord(resourceGroup, zoneName, name, options, _);
  },

  deleteRecord: function (resourceGroup, zoneName, name, options, _) {
    var dnsManagementClient = this._getDnsManagementClient(this.subscription);

    var dnsRecords = new DnsRecords(this.cli, dnsManagementClient);
    dnsRecords.deleteRecord(resourceGroup, zoneName, name, options, _);
  },
  ...
  listVirtualNetworkGateways: function (resourceGroup, vnetName, options, _) {
    var networkResourceProviderClient = this._getNetworkProviderClient(this.subscription);
    var vpnGateway = new VpnGateway(this.cli, networkResourceProviderClient);
    vpnGateway.listVirtualNetworkGateways(resourceGroup, vnetName, options, _);
  },
  ...
  setLocalNetworkGateway: function (resourceGroup, gatewayName, location, options, _) {
    var networkResourceProviderClient = this._getNetworkProviderClient(this.subscription);
    var vpnGateway = new VpnGateway(this.cli, networkResourceProviderClient);
    vpnGateway.setLocalNetworkGateway(resourceGroup, gatewayName, location, options, _);
  },
