...
__.extend(VirtualNetworkGateway.prototype, {
   ...
   */
  addRootCert: function (resourceGroupName, gatewayName, certName, options, _) {
    var self = this;
  ...
  removeRootCert: function (resourceGroupName, gatewayName, certName, options, _) {
    var self = this;
   ...
   */
  addRevokedCert: function(resourceGroupName, gatewayName, certName, options, _) {
    var self = this;
  ...
  removeRevokedCert: function(resourceGroupName, gatewayName, certName, options, _) {
    var self = this;
