...
exports.init = function (cli) {
  ...
  inboundNatRule.command('create [resource-group] [lb-name] [name]')
    ...
    .option('-f, --frontend-port <frontend-port>', util.format($('the frontend port %s'), Constants.toRange(Constants.portBoundsList)))
    .option('-b, --backend-port <backend-port>', util.format($('the backend port %s'), Constants.toRange(Constants.portBoundsList)))
    .option('-e, --enable-floating-ip <enable-floating-ip>', $('enable floating point ip [true,false]'))
    .option('-i, --vip <vip>', $('the name of the frontend ip configuration'))
  ...
  inboundNatRule.command('set [resource-group] [lb-name] [name]')
    ...
    .option('-b, --backend-port <backend-port>', util.format($('the backend port %s'), Constants.toRange(Constants.portBoundsList)))
    .option('-e, --enable-floating-ip <enable-floating-ip>', $('enable floating point ip [true,false]'))
    .option('-i, --vip <vip>', $('the comma separated list of frontend ip configurations names.' +
    '\n     e.g. "frontendIpConfiguration1,frontendIpConfiguration2"'))
    .option('-m, --vm-id [vm-id]', $('the VM id.' +
    '\n     e.g. /subscriptions/<subscription-id>/resourceGroups/<resource-group-name>/providers/Microsoft.Compute/virtualMachines/<vm-name>'))
  ...
  profile.command('create [resource-group] [name]')
    ...
    '\n     Name is required and value is optional. '))
    .option('-s, --subscription <subscription>', $('the subscription identifier'))
    .execute(function (resourceGroupName, name, trafficRoutingMethod, options, _) {
  ...
  profile.command('list [resource-group]')
    .description($('Lists a traffic manager profile'))
    .usage('[options] <resource-group>')
    .option('-g, --resource-group <resource-group>', $('the name of the resource group'))
    .option('-s, --subscription <subscription>', $('the subscription identifier'))
  ...
  profile.command('show [resource-group] [name]')
    .description($('Shows a traffic manager profile'))
    .usage('[options] <resource-group> <name>')
    .option('-g, --resource-group <resource-group>', $('the name of the resource group'))
    .option('-n, --name <name>', $('the name of the profile'))
    .option('-s, --subscription <subscription>', $('the subscription identifier'))
  ...
  profile.command('is-dns-available [resource-group] [relative-dns-name]')
    .description($('Checks traffic manager profile name availability'))
  ...
  endpoint.command('create [resource-group] [profile-name] [name] [endpoint-location]')
    .description($('Creates an endpoint in traffic manager profile'))
    ...
    .execute(function (resourceGroup, profileName, name, endpointLocation, options, _) {
      ...
      endpointLocation = cli.interaction.promptIfNotGiven($('Endpoint location: '), endpointLocation, _);
  ...
  endpoint.command('set [resource-group] [profile-name] [name]')
    .description($('Sets an endpoint defined in a traffic manager profile'))
  ...
  endpoint.command('delete [resource-group] [profile-name] [name]')
    .description($('Delete an endpoint in traffic manager profile'))
    .usage('[options] <resource-group> <profile-name> <name>')
    .option('-g, --resource-group <resource-group>', $('the name of the resource group'))
    .option('-f, --profile-name <profile-name>', $('the profile name'))
    .option('-n, --name <name>', $('the name of the endpoint'))
