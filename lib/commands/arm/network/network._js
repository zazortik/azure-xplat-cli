...
exports.init = function (cli) {
  ...
  nic.command('create [resource-group] [name] [location]')
    ...
    .option('-p, --public-ip-name <public-ip-name>', $('the public ip address name'))
    ...
    .execute(function (resourceGroup, name, location, options, _) {
      ...
      options.subnetVnetName = cli.interaction.promptIfNotGiven($('Virtual network name: '), options.subnetVnetName, _);
