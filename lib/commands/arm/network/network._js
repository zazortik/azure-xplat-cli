...
exports.init = function (cli) {
  ...
  var loadBalancerLBRule = lb.category('lbrule')
  ...
  var loadBalancerFEIPConfig = lb.category('frontend-ipconfig')
  ...
  var loadBalancerBackendAddressPool = lb.category('backend-addresspool')
