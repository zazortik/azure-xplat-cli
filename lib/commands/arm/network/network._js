...
exports.init = function (cli) {
  ...
  var prob = loadbalancer.category('prob')
    .description($('Commands to manage prob settings for load balancer'));

  prob.command('create <resourceGroup> <lb-name> <probe-name>')
    .usage('[options] <resourceGroup> <lb-name> <probe-name>')
    .description($('Adds a new prob settings to the list of probes in the load balancer'))
    .option('-t, --protocol <protocol>', $('the probe protocol'))
    .option('-r, --port <port>', $('the probe port'))
    .option('-h, --path <path>', $('the probe path'))
  ...
  prob.command('list <resourceGroup> [lb-name]')
    .usage('[options] <resourceGroup> [lb-name]')
  ...
  prob.command('delete <resourceGroup> <lb-name> <probe-name>')
    .usage('[options] <resourceGroup> <lb-name> <probe-name>')
  ...
  prob.command('update <resourceGroup> <lb-name> <probe-name>')
    .usage('[options] <resourceGroup> <lb-name> <probe-name>')
