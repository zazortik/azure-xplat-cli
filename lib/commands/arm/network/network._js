...
exports.init = function (cli) {
  ...
  vNetAddressPrefix.command('create <resource-group> <name> <startip-ipAddress/cidr>')
    ...
    .option('-m, --max-vm-count <maxVmCount>', $('the maximum number of VMs in the address'))
    .option('-i, --cidr <cidr>', $('the address space network mask in CIDR format'))
    .option('-s, --subscription <subscription>', $('the subscription identifier'))
  ...
  dnsserver.command('list [resource-group] [name]')
