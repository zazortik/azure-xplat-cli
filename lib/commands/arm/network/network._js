...
exports.init = function (cli) {
  ...
  loadBalancerLBRule.command('create <resource-group> <lb-name> <rule-name>')
    .description($('Adds a new load balancing rule to the list of lb rules configured for a load balancer'))
    .usage('[options] <resource-group> <lb-name> <rule-name>')
    .option('-p, --protocol <protocol>', $('protocol'))
    .option('-f, --frontendport <frontendport>', $('frontend port'))
    .option('-b, --backendport <backendport>', $('backend port'))
    .option('-e, --enable-floatingip <enable-floatingip>', $('enablefloating ip'))
    .option('-i, --idletimeout <idletimeout>', $('idle timeout'))
    .option('-n, --prob-name <prob-name>', $('prob name'))
    .option('-s, --subscription <subscription>', $('the subscription identifier'))
  ...
  loadBalancerLBRule.command('set <resource-group> <lb-name> <rule-name>')
    ...
    .option('-f, --frontendport <frontendport>', $('frontend port'))
    .option('-b, --backendport <backendport>', $('backend port'))
    .option('-e, --enable-floatingip <enable-floatingip>', $('enable floating ip'))
    .option('-i, --idletimeout <idletimeout>', $('idle timeout'))
    .option('-n, --prob-name <prob-name>', $('prob name'))
    .option('-s, --subscription <subscription>', $('the subscription identifier'))
    .execute(function (resourceGroup, lbName, ruleName, options, _) {
  ...
  loadBalancerLBRule.command('delete <resource-group> <lb-name> <rule-name>')
  ...
  loadBalancerFEIPConfig.command('create <resource-group> <lb-name> <ipconfig-name>')
    .description($('Update an existing load balancing rule configured for a load balancer'))
    .usage('[options] <resource-group> <lb-name> <ipconfig-name>')
  ...
  loadBalancerFEIPConfig.command('update <resource-group> <lb-name> <ipconfig-name>')
    .description($('Update an existing load balancing rule configured for a load balancer'))
    .usage('[options] <resource-group> <lb-name> <ipconfig-name>')
  ...
  loadBalancerFEIPConfig.command('delete <resource-group> <lb-name> <ipconfig-name>')
    .description($('Update an existing load balancing rule configured for a load balancer'))
    .usage('[options] <resource-group> <lb-name> <ipconfig-name>')
    .option('-q, --quiet', $('quiet mode, do not ask for delete confirmation'))
    .option('-s, --subscription <subscription>', $('the subscription identifier'))
  ...
  loadBalancerBackendAddressPool.command('update <resource-group> <lb-name> <pool-name>')
