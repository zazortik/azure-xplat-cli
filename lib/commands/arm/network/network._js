...
exports.init = function (cli) {
  ...
  dnsRecordSet.command('set [resource-group] [dns-zone-name] [name]')
  ...
  dnsRecordSet.command('show [resource-group] [dns-zone-name] [name]')
  ...
  dnsRecordSet.command('delete [resource-group] [dns-zone-name] [name]')
  ...
  dnsRecordSet.command('add-record [resource-group] [dns-zone-name] [record-set-name]')
  ...
  dnsRecordSet.command('delete-record [resource-group] [dns-zone-name] [record-set-name]')
