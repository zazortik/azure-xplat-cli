...
exports.init = function (cli) {
  ...
  subnet.command('create [resource-group] [vnet-name] [name]')
    .description($('Create virtual network subnet within a resource group'))
    ...
    .execute(function (resourceGroup, vnetName, name, options, _) {
      options.resourceGroup = cli.interaction.promptIfNotGiven($('Resource group name: '), resourceGroup, _);
      options.vnetName = cli.interaction.promptIfNotGiven($('The name of the virtual network: '), vnetName, _);
      options.name = cli.interaction.promptIfNotGiven($('The name of the virtual network: '), name, _);

      var networkClient = new NetworkClient(cli, options.subscription);
      networkClient.createSubnet(options, _);
    });
  ...
  subnet.command('set [resource-group] [vnet-name] [name]')
    ...
    .execute(function (resourceGroup, vnetName, name, options, _) {
      ...
      var networkClient = new NetworkClient(cli, options.subscription);
      networkClient.setSubnet(options, _);
    });
  ...
  subnet.command('list [resource-group] [vnet-name]')
    ...
    .execute(function (resourceGroup, vnetName, options, _) {
      options.resourceGroup = cli.interaction.promptIfNotGiven($('Resource group name: '), resourceGroup, _);
      options.vnetName = cli.interaction.promptIfNotGiven($('Virtual network name: '), vnetName, _);

      var networkClient = new NetworkClient(cli, options.subscription);
      networkClient.listSubnets(options, _);
    });

  subnet.command('show [resource-group] [vnet-name] [name]')
    .description($('Show details about a virtual network subnet'))
    .usage('[options] <resource-group> <vnet-name> <name>')
    .option('-g, --resource-group <resource-group>', $('the name of the resource group'))
    .option('-t, --vnet-name <vnet-name>', $('the name of the virtual network'))
    ...
    .execute(function (resourceGroup, vnetName, name, options, _) {
      options.resourceGroup = cli.interaction.promptIfNotGiven($('Resource group name: '), resourceGroup, _);
      options.vnetName = cli.interaction.promptIfNotGiven($('virtual network name: '), vnetName, _);
      options.name = cli.interaction.promptIfNotGiven($('subnet name: '), name, _);

      var networkClient = new NetworkClient(cli, options.subscription);
      networkClient.showSubnet(options, _);
    });
  ...
  subnet.command('delete [resource-group] [vnet-name] [name]')
    ...
    .execute(function (resourceGroup, vnetName, name, options, _) {
      ...
      var networkClient = new NetworkClient(cli, options.subscription);
      networkClient.deleteSubnet(options, _);
    });
  ...
  lb.command('show [resource-group] [name]')
    .description($('Show details about a load balancer'))
    .usage('[options] <resource-group> <name>')
    .option('-g, --resource-group <resource-group>', $('the resource group name'))
  ...
  lb.command('delete [resource-group] [name]')
    .description($('Delete one load balancer within a resource group'))
    .usage('[options] <resource-group> <name>')
    .option('-g, --resource-group <resource-group>', $('the resource group name'))
    .option('-n, --name <name>', $('the load balancer name'))
    .option('-q, --quiet', $('quiet mode, do not ask for delete confirmation'))
  ...
  probe.command('create [resource-group] [lb-name] [name]')
    ...
    .description($('Add a new probe to the list of probes in the load balancer'))
    .option('-g, --resource-group <resource-group>', $('the resource group name'))
  ...
  probe.command('list [resource-group] [lb-name]')
    ...
    .description($('List probes in the load balancer'))
    .option('-g, --resource-group <resource-group>', $('the resource group name'))
    .option('-b, --lb-name <lb-name>', $('the load balancer name'))
    .option('-s, --subscription <subscription>', $('the subscription identifier'))
  ...
  probe.command('delete [resource-group] [lb-name] [name]')
    .usage('[options] <resource-group> <lb-name> <name>')
    .description($('Delete a probe from list of probes in the load balancer'))
    .option('-g, --resource-group <resource-group>', $('the resource group name'))
    .option('-b, --lb-name <lb-name>', $('the load balancer name'))
    .option('-n, --name <name>', $('the probe name'))
    .option('-q, --quiet', $('quiet mode, do not ask for delete confirmation'))
  ...
  probe.command('set [resource-group] [lb-name] [name]')
    .usage('[options] <resource-group> <lb-name> <name>')
    .description($('Set an existing probe in the load balancer'))
    .option('-g, --resource-group <resource-group>', $('the resource group name'))
    .option('-b, --lb-name <lb-name>', $('the load balancer name'))
    .option('-n, --name <name>', $('the probe name'))
  ...
  loadBalancerLBRule.command('create [resource-group] [lb-name] [name]')
    .description($('Add a new load balancing rule to the list of lb rules configured for a load balancer'))
    .usage('[options] <resource-group> <lb-name> <name>')
    .option('-g, --resource-group <resource-group>', $('the resource group name'))
  ...
  loadBalancerLBRule.command('set [resource-group] [lb-name] [name]')
    .description($('Set an existing load balancing rule configured for a load balancer'))
    .usage('[options] <resource-group> <lb-name> <name>')
    .option('-g, --resource-group <resource-group>', $('the resource group name'))
    .option('-l, --lb-name <lb-name>', $('the name of the load balancer'))
    .option('-n, --name <name>', $('the name of the rule'))
  ...
  loadBalancerLBRule.command('delete [resource-group] [lb-name] [name]')
    .description($('Delete a load balancing rule from the list of load balancing rules configured for the load balancer'))
    .usage('[options] <resource-group> <lb-name> <name>')
    .option('-g, --resource-group <resource-group>', $('the resource group name'))
    .option('-l, --lb-name <lb-name>', $('the name of the load balancer'))
    .option('-n, --name <name>', $('the name of the rule'))
  ...
  inboundrule.command('create [resource-group] [lb-name] [name]')
    .usage('[options] <resource-group> <lb-name> <name>')
    .description($('Create inbound rule on a load balancer'))
    .option('-g, --resource-group <resource-group>', $('the name of the resource group'))
    .option('-l, --lb-name <lb-name>', $('the name of the load balancer'))
    ...
    .option('-m, --vm-name <vm-name>', $('the backend ip configuration name'))
    .option('-s, --subscription <subscription>', $('the subscription identifier'))
    .execute(function (resourceGroup, lbName, name, options, _) {
  ...
  inboundrule.command('set [resource-group] [lb-name] [name]')
    .usage('[options] <resource-group> <lb-name> <name>')
    .description($('Set an existing inbound rule on a load balancer'))
    .option('-g, --resource-group <resource-group>', $('the name of the resource group'))
    .option('-l, --lb-name <lb-name>', $('the name of the load balancer'))
    .option('-n, --name <name>', $('the name of the inbound NAT rule'))
    .option('-w, --new-name <new-name>', $('new inbound rule name'))
    .option('-p, --protocol <protocol>', $('the rule protocol'))
    .option('-f, --frontend-port <frontend-port>', $('the frontend port'))
    .option('-b, --backend-port <backend-port>', $('the backend port'))
    .option('-e, --enable-floating-ip <enable-floating-ip>', $('enable floating point ip'))
  ...
  inboundrule.command('delete [resource-group] [lb-name] [name]')
    .usage('[options] <resource-group> <lb-name> <name>')
    .description($('Delete inbound rule from a load balancer'))
    .option('-g, --resource-group <resource-group>', $('the name of the resource group'))
    .option('-l, --lb-name <lb-name>', $('the name of the load balancer'))
    .option('-n, --name <name>', $('the name of the inbound NAT rule'))
    .option('-s, --subscription <subscription>', $('the subscription identifier'))
  ...
  loadBalancerFEIPConfig.command('create [resource-group] [lb-name] [name]')
    .description($('Add a new frontend ip configuration to the list of frontend ipconfigurations defined for the load balancer'))
    .usage('[options] <resource-group> <lb-name> <name>')
    .option('-g, --resource-group <resource-group>', $('the name of the resource group'))
    .option('-l, --lb-name <lb-name>', $('the name of the load balancer'))
  ...
  loadBalancerFEIPConfig.command('set [resource-group] [lb-name] [name]')
    .description($('Set an existing frontend ip configuration in the list of frontend ip configuration defined for the load balancer'))
    .usage('[options] <resource-group> <lb-name> <name>')
    .option('-g, --resource-group <resource-group>', $('the name of the resource group'))
    .option('-l, --lb-name <lb-name>', $('the name of the load balancer'))
    .option('-n, --name <name>', $('the name of the frontend ip configuration'))
  ...
  loadBalancerFEIPConfig.command('delete [resource-group] [lb-name] [name]')
    .description($('Delete an existing frontend ip configuration from the list of frontend ip configurations defined for the load balancer'))
    .usage('[options] <resource-group> <lb-name> <name>')
    .option('-g, --resource-group <resource-group>', $('the name of the resource group'))
    .option('-l, --lb-name <lb-name>', $('the name of the load balancer'))
    .option('-n, --name <name>', $('the name of the frontend ip configuration'))
  ...
  loadBalancerBackendAddressPool.command('create [resource-group] [lb-name] [pool-name]')
    .description($('Add a new backend address pool to the list of backend address pool defined for the load balancer'))
    .usage('[options] <resource-group> <lb-name> <pool-name>')
    .option('-g, --resource-group <resource-group>', $('the name of the resource group'))
    .option('-l, --lb-name <lb-name>', $('the name of the load balancer'))
    .option('-n, --name <name>', $('the name of the backend address pool'))
    .option('-a, --vm-names <vm-names>', $('the comma separated list of vm names'))
    .option('-i, --vm-ids <vm-ids>', $('the comma separated list of vm ids'))
    .option('-s, --subscription <subscription>', $('the subscription identifier'))
    .execute(function (resourceGroup, lbName, name, options, _) {
      resourceGroup = cli.interaction.promptIfNotGiven($('Resource group name: '), resourceGroup, _);
      lbName = cli.interaction.promptIfNotGiven($('load balancer name: '), lbName, _);
  ...
  publicip.command('list [resource-group]')
    .description($('List the public ip addresses'))
    .usage('[options] <resource-group>')
    .option('-g, --resource-group <resource-group>', $('the resource group name'))
    .option('-s, --subscription <subscription>', $('the subscription identifier'))
    .execute(function (resourceGroup, options, _) {
  ...
  nic.command('create [resource-group] [name] [location]')
    .description($('Create a network interface card'))
    .usage('[options] <resource-group> <name> <location>')
    .option('-g, --resource-group <resource-group>', $('the resource group name'))
    .option('-n, --name <name>', $('the network interface card name'))
    .option('-l, --location <location>', $('the location'))
    .option('-a, --private-ip-address <private-ip-address>', $('the private ip address'))
    .option('-u, --subnet-id <subnet-id>', $('the subnet identifier, e.g. /subscriptions/<subscriptipn-id>/resourceGroups/<resource-group-name>/providers/Microsoft.Network/virtualNetworks/<vnet-name>/subnets/<subnet-name>'))
    ...
    .option('-i, --public-ip-id <public-ip-id>', $('the public ip address identifier, e.g. /subscriptions/<subscription-id>/resourceGroups/<resource-group-name>/providers/Microsoft.Network/publicIPAddresses/<public-ip-name>'))
    .option('-p, --public-ip-name <public-ip-name>', $('the public ip address name. This public ip must exists in the same resource group as the nic. Please use public-ip-id if that is not the case.'))
  ...
  nic.command('set [resource-group] [name]')
    .description($('Set a network interface card'))
    .usage('[options] <resource-group> <name>')
    .option('-g, --resource-group <resource-group>', $('the resource group name'))
    .option('-n, --name <name>', $('the network interface card name'))
    .option('-a, --private-ip-address <private-ip-address>', $('the private ip address'))
  ...
  nsg.command('list [resource-group]')
    .description($('List the network security groups'))
    .usage('[options] <resource-group>')
    .option('-g, --resource-group <resource-group>', $('the resource group name'))
    .option('-s, --subscription <subscription>', $('the subscription identifier'))
    .execute(function (resourceGroup, options, _) {
