...
exports.init = function (cli) {
  ...
  expressRoutePeering.command('create [resource-group] [circuit-name] [peering-name]')
    .description($('Create express route peering'))
    .usage('[options] <resource-group> <circuit-name> <peering-name>')
    .option('-g, --resource-group <resource-group>', $('the name of the resource group'))
    .option('-c, --circuit-name <circuit-name>', $('the name of the express route circuit'))
    .option('-n, --peering-name <peering-name>', $('the name of the express route circuit peering'))
    ...
    .option('-s, --subscription <subscription>', $('the subscription identifier'))
    .execute(function (resourceGroup, circuitName, peeringName, options, _) {
      resourceGroup = cli.interaction.promptIfNotGiven($('Resource group name: '), resourceGroup, _);
      circuitName = cli.interaction.promptIfNotGiven($('Express route circuit name: '), circuitName, _);
      peeringName = cli.interaction.promptIfNotGiven($('Express route peering name: '), peeringName, _);
      ...
      var networkManagementClient = getNetworkManagementClient(options);
      var expressRoute = new ExpressRoute(cli, networkManagementClient);
      expressRoute.createPeering(resourceGroup, circuitName, peeringName, options, _);
    });

  expressRoutePeering.command('set [resource-group] [circuit-name] [peering-name]')
    ...
    .execute(function (resourceGroup, circuitName, peeringName, options, _) {
      ...
      var networkManagementClient = getNetworkManagementClient(options);
      var expressRoute = new ExpressRoute(cli, networkManagementClient);
      expressRoute.setPeering(resourceGroup, circuitName, peeringName, options, _);
    });

  expressRoutePeering.command('show [resource-group] [circuit-name] [peering-name]')
    .description($('Get peering details'))
    .usage('[options] <resource-group> <circuit-name> <peering-name>')
    .option('-g, --resource-group <resource-group>', $('the name of the resource group'))
    .option('-c, --circuit-name <circuit-name>', $('the name of the express route circuit'))
    .option('-n, --peering-name <peering-name>', $('the name of the express route circuit express route peering'))
    .option('-s, --subscription <subscription>', $('the subscription identifier'))
    .execute(function (resourceGroup, circuitName, peeringName, options, _) {
      resourceGroup = cli.interaction.promptIfNotGiven($('Resource group name: '), resourceGroup, _);
      circuitName = cli.interaction.promptIfNotGiven($('Express route circuit name: '), circuitName, _);
      ...
      var networkManagementClient = getNetworkManagementClient(options);
      var expressRoute = new ExpressRoute(cli, networkManagementClient);
      expressRoute.showPeering(resourceGroup, circuitName, peeringName, options, _);
    });
  ...
  expressRoutePeering.command('delete [resource-group] [circuit-name] [peering-name]')
    ...
    .execute(function (resourceGroup, circuitName, peeringName, options, _) {
      ...
      var networkManagementClient = getNetworkManagementClient(options);
      var expressRoute = new ExpressRoute(cli, networkManagementClient);
      expressRoute.deletePeering(resourceGroup, circuitName, peeringName, options, _);
    });
