...
exports.init = function (cli) {
  ...
  subnet.command('create <resource-group> <vnet> <subnet-name>')
    ...
    .option('-g, --resource-group <resource-group>', $('the resource group name'))
    .option('-v, --vnet <vnet>', $('the virtual network name'))
    .option('-n, --subnet-name <subnet-name>')
    .option('-e, --address-prefix <ip4v>', $('the address prefix for the subnet'))
    .option('-m, --max-vm-count <max-vm-count>', $('the maximum number of VMs in the address space'))
  ...
  subnet.command('list <resource-group> <vnet>')
    ...
    .usage('[options] <resource-group> <vnet> ')
    .option('-g, --resource-group <resource-group>', $('the resource group name'))
    .option('-v, --vnet <vnet>', $('the virtual machine name'))
    .option('-s, --subscription <subscription>', $('the subscription identifier'))
    .execute(function (resourceGroup, vnet, options, _) {
      resourceGroup = cli.interaction.promptIfNotGiven($('Resource group name: '), resourceGroup, _);
      vnet = cli.interaction.promptIfNotGiven($('Virtual network name: '), vnet, _);
  ...
  subnet.command('show <resource-group> <vnet> <subnet-name>')
    ...
    .usage('[options] <resource-group> <vnet> <subnet-name>')
    .option('-g, --resource-group <resource-group>', $('the resource group name'))
    .option('-v, --vnet <vnet>', $('the network interface name'))
    .option('-n, --subnet-name <subnet-name>', $('the subnet name'))
    .option('-s, --subscription <subscription>', $('the subscription identifier'))
    .execute(function (resourceGroup, vnet, subnetName, options, _) {
      resourceGroup = cli.interaction.promptIfNotGiven($('Resource group name: '), resourceGroup, _);
      vnet = cli.interaction.promptIfNotGiven($('virtual network name: '), vnet, _);
  ...
  inboundrule.command('create <resource-group> <lb-name> <inbound-rule-name>')
    .usage('[options] <resource-group> <lb-name> <inbound-rule-name>')
    ...
    .option('-i, --frontend-ipconfig-names <frontend-ipconfig-names>', $('comma separated list of frontend ip configuration names defined in the same load balancer'))
    .option('-d, --backend-ipconfig-id <backend-ipconfig-id>', $('the backend ip configuration identifier'))
    .option('-h, --backend-ipconfig-name <backend-ipconfig-name>', $('the backend ip configuration name'))
    .option('-c, --backend-ipconfig-nic-name <backend-ipconfig-nic-name>', $('the name of the network interface card where backend ip configuration is defined'))
    .option('-r, --backend-ipconfig-nic-resource-group <backend-ipconfig-nic-resource-group>', $('the resource group under which nic with backend ip config is defined'))
    .option('-s, --subscription <subscription>', $('the subscription identifier'))
  ...
  inboundrule.command('set <resource-group> <lb-name> <inbound-rule-name>')
    .usage('[options] <resource-group> <lb-name> <inbound-rule-name>')
    .description($('Updates inbound rule to load balancer'))
    .option('-g, --resource-group <resource-group>', $('the resource group name'))
    .option('-l, --lb-name <lb-name>', $('the load balancer name'))
    .option('-n, --inbound-rule-name <inboundrule-name>', $('the inbound rule name'))
    .option('-n, --new-inbound-rule-name <new-inbound-rule-name>', $('new inbound rule name'))
  ...
  inboundrule.command('delete <resource-group> <lb-name> <inbound-rule-name>')
    .usage('[options] <resource-group> <lb-name> <inbound-rule-name>')
    .description($('Deletes inbound rule to load balancer'))
    .option('-g, --resource-group <resource-group>', $('the resource group name'))
    .option('-l, --lb-name <lb-name>', $('the load balancer name'))
    .option('-n, --inbound-rule-name <inbound-rule-name>', $('the inbound rule name'))
    .option('-q, --quiet', $('quiet mode, do not ask for delete confirmation'))
    .option('-s, --subscription <subscription>', $('the subscription identifier'))
    .execute(function (resourceGroup, lbName, inboundRuleName, options, _) {
      resourceGroup = cli.interaction.promptIfNotGiven($('Resource group name: '), resourceGroup, _);
