...
exports.init = function (cli) {
  ...
  appGatewaySslCert.command('list [resource-group] [gateway-name]')
    ...
    .execute(function(resourceGroup, gatewayName, options, _) {
      ...
      var networkManagementClient = getNetworkManagementClient(options);
      var appGateway = new AppGateway(cli, networkManagementClient);
      appGateway.listSsl(resourceGroup, gatewayName, options, _);
    });
  ...
  appGatewayFrontendIp.command('list [resource-group] [gateway-name]')
    ...
    .execute(function(resourceGroup, gatewayName, options, _) {
      ...
      var networkManagementClient = getNetworkManagementClient(options);
      var appGateway = new AppGateway(cli, networkManagementClient);
      appGateway.listFrontendIp(resourceGroup, gatewayName, options, _);
    });
  ...
  var appGatewayMapRule = appGatewayUrlPathMap.category('rule')
    .description('Commands to manage application gateway url path map rules');

  appGatewayMapRule.command('create [resource-group] [gateway-name] [name]')
  ...
  appGatewayMapRule.command('set [resource-group] [gateway-name] [name]')
  ...
  appGatewayMapRule.command('show [resource-group] [gateway-name] [url-path-map-name] [name]')
  ...
  appGatewayMapRule.command('list [resource-group] [gateway-name] [url-path-map-name]')
  ...
  appGatewayMapRule.command('delete [resource-group] [gateway-name] [name]')
