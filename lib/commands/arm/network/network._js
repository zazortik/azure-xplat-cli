...
exports.init = function (cli) {
  ...
  vnet.command('export <resource-group> <vnet-name> <file-path>')
    .description('Exports Virtual Networks configuration to a file')
    .usage('[options] <resource-group> <vnet-name> <file-path>')
    .option('-s, --subscription <subscription>', $('the subscription identifier'))
  ...
  vnet.command('import <resource-group> <vnet-name> <file-path>')
  ...
  loadbalancer.command('list [resource-group]')
  ...
  loadbalancer.command('show [resource-group] [name]')
  ...
  loadbalancer.command('delete [resource-group] [name]')
  ...
  loadbalancer.command('export <resource-group> <name> [file-path]')
    .description($('Exports the load balancer configuration to a file'))
    .usage('[options] <resource-group> <name> <file-path>')
    .option('-s, --subscription <subscription>', $('the subscription identifier'))
  ...
  loadbalancer.command('import <resource-group> <name> [file-path]')
  ...
  var loadBalancerLBRule = loadbalancer.category('lbrule')
  ...
  var loadBalancerFEIPConfig = loadbalancer.category('frontend-ipconfig')
  ...
  var loadBalancerBackendAddressPool = loadbalancer.category('backend-addresspool')
  ...
  var outboundrule = loadbalancer.category('outboundrule')
