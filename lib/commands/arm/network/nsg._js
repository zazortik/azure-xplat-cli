...
function Nsg(cli, networkResourceProviderClient) {
  ...
  this.DEFAULT_PROTOCOL = Constants.protocols[0];
  ...
  this.DEFAULT_ACCESS = Constants.accessModesList[0];
  this.DEFAULT_DIRECTION = Constants.directionModesList[0];
  this.DEFAULT_PRIORITY = Constants.priorityBoundsList[0];
}
...
__.extend(Nsg.prototype, {
  ...
  _parseAndValidateSecurityRule: function (params, useDefaults) {
    ...
    var accessTypes = Constants.accessModesList;
    var directions = Constants.directionModesList;
    var priorityRange = Constants.priorityBoundsList;
  ...
  _parsePortRange: function (port, portType) {
    ...
    var portRange = Constants.portBoundsList;
