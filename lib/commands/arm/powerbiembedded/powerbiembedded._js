...
* c. Run 'node bin/azure', you should see 'powerbiembedded' listed as a command set
...
exports.init = function (cli) {
  ...
  var powerbiembeddedcli = cli.category('powerbiembedded')
  ...
  powerbiembeddedcli.command('create <resourceGroup> <name> [location] [tags]')
    ...
    .option('-l --location [locatio]>', $('The location (azure region/datacenter) where the workspace collection will be provisioned'))
