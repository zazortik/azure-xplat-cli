...
exports.init = function(cli) {
  ...
  profiles.command('show [name] [resource-group]')
    ...
    .execute(function(name, resourceGroup, options, _) {
      ...
      var result, response;
      try {
        callbackArgs = client.profiles.get(name, resourceGroup, [_]);
  ...
  profiles.command('create [name] [resource-group] [location] [sku-name]')
    ...
    .execute(function(name, resourceGroup, location, skuName, options, _) {
      ...
      var result, response;
      try {
        callbackArgs = client.profiles.create(name, creationParameter, resourceGroup, [_]);
        result = callbackArgs[0];
        response = callbackArgs[2];
      } catch (e) {
        throw e;
  ...
  profiles.command('delete [name] [resource-group]')
    ...
    .execute(function(name, resourceGroup, options, _) {
      ...
      var result, response;
      try {
        callbackArgs = client.profiles.deleteIfExists(name, resourceGroup, [_]);
        result = callbackArgs[0];
        response = callbackArgs[2];
      } finally {
        progress.end();
  ...
  profiles.command('set [name] [resource-group]')
    ...
    .execute(function(name, resourceGroup, options, _) {
      ...
      var result, response;
      try {
        callbackArgs = client.profiles.update(name, resourceGroup, tags, [_]);
        result = callbackArgs[0];
        response = callbackArgs[2];
      } catch (e) {
        throw e;
  ...
  ssoUri.command('create [profile-name] [resource-group]')
    ...
    .execute(function(profileName, resourceGroup, options, _) {
      ...
      var result, response;
      try {
        callbackArgs = client.profiles.generateSsoUri(profileName, resourceGroup, [_]);
        result = callbackArgs[0];
        response = callbackArgs[2];
      } catch (e) {
        throw e;
  ...
  endpoint.command('list [profile-name] [resource-group]')
    ...
    .execute(function(profileName, resourceGroup, options, _) {
      ...
      var result, response;
      try {
        callbackArgs = client.endpoints.listByProfile(profileName, resourceGroup, [_]);
        result = callbackArgs[0];
        response = callbackArgs[2];
      } catch (e) {
        throw e;
  ...
  endpoint.command('show [name] [profile-name] [resource-group]')
    ...
    .execute(function(name, profileName, resourceGroup, options, _) {
      ...
      var result, response;
      try {
        callbackArgs = client.endpoints.get(name, profileName, resourceGroup, [_]);
        result = callbackArgs[0];
        response = callbackArgs[2];
      } catch (e) {
        throw e;
  ...
  endpoint.command('create [name] [profile-name] [resource-group] [location] [origin-name] [origin-host-name]')
    ...
    .execute(function(name, profileName, resourceGroup, location, originName, originHostName, options, _) {
      ...
      var result, response;
      try {
        callbackArgs = client.endpoints.create(name, endpointCreateParameters, profileName, resourceGroup, [_]);
        result = callbackArgs[0];
        response = callbackArgs[2];
      } catch (e) {
        throw e;
  ...
  endpoint.command('set [name] [profile-name] [resource-group]')
    ...
    .execute(function(name, profileName, resourceGroup, options, _) {
      ...
      var result, response;
      try {
        callbackArgs = client.endpoints.update(name, endpointUpdateParameters, profileName, resourceGroup, [_]);
        result = callbackArgs[0];
        response = callbackArgs[2];
      } catch (e) {
        throw e;
  ...
  endpoint.command('delete [name] [profile-name] [resource-group]')
    ...
    .execute(function(name, profileName, resourceGroup, options, _) {
      ...
      var result, response;
      try {
        callbackArgs = client.endpoints.deleteIfExists(name, profileName, resourceGroup, [_]);
        result = callbackArgs[0];
        response = callbackArgs[2];
      } catch (e) {
        throw e;
  ...
  endpoint.command('start [name] [profile-name] [resource-group]')
    ...
    .execute(function(name, profileName, resourceGroup, options, _) {
      ...
      var result, response;
      try {
        callbackArgs = client.endpoints.start(name, profileName, resourceGroup, [_]);
        result = callbackArgs[0];
        response = callbackArgs[2];
      } catch (e) {
        throw e;
  ...
  endpoint.command('stop [name] [profile-name] [resource-group]')
    ...
    .execute(function(name, profileName, resourceGroup, options, _) {
      ...
      var result, response;
      try {
        callbackArgs = client.endpoints.stop(name, profileName, resourceGroup, [_]);
        result = callbackArgs[0];
        response = callbackArgs[2];
      } catch (e) {
        throw e;
  ...
  endpoint.command('purge [name] [profile-name] [resource-group] [content-paths]')
    ...
    .execute(function(name, profileName, resourceGroup, contentPaths, options, _) {
      ...
      var result, response;
      try {
        callbackArgs = client.endpoints.purgeContent(name, profileName, resourceGroup, parsedContentPaths, [_]);
        result = callbackArgs[0];
        response = callbackArgs[2];
      } catch (e) {
        throw e;
  ...
  endpoint.command('load [name] [profile-name] [resource-group] [content-paths]')
    ...
    .execute(function(name, profileName, resourceGroup, contentPaths, options, _) {
      ...
      var result, response;
      try {
        callbackArgs = client.endpoints.loadContent(name, profileName, resourceGroup, parsedContentPaths, [_]);
        result = callbackArgs[0];
        response = callbackArgs[2];
      } catch (e) {
        throw e;
  ...
  endpoint.command('check [endpoint-name]')
    ...
    .execute(function(endpointName, options, _) {
      ...
      var result, response;
      try {
        callbackArgs = client.nameAvailability.checkNameAvailability(endpointName, 'Microsoft.Cdn/Profiles/Endpoints', [_]);
        result = callbackArgs[0];
        response = callbackArgs[2];
      } catch (e) {
        throw e;
  ...
  origin.command('show [name] [endpoint-name] [profile-name] [resource-group]')
    ...
    .execute(function(name, endpointName, profileName, resourceGroup, options, _) {
      ...
      var result, response;
      try {
        callbackArgs = client.origins.get(name, endpointName, profileName, resourceGroup, [_]);
        result = callbackArgs[0];
        response = callbackArgs[2];
      } catch (e) {
        throw e;
  ...
  origin.command('set [name] [endpoint-name] [profile-name] [resource-group]')
    ...
    .execute(function(name, endpointName, profileName, resourceGroup, options, _) {
      ...
      var result, response;
      try {
        callbackArgs = client.origins.update(name, originUpdateParameter, endpointName, profileName, resourceGroup, [_]);
        result = callbackArgs[0];
        response = callbackArgs[2];
      } catch (e) {
        throw e;
  ...
  customDomain.command('list [endpoint-name] [profile-name] [resource-group]')
    ...
    .execute(function(endpointName, profileName, resourceGroup, options, _) {
      ...
      var result, response;
      try {
        callbackArgs = client.customDomains.listByEndpoint(endpointName, profileName, resourceGroup, [_]);
        result = callbackArgs[0];
        response = callbackArgs[2];
      } catch (e) {
        throw e;
  ...
  customDomain.command('show [name] [endpoint-name] [profile-name] [resource-group]')
    ...
    .execute(function(name, endpointName, profileName, resourceGroup, options, _) {
      ...
      var result, response;
      try {
        callbackArgs = client.customDomains.get(name, endpointName, profileName, resourceGroup, [_]);
        result = callbackArgs[0];
        response = callbackArgs[2];
      } catch (e) {
        throw e;
  ...
  customDomain.command('create [name] [endpoint-name] [profile-name] [resource-group] [custom-domain-host-name]')
    ...
    .execute(function(name, endpointName, profileName, resourceGroup, customDomainHostName, options, _) {
      ...
      var result, response;
      try {
        callbackArgs = client.customDomains.create(name, endpointName, profileName, resourceGroup, customDomainHostName, [_]);
        result = callbackArgs[0];
        response = callbackArgs[2];
      } catch (e) {
        throw e;
  ...
  customDomain.command('delete [name] [endpoint-name] [profile-name] [resource-group]')
    ...
    .execute(function(name, endpointName, profileName, resourceGroup, options, _) {
      ...
      var result, response;
      try {
        callbackArgs = client.customDomains.deleteIfExists(name, endpointName, profileName, resourceGroup, [_]);
        result = callbackArgs[0];
        response = callbackArgs[2];
      } catch (e) {
        throw e;
  ...
  customDomain.command('validate [endpoint-name] [profile-name] [resource-group] [custom-domain-host-name]')
    ...
    .execute(function(endpointName, profileName, resourceGroup, customDomainHostName, options, _) {
      ...
      var result, response;
      try {
        callbackArgs = client.endpoints.validateCustomDomain(endpointName, profileName, resourceGroup, customDomainHostName, [_]);
        result = callbackArgs[0];
        response = callbackArgs[2];
      } catch (e) {
        throw e;
