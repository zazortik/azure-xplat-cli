...
exports.init = function(cli) {
  ...
  endpoint.command('purge <endpoint-name> <profile-name> <resource-group> <content-paths>')
    ...
    .execute(function(endpointName, profileName, resourceGroup, contentPaths, options, _) {
      ...
      var result, response;
      try {
        callbackArgs = client.endpoints.purgeContent(options.endpointName, options.profileName, options.resourceGroup, parsedContentPaths, [_]);
        result = callbackArgs[0];
        response = callbackArgs[2];
      } catch (e) {
        throw e;
  ...
  endpoint.command('load <endpoint-name> <profile-name> <resource-group> <content-paths>')
    ...
    .execute(function(endpointName, profileName, resourceGroup, contentPaths, options, _) {
      ...
      var result, response;
      try {
        callbackArgs = client.endpoints.loadContent(options.endpointName, options.profileName, options.resourceGroup, parsedContentPaths, [_]);
        result = callbackArgs[0];
        response = callbackArgs[2];
      } catch (e) {
        throw e;
