...
__.extend(VMStorageProfile.prototype, {
        ...
        _createStorageAccountIfRequired: function (_) {
          ...
          if (!utils.stringIsNullOrEmpty(this.params.storageAccountName)) {
            ...
            var r = this._findStorageAccount(storageInfo.storageAccountName, _);
            if (r) {
              storageInfo.profile = r.storageAccount;
            ...
            var r1 = this._getFirstStorageAccount(this.params.location, _);
            if (r1) {
              storageInfo.profile = r1.storageAccount;
