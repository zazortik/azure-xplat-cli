...
__.extend(VMStorageProfile.prototype, {
        ...
        generateDataDiskProfile: function(_) {
          var dataDiskInfo = this._parseDataDiskParams(this.params, _);
        ...
        _parseOSDataDiskImageParams: function (params, _) {
            ...
            if (params.imageName) {
              ...
              if (!params.subscriptionId) {
                params.subscriptionId = this.cli.interaction.prompt($('Enter subscription ID: '), _);
              }
            ...
            osDiskDataDiskImageInfo.dataDiskInfo = this._parseDataDiskParams(params, _);
        ...
        _parseDataDiskParams: function(params, _) {
