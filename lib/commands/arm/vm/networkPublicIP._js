...
__.extend(NetworkPublicIP.prototype, {
    ...
    getPublicIPExpanded: function (referenceUri, depth, memoize, dependencies, _) {
      ...
      var pIP = this._getPublicIP(resourceInfo.resourceGroupName, resourceInfo.resourceName, _);
      if (depth === 0 || pIP === null) {
        return pIP;
      }
