...
__.extend(VMImage.prototype, {
  ...
  _getVMImageListForPublisherOfferAndSkus: function (imageFilter, _) {
    ...
    var images = this.getVMImageListForSku(imageFilter.location, imageFilter.publishername, imageFilter.offer, imageFilter.skus, _);
    var imageQueries = [];
  ...
  _getVMImageListForPublisherAndOffer: function (imageFilter, _) {
    ...
    var skusCollection = this.getVMImageSkusList(imageFilter.location, imageFilter.publishername, imageFilter.offer, _);
    imageQueries = [];
