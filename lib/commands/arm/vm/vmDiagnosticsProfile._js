...
__.extend(VMDiagnosticsProfile.prototype, {
  ...
  updateDiagnosticsProfile: function(diagnosticsProfile) {
    if (!utils.stringIsNullOrEmpty(this.params.enableBootDiagnostics)
     || !utils.stringIsNullOrEmpty(this.params.bootDiagnosticsStorageUri)) {
  ...
  _parseDiagnosticsProfileParams: function(params) {
    ...
    requestProfile.bootDiagnostics = this._parseBootDiagnosticsParams(this.params);
