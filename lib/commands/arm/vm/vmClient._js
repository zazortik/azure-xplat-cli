...
__.extend(VMClient.prototype, {
  ...
  showAzureDiskEncryptionStatus: function(resourceGroupName, name, options, _) {
    ...
    if(vmModel.virtualMachine.storageProfile.oSDisk.encryptionSettings)
    {
      ...
      try {	  
        extensionStatus = serviceClients.computeManagementClient.virtualMachineExtensions.getWithInstanceView(resourceGroupName, name, vmConstants.EXTENSIONS.AZURE_DISK_ENCRYPTION_WINDOWS_EXTENSION_NAME, _);
      }
      catch (e) {
