...
__.extend(VMClient.prototype, {
  ...
  setVM: function(resourceGroupName, name, options, _) {
    ...
    if (vmResult.storageProfile.osDisk) {
      if (vmResult.storageProfile.osDisk.createOption === 'FromImage') {
        vmResult.storageProfile.osDisk.createOption = 'fromImage';
      }
      else if (vmResult.storageProfile.osDisk.createOption === 'Attach') {
        vmResult.storageProfile.osDisk.createOption = 'attach';
      }
      else if (vmResult.storageProfile.osDisk.createOption === 'Empty') {
        vmResult.storageProfile.osDisk.createOption = 'empty';
      }
    }
