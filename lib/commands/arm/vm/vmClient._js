...
__.extend(VMClient.prototype, {
  createVM: function (resourceGroupName, vmName, location, osType, options, _) {
    ...
    vmResult = virtualMachine.getVM(resourceGroupName, params.vmName, _);
    if (!params.disableBginfoExtension && vmResult && vmResult.virtualMachine.storageProfile.oSDisk.operatingSystemType === 'Windows') {
      var bgInfoParams = {
      ...
      var vmBgInfoExtension = vmExtensionProfile.generateVMBgInfoExtensionProfile(_);
