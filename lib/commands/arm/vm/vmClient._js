...
__.extend(VMClient.prototype, {
  ...
  setAzureDiskEncryption: function(resourceGroupName, name, options, _) {
    ...
    var extensionResult = serviceClients.computeManagementClient.virtualMachineExtensions.getWithInstanceView(resourceGroupName, name, vmConstants.EXTENSIONS.AZURE_DISK_ENCRYPTION_WINDOWS_EXTENSION_NAME, _);
      // handle the Linux case.
    var publisherMismatch = false;
    var extensionName = "";
    if (utils.ignoreCaseEquals(params.osType, 'Linux')) {
        publisherMismatch = !utils.ignoreCaseEquals(extensionResult.virtualMachineExtension.publisher, vmConstants.EXTENSIONS.AZURE_DISK_ENCRYPTION_LINUX_EXTENSION_PUBLISHER) ||
       !utils.ignoreCaseEquals(extensionResult.virtualMachineExtension.extensionType, vmConstants.EXTENSIONS.AZURE_DISK_ENCRYPTION_LINUX_EXTENSION_NAME);
        ...
        publisherMismatch = !utils.ignoreCaseEquals(extensionResult.virtualMachineExtension.publisher, vmConstants.EXTENSIONS.AZURE_DISK_ENCRYPTION_WINDOWS_EXTENSION_PUBLISHER) ||
       !utils.ignoreCaseEquals(extensionResult.virtualMachineExtension.extensionType, vmConstants.EXTENSIONS.AZURE_DISK_ENCRYPTION_WINDOWS_EXTENSION_NAME);
  ...
  showAzureDiskEncryptionStatus: function(resourceGroupName, name, options, _) {
    ...
    if(vmModel.virtualMachine.storageProfile.oSDisk.encryptionSettings)
    {
      ...
      try {	  
        var extensionStatus = serviceClients.computeManagementClient.virtualMachineExtensions.getWithInstanceView(resourceGroupName, name, vmConstants.EXTENSIONS.AZURE_DISK_ENCRYPTION_WINDOWS_EXTENSION_NAME, _);
      }
      catch (e) {
      ...
      if (utils.ignoreCaseEquals(vmModel.virtualMachine.storageProfile.oSDisk.osType, 'Linux')) {
          publisherMatches = utils.ignoreCaseEquals(extensionStatus.virtualMachineExtension.publisher, vmConstants.EXTENSIONS.AZURE_DISK_ENCRYPTION_WINDOWS_EXTENSION_PUBLISHER) &&
          utils.ignoreCaseEquals(extensionStatus.virtualMachineExtension.extensionType, vmConstants.EXTENSIONS.AZURE_DISK_ENCRYPTION_WINDOWS_EXTENSION_NAME);
      }
      else if (utils.ignoreCaseEquals(vmModel.virtualMachine.storageProfile.oSDisk.osType, 'Windows')) {
          publisherMatches = utils.ignoreCaseEquals(extensionStatus.virtualMachineExtension.publisher, vmConstants.EXTENSIONS.AZURE_DISK_ENCRYPTION_LINUX_EXTENSION_PUBLISHER) &&
          utils.ignoreCaseEquals(extensionStatus.virtualMachineExtension.extensionType, vmConstants.EXTENSIONS.AZURE_DISK_ENCRYPTION_LINUX_EXTENSION_NAME);
      }
      if((extensionStatus) &&
      ...
      {
        if(utils.ignoreCaseEquals(extensionStatus.virtualMachineExtension.settings.VolumeType , 'All') ||
           utils.ignoreCaseEquals(extensionStatus.virtualMachineExtension.settings.VolumeType , 'Data') ||
           (utils.stringIsNullOrEmpty(extensionStatus.virtualMachineExtension.publicSettings.volumeType)))
        {
