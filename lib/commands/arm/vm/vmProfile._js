  ...
  generateVMProfile: function(_) {
    ...
    if (this.params.disableBootDiagnostics !== null || this.params.enableBootDiagnostics !== null || this.params.bootDiagnosticsStorageUri !== null) {
      if (this.params.enableBootDiagnostics && this.params.bootDiagnosticsStorageUri == null) {
        if (storageProfileResult.storageAccountInfo && storageProfileResult.storageAccountInfo.profile) {
          var stoProfile = storageProfileResult.storageAccountInfo.profile;
          if (stoProfile.primaryEndpoints && stoProfile.primaryEndpoints.blob) {
            this.params.bootDiagnosticsStorageUri = storageProfileResult.storageAccountInfo.profile.primaryEndpoints.blob;
          }
        }
      }
