...
__.extend(NetworkVNetSubnet.prototype, {
    ...
    getSubnetExpanded: function (referenceUri, depth, memoize, dependencies, _) {
      ...
      var snet = this._getSubnet(resourceInfo.resourceGroupName, parentVnetName, resourceInfo.resourceName, _);
      if (depth === 0 || snet === null) {
        return snet;
      }
