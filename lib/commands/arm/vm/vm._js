...
exports.init = function (cli) {
  ...
  vm.command('list-ip-address')
    .description($('Get all virtual machines and their corresponding IP address'))
    .usage('[options]')
    .option('-g, --resource-group <resource-group>', $('the resource group name'))
    .option('-s, --subscription <subscription>', $('the subscription identifier'))
    .execute(function (resourceGroup, options, _) {
    ...
    extension.command('set [resource-group] [vm-name] [name] [publisher-name] [version]')
      ...
      .option('-U, --auto-upgrade-minor-version', $('Enable auto-upgrade across minor version'))
      .option('-s, --subscription <id>', $('the subscription id'))
