...
exports.init = function (cli) {
  ...
  vm.command('create [resource-group] [name] [location] [os-type]')
    ...
    .option('--encryption-key-vault-id <disk-encryption-key-vault-id>', $('The OS disk encryption key vault ID.'))
    .option('--encryption-key-secret-url <disk-encryption-key-secret-url>', $('The OS disk encryption key secret URL.'))
    .option('--encryption-master-key-vault-id <key-encryption-key-vault-id>', $('The vault reference Url for the OS disk encryption key.'))
    .option('--encryption-master-key-url <key-encryption-key-url>', $('The Url of the master key used to encrypt the OS disk encryption key.'))
