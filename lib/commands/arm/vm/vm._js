...
exports.init = function (cli) {
  ...
  vm.command('enable-disk-encryption [resource-group] [name]')
    ...
    .option('-k, --disk-encryption-keyvault-url <disk-encryption-keyvault-url>', $('URL of the KeyVault where generated encryption key will be placed to'))
	.option('-r, --disk-encryption-keyvault-id <disk-encryption-keyvault-id>', $('ResourceID of the KeyVault where generated encryption key will be placed to'))
	...
	.option('-i, --key-encryption-keyvault-id <key-encryption-keyvault-id>', $('ResourceID of the KeyVault containing the KeyEncryptionKey used to encrypt the disk encryption key'))
	...
	.option('-v, --volume-type <volume-type>', $('Type of the volume OS or Data or All to perform encryption operation'))
    .option('-q, --sequence-version <sequence-version>', $('Sequence version of encryption operation. This must be incremented to perform repeated encryption operations on the same VM'))
