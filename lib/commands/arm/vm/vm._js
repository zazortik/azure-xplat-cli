...
exports.init = function (cli) {
  ...
  vm.command('create [resource-group] [name] [location] [os-type]')
    ...
    .option('--disk-encryption-key-vault-id <disk-encryption-key-vault-id>', $('The disk encryption key vault ID.'))
    .option('--disk-encryption-key-secret-url <disk-encryption-key-secret-url>', $('The disk encryption key secret URL.'))
    .option('--key-encryption-key-vault-id <key-encryption-key-vault-id>', $('The key encryption key vault ID.'))
    .option('--key-encryption-key-url <key-encryption-key-url>', $('The key encryption key URL.'))
