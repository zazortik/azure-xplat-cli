...
exports.init = function (cli) {
  ...
  extension.command('list-publishers [location]')
  ...
  extension.command('list-types [location] [publisher]')
  ...
  extension.command('list-versions [location] [publisher] [typeName]')
      ...
      .option('-l, --location <location>', $('the location'))
      .option('-p, --publisher <publisher>', $('the publisher name'))
      .option('-p, --typeName <typeName>', $('the type name'))
      .option('-s, --subscription <subscription>', $('the subscription identifier'))
