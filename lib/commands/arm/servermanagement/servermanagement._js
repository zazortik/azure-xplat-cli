...
exports.init = function(cli) {
  ...
  gateway.command('create [resource-group] [location] [gateway-name]')
    .description($('Create a server management gateway'))
    .usage('[options] <resource-group> <location> <gateway-name>')
  ...
  gateway.command('show <resource-group> <gateway-name>')
  ...
  gateway.command('delete <resource-group> <gateway-name>')
  ...
  node.command('create [resource-group] [location] [gateway-name] [node-name]')
    .description($('Create a server management node'))
    .usage('[options] <resource-group> <location> <gateway-name> <node-name>')
    .option(help.resourceGroup.option, $(help.resourceGroup.description))
    .option(help.location.option, $(help.location.description))
    .option(help.gatewayName.option, $(help.gatewayName.description))
  ...
  node.command('show <resource-group> <node-name>')
    .description($('Show node information'))
    .usage('[options] <resource-group> <node-name>')
    .option(help.resourceGroup.option, $(help.resourceGroup.description))
    .option(help.nodeName.option, $(help.nodeName.description))
    .option(help.subscription.option, $(help.subscription.description))
  ...
  node.command('delete <resource-group> <node-name>')
  ...
  session.command('create [resource-group] [node-name] [session-name]')
    ...
    .execute(function(resourceGroup, nodeName, sessionName, options, _) {
      ...
      if (!sessionName) {
        return cli.missingArgument('session-name');
      }
      if (!options.userName) {
        return cli.missingArgument('user-name');
      }
  ...
  session.command('show <resource-group> <node-name> <session-name>')
    .description($('Show detailed session information'))
    .usage('[options] <resource-group> <session-name>')
    .option(help.resourceGroup.option, $(help.resourceGroup.description))
    .option(help.nodeName.option, $(help.nodeName.description))
    .option(help.sessionName.option, $(help.sessionName.description))
    .option(help.subscription.option, $(help.subscription.description))
  ...
  session.command('delete <resource-group> <session-name>')
