      ...
      switch (itemType.toLowerCase()) {
        case 'database':
         ...
         case 'schema':
          if(isList) {
            ...
            toReturn.push(client.catalog.getSchema(resourceGroup, accountName, catalogItem.databaseName, catalogItem.schemaAssemblyOrExternalDataSourceName, _).schema);
          }
          break;
        case 'secret':
          if(isList) {
            ...
            toReturn.push(client.catalog.getSecret(resourceGroup, accountName, catalogItem.databaseName, catalogItem.schemaAssemblyOrExternalDataSourceName, _).secret);
          }
          break;
        ...
        case 'assembly':
          if(isList) {
            ...
            toReturn.push(client.catalog.getAssembly(resourceGroup, accountName, catalogItem.databaseName, catalogItem.schemaAssemblyOrExternalDataSourceName, _).assembly);
          }
          break;
        case 'externaldatasource':
          if(isList) {
            toReturn = client.catalog.listExternalDataSources(resourceGroup, accountName, catalogItem.databaseName, _).externalDataSourceList.value;
          }
          else {
            toReturn.push(client.catalog.getExternalDataSource(resourceGroup, accountName, catalogItem.databaseName, catalogItem.schemaAssemblyOrExternalDataSourceName, _).externalDataSource);
          }
          break;
        case 'credential':
          if(isList) {
            toReturn = client.catalog.listCredentials(resourceGroup, accountName, catalogItem.databaseName, _).credentialList.value;
          }
          else {
            toReturn.push(client.catalog.getCredential(resourceGroup, accountName, catalogItem.databaseName, catalogItem.schemaAssemblyOrExternalDataSourceName, _).credential);
          }
          break;
        case 'table':
          if(isList) {
            toReturn = client.catalog.listTables(resourceGroup, accountName, catalogItem.databaseName, catalogItem.schemaAssemblyOrExternalDataSourceName, _).tableList.value;
          }
          else {
            toReturn.push(client.catalog.getTable(resourceGroup, accountName, catalogItem.databaseName, catalogItem.schemaAssemblyOrExternalDataSourceName, catalogItem.tableOrTableValuedFunctionName, _).table);
          }
          break;
        case 'tablevaluedfunction':
          if(isList) {
            toReturn = client.catalog.listTableValuedFunctions(resourceGroup, accountName, catalogItem.databaseName, catalogItem.schemaAssemblyOrExternalDataSourceName, _).tableValuedFunctionList.value;
          }
          else {
            toReturn.push(client.catalog.getTableValuedFunction(resourceGroup, accountName, catalogItem.databaseName, catalogItem.schemaAssemblyOrExternalDataSourceName, catalogItem.tableOrTableValuedFunctionName, _).tableValuedFunction);
          }
          break;
        case 'tablestatistics':
          if(isList) {
            toReturn = client.catalog.listTableStatistics(resourceGroup, accountName, catalogItem.databaseName, catalogItem.schemaAssemblyOrExternalDataSourceName, catalogItem.tableOrTableValuedFunctionName, _).statisticsList.value;
          }
          else {
            toReturn.push(client.catalog.getTableStatistic(resourceGroup, accountName, catalogItem.databaseName, catalogItem.schemaAssemblyOrExternalDataSourceName, catalogItem.tableOrTableValuedFunctionName, catalogItem.tableStatisticsName, _).statistics);
          }
          break;
        case 'view':
          if(isList) {
            toReturn = client.catalog.listViews(resourceGroup, accountName, catalogItem.databaseName, catalogItem.schemaAssemblyOrExternalDataSourceName, _).viewList.value;
          }
          else {
            toReturn.push(client.catalog.getView(resourceGroup, accountName, catalogItem.databaseName, catalogItem.schemaAssemblyOrExternalDataSourceName, catalogItem.tableOrTableValuedFunctionName, _).view);
          }
          break;
        case 'procedure':
          if(isList) {
            toReturn = client.catalog.listProcedures(resourceGroup, accountName, catalogItem.databaseName, catalogItem.schemaAssemblyOrExternalDataSourceName, _).procedureList.value;
          }
          else {
            toReturn.push(client.catalog.getProcedure(resourceGroup, accountName, catalogItem.databaseName, catalogItem.schemaAssemblyOrExternalDataSourceName, catalogItem.tableOrTableValuedFunctionName, _).procedure);
          }
          break;
        case 'types':
          if(isList) {
            toReturn = client.catalog.listTypes(resourceGroup, accountName, catalogItem.databaseName, catalogItem.schemaAssemblyOrExternalDataSourceName, _).typeList.value;
          }
          else {
