...
exports.init = function (cli) {
  ...
  dataLakeAnalyticsJob.command('create [accountName] [jobName] [script] [runtime] [compileMode] [compileOnly] [degreeOfParallelism] [priority]' )
    ...
    .execute(function (accountName, jobName, script, runtime, compileMode, compileOnly, degreeOfParallelism, priority, options, _) {
      ...
      if(compileOnly) {
        ...
        jobResponse = client.job.create(accountName, job.jobId, job, _);
      }
  ...
  dataLakeAnalyticsAccount.command('show [accountName] [resource-group]')
    ...
    .execute(function (accountName, resourceGroup, options, _) {
      ...
      var dataLakeAnalyticsAccount = client.dataLakeAnalyticsAccountOperations.get(resourceGroup, accountName, _);
    ...
    .execute(function (accountName, resourceGroup, options, _) {
      ...
      client.dataLakeAnalyticsAccountOperations.deleteMethod(resourceGroup, accountName, _);
    ...
    .execute(function (accountName, dataLakeStore, isDefaultDataLakeStore, azureBlob, accessKey, resourceGroup, options, _) {
      ...
      if (dataLakeStore) {
        client.dataLakeAnalyticsAccountOperations.addDataLakeStoreAccount(resourceGroup, accountName, dataLakeStore, parameters, _);
      }
      else {
        parameters = {
          properties: {
        ...
        client.dataLakeAnalyticsAccountOperations.addStorageAccount(resourceGroup, accountName, azureBlob, parameters, _);
      }
    ...
    .execute(function (accountName, dataLakeStore, azureBlob, resourceGroup, options, _) {
      ...
      if (dataLakeStore) {
        client.dataLakeAnalyticsAccountOperations.deleteDataLakeStoreAccount(resourceGroup, accountName, dataLakeStore, _);
      }
      else {
        client.dataLakeAnalyticsAccountOperations.deleteStorageAccount(resourceGroup, accountName, azureBlob, _);
      }
    ...
    .execute(function (accountName, dataLakeStore, isDefaultDataLakeStore, azureBlob, accessKey, resourceGroup, options, _) {
      ...
      if (dataLakeStore) {
        ...
        client.dataLakeAnalyticsAccountOperations.updateStorageAccount(resourceGroup, accountName, azureBlob, parameters, _);
      }
  ...
  function createOrUpdateDataLakeAnalyticsAccount(subscription, accountName, resourceGroup, location, defaultDataLakeStore, tags, _) {
      ...
      var create = false;
      try {
        client.dataLakeAnalyticsAccountOperations.get(resourceGroup, accountName, _);
      }
      catch(err){
        create = true;
      }
      ...
      if(create) {
        ...
        client.dataLakeAnalyticsAccountOperations.create(resourceGroup, accountParams.name, accountParams, _);
      }
      else {
        if (defaultDataLakeStore) {
          accountParams.properties.defaultDataLakeStoreAccount = defaultDataLakeStore;
        ...
        client.dataLakeAnalyticsAccountOperations.update(resourceGroup, accountParams.name, accountParams, _);
      }
      
      return client.dataLakeAnalyticsAccountOperations.get(resourceGroup, accountName, _);
  }
  ...
  function listAllDataLakeAnalyticsAccounts(subscription, resourceGroup, _) {
    ...
    var accounts;
    if (!resourceGroup) {
      var response = client.dataLakeAnalyticsAccountOperations.list(_);
      log.info(util.inspect(response));
      accounts = response;
      while (response.nextLink) {
        response = client.dataLakeAnalyticsAccountOperations.listNext(response.nextLink);
        accounts.push.apply(accounts, response);
      }
    }
    else {
      var response = client.dataLakeAnalyticsAccountOperations.listByResourceGroup(resourceGroup, _);
      accounts = response;
      while (response.nextLink) {
        response = client.dataLakeAnalyticsAccountOperations.listByResourceGroupNext(response.nextLink);
        accounts.push.apply(accounts, response);
      }
    }
