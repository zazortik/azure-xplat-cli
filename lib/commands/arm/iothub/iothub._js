...
exports.init = function (cli) {
  ...
  iotHub.command('create')
    ...
    .option('-e --enable-dm [enableDm]', $('The flag which indicates whether Device Management is enabled, one of true, false'))
  ...
  iotHubOpMon.command('set')
    ...
    .execute(function (options, _) {
      ...
      progress = cli.interaction.progress(util.format($('Updating operations monitoring properties of iothub %s'), options.name));
