...
exports.init = function (cli) {
  ...
  iotHub.command('create [resource-group] [name] [location] [sku-name] [units]')
    ...
    .option('-e --enable-dm [enableDm]', $('The flag which indicates whether the Device Management feature is enabled for this IoT hub. One of true, false.'))
    .option('-p --d2c-partitions [d2cPartitions]', $('The number of partitions for your device-to-cloud events. Range : F1 [2-2] Rest of the Skus [2-128].'))
    .option('-r --d2c-retention-time-in-days [d2cRetentionTimeInDays]', $('The number of days for which the device-to-cloud events will be maintained. Range : [1-7].'))
    .option('-d --c2d-max-delivery-count [c2dMaxDeliveryCount]', $('The number of times the IoT hub will attempt to deliver a cloud-to-device message to a device. Range : [1-100].'))
    .option('-c --c2d-ttl [c2dTtl]', $('The amount of time for which a cloud to device mesage is available for the device to consume before it is expired by IoT hub. Range : [1-48 hours].'))
    .option('-f --feedback-lock-duration [feedbackLockDuration]', $('The lock duration for the feedback messages. Range : [5 seconds - 5 minutes].'))
    .option('-F --feedback-ttl [feedbackTtl]', $('The amount of time a feedback mesage is available for the device to consume before it is expired by IotHub. Range : [1-48 hours].'))
    .option('-m --feedback-max-delivery-count [feedbackMaxDeliveryCount]', $('The number of times the IoT hub will attempt to deliver a cloud-device feedback message to a device. Range : [1-100].'))
    ...
    .option('-T --fileupload-sas-uri-ttl [fileuploadSasUriTtl]', $('The amount of time for which the SAS Uri generated by IoT hub is valid before it expires. Range : [1-24 hours].'))
    .option('-N --fileupload-notification-ttl [fileuploadNotificationTtl]', $('The amount of time for which a file upload notification is available for the service to consume before it is expired by IoT hub. Range : [1-48 hours].'))
    .option('-D --fileupload-notification-max-delivery-count [fileuploadNotificationMaxDeliveryCount]', $('The number of times the IoT hub will attempt to deliver a file notification message. Range [1-100].'))
  ...
  function showResource(resource, showDetail) {
    cli.interaction.formatOutput(resource, function (resourceGroup) {
