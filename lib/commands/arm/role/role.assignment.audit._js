...
exports.init = function (cli) {
  ...
  roleAssignmentLogsComand._executeEventsCmd = function (client, queryFilter, keepTheRecord, options, _) {
    ...
    try {
      ...
      var recordFilter = function (element) { if (keepTheRecord(element)) { insightsResult.push(element); } };
    ...
    auditUtils.processInsightsResults(log, insightsResult, subscription, _);
  };
};
