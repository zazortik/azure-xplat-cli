...
exports.init = function (cli) {
  ...
  roleAssignmentLogsComand.command('list')
      ...
      .usage('[options]')
      .option('-b --startTime <startTime>', $('The start time of the query. If both startTime and endTime are not specified, defaults to the last one hour. Maximum query interval supported is 15 days.'))
      .option('-e --endTime <endTime>', $('The end time of the query. If both startTime and endTime are not specified, defaults to the last one hour. Maximum query interval supported is 15 days.'))
