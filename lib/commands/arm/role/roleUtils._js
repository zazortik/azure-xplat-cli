...
exports.constructRoleDefinitionUpdateParameters = function (cli, inputrole, roleFromService) {
  ...
  var roleToUpdateRoleName = (!inputRoleCamelcased.name) ? roleFromService.properties.roleName : inputRoleCamelcased.name;
  var roleToUpdateActions = (!inputRoleCamelcased.actions) ? roleFromService.properties.actions : inputRoleCamelcased.actions;
  var roleToUpdateNotActions = (!inputRoleCamelcased.notActions) ? roleFromService.properties.notActions : inputRoleCamelcased.notActions;
  var roleToUpdateAssignableScopes = (!inputRoleCamelcased.assignableScopes) ? roleFromService.properties.assignableScopes : inputRoleCamelcased.assignableScopes;
  var roleToUpdateDescription = (!inputRoleCamelcased.description) ? roleFromService.properties.description : inputRoleCamelcased.description;
