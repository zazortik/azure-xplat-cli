...
exports.constructRoleDefinitionUpdateParameters = function (cli, inputrole, roleFromService) {
  ...
  var roleToUpdateActions = (!inputRoleCamelcased.actions) ? existingRoleActions : inputRoleCamelcased.actions;
  var roleToUpdateNotActions = (!inputRoleCamelcased.notActions) ? existingRoleNotActions : inputRoleCamelcased.notActions;
