...
exports.showRoleDefinition = function (role, log) {
  ...
  log.data($('IsCustom         :'), role.roleDefinition.properties.type.toLowerCase() === CUSTOM_ROLE_TYPE ? true : false);
  log.data('');
}

exports.getRoleToCreateOrUpdate = function (inputfile, roledefinition, _) {
  ...
  return toCamelCase(roleToCreateOrUpdate, _);
}

exports.validateAndConstructCreateParameters = function (cli, role, _) {
...
exports.constructRoleDefinitionUpdateParameters = function (cli, inputrole, roleFromService, _) {
  ...
  var inputRoleCamelcased = toCamelCase(inputrole, _);
