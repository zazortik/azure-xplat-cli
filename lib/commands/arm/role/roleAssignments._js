  ...
  fillInRoleDetails: function (assignments, roleDefinitions) {
    if (assignments.length > 0) {
      ...
      for (var i = 0; i < roleDefinitions.length; i++) {
        ...
        rolePermissionActionsList[roleDefinitionId] = roleUtils.serializeActionList(roleDefinition.properties.permissions);
        rolePermissionNotActionsList[roleDefinitionId] = roleUtils.serializeNotActionList(roleDefinition.properties.permissions);
