...
exports.init = function (cli) {
  ...
  function showRoleAssignment(roleAssignment) {
    //console.log("RAW:%s", util.inspect(roleAssignment, { depth: null }));
    log.data('');
    ...
    //log.data($('  ID:             '), roleAssignment.properties.aADObject.objectId);
    //log.data($('  Type:           '), roleAssignment.properties.aADObject.objectType);
    //log.data($('  Display Name:   '), roleAssignment.properties.aADObject.displayName);
    //log.data($('  Principal Name: '), roleAssignment.properties.aADObject.userPrincipalName);
    //log.data($('Scope:            '), roleAssignment.properties.scope);
    //log.data($('Role:'));
    //log.data($('  Name:           '), roleAssignment.properties.roleName);
