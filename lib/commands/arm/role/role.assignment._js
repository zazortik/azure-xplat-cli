...
function getUserObjectId(user, subscription, _) {
  ...
  var graphCred = cred.accessToken.getGraphAccessInfo(_);
  /*cred.accessToken.authConfig.tenantId*/
  var response = getUserProfile(graphCred.accessToken, graphCred.tenantId /*'72f988bf-86f1-41af-91ab-2d7cd011db47'*/, user, _);
