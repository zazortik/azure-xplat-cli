...
exports.init = function (cli) {
  ...
  dataLakeStoreFileSystem.command('list [accountName] [path] [listSize]')
    ...
    .execute(function (accountName, path, value, folder, force, options, _) {
      ...
      if(folder) {
        var result = client.fileSystem.mkdirs(path, accountName, _);
        if (result.boolean !== true) { // we pass in null for permissions because permission setting is not supported in public preview.
        ...
        function (log, _) {
          ...
          parameters.streamContents = value;
          client.fileSystem.create(path, accountName, parameters, _);
        }, _);
      }
        ...
        try {
          ...
          while(offset < fileSizeInBytes ) {
            ...
            if(offset === 0) {
              ...
              client.fileSystem.create(destination, accountName, parameters, _);
            }
            else {
              client.fileSystem.append(destination, accountName, buffer, _);
            }
  ...
  dataLakeStoreFileSystem.command('addcontent [accountName] [path] [value]')
    ...
    .execute(function (accountName, path, value, options, _) {
      ...
      function (log, _) {
        client.fileSystem.append(path, accountName, value, _);
      }, _);
      ...
      function (log, _) {
        ...
        try {
          ...
          while(offset < fileSizeInBytes ) {
            ...
            var response = client.fileSystem.open(path, accountName, parameters, _);
  ...
  dataLakeStoreFileSystem.command('read [accountName] [path] [length] [offset]')
    ...
    .execute(function (accountName, path, length, offset, options, _) {
      ...
      function (log, _) {
        var client = utils.createDataLakeStoreFileSystemManagementClient(subscription);
        response = client.fileSystem.open(path, accountName, parameters, _);
      }, _);
  ...
  dataLakeStoreAccount.command('show [accountName] [resource-group]')
    ...
    .execute(function (accountName, resourceGroup, options, _) {
      ...
      var dataLakeStoreAccount = client.dataLakeStoreAccountOperations.get(resourceGroup, accountName, _);
  ...
  dataLakeStoreAccount.command('delete [accountName] [resource-group]')
    ...
    .execute(function (accountName, resourceGroup, options, _) {
      ...
      var response = client.dataLakeStoreAccountOperations.deleteMethod(resourceGroup, accountName, _);
  ...
  function createOrUpdateDataLakeStoreAccount(subscription, accountName, resourceGroup, location, defaultGroup, tags, _) {
      ...
      var create = false;
      try {
        client.dataLakeStoreAccountOperations.get(resourceGroup, accountName, _);
      }
      catch(err){
        create = true;
      }
      ...
      var response;
      if(create) {
        client.dataLakeStoreAccountOperations.create(resourceGroup, accountParams.name, accountParams, _);
      }
      else {
        client.dataLakeStoreAccountOperations.update(resourceGroup, accountParams.name, accountParams, _);
      }
      
      return client.dataLakeStoreAccountOperations.get(resourceGroup, accountName, _);
  }
  ...
  function listAllDataLakeStoreAccounts(subscription, resourceGroup, _) {
    ...
    var accounts;
    if (!resourceGroup) {
      var response = client.dataLakeStoreAccountOperations.list(resourceGroup, _);
      var accounts = response;
      while (response.nextLink) {
        response = client.dataLakeStoreAccountOperations.listNext(response.nextLink);
        accounts.push.apply(accounts, response);
      }
    }
    else {
      var response = client.dataLakeStoreAccountOperations.listByResourceGroup(resourceGroup, _);
      var accounts = response;
      while (response.nextLink) {
        response = client.dataLakeStoreAccountOperations.listByResourceGroupNext(response.nextLink);
        accounts.push.apply(accounts, response);
      }
    }
