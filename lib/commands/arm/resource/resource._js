...
exports.init = function (cli) {
  ...
  resource.command('create [resource-group] [name] [resource-type] [location] [api-version] [sku] [plan]')
    ...
    .execute(function (resourceGroup, name, resourceType, location, apiVersion, parent, properties, sku, plan, options, _) {
      resource.createResource(resourceGroup, name, resourceType, location, apiVersion, options.properties, sku, plan, options, _);
    });

  resource.command('set [resource-group] [name] [resource-type] [api-version] [properties] [sku] [plan]')
