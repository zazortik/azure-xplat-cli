...
exports.init = function (cli) {
  ...
  resource.command('create [resource-group] [name] [resource-type] [location] [api-version] [properties] [sku] [plan]')
    ...
    .execute(function (resourceGroup, name, resourceType, location, apiVersion, properties, sku, plan, options, _) {
      resource.createResource(resourceGroup, name, resourceType, location, apiVersion, options.properties, sku, plan, options, _);
    });

  resource.command('set [resource-group] [name] [resource-type] [properties] [api-version] [properties] [sku] [plan]')
    ...
    .option('--subscription <subscription>', $('the subscription identifier'))
    .execute(function (resourceGroup, name, resourceType, properties, apiVersion, sku, plan, options, _) {
      resource.createResource(resourceGroup, name, resourceType, '', apiVersion, properties, sku, plan, options, _);
    });

  resource.createResource = function (resourceGroup, name, resourceType, location, apiVersion, propertiesParam, skuObj, planObj, options, _) {
    if (!resourceGroup) {
  ...
  resource.command('show [resource-group] [name] [resource-type] [resource-id] [api-version]')
    .description($('Gets one resource within a resource group or subscription'))
    .usage('[options] <resource-group> <name> <resource-type> <resource-id> <api-version>')
    .option('-g --resource-group <resource-group>', $('the resource group name'))
    .option('-n --name <name>', $('the resource name'))
    .option('-r --resource-type <resource-type>', $('the resource type'))
    ...
    .option('--parent <parent>', $('the name of the parent resource (if needed), in path/path/path format'))
    .option('--subscription <subscription>', $('the subscription identifier'))
    .execute(function (resourceGroup, name, resourceType, resourceId, apiVersion, options, _) {
      if(!resourceId) {
  ...
  resource.command('delete [resource-group] [name] [resource-type] [resource-id] [api-version]')
  ...
  function extractAllValues(resourceId){
    ...
    array = array.filter(function(x){return x !== ""});
