...
function showDeprecateMessage(log){
  if (!log.format().json){
    log.warn('With the shutdown of V1 service, Api App commands will be removed ' + 
      'in a future release of azure-cli.');
  }
}