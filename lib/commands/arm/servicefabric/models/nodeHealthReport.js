 ...
 * 
 */
function NodeHealthReport(parameters) {
...
/**
 * Validate the payload against the NodeHealthReport schema
 *
 * @param {JSON} payload
 *
 */
NodeHealthReport.prototype.serialize = function () {
  var payload = {};
...
/**
 * Deserialize the instance to NodeHealthReport schema
 *
 * @param {JSON} instance
 *
 */
NodeHealthReport.prototype.deserialize = function (instance) {
  if (instance) {
