 ...
 * 
 */
function ApplicationsHealthEvaluation(parameters) {
  ApplicationsHealthEvaluation['super_'].call(this, parameters);
...
/**
 * Validate the payload against the ApplicationsHealthEvaluation schema
 *
 * @param {JSON} payload
 *
 */
ApplicationsHealthEvaluation.prototype.serialize = function () {
  var payload = ApplicationsHealthEvaluation['super_'].prototype.serialize.call(this);
...
/**
 * Deserialize the instance to ApplicationsHealthEvaluation schema
 *
 * @param {JSON} instance
 *
 */
ApplicationsHealthEvaluation.prototype.deserialize = function (instance) {
  ApplicationsHealthEvaluation['super_'].prototype.deserialize.call(this, instance);
  if (instance) {
