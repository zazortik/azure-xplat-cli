 ...
 * 
 */
function ServiceHealthEvaluation(parameters) {
  ServiceHealthEvaluation['super_'].call(this, parameters);
...
/**
 * Validate the payload against the ServiceHealthEvaluation schema
 *
 * @param {JSON} payload
 *
 */
ServiceHealthEvaluation.prototype.serialize = function () {
  var payload = ServiceHealthEvaluation['super_'].prototype.serialize.call(this);
...
/**
 * Deserialize the instance to ServiceHealthEvaluation schema
 *
 * @param {JSON} instance
 *
 */
ServiceHealthEvaluation.prototype.deserialize = function (instance) {
  ServiceHealthEvaluation['super_'].prototype.deserialize.call(this, instance);
  if (instance) {
