...
/**
 * @class
 * Initializes a new instance of the ClusterHealthEvaluationHealthEvents class.
 * @constructor
 * @member {number} [kind]
 * 
 ...
 * 
 */
function ClusterHealthEvaluationHealthEvents(parameters) {
  if (parameters !== null && parameters !== undefined) {
    ...
    if (parameters.unhealthyEvaluations) {
      ...
      parameters.unhealthyEvaluations.forEach(function(element) {
        if (element) {
          element = new models['ApplicationUnhealthyEvaluation'](element);
        }
...
/**
 * Validate the payload against the ClusterHealthEvaluationHealthEvents schema
 *
 * @param {JSON} payload
 *
 */
ClusterHealthEvaluationHealthEvents.prototype.serialize = function () {
  var payload = {};
...
/**
 * Deserialize the instance to ClusterHealthEvaluationHealthEvents schema
 *
 * @param {JSON} instance
 *
 */
ClusterHealthEvaluationHealthEvents.prototype.deserialize = function (instance) {
  if (instance) {
    ...
    if (instance['UnhealthyEvaluations']) {
      ...
      instance['UnhealthyEvaluations'].forEach(function(element1) {
        if (element1) {
          element1 = new models['ApplicationUnhealthyEvaluation']().deserialize(element1);
        }
...
module.exports = ClusterHealthEvaluationHealthEvents;
