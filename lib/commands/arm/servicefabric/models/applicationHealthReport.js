 ...
 * 
 */
function ApplicationHealthReport(parameters) {
...
/**
 * Validate the payload against the ApplicationHealthReport schema
 *
 * @param {JSON} payload
 *
 */
ApplicationHealthReport.prototype.serialize = function () {
  var payload = {};
...
/**
 * Deserialize the instance to ApplicationHealthReport schema
 *
 * @param {JSON} instance
 *
 */
ApplicationHealthReport.prototype.deserialize = function (instance) {
  if (instance) {
...
module.exports = ApplicationHealthReport;
