 ...
 * 
 */
function ReplicaHealthReport(parameters) {
...
/**
 * Validate the payload against the ReplicaHealthReport schema
 *
 * @param {JSON} payload
 *
 */
ReplicaHealthReport.prototype.serialize = function () {
  var payload = {};
...
/**
 * Deserialize the instance to ReplicaHealthReport schema
 *
 * @param {JSON} instance
 *
 */
ReplicaHealthReport.prototype.deserialize = function (instance) {
  if (instance) {
