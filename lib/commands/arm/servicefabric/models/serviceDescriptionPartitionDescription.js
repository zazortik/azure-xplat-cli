...
/**
 * @class
 * Initializes a new instance of the ServiceDescriptionPartitionDescription class.
 * @constructor
 ...
 * 
 */
function ServiceDescriptionPartitionDescription(parameters) {
...
/**
 * Validate the payload against the ServiceDescriptionPartitionDescription schema
 *
 * @param {JSON} payload
 *
 */
ServiceDescriptionPartitionDescription.prototype.serialize = function () {
  var payload = {};
...
/**
 * Deserialize the instance to ServiceDescriptionPartitionDescription schema
 *
 * @param {JSON} instance
 *
 */
ServiceDescriptionPartitionDescription.prototype.deserialize = function (instance) {
  if (instance) {
...
module.exports = ServiceDescriptionPartitionDescription;
