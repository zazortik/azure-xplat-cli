...
/**
 * @class
 * Initializes a new instance of the ReplicaHealthEvaluation2 class.
 * @constructor
 ...
 * 
 */
function ReplicaHealthEvaluation2(parameters) {
  ReplicaHealthEvaluation2['super_'].call(this, parameters);
...
util.inherits(ReplicaHealthEvaluation2, models['HealthEvaluation']);

/**
 * Validate the payload against the ReplicaHealthEvaluation2 schema
 *
 * @param {JSON} payload
 *
 */
ReplicaHealthEvaluation2.prototype.serialize = function () {
  var payload = ReplicaHealthEvaluation2['super_'].prototype.serialize.call(this);
...
/**
 * Deserialize the instance to ReplicaHealthEvaluation2 schema
 *
 * @param {JSON} instance
 *
 */
ReplicaHealthEvaluation2.prototype.deserialize = function (instance) {
  ReplicaHealthEvaluation2['super_'].prototype.deserialize.call(this, instance);
  if (instance) {
...
module.exports = ReplicaHealthEvaluation2;
