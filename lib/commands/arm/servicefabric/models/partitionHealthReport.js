 ...
 * 
 */
function PartitionHealthReport(parameters) {
...
/**
 * Validate the payload against the PartitionHealthReport schema
 *
 * @param {JSON} payload
 *
 */
PartitionHealthReport.prototype.serialize = function () {
  var payload = {};
...
/**
 * Deserialize the instance to PartitionHealthReport schema
 *
 * @param {JSON} instance
 *
 */
PartitionHealthReport.prototype.deserialize = function (instance) {
  if (instance) {
