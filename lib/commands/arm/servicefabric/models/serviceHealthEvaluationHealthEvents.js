...
/**
 * @class
 * Initializes a new instance of the ServiceHealthEvaluationHealthEvents class.
 * @constructor
 * @member {number} [kind]
 * 
 ...
 * 
 */
function ServiceHealthEvaluationHealthEvents(parameters) {
...
/**
 * Validate the payload against the ServiceHealthEvaluationHealthEvents schema
 *
 * @param {JSON} payload
 *
 */
ServiceHealthEvaluationHealthEvents.prototype.serialize = function () {
  var payload = {};
...
/**
 * Deserialize the instance to ServiceHealthEvaluationHealthEvents schema
 *
 * @param {JSON} instance
 *
 */
ServiceHealthEvaluationHealthEvents.prototype.deserialize = function (instance) {
  if (instance) {
...
module.exports = ServiceHealthEvaluationHealthEvents;
