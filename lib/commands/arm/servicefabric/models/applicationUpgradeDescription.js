 ...
 * 
 */
function ApplicationUpgradeDescription(parameters) {
...
/**
 * Validate the payload against the ApplicationUpgradeDescription schema
 *
 * @param {JSON} payload
 *
 */
ApplicationUpgradeDescription.prototype.serialize = function () {
  var payload = {};
...
/**
 * Deserialize the instance to ApplicationUpgradeDescription schema
 *
 * @param {JSON} instance
 *
 */
ApplicationUpgradeDescription.prototype.deserialize = function (instance) {
  if (instance) {
