 ...
 * 
 */
function DeployedServicePackageHealthReport(parameters) {
...
/**
 * Validate the payload against the DeployedServicePackageHealthReport schema
 *
 * @param {JSON} payload
 *
 */
DeployedServicePackageHealthReport.prototype.serialize = function () {
  var payload = {};
...
/**
 * Deserialize the instance to DeployedServicePackageHealthReport schema
 *
 * @param {JSON} instance
 *
 */
DeployedServicePackageHealthReport.prototype.deserialize = function (instance) {
  if (instance) {
