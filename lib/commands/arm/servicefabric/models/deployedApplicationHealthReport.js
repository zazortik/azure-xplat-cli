 ...
 * 
 */
function DeployedApplicationHealthReport(parameters) {
...
/**
 * Validate the payload against the DeployedApplicationHealthReport schema
 *
 * @param {JSON} payload
 *
 */
DeployedApplicationHealthReport.prototype.serialize = function () {
  var payload = {};
...
/**
 * Deserialize the instance to DeployedApplicationHealthReport schema
 *
 * @param {JSON} instance
 *
 */
DeployedApplicationHealthReport.prototype.deserialize = function (instance) {
  if (instance) {
