...
/**
 * Validate the payload against the NodeId schema
 *
 * @param {JSON} payload
 *
 */
...
/**
 * Deserialize the instance to NodeId schema
 *
 * @param {JSON} instance
 *
 */
NodeId.prototype.deserialize = function (instance) {
  if (instance) {
