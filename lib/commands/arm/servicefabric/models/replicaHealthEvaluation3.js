...
/**
 * @class
 * Initializes a new instance of the ReplicaHealthEvaluation3 class.
 * @constructor
 ...
 * 
 */
function ReplicaHealthEvaluation3(parameters) {
  ReplicaHealthEvaluation3['super_'].call(this, parameters);
...
util.inherits(ReplicaHealthEvaluation3, models['HealthEvaluation']);

/**
 * Validate the payload against the ReplicaHealthEvaluation3 schema
 *
 * @param {JSON} payload
 *
 */
ReplicaHealthEvaluation3.prototype.serialize = function () {
  var payload = ReplicaHealthEvaluation3['super_'].prototype.serialize.call(this);
...
/**
 * Deserialize the instance to ReplicaHealthEvaluation3 schema
 *
 * @param {JSON} instance
 *
 */
ReplicaHealthEvaluation3.prototype.deserialize = function (instance) {
  ReplicaHealthEvaluation3['super_'].prototype.deserialize.call(this, instance);
  if (instance) {
...
module.exports = ReplicaHealthEvaluation3;
