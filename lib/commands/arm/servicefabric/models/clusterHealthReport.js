 ...
 * 
 */
function ClusterHealthReport(parameters) {
...
/**
 * Validate the payload against the ClusterHealthReport schema
 *
 * @param {JSON} payload
 *
 */
ClusterHealthReport.prototype.serialize = function () {
  var payload = {};
...
/**
 * Deserialize the instance to ClusterHealthReport schema
 *
 * @param {JSON} instance
 *
 */
ClusterHealthReport.prototype.deserialize = function (instance) {
  if (instance) {
...
module.exports = ClusterHealthReport;
