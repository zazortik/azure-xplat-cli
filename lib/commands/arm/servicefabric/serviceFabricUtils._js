...
var constants = {
  ...
  serviceFabricCodePath: '/home/jeffrey/Desktop/WindowsFabric/build.prod/lib',
  managedPath: '/home/jeffrey/Desktop/WindowsFabric/build.prod/FabricManagedRefs',
  defaultConfig: {
    noRetryPolicy: true
  }
};
...
exports.runChildProcess = function (command, _) {
  ...
  var processEnv = {MONO_LOG_LEVEL: 'error', LD_LIBRARY_PATH: constants.serviceFabricCodePath, FabricCodePath: constants.serviceFabricCodePath, FabricConfigFileName: path.join(constants.managedPath, 'AzureCliProxy.cfg')}
