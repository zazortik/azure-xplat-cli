...
ServiceFabricClient.prototype.disableNode = function (nodeName, disableNode, options, callback) {
  ...
  try {
    if (disableNode) {
      requestModel = new client._models['DisableNode'](disableNode);
    }
    if (requestModel !== null && requestModel !== undefined) {
      requestContent = JSON.stringify(requestModel.serialize());
    } else {
...
ServiceFabricClient.prototype.updateServiceGroup = function (applicationName, serviceName, serviceGroupUpdateDescription, options, callback) {
  ...
  var requestModel = null;
  try {
    if (serviceGroupUpdateDescription) {
      requestModel = new client._models.discriminators[serviceGroupUpdateDescription['ServiceKind']](serviceGroupUpdateDescription);
    }
    if (requestModel !== null && requestModel !== undefined) {
      requestContent = JSON.stringify(requestModel.serialize());
    } else {
...
ServiceFabricClient.prototype.updateService = function (serviceName, serviceUpdateDescription, options, callback) {
  ...
  var requestModel = null;
  try {
    if (serviceUpdateDescription) {
      requestModel = new client._models.discriminators[serviceUpdateDescription['ServiceKind']](serviceUpdateDescription);
    }
    if (requestModel !== null && requestModel !== undefined) {
      requestContent = JSON.stringify(requestModel.serialize());
    } else {
...
ServiceFabricClient.prototype.resolveService = function (serviceName, options, callback) {
  ...
  try {
    ...
    if (partitionKeyType !== null && partitionKeyType !== undefined && typeof partitionKeyType.valueOf() !== 'string') {
      throw new Error('partitionKeyType must be of type string.');
    }
  ...
  if (partitionKeyType !== null && partitionKeyType !== undefined) {
    queryParameters.push('PartitionKeyType=' + encodeURIComponent(partitionKeyType));
  }
  ...
  return client.pipeline(httpRequest, function (err, response, responseBody) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        result = JSON.parse(responseBody);
        if (parsedResponse) {
          result = new client._models['ResolvedServicePartition'](parsedResponse);
        }
        if (parsedResponse !== null && parsedResponse !== undefined) {
          result.deserialize(parsedResponse);
        }
