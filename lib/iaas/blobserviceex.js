...
// TODO: Deprecate this file once Node.js SDK 0.7.3 is out which includes this api's version.
...
var azureutil = require('../../node_modules/azure/lib/util/util');
var BlobResult = require('../../node_modules/azure/lib/services/blob/models/blobresult');
...
BlobServiceEx.prototype.copyBlobStatus = function (targetContainer, targetBlob, optionsOrCallback, callback) {
  ...
  webResource.withOkCode(HttpConstants.HttpResponseCodes.Accepted);
  webResource.withOkCode(HttpConstants.HttpResponseCodes.Ok);
