...
exports.copyBlob =
  ...
  var blobService = utils.createBlobService(splitDestination.accountName, destinationAccountKey);
...
exports.uploadPageBlob =
  ...
  // Using default host provided by Node SDK if not specified
  var blobService = utils.createBlobService(splitDestination.accountName, accountKey);
