...
var WebsitesClient = require('../../commands/websites/websitesclient');
...
LinkedRevisionControlClient.prototype._addRemotesToLocalGitRepo = function (context, _) {
  ...
  if (!context.site.localGitRemote) {
...
GithubClient.prototype.init = function (context, _) {
  ...
  if (!context.github.repository) {
    ...
    context.github.repository = repositories[this.cli.interaction.choose(this.cli, repositories.map(function (repository) {
