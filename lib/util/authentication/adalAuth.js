...
function refreshToken(authConfig, refreshToken, callback) {
  ...
  context.acquireTokenWithRefreshToken(refreshToken, authConfig.clientId, null, function (err, response) {
...
_.extend(AdalAccessToken.prototype, {
  ...
  needsRefresh: function () {
    return (this.expiresAt.getTime() - Date.now()) <= 10 /* min */ * 60 /* sec/min */ * 1000 /* ms/sec */;
  },
