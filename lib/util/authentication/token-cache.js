  ...
  _normalize: function (entries, removeUselessFields) {
    entries.forEach(function (entry) {
      ...
      if (removeUselessFields) {
        var uselessFields = ['familyName', 'givenName', 'isUserIdDisplayable', 'tenantId'];
        uselessFields.forEach(function (field) {
          delete entry[field];
        });
      }
    });
