...
exports._createWebsiteClient = function (subscription, logger) {
  return exports._createService('_createWebsiteClient', subscription, logger);
};

exports._createSqlClient = function (subscription, logger) {
  return exports._createService('_createSqlClient', subscription, logger);
};

exports._createServiceBusClient = function (subscription, logger) {
  return exports._createService('_createServiceBusClient', subscription, logger);
};
...
exports._createStorageClient = function (subscription, logger) {
  return exports._createService('_createStorageClient', subscription, logger);
};

exports._createCloudServiceClient = function (subscription, logger) {
  return exports._createService('_createCloudServiceClient', subscription, logger);
};

exports._createComputeClient = function (subscription, logger) {
  return exports._createService('_createComputeClient', subscription, logger);
};
