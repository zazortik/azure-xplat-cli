...
exports.createWebsiteClient = function (subscription, callback) {
  ...
  subscription.registerAsmProvider('website', function (err) {
    ...
    client = _createAsmClient(azureWebSite.createWebSiteManagementClient, subscription);
...
exports.createSqlClient = function (subscription) {
  ...
  return _createAsmClient(azureSqlMgmt.createSqlManagementClient, subscription);
};

exports.createServiceBusClient = function (subscription) {
  var azureServiceBus = require('azure-mgmt-sb');
  return _createAsmClient(azureServiceBus.createServiceBusManagementClient, subscription);
};

exports.createManagementClient = function (subscription) {
  var azureManagement = require('azure-mgmt');
  return _createAsmClient(azureManagement.createManagementClient, subscription);
};

exports.createStorageClient = function (subscription) {
  var azureStorage = require('azure-mgmt-storage');
  return _createAsmClient(azureStorage.createStorageManagementClient, subscription);
};
...
exports.createStorageResourceProviderClient = function (subscription) {
  ...
  return _createArmClient(srpClient.createStorageManagementClient, subscription);
};

exports.createComputeResourceProviderClient = function (subscription) {
  var computeClient = require('./../commands/arm/armsdk/compute');
  return _createArmClient(computeClient.createComputeManagementClient, subscription);
};

exports.createNetworkResourceProviderClient = function (subscription) {
  var networkClient = require('./../commands/arm/armsdk/network');
  return _createArmClient(networkClient.createNetworkResourceProviderClient, subscription);
};

exports.createTrafficManagerResourceProviderClient = function (subscription) {
  var tmClient = require('./../commands/arm/armsdk/trafficManager');
  return _createArmClient(tmClient.createTrafficManagerManagementClient, subscription);
};

exports.createDnsResourceProviderClient = function (subscription) {
  var dnsClient = require('./../commands/arm/armsdk/dns');
  return _createArmClient(dnsClient.createDnsManagementClient, subscription);
};

exports.createComputeClient = function (subscription) {
  var azureCompute = require('azure-mgmt-compute');
  return _createAsmClient(azureCompute.createComputeManagementClient, subscription);
};

exports.createNetworkClient = function (subscription) {
  var azureNetwork = require('azure-mgmt-vnet');
  return _createAsmClient(azureNetwork.createNetworkManagementClient, subscription);
};

exports.createResourceClient = function (subscription) {
  var resourceManagement = require('azure-mgmt-resource');
  return _createArmClient(resourceManagement.createResourceManagementClient, subscription);  
};
...
exports.createEventsClient = function (subscription) {
  ...
  return _createArmClient(azureMonitoring.createEventsClient, subscription);
};

exports.createGalleryClient = function (subscription) {
  var gallery = require('azure-gallery');
  return exports.createClient(gallery.createGalleryClient,
...
exports.createWebsiteManagementService = function (subscription) {
  var azureWebSite = require('azure-mgmt-website');
  return createService(azureWebSite.createWebsiteManagementService, subscription);
};
...
exports.ignoreCaseAndSpaceEquals = function (a, b) {
  return a === b ||
    (a !== null && a !== undefined &&
    b !== null && b !== undefined &&
    (a.replace(/ /gi, '').toLowerCase() === b.replace(/ /gi, '').toLowerCase()));
};
