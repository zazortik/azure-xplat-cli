...
var EndPointUtil = require('./endpointUtil');
...
exports.protocols = function () {
  var endPointUtil = new EndPointUtil();
  var protocols = endPointUtil.endPointConsts.protocols;
  return getArrayAsStr(protocols);
};

this.accessModesList = ['allow', 'deny'];
exports.accessModesEnum = function () {
  return this.accessModesList;
};
exports.accessModes = function () {
  return getArrayAsStr(this.accessModesList);
};

this.directionModesList = ['inbound', 'outbound'];
exports.directionModesEnum = function () {
  return this.directionModesList;
};
exports.directionModes = function () {
  return getArrayAsStr(this.directionModesList);
};

function getArrayAsStr(array) {
  return '[' + array + ']';
}