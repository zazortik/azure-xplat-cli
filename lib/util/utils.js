...
var hdinsight = require('azure-mgmt-hdinsight');

exports.getHDInsightJobManagementClient = function getHDInsightJobManagementClient(clusterDnsName, userName, password) {
...
exports.getHDInsightClusterManagementClient = function getHDInsightClusterManagementClient(cloudServiceName, credentials) {
  var client = hdinsight.createHDInsightClusterManagementClient(cloudServiceName, credentials);
  return client;
};

exports.getHDInsightCluster2ManagementClient = function getHDInsightCluster2ManagementClient(cloudServiceName, credentials) {
  var client = hdinsight.createHDInsightCluster2ManagementClient(cloudServiceName, credentials);
  return client;
};
