...
exports.escapeFilePath = function(name) {
  if(exports.isWindows()) {
    ...
    for(var i = 0; i < exports.invalidFileNameChars.length; i++) {
      var regExp = exports.getRepleaceRegExp(exports.invalidFileNameChars[i]);
      var newValue = '%' + exports.invalidFileNameChars[i].toString(16);
...
/**
* Get repleace regular expression
*/
exports.getRepleaceRegExp = function(charCode) {
