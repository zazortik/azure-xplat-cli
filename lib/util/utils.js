...
exports.getPublishingProfileUrls = function () {
  return {
    'global': constants.GLOBAL_PUBLISHINGPROFILE_URL,
    'china': constants.CHINA_PUBLISHINGPROFILE_URL
  };
}
...
exports.getPublishingProfileUrl = function (realm, environment) {
  ...
  if (process.env.AZURE_PUBLISHINGPROFILE_URL) {
    targetUrl = process.env.AZURE_PUBLISHINGPROFILE_URL;
  } else if (environment) {
    var urls = exports.getPublishingProfileUrls();
    var e = Object.keys(urls).filter(function (e) {
      return exports.ignoreCaseEquals(e, environment);
    })[0];
    targetUrl = urls[e];
  } else {
    targetUrl = constants.DEFAULT_PUBLISHINGPROFILE_URL;
  }
