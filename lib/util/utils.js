...
exports.createAutoRestClient = function (FactoryMethod, subscription) {
  ...
  var baseUri = this.stringTrimEnd(subscription.resourceManagerEndpointUrl, '/');
  ...
  // To reduce playback time in test cases
  var isRecording = process.env.AZURE_NOCK_RECORD || false;
  if (!isRecording) client.longRunningOperationRetryTimeoutInSeconds = 0;
