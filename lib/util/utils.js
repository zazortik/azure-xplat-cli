...
exports.createStorageResourceProviderClient = function (subscription) {
  ...
  return _createArmClient(functionName, subscription);
};

exports.createComputeResourceProviderClient = function (subscription) {
  var computeClient = require('./../commands/arm/armsdk/compute');
  var functionName = 'createComputeManagementClient';
  azure[functionName] = computeClient.createComputeManagementClient;
  return _createArmClient(functionName, subscription);
};

exports.createNetworkResourceProviderClient = function (subscription) {
  var networkClient = require('./../commands/arm/armsdk/network');
  var functionName = 'createNetworkResourceProviderClient';
  azure[functionName] = networkClient.createNetworkResourceProviderClient;
  return _createArmClient(functionName, subscription);
};
...
exports.createTrafficManagerResourceProviderClient = function (subscription) {
  ...
  var functionName = 'createTrafficManagerManagementClient';
  azure[functionName] = tmClient.createTrafficManagerManagementClient;
  return _createArmClient(functionName, subscription);
};

exports.createDnsResourceProviderClient = function (subscription) {
  var dnsClient = require('./../commands/arm/armsdk/dns');
  var functionName = 'createDnsManagementClient';
  azure[functionName] = dnsClient.createDnsManagementClient;
  return _createArmClient(functionName, subscription);
};
  ...
  return function handle(resource, next, callback) {
    var nextStream = next(resource, function (err, response, body) {
      if (err && response && response.statusCode === 409) {
        err.message = util.format('%s You can register it by executing the command of \'azure provider register\'.', 
                                  err.message);
      }
      callback(err, response, body);
    });
