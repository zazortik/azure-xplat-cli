...
exports.createStorageManagementClient = function (subscription) {
...
exports.createStorageResourceProviderClient = function (subscription) {
  // TODO: delete 'armsdk' folder after the SDK is released
  var clientConstructor = require('./../commands/arm/armsdk/storage/storageManagementClient');
  return this.createAutoRestClient(clientConstructor, subscription);
}
...
exports.createBatchClient = function (accountName, accountKey, taskUri) {
  var SharedKeyAuth = require('azure-batch/lib/batchSharedKeyCredentials');
  var credentials = new SharedKeyAuth(accountName, accountKey);
  ...
  var FactoryMethod = require('azure-batch');
  var client = new FactoryMethod(credentials, taskUri, options);
  return client;
};
