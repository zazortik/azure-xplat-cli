...
exports.createServiceManagementService = function (subscription) {
  return subscription.createService('createServiceManagementService');
};

exports.createWebsiteManagementService = function (subscription) {
  return subscription.createService('createWebsiteManagementService');
};

exports._createWebsiteClient = function (subscription, callback) {
  var client;
  if (!subscription.registeredProviders.some(function (item) {
    return exports.ignoreCaseEquals(item, 'website');
  })) {
    subscription.registerAsmProvider('website', function (err) {
      if (err) {
        return callback(err);
      }
      client = subscription.createClient('createWebSiteManagementClient');
...
exports._createSqlClient = function (subscription) {
  return subscription.createClient('createSqlManagementClient');
};

exports._createServiceBusClient = function (subscription) {
  return subscription.createClient('createServiceBusManagementClient');
};

exports._createManagementClient = function (subscription) {
  return subscription.createClient('createManagementClient');
};

exports._createStorageClient = function (subscription) {
  return subscription.createClient('createStorageManagementClient');
};

exports._createComputeClient = function (subscription) {
  return subscription.createClient('createComputeManagementClient');
};

exports._createNetworkClient = function (subscription) {
  return subscription.createClient('createNetworkManagementClient');
};
