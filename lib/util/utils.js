...
exports.createAsmClient = function (factory, subscription) {
  return exports.createClient(factory,
                       subscription._createCredentials(), 
                       subscription.managementEndpointUrl);
};

exports.createArmClient = function (factory, subscription) {
  return exports.createClient(factory,
                       subscription._createCredentials(), 
                       subscription.resourceManagerEndpointUrl);
};

//website provider might not be registered yet, so make sure register it
exports.createWebsiteClient = function (subscription, callback) {
  ...
  if (!subscription.registeredProviders.some(function (item) {
    ...
    subscription.registerAsmProvider('website', function (err) {
      ...
      client = exports.createAsmClient('createWebSiteManagementClient', subscription);
...
exports.createSqlClient = function (subscription) {
  return exports.createAsmClient('createSqlManagementClient', subscription);
};

exports.createServiceBusClient = function (subscription) {
  return exports.createAsmClient('createServiceBusManagementClient', subscription);
};

exports.createManagementClient = function (subscription) {
  return exports.createAsmClient('createManagementClient', subscription);
};

exports.createStorageClient = function (subscription) {
  return exports.createAsmClient('createStorageManagementClient', subscription);
};

exports.createComputeClient = function (subscription) {
  return exports.createAsmClient('createComputeManagementClient', subscription);
};

exports.createNetworkClient = function (subscription) {
  return exports.createAsmClient('createNetworkManagementClient', subscription);
};

exports.createResourceClient = function (subscription) {
  return exports.createArmClient('createResourceManagementClient', subscription);
};

exports.createEventsClient = function (subscription) {
  return exports.createArmClient('createEventsClient', subscription);
};
