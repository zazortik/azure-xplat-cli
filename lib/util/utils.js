...
exports.escapeFilePath = function(name) {
  if(exports.isWindows()) {
    ...
    var regExp = exports.getRepleaceRegExpFromCharCode(exports.invalidFileNameChars);
...
*/
exports.getRepleaceRegExpFromCharCode = function(charCodeArray) {
