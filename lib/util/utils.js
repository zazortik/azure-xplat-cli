...
exports.createAutoRestClient = function (FactoryMethod, subscription, options) {
  ...
  if(!options.dnsSuffix) {
    return new FactoryMethod(credentials, subscriptionId, baseUri, options);
  }
  else {
    //TODO: the baseUri will be completely removed from the constructor for these scenarios.
    return new FactoryMethod(credentials, subscriptionId, options.dnsSuffix, null, options);
  }
};
