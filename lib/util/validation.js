...
exports.isIn = function (str, values, paramName) {
  ...
  if (index === -1) {
    throw new Error(util.format(exports.getLocaleString('Given %s "%s" is invalid, supported values are: %s'), paramName, str, values.join(', ')));
  }
  return values[i];
};
...
exports.isURL = function (url) {
  var options = {require_protocol: true, require_valid_protocol: true};
