...
_.extend(Subscription.prototype, {
  ...
  */
  ...
  _checkSubscriptionIsApplicable: function (endpoint) {
    if (this.isCsmOnly && endpoint !== this.resourceManagerEndpointUrl) {
      throw new Error($('This subscription canonly  be used to create azure resource manager service'));
    }
  },
  ...
  */
  ...
  _createCredentials: function () {
    if (this.username) {
      var token = new adalAuth.AdalAccessToken(this.environment.authConfig, this.username);
