...
function Subscription(subscriptionData, environment) {
  ...
  this.registeredResourceNamespaces = _.without(subscriptionData.registeredResourceNamespaces.toString()
                                       .split(','), 'undefined', '');
  this.registeredProviders = _.without(subscriptionData.registeredProviders.toString()
                              .split(','), 'undefined', '');
}
