...
var mfaSubscriptionUtils = require('./mfaSubscriptionUtils');
...
_.extend(Environment.prototype, {
  ...
  addAccount: function (username, password, tenant, loginType, callback) {
    var self = this;
    ...
    function processSubscriptions(err, result) {
    ...
    if (loginType.servicePrincipal) {
      ...
      mfaSubscriptionUtils.getSubscriptions(self, username, tenant, processSubscriptions);
    } else {
