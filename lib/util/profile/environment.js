...
function Environment(envData) {
  ...
  Object.defineProperties(this, {
    ...
    resourceManagementEndpointUrl: propDescriptor('resourceManagementEndpointUrl', 'AZURE_RESOURCEENDPOINT_URL'),
    ...
    publicGalleryEndpointUrl: propDescriptor('publicGalleryEndpointUrl', 'AZURE_PUBLIC_GALLERY_ENDPOINT_URL'),
    isPublicEnvironment: {
      enumerable: true,
      configurable: false,
      get: function () {
