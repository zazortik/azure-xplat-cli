...
Environment.publicEnvironments = [
  ...
  new Environment({
    ...
    commonTenantName: 'common',
    graphResourceUri: 'https://graph.ppe.windows.net/',
    graphApiVersion: '1.42-previewInternal'
    //TODO: ask around to see whether more end points to be specified.
  })
];
