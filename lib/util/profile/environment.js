...
var SubscriptionUtils = require('./subscriptionUtils._js');
...
_.extend(Environment.prototype, {
  ...
  addAccount: function (username, password, callback) {
    ...
    SubscriptionUtils.getSubscriptions(this, username, password, function (err, subscriptions) {
  ...
  acquireTokenForUser : function (username, password, tenantId, callback) {
    this.acquireToken(this.getAuthConfig(tenantId), username, password, callback);
  }
});
