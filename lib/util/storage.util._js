...
var BlobConstants = storage.BlobUtilities;
...
var StorageServiceSettings = storage.StorageServiceClient.getStorageSettings;
...
function getStorageServiceSettings(connectionString) {
    ...
    if (!connectionString) {
        ...
        return StorageServiceSettings(connectionString);
    }
}
