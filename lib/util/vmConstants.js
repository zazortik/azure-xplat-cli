...
var VMConstants = {
  EXTENSIONS: {
    ...
    AZURE_DISK_ENCRYPTION_WINDOWS_EXTENSION_VERSION: '1.3',
    AZURE_DISK_ENCRYPTION_WINDOWS_EXTENSION_NAME: 'ADETest',
    ...
    AZURE_DISK_ENCRYPTION_LINUX_EXTENSION_NAME: 'VMEncryptionPreview',
