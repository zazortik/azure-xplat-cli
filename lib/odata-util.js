...
// Expose 'ODataUtil'.
exports = module.exports = ODataUtil;

/**
* Creates a new ODataUtil object.
*
* @constructor
*/
function ODataUtil() {
  ODataUtil.super_.call(this);
  this.Constants = {
...
util.inherits(ODataUtil, ServiceClient);
...
*/
ODataUtil.prototype.resolveUid = function (uid, callback) {
...
* @return {undefined}
*/
ODataUtil.prototype._buildRequestOptions = function(webResource, options, callback) {
  var self = this;
...
* @return {string}
*/
ODataUtil.prototype._getContentType = function() {
...
* @return {string}
*/
ODataUtil.prototype._getAcceptType = function() {
...
*/
ODataUtil.prototype._getHostname = function () {
