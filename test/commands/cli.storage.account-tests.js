...
describe('cli', function () {
  describe('storage account', function () {
	...
	it('should show connecting string', function (done) {
      suite.execute('storage account connection-string show %s --json', storageName, function (result) {
	...
	it('should show connecting string with endpoints', function (done) {
      suite.execute('storage account connection-string show --use-http --blob-endpoint myBlob.ep --queue-endpoint 10.0.0.10 --table-endpoint mytable.core.windows.net %s --json', storageName, function (result) {
	    var connectionString = JSON.parse(result.text);
