...
var testprefix = 'arm-cli-insights-logs-correlationId-tests';
      ...
      describe('correlationId', function() {
        ...
        describe('list', function () {
          it('should work without options', function (done) {
            suite.execute('insights logs correlationId list %s', '2ad3397d-8120-4754-ad47-d2ca058330fc', function (result) {
