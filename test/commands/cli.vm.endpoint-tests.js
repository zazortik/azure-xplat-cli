...
describe('cli', function () {
  describe('vm', function () {
    var vmImgName, name, location, affinityName = 'xplattestaffingrp',
      vnetName = 'xplattestvnet',
      vnetVmName = 'xplattestvmVnet';
    ...
    describe('create for vnet and endpoints: ', function () {
      ...
      it('Creating affinity group', function (done) {
      ...
      it('Create virtual network and assign VM', function (done) {
        suite.execute('network vnet create %s -a %s --json',
          vnetName, affinityName, function (result) {
            ...
            suite.execute('vm create --virtual-network-name %s -l %s %s %s "azureuser" "Pa$$word@123" --json',
              vnetName, location, vnetVmName, getImageName.imageName, function (result) {
                if (result.exitStatus == 1)
                  done(result.errorText, null);
                result.exitStatus.should.equal(0);
    ...
    describe('VM with Endpoint: ', function () {
