...
nock('https://management.core.windows.net:443')
  ...
  'x-ms-request-id': 'e99d8c917ca78d999dd356bb311c9502',
  date: 'Wed, 08 Apr 2015 01:07:58 GMT' });
 return result; },
function (nock) { 
var result = 
nock('https://management.core.windows.net:443')
...
.put('/5e7d1bb6-4953-44fe-8a54-43fbdb53b989/services/mobileservices/mobileservices/clitestnode2625/authsettings', '*')
  ...
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  'x-powered-by': 'ASP.NET',
  'x-ms-request-id': '11552d35b9b882a3a2a371c7346cdcdc',
  date: 'Wed, 08 Apr 2015 01:08:01 GMT' });
 return result; }]];