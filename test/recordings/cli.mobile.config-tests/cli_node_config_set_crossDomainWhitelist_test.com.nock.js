...
nock('https://management.core.windows.net:443')
  ...
  'x-ms-request-id': '6ecfd69e75cb8486a0294f71f840792f',
  date: 'Wed, 08 Apr 2015 01:07:55 GMT' });
 return result; },
function (nock) { 
var result = 
nock('https://management.core.windows.net:443')
...
.patch('/5e7d1bb6-4953-44fe-8a54-43fbdb53b989/services/mobileservices/mobileservices/clitestnode2625/settings', '*')
  ...
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  'x-powered-by': 'ASP.NET',
  'x-ms-request-id': '54f54fd768f5849a8c04cac191117a7d',
  date: 'Wed, 08 Apr 2015 01:07:56 GMT' });
 return result; }]];