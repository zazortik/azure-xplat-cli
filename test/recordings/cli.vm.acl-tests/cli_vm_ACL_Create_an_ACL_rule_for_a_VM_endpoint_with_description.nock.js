...
nock('http://management.core.windows.net:443')
  ...
  'x-ms-request-id': '55af786a415d9882a85f46fee20482b2',
  date: 'Fri, 22 Apr 2016 03:42:24 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
...
nock('http://management.core.windows.net:443')
  ...
  'x-ms-servedbyregion': 'ussouth3',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  'x-ms-request-id': '4ff296d205cb9f0caf9b16346732a0f7',
  date: 'Fri, 22 Apr 2016 03:42:25 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
...
.put('/e33f361b-53c2-4cc7-b829-78906708387b/services/hostedservices/clitestvm4864/deployments/clitestvm4864/roles/clitestvm4864', '*')
  ...
  'x-ms-servedbyregion': 'ussouth3',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  'x-ms-request-id': '92685504fc2e92658432b6c6a1b45bea',
  date: 'Fri, 22 Apr 2016 03:42:26 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
...
var result = 
nock('http://management.core.windows.net:443')
  .get('/e33f361b-53c2-4cc7-b829-78906708387b/operations/92685504fc2e92658432b6c6a1b45bea')
  .reply(200, "<Operation xmlns=\"http://schemas.microsoft.com/windowsazure\" xmlns:i=\"http://www.w3.org/2001/XMLSchema-instance\"><ID>92685504-fc2e-9265-8432-b6c6a1b45bea</ID><Status>Succeeded</Status><HttpStatusCode>200</HttpStatusCode></Operation>", { 'cache-control': 'no-cache',
  'content-length': '232',
  'content-type': 'application/xml; charset=utf-8',
  server: '1.0.6198.357 (rd_rdfe_stable.160413-1538) Microsoft-HTTPAPI/2.0',
  'x-ms-servedbyregion': 'ussouth3',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  'x-ms-request-id': '4816a4dab1a3997990bacb8034caa496',
  date: 'Fri, 22 Apr 2016 03:42:56 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
