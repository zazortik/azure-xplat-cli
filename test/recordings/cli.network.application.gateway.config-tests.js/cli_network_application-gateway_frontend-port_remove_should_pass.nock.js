...
nock('http://management.core.windows.net:443')
  ...
  'x-ms-request-id': '5d3f1476b2a206d0812db7086ca786a9',
  date: 'Wed, 26 Aug 2015 10:26:37 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
...
.post('/5893435f-6990-4bb3-bebb-b12f3535f990/services/networking/ApplicationGateways/CliTestAppGate/configuration?api-version=2015-04-01', '*')
  .reply(202, "<GatewayOperationAsyncResponse xmlns=\"http://schemas.microsoft.com/windowsazure\" xmlns:i=\"http://www.w3.org/2001/XMLSchema-instance\"><ID>de6e063c-4063-4ebf-9b62-5748cab31788</ID></GatewayOperationAsyncResponse>", { 'cache-control': 'no-cache',
  'content-length': '210',
  'content-type': 'application/xml; charset=utf-8',
  server: '1.0.6198.257 (rd_rdfe_stable.150819-0641) Microsoft-HTTPAPI/2.0',
  'x-ms-servedbyregion': 'ussouth3',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  'x-ms-request-id': '56a98d35d5420f84bafce755c3b72acd',
  date: 'Wed, 26 Aug 2015 10:26:40 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
...
var result = 
nock('http://management.core.windows.net:443')
  .get('/5893435f-6990-4bb3-bebb-b12f3535f990/services/networking/operation/de6e063c-4063-4ebf-9b62-5748cab31788')
  .reply(200, "<GatewayOperation xmlns=\"http://schemas.microsoft.com/windowsazure\" xmlns:i=\"http://www.w3.org/2001/XMLSchema-instance\"><Data/><HttpStatusCode>OK</HttpStatusCode><ID>de6e063c-4063-4ebf-9b62-5748cab31788</ID><OperationCompletedTime>2015-08-26T10:26:44.4398544</OperationCompletedTime><OperationStartedTime>2015-08-26T10:26:41.1996677</OperationStartedTime><Status>Successful</Status></GatewayOperation>", { 'cache-control': 'no-cache',
  'content-length': '401',
  'content-type': 'application/xml; charset=utf-8',
  server: '1.0.6198.257 (rd_rdfe_stable.150819-0641) Microsoft-HTTPAPI/2.0',
  'x-ms-servedbyregion': 'ussouth3',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  'x-ms-request-id': 'a3f1e7e4114904c2afbb024abbd4b431',
  date: 'Wed, 26 Aug 2015 10:27:12 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
