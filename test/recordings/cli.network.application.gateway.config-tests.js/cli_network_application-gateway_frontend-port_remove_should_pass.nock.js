...
nock('http://management.core.windows.net:443')
  ...
  'x-ms-request-id': '3a0d0989ffd0b0e3a1e3f8ff68fe6d9c',
  date: 'Wed, 17 Jun 2015 08:45:26 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
...
.post('/bfb5e0bf-124b-4d0c-9352-7c0a9f4d9948/services/appgwprodnext/ApplicationGateways/CliTestAppGate/configuration?api-version=1.0', '*')
  .reply(202, "<GatewayOperationAsyncResponse xmlns=\"http://schemas.microsoft.com/windowsazure\" xmlns:i=\"http://www.w3.org/2001/XMLSchema-instance\"><ID>68c27e52-8b76-42e0-803e-d55af67539fb</ID></GatewayOperationAsyncResponse>", { 'cache-control': 'no-cache',
  'content-length': '210',
  'content-type': 'application/xml; charset=utf-8',
  server: '1.0.6198.240 (rd_rdfe_stable.150608-1900) Microsoft-HTTPAPI/2.0 Microsoft-HTTPAPI/2.0',
  'x-ms-servedbyregion': 'usnorth2',
  'x-ms-request-id': 'f3094c230ec3b4d6a48b9648cfaff6e2',
  date: 'Wed, 17 Jun 2015 08:45:35 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
...
var result = 
nock('http://management.core.windows.net:443')
  .get('/bfb5e0bf-124b-4d0c-9352-7c0a9f4d9948/services/appgwprodnext/operation/68c27e52-8b76-42e0-803e-d55af67539fb')
  .reply(200, "<GatewayOperation xmlns=\"http://schemas.microsoft.com/windowsazure\" xmlns:i=\"http://www.w3.org/2001/XMLSchema-instance\"><Data/><HttpStatusCode>OK</HttpStatusCode><ID>68c27e52-8b76-42e0-803e-d55af67539fb</ID><OperationCompletedTime>2015-06-17T08:45:38.1841991</OperationCompletedTime><OperationStartedTime>2015-06-17T08:45:35.4620725</OperationStartedTime><Status>Successful</Status></GatewayOperation>", { 'cache-control': 'no-cache',
  'content-length': '401',
  'content-type': 'application/xml; charset=utf-8',
  server: '1.0.6198.240 (rd_rdfe_stable.150608-1900) Microsoft-HTTPAPI/2.0 Microsoft-HTTPAPI/2.0',
  'x-ms-servedbyregion': 'usnorth2',
  'x-ms-request-id': '9c1bd782d5fbb374989eb87815fef123',
  date: 'Wed, 17 Jun 2015 08:46:07 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
