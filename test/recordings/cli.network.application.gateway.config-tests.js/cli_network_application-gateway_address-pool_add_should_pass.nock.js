...
nock('http://management.core.windows.net:443')
  ...
  'x-ms-request-id': 'c7b6793abe3e9cf1a3db0679b00d5af1',
  date: 'Mon, 25 Apr 2016 09:45:48 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
...
.post('/2c224e7e-3ef5-431d-a57b-e71f4662e3a6/services/networking/ApplicationGateways/CliTestAppGate/configuration?api-version=2016-03-01', '*')
  .reply(202, "<GatewayOperationAsyncResponse xmlns=\"http://schemas.microsoft.com/windowsazure\" xmlns:i=\"http://www.w3.org/2001/XMLSchema-instance\"><ID>60c6902d-64d8-429d-a01a-97dcf9c12413</ID></GatewayOperationAsyncResponse>", { 'cache-control': 'no-cache',
  'content-length': '210',
  'content-type': 'application/xml; charset=utf-8',
  server: '1.0.6198.357 (rd_rdfe_stable.160413-1538) Microsoft-HTTPAPI/2.0',
  'x-ms-servedbyregion': 'ussouth3',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  'x-ms-request-id': '254ff107f05e9b7a99b16eb8b3dfebcc',
  date: 'Mon, 25 Apr 2016 09:45:53 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
...
var result = 
nock('http://management.core.windows.net:443')
  .get('/2c224e7e-3ef5-431d-a57b-e71f4662e3a6/services/networking/operation/60c6902d-64d8-429d-a01a-97dcf9c12413')
  .reply(200, "<GatewayOperation xmlns=\"http://schemas.microsoft.com/windowsazure\" xmlns:i=\"http://www.w3.org/2001/XMLSchema-instance\"><Data/><HealthStatus/><HttpStatusCode>OK</HttpStatusCode><ID>60c6902d-64d8-429d-a01a-97dcf9c12413</ID><OperationCompletedTime>2016-04-25T09:45:55.199576</OperationCompletedTime><OperationStartedTime>2016-04-25T09:45:51.9727404</OperationStartedTime><Status>Successful</Status></GatewayOperation>", { 'cache-control': 'no-cache',
  'content-length': '415',
  'content-type': 'application/xml; charset=utf-8',
  server: '1.0.6198.357 (rd_rdfe_stable.160413-1538) Microsoft-HTTPAPI/2.0',
  'x-ms-servedbyregion': 'ussouth3',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  'x-ms-request-id': 'fe4d57ca87699b659877a3cfcdc10933',
  date: 'Mon, 25 Apr 2016 09:46:25 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
