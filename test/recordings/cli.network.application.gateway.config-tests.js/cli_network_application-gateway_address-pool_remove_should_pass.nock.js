...
nock('http://management.core.windows.net:443')
  ...
  'x-ms-request-id': '7e181377d637072aaf6519326cca2bab',
  date: 'Wed, 26 Aug 2015 10:27:51 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
...
.post('/5893435f-6990-4bb3-bebb-b12f3535f990/services/networking/ApplicationGateways/CliTestAppGate/configuration?api-version=2015-04-01', '*')
  .reply(202, "<GatewayOperationAsyncResponse xmlns=\"http://schemas.microsoft.com/windowsazure\" xmlns:i=\"http://www.w3.org/2001/XMLSchema-instance\"><ID>938d8279-411b-4d74-9fcf-963e3efead09</ID></GatewayOperationAsyncResponse>", { 'cache-control': 'no-cache',
  'content-length': '210',
  'content-type': 'application/xml; charset=utf-8',
  server: '1.0.6198.257 (rd_rdfe_stable.150819-0641) Microsoft-HTTPAPI/2.0',
  'x-ms-servedbyregion': 'ussouth3',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  'x-ms-request-id': '851ec8fff04209bc90ea6d5f0c1d9a5f',
  date: 'Wed, 26 Aug 2015 10:27:55 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
...
var result = 
nock('http://management.core.windows.net:443')
  .get('/5893435f-6990-4bb3-bebb-b12f3535f990/services/networking/operation/938d8279-411b-4d74-9fcf-963e3efead09')
  .reply(200, "<GatewayOperation xmlns=\"http://schemas.microsoft.com/windowsazure\" xmlns:i=\"http://www.w3.org/2001/XMLSchema-instance\"><Data/><HttpStatusCode>OK</HttpStatusCode><ID>938d8279-411b-4d74-9fcf-963e3efead09</ID><OperationCompletedTime>2015-08-26T10:28:02.1845255</OperationCompletedTime><OperationStartedTime>2015-08-26T10:27:55.8498618</OperationStartedTime><Status>Successful</Status></GatewayOperation>", { 'cache-control': 'no-cache',
  'content-length': '401',
  'content-type': 'application/xml; charset=utf-8',
  server: '1.0.6198.257 (rd_rdfe_stable.150819-0641) Microsoft-HTTPAPI/2.0',
  'x-ms-servedbyregion': 'ussouth3',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  'x-ms-request-id': '2ef0ecef6dd8073d8cf46994cacc7e13',
  date: 'Wed, 26 Aug 2015 10:28:27 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
