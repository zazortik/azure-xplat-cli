...
nock('http://management.core.windows.net:443')
  ...
  'x-ms-request-id': '479299988115906e96fcefef69393ee2',
  date: 'Mon, 25 Apr 2016 08:43:33 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
...
var result = 
nock('http://management.core.windows.net:443')
  .delete('/2c224e7e-3ef5-431d-a57b-e71f4662e3a6/services/networking/networksecuritygroups/xplatTestNsg/rules/xplatTestNsgRule')
  .reply(202, "", { 'cache-control': 'no-cache',
  'content-length': '0',
  server: '1.0.6198.357 (rd_rdfe_stable.160413-1538) Microsoft-HTTPAPI/2.0',
  'x-ms-servedbyregion': 'ussouth3',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  'x-ms-request-id': '713cb63e6026942eb706a4a392f8ea3f',
  date: 'Mon, 25 Apr 2016 08:43:34 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
...
var result = 
nock('http://management.core.windows.net:443')
  .get('/2c224e7e-3ef5-431d-a57b-e71f4662e3a6/operations/713cb63e6026942eb706a4a392f8ea3f')
  .reply(200, "<Operation xmlns=\"http://schemas.microsoft.com/windowsazure\" xmlns:i=\"http://www.w3.org/2001/XMLSchema-instance\"><ID>713cb63e-6026-942e-b706-a4a392f8ea3f</ID><Status>Succeeded</Status><HttpStatusCode>200</HttpStatusCode></Operation>", { 'cache-control': 'no-cache',
  'content-length': '232',
  'content-type': 'application/xml; charset=utf-8',
  server: '1.0.6198.357 (rd_rdfe_stable.160413-1538) Microsoft-HTTPAPI/2.0',
  'x-ms-servedbyregion': 'ussouth3',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  'x-ms-request-id': '34f2188cdbc492f49a764e6eef0567d9',
  date: 'Mon, 25 Apr 2016 08:44:06 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
