...
nock('https://management.azure.com:443')
  ...
  'x-ms-request-id': '3677c677-e1a9-4068-ab66-1f80cf9561f3',
  server: 'Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-reads': '14766',
  'x-ms-correlation-request-id': '5c3fd53b-43ca-4863-8367-ca37fd5328b0',
  'x-ms-routing-request-id': 'WESTEUROPE:20160815T170610Z:5c3fd53b-43ca-4863-8367-ca37fd5328b0',
  date: 'Mon, 15 Aug 2016 17:06:10 GMT' });
 return result; },
function (nock) { 
var result = 
nock('https://management.azure.com:443')
  .get('/subscriptions/2c224e7e-3ef5-431d-a57b-e71f4662e3a6/resourceGroups/xplatTestGExtension5553/providers/Microsoft.Compute/virtualMachines/xplatvmExt/extensions/VMAccessAgent?$expand=instanceView&api-version=2016-03-30')
  ...
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  'x-ms-served-by': 'f1952173-7412-4020-8c98-fffca6509750_131118073625769552',
  'x-ms-request-id': '1c364f81-7cf3-44bd-93a3-d1d0a4fefe8f',
  server: 'Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-reads': '14955',
  'x-ms-correlation-request-id': 'd8e69139-c006-481a-b591-ee44d0287374',
  'x-ms-routing-request-id': 'WESTEUROPE:20160815T170611Z:d8e69139-c006-481a-b591-ee44d0287374',
  date: 'Mon, 15 Aug 2016 17:06:10 GMT' });
 return result; },
function (nock) { 
var result = 
nock('https://management.azure.com:443')
  .delete('/subscriptions/2c224e7e-3ef5-431d-a57b-e71f4662e3a6/resourceGroups/xplatTestGExtension5553/providers/Microsoft.Compute/virtualMachines/xplatvmExt/extensions/VMAccessAgent?api-version=2016-03-30')
  .reply(202, "", { 'cache-control': 'no-cache',
  pragma: 'no-cache',
  'content-length': '0',
  expires: '-1',
  location: 'https://management.azure.com/subscriptions/2c224e7e-3ef5-431d-a57b-e71f4662e3a6/providers/Microsoft.Compute/locations/eastus/operations/04725c42-5eff-42be-9d17-47970109df4f?monitor=true&api-version=2016-03-30',
  'azure-asyncoperation': 'https://management.azure.com/subscriptions/2c224e7e-3ef5-431d-a57b-e71f4662e3a6/providers/Microsoft.Compute/locations/eastus/operations/04725c42-5eff-42be-9d17-47970109df4f?api-version=2016-03-30',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  'x-ms-served-by': 'f1952173-7412-4020-8c98-fffca6509750_131118073625769552',
  'x-ms-request-id': '04725c42-5eff-42be-9d17-47970109df4f',
  server: 'Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-writes': '1187',
  'x-ms-correlation-request-id': '1e6250a9-1ead-42e0-ad84-d533c83f25d6',
  'x-ms-routing-request-id': 'WESTEUROPE:20160815T170612Z:1e6250a9-1ead-42e0-ad84-d533c83f25d6',
  date: 'Mon, 15 Aug 2016 17:06:12 GMT' });
 return result; },
function (nock) { 
var result = 
nock('https://management.azure.com:443')
  .get('/subscriptions/2c224e7e-3ef5-431d-a57b-e71f4662e3a6/providers/Microsoft.Compute/locations/eastus/operations/04725c42-5eff-42be-9d17-47970109df4f?api-version=2016-03-30')
  .reply(200, "{\r\n  \"startTime\": \"2016-08-15T17:06:10.5423887+00:00\",\r\n  \"status\": \"InProgress\",\r\n  \"name\": \"04725c42-5eff-42be-9d17-47970109df4f\"\r\n}", { 'cache-control': 'no-cache',
  pragma: 'no-cache',
  'content-length': '134',
  'content-type': 'application/json; charset=utf-8',
  expires: '-1',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  'x-ms-served-by': 'f1952173-7412-4020-8c98-fffca6509750_131118073625769552',
  'x-ms-request-id': '2877bfec-9d27-4b3d-810c-e88dbef0d78b',
  server: 'Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-reads': '14968',
  'x-ms-correlation-request-id': '955284fa-fe41-4de9-baca-4b8ca361b80a',
  'x-ms-routing-request-id': 'WESTEUROPE:20160815T170643Z:955284fa-fe41-4de9-baca-4b8ca361b80a',
  date: 'Mon, 15 Aug 2016 17:06:42 GMT' });
 return result; },
function (nock) { 
var result = 
nock('https://management.azure.com:443')
  .get('/subscriptions/2c224e7e-3ef5-431d-a57b-e71f4662e3a6/providers/Microsoft.Compute/locations/eastus/operations/04725c42-5eff-42be-9d17-47970109df4f?api-version=2016-03-30')
  .reply(200, "{\r\n  \"startTime\": \"2016-08-15T17:06:10.5423887+00:00\",\r\n  \"endTime\": \"2016-08-15T17:07:06.8388666+00:00\",\r\n  \"status\": \"Succeeded\",\r\n  \"name\": \"04725c42-5eff-42be-9d17-47970109df4f\"\r\n}", { 'cache-control': 'no-cache',
  pragma: 'no-cache',
  'content-length': '184',
  'content-type': 'application/json; charset=utf-8',
  expires: '-1',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  'x-ms-served-by': 'f1952173-7412-4020-8c98-fffca6509750_131118073625769552',
  'x-ms-request-id': 'ef93f96b-42bd-4502-b5c8-7d1dc4ee5ac9',
  server: 'Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-reads': '14957',
  'x-ms-correlation-request-id': '4ae73be4-d291-47d8-9457-8eba3402d24b',
  'x-ms-routing-request-id': 'WESTEUROPE:20160815T170714Z:4ae73be4-d291-47d8-9457-8eba3402d24b',
  date: 'Mon, 15 Aug 2016 17:07:13 GMT' });
 return result; }]];
