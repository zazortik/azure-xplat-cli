...
nock('http://management.azure.com:443')
  ...
  'x-ms-request-id': '469bc6b9-3933-432a-ab04-c44cdd3ff32d',
  server: 'Microsoft-HTTPAPI/2.0, Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-reads': '14954',
  'x-ms-correlation-request-id': '8a71e99a-2828-49b3-9251-f6384dc832b8',
  'x-ms-routing-request-id': 'SOUTHINDIA:20160617T102554Z:8a71e99a-2828-49b3-9251-f6384dc832b8',
  date: 'Fri, 17 Jun 2016 10:25:54 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
...
var result = 
nock('http://management.azure.com:443')
  .get('/subscriptions/cffbd00f-9edf-41f9-8f74-4a6ec260dcb8/resourceGroups/xplatTestGExtension3298/providers/Microsoft.Compute/virtualMachines/xplatvmExt/extensions/VMAccessAgent?$expand=instanceView&api-version=2016-03-30')
  ...
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  'x-ms-served-by': '01eb2e40-e2b7-4708-9a67-7dae2c14e507_131097912153451731',
  'x-ms-request-id': 'fa6c5826-a196-47f2-9c4e-56214689fa94',
  server: 'Microsoft-HTTPAPI/2.0, Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-reads': '14961',
  'x-ms-correlation-request-id': 'e2e904f0-163b-4fe4-9377-b212366bc2ec',
  'x-ms-routing-request-id': 'SOUTHINDIA:20160617T102556Z:e2e904f0-163b-4fe4-9377-b212366bc2ec',
  date: 'Fri, 17 Jun 2016 10:25:56 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
...
var result = 
nock('http://management.azure.com:443')
  .delete('/subscriptions/cffbd00f-9edf-41f9-8f74-4a6ec260dcb8/resourceGroups/xplatTestGExtension3298/providers/Microsoft.Compute/virtualMachines/xplatvmExt/extensions/VMAccessAgent?api-version=2016-03-30')
  .reply(202, "", { 'cache-control': 'no-cache',
  pragma: 'no-cache',
  'content-length': '0',
  expires: '-1',
  location: 'https://management.azure.com/subscriptions/cffbd00f-9edf-41f9-8f74-4a6ec260dcb8/providers/Microsoft.Compute/locations/eastus/operations/eaaf11e3-e118-4fc1-bfbc-d44e2f588210?monitor=true&api-version=2016-03-30',
  'azure-asyncoperation': 'https://management.azure.com/subscriptions/cffbd00f-9edf-41f9-8f74-4a6ec260dcb8/providers/Microsoft.Compute/locations/eastus/operations/eaaf11e3-e118-4fc1-bfbc-d44e2f588210?api-version=2016-03-30',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  'x-ms-served-by': '01eb2e40-e2b7-4708-9a67-7dae2c14e507_131097912153451731',
  'x-ms-request-id': 'eaaf11e3-e118-4fc1-bfbc-d44e2f588210',
  server: 'Microsoft-HTTPAPI/2.0, Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-writes': '1192',
  'x-ms-correlation-request-id': '831fad2e-dc8f-4cdf-80da-d20666324256',
  'x-ms-routing-request-id': 'SOUTHINDIA:20160617T102558Z:831fad2e-dc8f-4cdf-80da-d20666324256',
  date: 'Fri, 17 Jun 2016 10:25:57 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
...
var result = 
nock('http://management.azure.com:443')
  .get('/subscriptions/cffbd00f-9edf-41f9-8f74-4a6ec260dcb8/providers/Microsoft.Compute/locations/eastus/operations/eaaf11e3-e118-4fc1-bfbc-d44e2f588210?api-version=2016-03-30')
  .reply(200, "{\r\n  \"startTime\": \"2016-06-17T10:25:59.1588109+00:00\",\r\n  \"status\": \"InProgress\",\r\n  \"name\": \"eaaf11e3-e118-4fc1-bfbc-d44e2f588210\"\r\n}", { 'cache-control': 'no-cache',
  pragma: 'no-cache',
  'content-length': '134',
  'content-type': 'application/json; charset=utf-8',
  expires: '-1',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  'x-ms-served-by': '01eb2e40-e2b7-4708-9a67-7dae2c14e507_131097912153451731',
  'x-ms-request-id': '231b779f-86fe-444c-8368-b6e13253e6e1',
  server: 'Microsoft-HTTPAPI/2.0, Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-reads': '14948',
  'x-ms-correlation-request-id': 'bd55172a-6c38-47ff-b314-72ed02d72530',
  'x-ms-routing-request-id': 'SOUTHINDIA:20160617T102629Z:bd55172a-6c38-47ff-b314-72ed02d72530',
  date: 'Fri, 17 Jun 2016 10:26:29 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
...
nock('http://management.azure.com:443')
  .get('/subscriptions/cffbd00f-9edf-41f9-8f74-4a6ec260dcb8/providers/Microsoft.Compute/locations/eastus/operations/eaaf11e3-e118-4fc1-bfbc-d44e2f588210?api-version=2016-03-30')
  .reply(200, "{\r\n  \"startTime\": \"2016-06-17T10:25:59.1588109+00:00\",\r\n  \"endTime\": \"2016-06-17T10:26:39.9400947+00:00\",\r\n  \"status\": \"Succeeded\",\r\n  \"name\": \"eaaf11e3-e118-4fc1-bfbc-d44e2f588210\"\r\n}", { 'cache-control': 'no-cache',
  pragma: 'no-cache',
  'content-length': '184',
  'content-type': 'application/json; charset=utf-8',
  expires: '-1',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  'x-ms-served-by': '01eb2e40-e2b7-4708-9a67-7dae2c14e507_131097912153451731',
  'x-ms-request-id': 'c4fa21c9-9229-4e69-b2b3-1db0a058401a',
  server: 'Microsoft-HTTPAPI/2.0, Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-reads': '14960',
  'x-ms-correlation-request-id': '09f26c05-7630-489b-945a-194631f3b666',
  'x-ms-routing-request-id': 'SOUTHINDIA:20160617T102701Z:09f26c05-7630-489b-945a-194631f3b666',
  date: 'Fri, 17 Jun 2016 10:27:00 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
