...
nock('https://management.azure.com:443')
  ...
  'x-ms-request-id': '2453a4f5-dcd3-43eb-b227-6bb319f72083',
  server: 'Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-reads': '14967',
  'x-ms-correlation-request-id': '44a58d46-6431-43f5-973d-621beedc2fff',
  'x-ms-routing-request-id': 'WESTEUROPE:20160815T170048Z:44a58d46-6431-43f5-973d-621beedc2fff',
  date: 'Mon, 15 Aug 2016 17:00:47 GMT' });
 return result; },
function (nock) { 
var result = 
nock('https://management.azure.com:443')
  .filteringRequestBody(function (path) { return '*';})
.put('/subscriptions/2c224e7e-3ef5-431d-a57b-e71f4662e3a6/resourceGroups/xplatTestGExtension5553/providers/Microsoft.Compute/virtualMachines/xplatvmExt/extensions/VMAccessAgent?api-version=2016-03-30', '*')
  ...
  'content-type': 'application/json; charset=utf-8',
  expires: '-1',
  'azure-asyncoperation': 'https://management.azure.com/subscriptions/2c224e7e-3ef5-431d-a57b-e71f4662e3a6/providers/Microsoft.Compute/locations/eastus/operations/76864a4d-0d2f-4159-bed8-ff5880397827?api-version=2016-03-30',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  'x-ms-served-by': 'f1952173-7412-4020-8c98-fffca6509750_131118073625769552',
  'x-ms-request-id': '76864a4d-0d2f-4159-bed8-ff5880397827',
  server: 'Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-writes': '1191',
  'x-ms-correlation-request-id': 'acefbef5-561c-4092-bc09-fe90d433d012',
  'x-ms-routing-request-id': 'WESTEUROPE:20160815T170051Z:acefbef5-561c-4092-bc09-fe90d433d012',
  date: 'Mon, 15 Aug 2016 17:00:50 GMT' });
 return result; },
function (nock) { 
var result = 
nock('https://management.azure.com:443')
  .get('/subscriptions/2c224e7e-3ef5-431d-a57b-e71f4662e3a6/providers/Microsoft.Compute/locations/eastus/operations/76864a4d-0d2f-4159-bed8-ff5880397827?api-version=2016-03-30')
  .reply(200, "{\r\n  \"startTime\": \"2016-08-15T17:00:48.6688124+00:00\",\r\n  \"status\": \"InProgress\",\r\n  \"name\": \"76864a4d-0d2f-4159-bed8-ff5880397827\"\r\n}", { 'cache-control': 'no-cache',
  pragma: 'no-cache',
  'content-length': '134',
  'content-type': 'application/json; charset=utf-8',
  expires: '-1',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  'x-ms-served-by': 'f1952173-7412-4020-8c98-fffca6509750_131118073625769552',
  'x-ms-request-id': '87f0d7fa-d6ce-4698-ae06-6d6bc16076bd',
  server: 'Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-reads': '14934',
  'x-ms-correlation-request-id': '35787841-92e1-4e3b-bf3a-13d08f9cdd8f',
  'x-ms-routing-request-id': 'WESTEUROPE:20160815T170121Z:35787841-92e1-4e3b-bf3a-13d08f9cdd8f',
  date: 'Mon, 15 Aug 2016 17:01:21 GMT' });
 return result; },
function (nock) { 
var result = 
nock('https://management.azure.com:443')
  .get('/subscriptions/2c224e7e-3ef5-431d-a57b-e71f4662e3a6/providers/Microsoft.Compute/locations/eastus/operations/76864a4d-0d2f-4159-bed8-ff5880397827?api-version=2016-03-30')
  .reply(200, "{\r\n  \"startTime\": \"2016-08-15T17:00:48.6688124+00:00\",\r\n  \"endTime\": \"2016-08-15T17:01:39.2938157+00:00\",\r\n  \"status\": \"Succeeded\",\r\n  \"name\": \"76864a4d-0d2f-4159-bed8-ff5880397827\"\r\n}", { 'cache-control': 'no-cache',
  pragma: 'no-cache',
  'content-length': '184',
  'content-type': 'application/json; charset=utf-8',
  expires: '-1',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  'x-ms-served-by': 'f1952173-7412-4020-8c98-fffca6509750_131118073625769552',
  'x-ms-request-id': '78280cb8-3b8c-40e7-9ae5-f664e3976968',
  server: 'Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-reads': '14956',
  'x-ms-correlation-request-id': 'cddcc481-0089-4978-88aa-ce3b13b0df7c',
  'x-ms-routing-request-id': 'WESTEUROPE:20160815T170152Z:cddcc481-0089-4978-88aa-ce3b13b0df7c',
  date: 'Mon, 15 Aug 2016 17:01:52 GMT' });
 return result; },
function (nock) { 
var result = 
nock('https://management.azure.com:443')
  .get('/subscriptions/2c224e7e-3ef5-431d-a57b-e71f4662e3a6/resourceGroups/xplatTestGExtension5553/providers/Microsoft.Compute/virtualMachines/xplatvmExt/extensions/VMAccessAgent?api-version=2016-03-30')
  .reply(200, "{\r\n  \"properties\": {\r\n    \"publisher\": \"Microsoft.Compute\",\r\n    \"type\": \"VMAccessAgent\",\r\n    \"typeHandlerVersion\": \"2.0\",\r\n    \"autoUpgradeMinorVersion\": false,\r\n    \"provisioningState\": \"Succeeded\"\r\n  },\r\n  \"id\": \"/subscriptions/2c224e7e-3ef5-431d-a57b-e71f4662e3a6/resourceGroups/xplatTestGExtension5553/providers/Microsoft.Compute/virtualMachines/xplatvmExt/extensions/VMAccessAgent\",\r\n  \"name\": \"VMAccessAgent\",\r\n  \"type\": \"Microsoft.Compute/virtualMachines/extensions\",\r\n  \"location\": \"eastus\"\r\n}", { 'cache-control': 'no-cache',
  pragma: 'no-cache',
  'content-length': '503',
  'content-type': 'application/json; charset=utf-8',
  ...
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  'x-ms-served-by': 'f1952173-7412-4020-8c98-fffca6509750_131118073625769552',
  'x-ms-request-id': 'b092987e-cb66-4382-9dfa-a2119e391f9a',
  server: 'Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-reads': '14943',
  'x-ms-correlation-request-id': '3893ac9c-62af-4c03-b93d-8006a7d34f85',
  'x-ms-routing-request-id': 'WESTEUROPE:20160815T170153Z:3893ac9c-62af-4c03-b93d-8006a7d34f85',
  date: 'Mon, 15 Aug 2016 17:01:53 GMT' });
 return result; }]];
