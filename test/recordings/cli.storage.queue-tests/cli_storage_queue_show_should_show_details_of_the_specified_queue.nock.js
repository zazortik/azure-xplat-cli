...
nock('https://teststorage101.queue.core.windows.net:443')
  ...
  'x-ms-request-id': '1e1877a6-0003-0067-0bb2-3672c3000000',
  'x-ms-version': '2014-02-14',
  'x-ms-approximate-messages-count': '0',
  date: 'Fri, 13 Mar 2015 03:51:05 GMT' });
 return result; },
function (nock) { 
var result = 
nock('https://teststorage101.queue.core.windows.net:443')
  ...
  'transfer-encoding': 'chunked',
  server: 'Windows-Azure-Queue/1.0 Microsoft-HTTPAPI/2.0',
  'x-ms-request-id': 'f5accdfb-0003-002b-18d8-9ac740000000',
  'x-ms-version': '2014-02-14',
  'x-ms-approximate-messages-count': '0',
  date: 'Fri, 13 Mar 2015 03:51:06 GMT' });
 return result; },
function (nock) { 
var result = 
nock('https://teststorage101.queue.core.windows.net:443')
  ...
  server: 'Windows-Azure-Queue/1.0 Microsoft-HTTPAPI/2.0',
  'x-ms-request-id': 'df4e9c91-0003-0004-5a0f-639a04000000',
  'x-ms-version': '2014-02-14',
