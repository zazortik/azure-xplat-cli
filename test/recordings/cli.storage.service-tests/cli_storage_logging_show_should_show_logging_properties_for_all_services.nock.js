...
nock('https://teststorage101.blob.core.windows.net:443')
  ...
  'x-ms-request-id': 'f4ac6c66-0001-0058-6426-10676b000000',
...
nock('https://teststorage101.table.core.windows.net:443')
  ...
  'x-ms-request-id': 'bdb81863-0002-0045-762f-a7c146000000',
  'x-ms-version': '2014-02-14',
  date: 'Fri, 13 Mar 2015 03:51:07 GMT' });
 return result; },
function (nock) { 
...
nock('https://teststorage101.queue.core.windows.net:443')
  ...
  'x-ms-request-id': '5e3eaea7-0003-0054-7dae-b505ad000000',
  'x-ms-version': '2014-02-14',
  date: 'Fri, 13 Mar 2015 03:51:07 GMT' });
 return result; }]];