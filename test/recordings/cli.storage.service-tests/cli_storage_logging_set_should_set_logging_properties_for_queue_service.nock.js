...
nock('http://xplat.queue.core.windows.net:443')
  ...
  'x-ms-request-id': '20b71901-0003-0036-6cd2-bf3b55000000',
...
.put('/?comp=properties&restype=service', '*')
  ...
  server: 'Windows-Azure-Queue/1.0 Microsoft-HTTPAPI/2.0',
  'x-ms-request-id': '0e00eed5-0003-0031-35d2-bfcdd0000000',
  'x-ms-version': '2015-04-05',
  date: 'Mon, 06 Jun 2016 09:03:34 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
...
nock('http://xplat.queue.core.windows.net:443')
  ...
  'content-type': 'application/xml',
  server: 'Windows-Azure-Queue/1.0 Microsoft-HTTPAPI/2.0',
  'x-ms-request-id': '71fe0440-0003-0013-6bd2-bfa3e6000000',
  'x-ms-version': '2015-04-05',
