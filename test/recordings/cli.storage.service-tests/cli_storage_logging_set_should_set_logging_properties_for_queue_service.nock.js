...
nock('https://teststorage101.queue.core.windows.net:443')
  ...
  'x-ms-request-id': 'f09aaa4a-0003-007e-11d7-c56a33000000',
...
.put('/?comp=properties&restype=service', '*')
  ...
  server: 'Windows-Azure-Queue/1.0 Microsoft-HTTPAPI/2.0',
  'x-ms-request-id': '011c3680-0003-006a-75ee-702f07000000',
  'x-ms-version': '2014-02-14',
...
nock('https://teststorage101.queue.core.windows.net:443')
  ...
  'content-type': 'application/xml',
  server: 'Windows-Azure-Queue/1.0 Microsoft-HTTPAPI/2.0',
  'x-ms-request-id': '6f603492-0003-0042-80f5-35cf52000000',
  'x-ms-version': '2014-02-14',
  date: 'Fri, 13 Mar 2015 03:51:15 GMT' });
 return result; }]];