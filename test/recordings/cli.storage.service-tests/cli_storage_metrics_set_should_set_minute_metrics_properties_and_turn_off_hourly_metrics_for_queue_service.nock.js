...
nock('http://xplat.queue.core.windows.net:443')
  ...
  'x-ms-request-id': '36c38c31-0003-0008-3ed2-bf8d74000000',
...
.put('/?comp=properties&restype=service', '*')
  ...
  server: 'Windows-Azure-Queue/1.0 Microsoft-HTTPAPI/2.0',
  'x-ms-request-id': '2372829b-0003-0017-09d2-bf5664000000',
  'x-ms-version': '2015-04-05',
  date: 'Mon, 06 Jun 2016 09:03:43 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
...
nock('http://xplat.queue.core.windows.net:443')
  ...
  'content-type': 'application/xml',
  server: 'Windows-Azure-Queue/1.0 Microsoft-HTTPAPI/2.0',
  'x-ms-request-id': '7942ec48-0003-0048-61d2-bfa49a000000',
  'x-ms-version': '2015-04-05',
  date: 'Mon, 06 Jun 2016 09:03:43 GMT',
  connection: 'close' });
 return result; },
