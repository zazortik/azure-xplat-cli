...
nock('https://teststorage101.blob.core.windows.net:443')
  ...
  'x-ms-request-id': '58d8914f-0001-0070-5999-1d6769000000',
...
.put('/?comp=properties&restype=service', '*')
  ...
  server: 'Windows-Azure-Blob/1.0 Microsoft-HTTPAPI/2.0',
  'x-ms-request-id': 'f104e9f1-0001-005c-2073-489b79000000',
  'x-ms-version': '2014-02-14',
  date: 'Fri, 13 Mar 2015 03:51:20 GMT' });
 return result; },
function (nock) { 
var result = 
nock('https://teststorage101.blob.core.windows.net:443')
  ...
  'content-type': 'application/xml',
  server: 'Windows-Azure-Blob/1.0 Microsoft-HTTPAPI/2.0',
  'x-ms-request-id': '9865be4f-0001-000c-7b1d-b279e9000000',
  'x-ms-version': '2014-02-14',
  date: 'Fri, 13 Mar 2015 03:51:20 GMT' });
 return result; }]];