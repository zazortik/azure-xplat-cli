...
nock('https://teststorage101.blob.core.windows.net:443')
  ...
  'x-ms-request-id': '47d0957e-0001-0009-75b7-ec62a8000000',
...
.put('/?comp=properties&restype=service', '*')
  ...
  server: 'Windows-Azure-Blob/1.0 Microsoft-HTTPAPI/2.0',
  'x-ms-request-id': 'a76736f4-0001-0059-2fd3-e7adfb000000',
  'x-ms-version': '2014-02-14',
...
nock('https://teststorage101.blob.core.windows.net:443')
  ...
  'content-type': 'application/xml',
  server: 'Windows-Azure-Blob/1.0 Microsoft-HTTPAPI/2.0',
  'x-ms-request-id': '3ddc4a0d-0001-0045-4e29-e6fe62000000',
  'x-ms-version': '2014-02-14',
  date: 'Fri, 13 Mar 2015 03:51:11 GMT' });
 return result; }]];