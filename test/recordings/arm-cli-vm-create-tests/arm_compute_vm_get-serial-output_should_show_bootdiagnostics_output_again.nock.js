...
nock('http://management.azure.com:443')
  ...
  'x-ms-request-id': '76aef441-5c3b-4135-9982-2e4a1e5f9726',
  server: 'Microsoft-HTTPAPI/2.0, Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-reads': '14935',
  'x-ms-correlation-request-id': '4043d2c1-81d7-49b3-aa47-858580b41dc3',
  'x-ms-routing-request-id': 'SOUTHINDIA:20160628T152726Z:4043d2c1-81d7-49b3-aa47-858580b41dc3',
  date: 'Tue, 28 Jun 2016 15:27:26 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
...
nock('http://management.azure.com:443')
  ...
  expires: '-1',
  'x-ms-request-id': 'be04d5e0-06cd-419e-ba17-f167673d0053',
  server: 'Microsoft-Azure-Storage-Resource-Provider/1.0, Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-writes': '1187',
  'x-ms-correlation-request-id': 'be04d5e0-06cd-419e-ba17-f167673d0053',
  'x-ms-routing-request-id': 'SOUTHINDIA:20160628T152727Z:be04d5e0-06cd-419e-ba17-f167673d0053',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  date: 'Tue, 28 Jun 2016 15:27:26 GMT',
  connection: 'close' });
 return result; },
...
function (nock) { 
var result = 
nock('http://xplatteststorage13862.blob.core.windows.net:443')
  .head('/bootdiagnostics-xplatvm-446b6563-8ffe-406f-8046-6c8cd62ffe1e/xplatvm.446b6563-8ffe-406f-8046-6c8cd62ffe1e.serialconsole.log')
  .reply(404, "", { 'transfer-encoding': 'chunked',
  server: 'Windows-Azure-Blob/1.0 Microsoft-HTTPAPI/2.0',
  'x-ms-request-id': '00f633b2-0001-0022-4951-d1def8000000',
...
function (nock) { 
var result = 
nock('https://xplatteststorage13862.blob.core.windows.net:443')
  .head('/bootdiagnostics-xplatvm-446b6563-8ffe-406f-8046-6c8cd62ffe1e/xplatvm.446b6563-8ffe-406f-8046-6c8cd62ffe1e.serialconsole.log')
  .reply(404, "", { 'transfer-encoding': 'chunked',
  server: 'Windows-Azure-Blob/1.0 Microsoft-HTTPAPI/2.0',
  'x-ms-request-id': '00f633b2-0001-0022-4951-d1def8000000',
