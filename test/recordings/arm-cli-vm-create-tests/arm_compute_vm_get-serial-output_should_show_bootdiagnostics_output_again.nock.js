...
nock('http://management.azure.com:443')
  ...
  'x-ms-request-id': '97b7f44c-6ec4-4d45-b9e6-f469f0e06eb6',
  server: 'Microsoft-HTTPAPI/2.0, Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-reads': '14968',
  'x-ms-correlation-request-id': '2f84d2dd-9c2e-4d3f-94b6-f0eff78b920e',
  'x-ms-routing-request-id': 'WESTUS:20151226T050311Z:2f84d2dd-9c2e-4d3f-94b6-f0eff78b920e',
  date: 'Sat, 26 Dec 2015 05:03:11 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
...
nock('http://management.azure.com:443')
  ...
  expires: '-1',
  'x-ms-request-id': '68c7a04f-5b40-422c-9b91-bfb550d6564d',
  server: 'Microsoft-Azure-Storage-Resource-Provider/1.0, Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-writes': '1189',
  'x-ms-correlation-request-id': '68c7a04f-5b40-422c-9b91-bfb550d6564d',
  'x-ms-routing-request-id': 'WESTUS:20151226T050311Z:68c7a04f-5b40-422c-9b91-bfb550d6564d',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  date: 'Sat, 26 Dec 2015 05:03:11 GMT',
  connection: 'close' });
 return result; },
...
function (nock) { 
var result = 
nock('http://xplatteststorage18903.blob.core.windows.net:443')
  .head('/bootdiagnostics-xplatvm-f677852c-5ef1-4e5f-8ce9-1b3f4ec57a96/xplatvm.f677852c-5ef1-4e5f-8ce9-1b3f4ec57a96.serialconsole.log')
  .reply(404, "", { 'transfer-encoding': 'chunked',
  server: 'Windows-Azure-Blob/1.0 Microsoft-HTTPAPI/2.0',
  'x-ms-request-id': '885aa381-0001-011b-0d9a-3f92d9000000',
...
function (nock) { 
var result = 
nock('https://xplatteststorage18903.blob.core.windows.net:443')
  .head('/bootdiagnostics-xplatvm-f677852c-5ef1-4e5f-8ce9-1b3f4ec57a96/xplatvm.f677852c-5ef1-4e5f-8ce9-1b3f4ec57a96.serialconsole.log')
  .reply(404, "", { 'transfer-encoding': 'chunked',
  server: 'Windows-Azure-Blob/1.0 Microsoft-HTTPAPI/2.0',
  'x-ms-request-id': '885aa381-0001-011b-0d9a-3f92d9000000',
