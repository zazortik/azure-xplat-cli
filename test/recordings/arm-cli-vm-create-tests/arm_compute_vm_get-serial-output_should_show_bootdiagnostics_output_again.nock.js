...
nock('http://management.azure.com:443')
  ...
  'x-ms-request-id': '886c7f9b-c1fd-47b3-af83-c2a8bfd2af5b',
  server: 'Microsoft-HTTPAPI/2.0, Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-reads': '14551',
  'x-ms-correlation-request-id': '48c63688-d2fc-4ca3-b573-2fa990750118',
  'x-ms-routing-request-id': 'WESTUS:20151010T003436Z:48c63688-d2fc-4ca3-b573-2fa990750118',
  date: 'Sat, 10 Oct 2015 00:34:36 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
...
nock('http://management.azure.com:443')
  ...
  expires: '-1',
  'x-ms-request-id': 'f0a40953-c4f9-4e02-ba1a-c9145780eba4',
  server: 'Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-writes': '1189',
  'x-ms-correlation-request-id': 'f0a40953-c4f9-4e02-ba1a-c9145780eba4',
  'x-ms-routing-request-id': 'WESTUS:20151010T003437Z:f0a40953-c4f9-4e02-ba1a-c9145780eba4',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  date: 'Sat, 10 Oct 2015 00:34:37 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
...
function (nock) { 
var result = 
nock('http://xplatteststorage12077.blob.core.windows.net:443')
  .head('/bootdiagnostics-xplattest-82bd394c-f574-440e-87a9-a417cc9ff2b3/xplattestvm.82bd394c-f574-440e-87a9-a417cc9ff2b3.serialconsole.log')
  .reply(404, "", { 'transfer-encoding': 'chunked',
  server: 'Windows-Azure-Blob/1.0 Microsoft-HTTPAPI/2.0',
  'x-ms-request-id': 'da5a7915-0001-0099-2df3-02142f000000',
...
function (nock) { 
var result = 
nock('https://xplatteststorage12077.blob.core.windows.net:443')
  .head('/bootdiagnostics-xplattest-82bd394c-f574-440e-87a9-a417cc9ff2b3/xplattestvm.82bd394c-f574-440e-87a9-a417cc9ff2b3.serialconsole.log')
  .reply(404, "", { 'transfer-encoding': 'chunked',
  server: 'Windows-Azure-Blob/1.0 Microsoft-HTTPAPI/2.0',
  'x-ms-request-id': 'da5a7915-0001-0099-2df3-02142f000000',
