...
nock('https://management.azure.com:443')
  ...
  'x-ms-request-id': '4b7ae982-d170-40b1-bdf0-7206a3a34c54',
  server: 'Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-reads': '14937',
  'x-ms-correlation-request-id': '2c15a902-37cd-4a17-84a1-c8f59b0ba84d',
  'x-ms-routing-request-id': 'WESTEUROPE:20160816T080223Z:2c15a902-37cd-4a17-84a1-c8f59b0ba84d',
  date: 'Tue, 16 Aug 2016 08:02:23 GMT' });
 return result; },
function (nock) { 
var result = 
nock('https://management.azure.com:443')
  ...
  expires: '-1',
  'x-ms-request-id': '9264fd4b-eaea-4100-bf6e-54db8c8960be',
  server: 'Microsoft-Azure-Storage-Resource-Provider/1.0',
  'x-ms-ratelimit-remaining-subscription-writes': '1195',
  'x-ms-correlation-request-id': '9264fd4b-eaea-4100-bf6e-54db8c8960be',
  'x-ms-routing-request-id': 'WESTEUROPE:20160816T080224Z:9264fd4b-eaea-4100-bf6e-54db8c8960be',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  date: 'Tue, 16 Aug 2016 08:02:24 GMT' });
 return result; },
function (nock) { 
var result = 
nock('https://xplatteststorage12584.blob.core.windows.net:443')
  .head('/bootdiagnostics-xplatvm-f9d2fee8-368a-414d-b098-17f47f8cff10/xplatvm.f9d2fee8-368a-414d-b098-17f47f8cff10.serialconsole.log')
  .reply(404, "", { 'transfer-encoding': 'chunked',
  server: 'Windows-Azure-Blob/1.0 Microsoft-HTTPAPI/2.0',
  'x-ms-request-id': '2caa9506-0001-0000-3394-f7db75000000',
  'x-ms-version': '2015-04-05',
  date: 'Tue, 16 Aug 2016 08:02:22 GMT' });
 return result; }]];