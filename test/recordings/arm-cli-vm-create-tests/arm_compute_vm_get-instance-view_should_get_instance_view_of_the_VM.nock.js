...
nock('http://management.azure.com:443')
  ...
  'x-ms-request-id': 'f7de0820-694f-4b7e-8a7e-598b9d1ce7e6',
  server: 'Microsoft-HTTPAPI/2.0, Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-reads': '14980',
  'x-ms-correlation-request-id': 'dec78328-276e-4786-9d5a-1179a46476be',
  'x-ms-routing-request-id': 'SOUTHEASTASIA:20150819T052613Z:dec78328-276e-4786-9d5a-1179a46476be',
  date: 'Wed, 19 Aug 2015 05:26:13 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
