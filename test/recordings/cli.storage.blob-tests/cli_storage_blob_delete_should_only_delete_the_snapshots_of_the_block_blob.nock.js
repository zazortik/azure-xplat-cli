...
nock('http://xplat.blob.core.windows.net:443')
  .delete('/storage-cli-blob-test/blockblobname757')
  .reply(202, "", { 'transfer-encoding': 'chunked',
  server: 'Windows-Azure-Blob/1.0 Microsoft-HTTPAPI/2.0',
  'x-ms-request-id': 'a3289643-0001-003d-044e-e22321000000',
...
nock('http://xplat.blob.core.windows.net:443')
  ...
  server: 'Windows-Azure-Blob/1.0 Microsoft-HTTPAPI/2.0',
  'x-ms-request-id': 'b941462d-0001-001a-264e-e2b968000000',
  'x-ms-version': '2015-04-05',
  'x-ms-write-protection': 'false',
  'x-ms-lease-status': 'unlocked',
  'x-ms-lease-state': 'broken',
  'x-ms-blob-type': 'BlockBlob',
  date: 'Wed, 20 Jul 2016 06:16:19 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
