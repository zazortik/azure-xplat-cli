...
nock('http://xplat.blob.core.windows.net:443')
  ...
  'x-ms-request-id': '21495bd1-0001-0000-535f-e29607000000',
  'x-ms-version': '2015-04-05',
  'x-ms-lease-id': '091ebdc5-3777-4a99-8797-21b49da3a6af',
  date: 'Wed, 20 Jul 2016 08:19:20 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
...
nock('http://xplat.blob.core.windows.net:443')
  ...
  etag: '"0x8D3B076733B9D7A"',
  server: 'Windows-Azure-Blob/1.0 Microsoft-HTTPAPI/2.0',
  'x-ms-request-id': '6d31b010-0001-0021-225f-e2fb36000000',
  'x-ms-version': '2015-04-05',
...
nock('http://xplat.blob.core.windows.net:443')
  ...
  etag: '"0x8D3B076733B9D7A"',
  server: 'Windows-Azure-Blob/1.0 Microsoft-HTTPAPI/2.0',
  'x-ms-request-id': 'ce24bc62-0001-0002-4e5f-e294fd000000',
  'x-ms-version': '2015-04-05',
