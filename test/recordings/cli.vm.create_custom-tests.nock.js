  ...
  [
    ...
    function(nock) {
      var result = nock('https://management.core.windows.net:443')
        ...
        .post('/db1ab6f0-4769-4b27-930e-01e2ef9c123c/services/hostedservices/xplattestvmcustdata/certificates', "*")
        .reply(202, "", {
          'cache-control': 'no-cache',
          'content-length': '0',
          server: '1.0.6198.25 (rd_rdfe_stable.131118-1436) Microsoft-HTTPAPI/2.0',
    ...
    function(nock) {
      var result = nock('https://management.core.windows.net:443')
        ...
        .post('/db1ab6f0-4769-4b27-930e-01e2ef9c123c/services/hostedservices/xplattestvmcustdata/deployments', "*")
    ...
    function(nock) {
      var result = nock('https://management.core.windows.net:443')
        .get('/db1ab6f0-4769-4b27-930e-01e2ef9c123c/services/hostedservices/xplattestvmcustdata/deploymentslots/Production')
