    ...
    function(nock) {
      var result = nock('https://management.core.windows.net:443')
        ...
        .reply(201, "", {
          'cache-control': 'no-cache',
          'content-length': '0',
          location: 'https://management.core.windows.net/subscriptions/db1ab6f0-4769-4b27-930e-01e2ef9c123c/compute/xplattestvmcustdata',
          server: '1.0.6198.25 (rd_rdfe_stable.131118-1436) Microsoft-HTTPAPI/2.0',
          'x-ms-servedbyregion': 'ussouth',
