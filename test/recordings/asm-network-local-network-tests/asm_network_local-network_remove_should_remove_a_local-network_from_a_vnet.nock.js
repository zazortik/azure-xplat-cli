...
nock('http://management.core.windows.net:443')
  ...
  'x-ms-request-id': 'a60290cff609b986a3667759ecffaa47',
  date: 'Wed, 24 Jun 2015 14:32:55 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
...
.put('/bfb5e0bf-124b-4d0c-9352-7c0a9f4d9948/services/networking/media', '*')
  ...
  server: '1.0.6198.243 (rd_rdfe_stable.150618-1025) Microsoft-HTTPAPI/2.0 Microsoft-HTTPAPI/2.0',
  'x-ms-servedbyregion': 'usnorth2',
  'x-ms-request-id': '8cb97fc833edbb80ae47850b5eae8fab',
  date: 'Wed, 24 Jun 2015 14:32:58 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
...
var result = 
nock('http://management.core.windows.net:443')
  .get('/bfb5e0bf-124b-4d0c-9352-7c0a9f4d9948/operations/8cb97fc833edbb80ae47850b5eae8fab')
  .reply(200, "<Operation xmlns=\"http://schemas.microsoft.com/windowsazure\" xmlns:i=\"http://www.w3.org/2001/XMLSchema-instance\"><ID>8cb97fc8-33ed-bb80-ae47-850b5eae8fab</ID><Status>Succeeded</Status><HttpStatusCode>200</HttpStatusCode></Operation>", { 'cache-control': 'no-cache',
  'content-length': '232',
  'content-type': 'application/xml; charset=utf-8',
  server: '1.0.6198.243 (rd_rdfe_stable.150618-1025) Microsoft-HTTPAPI/2.0 Microsoft-HTTPAPI/2.0',
  'x-ms-servedbyregion': 'usnorth2',
  'x-ms-request-id': '56e291b69d28bc8198c06fcc8ef67ea7',
  date: 'Wed, 24 Jun 2015 14:33:31 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
