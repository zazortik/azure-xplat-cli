...
nock('http://management.azure.com:443')
  ...
  'x-ms-request-id': 'd3d724cd-116d-4843-a0cb-c82b4fd85ba0',
  server: 'Microsoft-HTTPAPI/2.0, Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-reads': '14989',
  'x-ms-correlation-request-id': 'ebf397d6-235c-4ff5-8692-f2f3d7396842',
  'x-ms-routing-request-id': 'CENTRALUS:20160210T071338Z:ebf397d6-235c-4ff5-8692-f2f3d7396842',
  date: 'Wed, 10 Feb 2016 07:13:38 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
