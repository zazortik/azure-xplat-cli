...
nock('http://management.azure.com:443')
  ...
  'x-ms-request-id': 'b0b673ae-9842-4733-af0e-fa35a00844ba',
  server: 'Microsoft-HTTPAPI/2.0, Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-reads': '14972',
  'x-ms-correlation-request-id': '413bf517-a6db-4165-aff4-7b076341cf91',
  'x-ms-routing-request-id': 'WESTUS:20160315T051104Z:413bf517-a6db-4165-aff4-7b076341cf91',
  date: 'Tue, 15 Mar 2016 05:11:03 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
