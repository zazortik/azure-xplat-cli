...
nock('http://management.azure.com:443')
  ...
  'x-ms-request-id': 'c46c93e3-0ea2-4d0b-8a6f-53f916186be0',
  server: 'Microsoft-HTTPAPI/2.0, Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-reads': '14928',
  'x-ms-correlation-request-id': '4be40956-e10b-4a49-99f3-efb7172445d9',
  'x-ms-routing-request-id': 'WESTUS:20160425T230141Z:4be40956-e10b-4a49-99f3-efb7172445d9',
  date: 'Mon, 25 Apr 2016 23:01:40 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
