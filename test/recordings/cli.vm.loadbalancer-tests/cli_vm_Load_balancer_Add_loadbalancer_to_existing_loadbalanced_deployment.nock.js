...
nock('https://management.core.windows.net:443')
  ...
  'x-ms-request-id': 'd699b5c0990e8173a5e2c62a000ad893',
  date: 'Mon, 16 Mar 2015 18:38:43 GMT' });
 return result; },
function (nock) { 
var result = 
nock('https://management.core.windows.net:443')
  ...
  server: '1.0.6198.202 (rd_rdfe_stable.150307-1902) Microsoft-HTTPAPI/2.0',
  'x-ms-servedbyregion': 'ussouth2',
  'x-ms-request-id': '15d5014755598430a56a5e30d2a345cb',
  date: 'Mon, 16 Mar 2015 18:38:44 GMT' });
 return result; },
function (nock) { 
var result = 
nock('https://management.core.windows.net:443')
  ...
  server: '1.0.6198.202 (rd_rdfe_stable.150307-1902) Microsoft-HTTPAPI/2.0',
  'x-ms-servedbyregion': 'ussouth2',
  'x-ms-request-id': '9f2882b424d7863c8bf8d31ba9fb98aa',
  date: 'Mon, 16 Mar 2015 18:38:45 GMT' });
 return result; },
function (nock) { 
var result = 
nock('https://management.core.windows.net:443')
...
.post('/2c224e7e-3ef5-431d-a57b-e71f4662e3a6/services/hostedservices/clitestvmVnet4408/deployments/clitestvmVnet4408/loadbalancers', '*')
  ...
  server: '1.0.6198.202 (rd_rdfe_stable.150307-1902) Microsoft-HTTPAPI/2.0',
  'x-ms-servedbyregion': 'ussouth2',
  'x-ms-request-id': 'a36d35d692af85078df3d3dfd5569a79',
  date: 'Mon, 16 Mar 2015 18:38:46 GMT' });
 return result; }]];