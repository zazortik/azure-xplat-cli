...
nock('http://management.core.windows.net:443')
  ...
  'x-ms-request-id': '355d8c248b73b468a3b672e9054a0be7',
  date: 'Fri, 12 Jun 2015 06:54:29 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
...
var result = 
nock('http://management.core.windows.net:443')
  .delete('/bfb5e0bf-124b-4d0c-9352-7c0a9f4d9948/services/hostedservices/clitestvmVnet7153/deployments/clitestvmVnet7153/loadbalancers/testload')
  .reply(202, "", { 'cache-control': 'no-cache',
  'transfer-encoding': 'chunked',
  server: '1.0.6198.240 (rd_rdfe_stable.150608-1900) Microsoft-HTTPAPI/2.0 Microsoft-HTTPAPI/2.0',
  'x-ms-servedbyregion': 'usnorth2',
  'x-ms-request-id': 'a54afee83faab0abac8af0c865c2a203',
  date: 'Fri, 12 Jun 2015 06:54:33 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
...
var result = 
nock('http://management.core.windows.net:443')
  .get('/bfb5e0bf-124b-4d0c-9352-7c0a9f4d9948/operations/a54afee83faab0abac8af0c865c2a203')
  .reply(200, "<Operation xmlns=\"http://schemas.microsoft.com/windowsazure\" xmlns:i=\"http://www.w3.org/2001/XMLSchema-instance\"><ID>a54afee8-3faa-b0ab-ac8a-f0c865c2a203</ID><Status>Succeeded</Status><HttpStatusCode>200</HttpStatusCode></Operation>", { 'cache-control': 'no-cache',
  'content-length': '232',
  'content-type': 'application/xml; charset=utf-8',
  server: '1.0.6198.240 (rd_rdfe_stable.150608-1900) Microsoft-HTTPAPI/2.0 Microsoft-HTTPAPI/2.0',
  'x-ms-servedbyregion': 'usnorth2',
  'x-ms-request-id': '269e2ddd9630b43eba4f36a64844cc9c',
  date: 'Fri, 12 Jun 2015 06:55:04 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
