...
nock('https://management.core.windows.net:443')
  ...
  'x-ms-request-id': 'c3db94119f32886da864763ab0639f7f',
  date: 'Mon, 16 Mar 2015 18:39:25 GMT' });
 return result; },
function (nock) { 
var result = 
nock('https://management.core.windows.net:443')
  ...
  server: '1.0.6198.202 (rd_rdfe_stable.150307-1902) Microsoft-HTTPAPI/2.0',
  'x-ms-servedbyregion': 'ussouth2',
  'x-ms-request-id': '5650aedda0958ec1b668b3f32936b3c2',
  date: 'Mon, 16 Mar 2015 18:39:26 GMT' });
 return result; },
function (nock) { 
var result = 
nock('https://management.core.windows.net:443')
  ...
  server: '1.0.6198.202 (rd_rdfe_stable.150307-1902) Microsoft-HTTPAPI/2.0',
  'x-ms-servedbyregion': 'ussouth2',
  'x-ms-request-id': 'f4c2081a52258b51b5bc035aabd1dcf9',
  date: 'Mon, 16 Mar 2015 18:39:26 GMT' });
 return result; },
function (nock) { 
var result = 
nock('https://management.core.windows.net:443')
  .delete('/2c224e7e-3ef5-431d-a57b-e71f4662e3a6/services/hostedservices/clitestvmVnet4408/deployments/clitestvmVnet4408/loadbalancers/testload')
  .reply(202, "", { 'cache-control': 'no-cache',
  'content-length': '0',
  server: '1.0.6198.202 (rd_rdfe_stable.150307-1902) Microsoft-HTTPAPI/2.0',
  'x-ms-servedbyregion': 'ussouth2',
  'x-ms-request-id': '6daba244cad888b0897d73db2e351665',
  date: 'Mon, 16 Mar 2015 18:39:28 GMT' });
 return result; },
function (nock) { 
var result = 
nock('https://management.core.windows.net:443')
  ...
  server: '1.0.6198.202 (rd_rdfe_stable.150307-1902) Microsoft-HTTPAPI/2.0',
  'x-ms-servedbyregion': 'ussouth2',
  'x-ms-request-id': '1fa0f957784d8229ad8cd7923d5cc230',
  date: 'Mon, 16 Mar 2015 18:39:58 GMT' });
 return result; },
function (nock) { 
var result = 
nock('https://management.core.windows.net:443')
  .get('/2c224e7e-3ef5-431d-a57b-e71f4662e3a6/operations/6daba244cad888b0897d73db2e351665')
  .reply(200, "<Operation xmlns=\"http://schemas.microsoft.com/windowsazure\" xmlns:i=\"http://www.w3.org/2001/XMLSchema-instance\"><ID>6daba244-cad8-88b0-897d-73db2e351665</ID><Status>Succeeded</Status><HttpStatusCode>200</HttpStatusCode></Operation>", { 'cache-control': 'no-cache',
  'content-length': '232',
  'content-type': 'application/xml; charset=utf-8',
  server: '1.0.6198.202 (rd_rdfe_stable.150307-1902) Microsoft-HTTPAPI/2.0',
  'x-ms-servedbyregion': 'ussouth2',
  'x-ms-request-id': '5cb20863725d8212822dedba9eef49c3',
  date: 'Mon, 16 Mar 2015 18:39:59 GMT' });
 return result; }]];