...
.post('/providers/Microsoft.Network/checkTrafficManagerNameAvailability?api-version=2015-11-01', '*')
  ...
  'x-ms-request-id': 'fcfec319-1c88-479a-bfaf-645d58f1f163',
  server: 'Microsoft-IIS/8.5',
  'x-aspnet-version': '4.0.30319',
  'x-powered-by': 'ASP.NET',
  'x-ms-ratelimit-remaining-tenant-writes': '1199',
  'x-ms-correlation-request-id': 'ea51ec99-5a63-456f-85fa-711642e38162',
  'x-ms-routing-request-id': 'WESTEUROPE:20160218T081739Z:ea51ec99-5a63-456f-85fa-711642e38162',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  date: 'Thu, 18 Feb 2016 08:17:38 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
