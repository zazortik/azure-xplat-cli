...
nock('http://management.azure.com:443')
  ...
  'x-ms-request-id': '3482cefd-1553-4779-a931-8745fcdd8179',
  server: 'Microsoft-IIS/8.5',
  'x-aspnet-version': '4.0.30319',
  'x-powered-by': 'ASP.NET',
  'x-ms-ratelimit-remaining-subscription-resource-requests': '10798',
  'x-ms-correlation-request-id': 'af7f78bc-43bd-4414-a416-5659c42f908d',
  'x-ms-routing-request-id': 'WESTEUROPE:20160218T081736Z:af7f78bc-43bd-4414-a416-5659c42f908d',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  date: 'Thu, 18 Feb 2016 08:17:36 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
