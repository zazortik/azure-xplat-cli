...
nock('http://management.azure.com:443')
  ...
  expires: '-1',
  etag: 'W/"f2663aa5-f98b-4794-8e1a-6c91da83bb86"',
  'x-ms-request-id': '51f7a3b8-6471-49b6-9833-56c67e43504a',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  server: 'Microsoft-HTTPAPI/2.0, Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-reads': '14996',
  'x-ms-correlation-request-id': 'efecbbcb-5843-4b16-9215-87752ebb5e2a',
  'x-ms-routing-request-id': 'WESTEUROPE:20160914T085835Z:efecbbcb-5843-4b16-9215-87752ebb5e2a',
  date: 'Wed, 14 Sep 2016 08:58:34 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
