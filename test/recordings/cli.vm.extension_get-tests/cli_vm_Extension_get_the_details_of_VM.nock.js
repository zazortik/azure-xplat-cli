...
nock('https://management.core.windows.net:443')
  ...
  'x-ms-request-id': 'e054d7490fed8464bf0abe60bf59ddec',
  date: 'Mon, 16 Mar 2015 01:06:43 GMT' });
 return result; },
function (nock) { 
var result = 
nock('https://management.core.windows.net:443')
  ...
  server: '1.0.6198.202 (rd_rdfe_stable.150307-1902) Microsoft-HTTPAPI/2.0',
  'x-ms-servedbyregion': 'ussouth2',
  'x-ms-request-id': 'b44cc77fff1e8309909a0bc2107ed213',
  date: 'Mon, 16 Mar 2015 01:06:44 GMT' });
 return result; },
function (nock) { 
var result = 
nock('https://management.core.windows.net:443')
  ...
  server: '1.0.6198.202 (rd_rdfe_stable.150307-1902) Microsoft-HTTPAPI/2.0',
  'x-ms-servedbyregion': 'ussouth2',
  'x-ms-request-id': 'e4d9453a9ef688bcaf8ee461698673e3',
  date: 'Mon, 16 Mar 2015 01:06:44 GMT' });
 return result; },
function (nock) { 
var result = 
nock('https://management.core.windows.net:443')
  ...
  server: '1.0.6198.202 (rd_rdfe_stable.150307-1902) Microsoft-HTTPAPI/2.0',
  'x-ms-servedbyregion': 'ussouth2',
  'x-ms-request-id': '959d56302230866aadab7010266bdc5e',
  date: 'Mon, 16 Mar 2015 01:06:44 GMT' });
 return result; },
function (nock) { 
var result = 
...
nock('https://management.core.windows.net:443')
  ...
  server: '1.0.6198.202 (rd_rdfe_stable.150307-1902) Microsoft-HTTPAPI/2.0',
  'x-ms-servedbyregion': 'ussouth2',
  'x-ms-request-id': '32210501e7188e1cb4866a1aac6e4c83',
  date: 'Mon, 16 Mar 2015 01:06:46 GMT' });
 return result; },
function (nock) { 
var result = 
nock('https://management.core.windows.net:443')
  ...
  server: '1.0.6198.202 (rd_rdfe_stable.150307-1902) Microsoft-HTTPAPI/2.0',
  'x-ms-servedbyregion': 'ussouth2',
  'x-ms-request-id': 'e4e89135b47787bdbcee657f7902718c',
  date: 'Mon, 16 Mar 2015 01:06:47 GMT' });
 return result; },
function (nock) { 
var result = 
nock('https://management.core.windows.net:443')
  ...
  server: '1.0.6198.202 (rd_rdfe_stable.150307-1902) Microsoft-HTTPAPI/2.0',
  'x-ms-servedbyregion': 'ussouth2',
  'x-ms-request-id': '6055fff06b548b9bb77f345c51a9c834',
  date: 'Mon, 16 Mar 2015 01:06:47 GMT' });
 return result; },
function (nock) { 
var result = 
nock('https://management.core.windows.net:443')
  ...
  server: '1.0.6198.202 (rd_rdfe_stable.150307-1902) Microsoft-HTTPAPI/2.0',
  'x-ms-servedbyregion': 'ussouth2',
  'x-ms-request-id': 'c1f5fbe22e89865ba159cf92faa48545',
  date: 'Mon, 16 Mar 2015 01:06:47 GMT' });
 return result; },
function (nock) { 
var result = 
nock('https://management.core.windows.net:443')
  ...
  server: '1.0.6198.202 (rd_rdfe_stable.150307-1902) Microsoft-HTTPAPI/2.0',
  'x-ms-servedbyregion': 'ussouth2',
  'x-ms-request-id': '039b0ce5bfe882638a0453f3553a234d',
  date: 'Mon, 16 Mar 2015 01:06:47 GMT' });
 return result; },
function (nock) { 
var result = 
nock('https://management.core.windows.net:443')
  ...
  server: '1.0.6198.202 (rd_rdfe_stable.150307-1902) Microsoft-HTTPAPI/2.0',
  'x-ms-servedbyregion': 'ussouth2',
  'x-ms-request-id': '9c412d7b3bfd84f98728a08303becc67',
  date: 'Mon, 16 Mar 2015 01:06:48 GMT' });
 return result; }]];